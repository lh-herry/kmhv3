  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_pdest = _RANDOM[4'h6][13:6];
        enqDelayValidReg_last_REG = _RANDOM[4'h7][0];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType = _RANDOM[4'h7][9:1];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_wflags = _RANDOM[4'h7][10];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_fmt = _RANDOM[4'h7][12:11];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_rm = _RANDOM[4'h7][15:13];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[4'h7][24:17];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG =
          {_RANDOM[4'h7][31:25], _RANDOM[4'h8][0]};
        io_commonOut_entry_bits_status_srcStatus_2_psrc_REG = _RANDOM[4'h8][8:1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
