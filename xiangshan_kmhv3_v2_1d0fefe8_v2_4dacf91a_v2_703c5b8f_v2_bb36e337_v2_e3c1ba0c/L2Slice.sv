...
module L2Slice(
  ...
  wire         activated =
    ...
    & (mbist_array == 4'h2 | mbist_array == 4'h3 | mbist_array == 4'h4
       ...
       | mbist_array == 4'hB | mbist_array == 4'hC);
  reg  [3:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  wire         selected =
    ...
    | arrayReg == 4'h6 | arrayReg == 4'h7 | arrayReg == 4'h8;
  wire         doSpread = selected | allReg;
  wire         selected_1 =
    arrayReg == 4'h9 | arrayReg == 4'hA | arrayReg == 4'hB | arrayReg == 4'hC;
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[4'h0][31:28],
           ...
           _RANDOM[4'h4],
           _RANDOM[4'h5][4:0]};
        renReg = _RANDOM[4'h5][5];
        addrRdReg = _RANDOM[4'h5][18:6];
        pipelineDataOutReg =
          {_RANDOM[4'h5][31:19],
           _RANDOM[4'h6],
           _RANDOM[4'h7],
  ...
  assign toNextPipeline_0_array = doSpread ? arrayReg : 4'h0;
