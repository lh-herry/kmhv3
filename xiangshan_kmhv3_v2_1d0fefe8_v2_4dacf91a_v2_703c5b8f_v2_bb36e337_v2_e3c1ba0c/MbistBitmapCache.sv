...
module MbistBitmapCache(
  ...
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 90'h0;
  wire        selectedVec_0_1 = arrayReg == 6'h29;
  wire        doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 90'h0;
  wire        selectedVec_0_2 = arrayReg == 6'h2A;
  wire        doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = selectedVec_0_2 ? toSRAM_2_rdata : 90'h0;
  wire        selectedVec_0_3 = arrayReg == 6'h2B;
  wire        doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = selectedVec_0_3 ? toSRAM_3_rdata : 90'h0;
  wire        activated =
    mbist_all | mbist_req
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        addrReg = _RANDOM[2'h0][16:11];
        dataInReg =
          {_RANDOM[2'h0][31:17], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][10:0]};
        renReg = _RANDOM[2'h3][11];
        addrRdReg = _RANDOM[2'h3][17:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
