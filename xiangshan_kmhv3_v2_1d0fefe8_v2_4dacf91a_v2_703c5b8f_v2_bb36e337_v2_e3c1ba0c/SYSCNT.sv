...
module SYSCNT(
  ...
  reg              time_en;
  wire             _out_out_bits_data_WIRE_3 = auto_in_a_bits_address[15:5] == 11'h5FF;
  wire             _out_out_bits_data_WIRE_2 = auto_in_a_bits_address[15:5] == 11'h600;
  wire [3:0]       _out_backSel_T = 4'h1 << auto_in_a_bits_address[4:3];
  ...
  always @(posedge bus_clock or posedge bus_reset) begin
    if (bus_reset) begin
      ...
      time_sw_req <=
        _out_wofireMux_T_2 & _out_backSel_T[2] & _out_out_bits_data_WIRE_2
        & auto_in_a_bits_mask[0]
          ? auto_in_a_bits_data[0]
          : ~_time_sw_update_bus_chain_io_q & time_sw_req;
      if (_out_wofireMux_T_2 & _out_backSel_T[0] & _out_out_bits_data_WIRE_2
          & auto_in_a_bits_mask[0])
        freqidx <= auto_in_a_bits_data[2:0];
      freqidx_req <=
        _out_wofireMux_T_2 & _out_backSel_T[1] & _out_out_bits_data_WIRE_2
        & auto_in_a_bits_mask[0]
          ? auto_in_a_bits_data[0]
          : ~_inc_update_bus_chain_io_q & freqidx_req;
    end
  end // always @(posedge, posedge)
