...
module SRT16Divint_4(
  ...
  wire [34:0]      _GEN = 35'(35'h0 - norm_d);
  ...
  wire [7:0]       sel_cons_0_0 = 8'(_GEN[31:24] + _qds_cons_io_m_neg_1[8:1]);
  wire [7:0]       sel_cons_0_1 = 8'(_GEN[31:24] + _qds_cons_io_m_neg_0[8:1]);
  wire [7:0]       sel_cons_0_2 = 8'(_GEN[31:24] + _qds_cons_io_m_pos_1[8:1]);
  wire [7:0]       sel_cons_0_3 = 8'(_GEN[31:24] + _qds_cons_io_m_pos_2[8:1]);
  wire [7:0]       sel_cons_1_0 = 8'(_GEN[32:25] + _qds_cons_io_m_neg_1[8:1]);
  wire [7:0]       sel_cons_1_1 = 8'(_GEN[32:25] + _qds_cons_io_m_neg_0[8:1]);
  wire [7:0]       sel_cons_1_2 = 8'(_GEN[32:25] + _qds_cons_io_m_pos_1[8:1]);
  wire [7:0]       sel_cons_1_3 = 8'(_GEN[32:25] + _qds_cons_io_m_pos_2[8:1]);
  ...
  wire [37:0]      rem_adjust_ralign =
    $unsigned($signed($signed(rem_adjust) >>> 6'({1'h0, lzc_d_reg} + 6'h5)));
  ...
  wire [37:0]      _GEN_0 = {4'h0, _early_rem_T ? {abs_x_reg, 2'h0} : 34'h0};
  wire [3:0]       _GEN_1 =
    {{1'h0}, {io_dividend[31]}, {io_dividend[15]}, {io_dividend[7]}};
  wire             x_sign = io_sign & _GEN_1[io_sew];
  wire [3:0]       _GEN_2 = {{1'h0}, {io_divisor[31]}, {io_divisor[15]}, {io_divisor[7]}};
  ...
  wire [31:0]      neg_x_q =
    32'(32'h0 - (in_handshake ? _GEN_3[io_sew][31:0] : iter_q_A_reg));
  ...
  wire [31:0]      neg_d_q =
    32'(32'h0 - (in_handshake ? _GEN_4[io_sew][31:0] : iter_q_B_reg));
  wire [4:0]       lzc_x =
    abs_x_reg[31]
      ? 5'h0
      : abs_x_reg[30]
  ...
  wire [94:0]      _norm_x_part_T_2 = {63'h0, abs_x_reg} << {90'h0, lzc_x[4:2], 2'h0};
  wire [94:0]      _norm_d_part_T_2 = {63'h0, abs_d_reg} << {90'h0, lzc_d[4:2], 2'h0};
  wire [5:0]       _lzc_diff_T_2 = 6'({1'h0, lzc_d} - {1'h0, lzc_x});
  wire [37:0]      _GEN_5 =
    {24'h0,
     abs_x_reg == 32'h0,
     lzc_x[1:0],
  ...
  always @(posedge clock) begin
    ...
    if (stateReg[1] | stateReg[2] | stateReg[3]) begin
      ...
      iterB_reg_1 <=
        stateReg[1]
          ? _GEN_5
          : stateReg[2] ? (early_finish ? _GEN_0 : 38'h0) : _IterBlock_io_nxt_iterB_1;
    end
    if (in_handshake) begin
      abs_x_reg <= x_sign ? neg_x_q : _GEN_3[io_sew][31:0];
      abs_d_reg <= d_sign ? neg_d_q : _GEN_4[io_sew][31:0];
    end
    if (stateReg[1])
      lzc_d_reg <= lzc_d;
    if (stateReg[1])
    ...
    if (stateReg[2]) begin
      spec_cons_reg_0_0 <= 9'(_GEN[29:21] + _qds_cons_io_m_neg_1);
      spec_cons_reg_0_1 <= 9'(_GEN[29:21] + _qds_cons_io_m_neg_0);
      spec_cons_reg_0_2 <= 9'(_GEN[29:21] + _qds_cons_io_m_pos_1);
      spec_cons_reg_0_3 <= 9'(_GEN[29:21] + _qds_cons_io_m_pos_2);
      spec_cons_reg_1_0 <= 9'(_GEN[30:22] + _qds_cons_io_m_neg_1);
      spec_cons_reg_1_1 <= 9'(_GEN[30:22] + _qds_cons_io_m_neg_0);
      spec_cons_reg_1_2 <= 9'(_GEN[30:22] + _qds_cons_io_m_pos_1);
      spec_cons_reg_1_3 <= 9'(_GEN[30:22] + _qds_cons_io_m_pos_2);
