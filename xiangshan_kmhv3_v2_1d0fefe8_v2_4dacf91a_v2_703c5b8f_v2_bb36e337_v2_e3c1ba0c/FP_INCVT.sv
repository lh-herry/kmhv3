...
module FP_INCVT(
  ...
  wire         expPlus1EnableNext =
    isFpNarrowNext | ~(io_opType[6]) | isCrossLow | _expPlus1EnableNext_T_2
    & isSubnormalSrcNext;
  reg          expPlus1Enable;
  reg  [63:0]  shiftLeft;
  ...
  wire [22:0]  subRounderInput =
    {13'h0, output1HReg[1] ? inRounder[63:54] : 10'h0}
    | (output1HReg[2] ? inRounder[63:41] : 23'h0);
  ...
  wire         _GEN_1 = input_0[62:52] < 11'h433 & ~(|(fcvtmodShift[10:6]));
  wire [127:0] shiftLeftNext =
    {63'h0, input_0[51:0], 13'h0} << _leadZerosNext_lzc_io_out_data;
  ...
  wire [51:0]  fracNormaled = isSubnormalSrc ? shiftLeft[63:12] : fracSrcLeft[63:12];
  ...
  wire [63:0]  _froundUpInput_T =
    64'(froundOldInput
        + ({63'h0, _froundUpShiftMask_T} | {62'h0, _froundUpShiftMask_T_2, 1'h0}
           ...
           | {59'h0, _froundUpShiftMask_T_8, 4'h0}
           | {58'h0, _froundUpShiftMask_T_10, 5'h0}
           | {57'h0, _froundUpShiftMask_T_12, 6'h0}
           | {56'h0, _froundUpShiftMask_T_14, 7'h0}
           | {55'h0, _froundUpShiftMask_T_16, 8'h0}
           | {54'h0, _froundUpShiftMask_T_18, 9'h0}
           | {53'h0, _froundUpShiftMask_T_20, 10'h0}
           | {52'h0, _froundUpShiftMask_T_22, 11'h0}
           | {51'h0, _froundUpShiftMask_T_24, 12'h0}
           | {50'h0, _froundUpShiftMask_T_26, 13'h0}
           | {49'h0, _froundUpShiftMask_T_28, 14'h0}
           | {48'h0, _froundUpShiftMask_T_30, 15'h0}
           | {47'h0, _froundUpShiftMask_T_32, 16'h0}
           | {46'h0, _froundUpShiftMask_T_34, 17'h0}
           | {45'h0, _froundUpShiftMask_T_36, 18'h0}
           | {44'h0, _froundUpShiftMask_T_38, 19'h0}
           | {43'h0, _froundUpShiftMask_T_40, 20'h0}
           | {42'h0, _froundUpShiftMask_T_42, 21'h0}
           | {41'h0, _froundUpShiftMask_T_44, 22'h0}
           | {40'h0, _froundUpShiftMask_T_46, 23'h0}
           | {39'h0, _froundUpShiftMask_T_48, 24'h0}
           | {38'h0, _froundUpShiftMask_T_50, 25'h0}
           | {37'h0, _froundUpShiftMask_T_52, 26'h0}
           | {36'h0, _froundUpShiftMask_T_54, 27'h0}
           | {35'h0, _froundUpShiftMask_T_56, 28'h0}
           | {34'h0, _froundUpShiftMask_T_58, 29'h0}
           | {33'h0, _froundUpShiftMask_T_60, 30'h0}
           | {32'h0, _froundUpShiftMask_T_62, 31'h0}
           | {31'h0, _froundUpShiftMask_T_64, 32'h0}
           | {30'h0, _froundUpShiftMask_T_66, 33'h0}
           | {29'h0, _froundUpShiftMask_T_68, 34'h0}
           | {28'h0, _froundUpShiftMask_T_70, 35'h0}
           | {27'h0, _froundUpShiftMask_T_72, 36'h0}
           | {26'h0, _froundUpShiftMask_T_74, 37'h0}
           | {25'h0, _froundUpShiftMask_T_76, 38'h0}
           | {24'h0, _froundUpShiftMask_T_78, 39'h0}
           | {23'h0, _froundUpShiftMask_T_80, 40'h0}
           | {22'h0, _froundUpShiftMask_T_82, 41'h0}
           | {21'h0, _froundUpShiftMask_T_84, 42'h0}
           | {20'h0, _froundUpShiftMask_T_86, 43'h0}
           | {19'h0, _froundUpShiftMask_T_88, 44'h0}
           | {18'h0, _froundUpShiftMask_T_90, 45'h0}
           | {17'h0, _froundUpShiftMask_T_92, 46'h0}
           | {16'h0, _froundUpShiftMask_T_94, 47'h0}
           | {15'h0, _froundUpShiftMask_T_96, 48'h0}
           | {14'h0, _froundUpShiftMask_T_98, 49'h0}
           | {13'h0, _froundUpShiftMask_T_100, 50'h0}
           | {12'h0, _froundUpShiftMask_T_102, 51'h0}
           | {11'h0, _froundUpShiftMask_T_104, 52'h0}
           | {10'h0, _froundUpShiftMask_T_106, 53'h0}
           | {9'h0, _froundUpShiftMask_T_108, 54'h0}
           | {8'h0, _froundUpShiftMask_T_110, 55'h0}
           | {7'h0, _froundUpShiftMask_T_112, 56'h0}
           | {6'h0, _froundUpShiftMask_T_114, 57'h0}
           | {5'h0, _froundUpShiftMask_T_116, 58'h0}
           | {4'h0, _froundUpShiftMask_T_118, 59'h0}
           | {3'h0, _froundUpShiftMask_T_120, 60'h0}
           | {2'h0, _froundUpShiftMask_T_122, 61'h0}
           | {1'h0, _froundUpShiftMask_T_124, 62'h0}
           | {_froundUpShiftMask_T_126, 63'h0}));
  wire [12:0]  _exp_T_1 = 13'(expReg + {12'h0, expPlus1Enable});
  wire         cout =
    _rounder_io_r_up
    & (isFp2Int
  ...
  wire [7:0]   _expRounded_T =
    cout ? 8'(expReg[7:0] + {6'h0, expPlus1Enable ? 2'h2 : 2'h1}) : _exp_T_1[7:0];
  ...
  wire         _fpwidenResultMap_T_16 = isSubnormalSrc | isnormalSrc;
  wire         ofRounded =
    ~(_exp_T_1[12])
    & (output1HReg[1]
       & (cout
            ? (|{&(_exp_T_1[4:1]), _exp_T_1[11:5]})
            : (|{&(_exp_T_1[4:0]), _exp_T_1[11:5]})) | output1HReg[2]
       & (cout
            ? (|{&(_exp_T_1[7:1]), _exp_T_1[11:8]})
            : (|{&(_exp_T_1[7:0]), _exp_T_1[11:8]})) | output1HReg[3]
       & (cout
            ? (&(_exp_T_1[10:1])) | _exp_T_1[11]
            : (&(_exp_T_1[10:0])) | _exp_T_1[11]));
  wire         maybeSub = _exp_T_1[12] | ~(|_exp_T_1);
  wire [22:0]  subFracRounded =
    _subRounder_io_r_up ? 23'(subRounderInput + 23'h1) : subRounderInput;
  wire         subCout =
    _subRounder_io_r_up
    & (output1HReg[1] & (&(inRounder[63:54])) | output1HReg[2] & (&(inRounder[63:41])));
  wire         _result1H_T_12 = rm == 3'h6;
  wire         _fpNarrowResultMap_T_33 =
    ~expIsOnesSrc & ~maybeSub & ofRounded & (rmin | _result1H_T_12);
  wire         _fpNarrowResultMap_T_32 =
    ~expIsOnesSrc & ~maybeSub & ofRounded & ~(rmin | _result1H_T_12);
  wire         _fpNarrowResultMap_T_31 = ~expIsOnesSrc & ~maybeSub & ~ofRounded;
  wire         _fpNarrowResultMap_T_30 = ~expIsOnesSrc & maybeSub;
  ...
  wire [3:0]   _GEN_3 = {2'h0, hasSignInt, cout};
  wire [3:0]   _ofExpRounded_T_3 = 4'h1 << _GEN_3;
  wire [3:0]   _ofExpRounded_T_34 = 4'h1 << _GEN_3;
  wire [3:0]   _ofExpRounded_T_65 = 4'h1 << _GEN_3;
  wire [3:0]   _ofExpRounded_T_96 = 4'h1 << _GEN_3;
  wire         ofExpRounded =
    ~(_exp_T_1[12])
    & (output1HReg[0]
       & (_ofExpRounded_T_3[0] & (|(_exp_T_1[11:3])) | _ofExpRounded_T_3[1]
          & ((|(_exp_T_1[11:3])) | (&(_exp_T_1[2:0]))) | _ofExpRounded_T_3[2]
          & ((|(_exp_T_1[11:3])) | (&(_exp_T_1[2:0]))) | _ofExpRounded_T_3[3]
  ...
  wire         toInv =
    ofExpRounded
    & ~(signSrc
        & (output1HReg[0] & _exp_T_1[12:3] == 10'h0
           & (cout ? (&(_exp_T_1[2:1])) & ~(_exp_T_1[0]) : (&(_exp_T_1[2:0])))
           | output1HReg[1] & _exp_T_1[12:4] == 9'h0
           & (cout ? (&(_exp_T_1[3:1])) & ~(_exp_T_1[0]) : (&(_exp_T_1[3:0])))
           | output1HReg[2] & _exp_T_1[12:5] == 8'h0
        ...
        fflags <=
          {_GEN_2
           ...
           ~_GEN_2 & _rounderMapIn_T & ~expIsOnesSrc & maybeSub
             & (~cout & ~(|_exp_T_1) | _exp_T_1[12]) & _subRounder_io_inexact
             & ~s1_fpCanonicalNAN,
           ~_GEN_2
             & (_rounderMapIn_T
                  ? ~expIsOnesSrc
            ...
            ? {32'h0,
               output1HReg[2]
                 ? (expIsOnesSrc ? {signNonNan, 8'hFF, fracNotZeroSrc, 22'h0} : 32'h0)
                   ...
                   | (_fpwidenResultMap_T_16
                        ? {signNonNan, _exp_T_1[7:0], fracNormaled[51:29]}
                        : 32'h0)
                 : 32'h0}
              | (output1HReg[3]
                   ? (expIsOnesSrc ? {signNonNan, 11'h7FF, fracNotZeroSrc, 51'h0} : 64'h0)
                     ...
                     | (_fpwidenResultMap_T_16
                          ? {signNonNan, _exp_T_1[10:0], fracNormaled}
                          : 64'h0)
                   : 64'h0)
            : _rounderMapIn_T
                ? {32'h0,
                   {16'h0,
                    output1HReg[1]
                      ? (expIsOnesSrc ? {signNonNan, 5'h1F, fracNotZeroSrc, 9'h0} : 16'h0)
                        ...
                        | (_fpNarrowResultMap_T_31
                             ? {signNonNan, _expRounded_T[4:0], fracRounded[9:0]}
                             : 16'h0)
                        | (_fpNarrowResultMap_T_30
                     ...
                     | (output1HReg[2]
                          ? (expIsOnesSrc
                               ...
                               : 32'h0)
                            | (_fpNarrowResultMap_T_33
                                 ? {signNonNan, 31'h7F7FFFFF}
                                 : 32'h0)
                            | (_fpNarrowResultMap_T_32
                                 ? {signNonNan, 31'h7F800000}
                                 : 32'h0)
                            | (_fpNarrowResultMap_T_31
                ...
                : isFroundOrFroundnxReg
                    ? (output1HReg[1]
                         ? (_froundResultMap_T_75 ? oldInputReg : 64'h0)
      ...
      expReg <=
        13'({1'h0,
            ...
            + (expPlus1EnableNext
                 ? {3'h7,
                    ~({4'h0,
                       _expPlus1EnableNext_T_2 ? _leadZerosNext_lzc_io_out_data : 6'h0}
                      | (isFpNarrowNext
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        expReg = _RANDOM[4'h3][15:3];
        expPlus1Enable = _RANDOM[4'h3][16];
        shiftLeft = {_RANDOM[4'h3][31:17], _RANDOM[4'h4], _RANDOM[4'h5][16:0]};
        fracSrcLeft = {_RANDOM[4'h5][31:17], _RANDOM[4'h6], _RANDOM[4'h7][16:0]};
        inRounder = {_RANDOM[4'h7][31:17], _RANDOM[4'h8], _RANDOM[4'h9][17:0]};
        sticky = _RANDOM[4'h9][18];
        froundExpLessThanBias = _RANDOM[4'h9][19];
        froundExpGreaterThanMaxExp = _RANDOM[4'h9][20];
        fracShiftMask = _RANDOM[4'h9][31:21];
        froundOldExp = _RANDOM[4'hA][10:0];
        froundOldFrac = {_RANDOM[4'hA][31:11], _RANDOM[4'hB][30:0]};
        fcvtmodFracReg = {_RANDOM[4'hB][31], _RANDOM[4'hC], _RANDOM[4'hD][30:0]};
        fcvtmodTrueExpReg = {_RANDOM[4'hD][31], _RANDOM[4'hE][9:0]};
        fcvtmodNxReg = _RANDOM[4'hE][10];
        fcvtmodExpLessThanBias = _RANDOM[4'hE][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fireReg_last_r = 1'h0;
        expNotZeroSrc = 1'h0;
  ...
  ShiftRightJam shiftRightJam (
    .io_in     ({_fracValueSrc_T_1, input_0[51:0], 12'h0}),
    .io_shamt
      ((&_shamtWidth_T_19)
         ? 11'h0
         : (|(_shamtWidth_T_19[10:6])) ? 11'h41 : 11'(_shamtWidth_T_19 + 11'h1)),
  ...
  RoundingUnit_2 subRounder (
    ...
    .io_roundIn  (output1HReg[1] & inRounder[53] | output1HReg[2] & inRounder[40]),
    .io_stickyIn
      (output1HReg[1] & (|{_subRounderMap_T_9, inRounder[52:0]}) | output1HReg[2]
       & (|{_subRounderMap_T_9, inRounder[39:0]})),
    .io_signIn   (signSrc),
    .io_rm       (rm),
