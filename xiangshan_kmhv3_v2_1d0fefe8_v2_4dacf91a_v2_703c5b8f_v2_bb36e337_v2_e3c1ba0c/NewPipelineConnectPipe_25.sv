  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_ftqPtr_value = _RANDOM[6'h4][17:12];
        data_uop_ftqOffset = _RANDOM[6'h4][22:18];
        data_uop_fuOpType = _RANDOM[6'h6][31:23];
        data_uop_rfWen = _RANDOM[6'h7][0];
        data_uop_fpWen = _RANDOM[6'h7][1];
        data_uop_vpu_vstart = _RANDOM[6'h9][14:7];
        data_uop_vpu_veew = _RANDOM[6'hE][15:14];
        data_uop_pdest = _RANDOM[6'h12][14:7];
        data_uop_robIdx_flag = _RANDOM[6'h13][4];
        data_uop_robIdx_value = _RANDOM[6'h13][13:5];
        data_uop_storeSetHit = _RANDOM[6'h27][29];
        data_uop_waitForRobIdx_flag = _RANDOM[6'h27][30];
        data_uop_waitForRobIdx_value = {_RANDOM[6'h27][31], _RANDOM[6'h28][7:0]};
        data_uop_loadWaitBit = _RANDOM[6'h28][8];
        data_uop_loadWaitStrict = _RANDOM[6'h28][9];
        data_uop_lqIdx_flag = _RANDOM[6'h28][17];
        data_uop_lqIdx_value = _RANDOM[6'h28][24:18];
        data_uop_sqIdx_flag = _RANDOM[6'h28][25];
        data_uop_sqIdx_value = _RANDOM[6'h28][31:26];
        data_vaddr = {_RANDOM[6'h29][31:7], _RANDOM[6'h2A][24:0]};
        data_fullva = {_RANDOM[6'h2A][31:25], _RANDOM[6'h2B], _RANDOM[6'h2C][24:0]};
        data_size = _RANDOM[6'h2C][27:25];
        data_mask = {_RANDOM[6'h2C][31:28], _RANDOM[6'h2D][11:0]};
        data_elemIdx = _RANDOM[6'h2D][19:12];
        data_mbIndex = _RANDOM[6'h2D][23:20];
        data_regOffset = _RANDOM[6'h2D][27:24];
        data_elemIdxInsideVd = {_RANDOM[6'h2D][31:28], _RANDOM[6'h2E][3:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
