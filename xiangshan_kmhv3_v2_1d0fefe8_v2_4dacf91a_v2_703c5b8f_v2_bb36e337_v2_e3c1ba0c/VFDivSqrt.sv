      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:27],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][26:0]};
        outData_r_vl = {_RANDOM[5'h17][31:27], _RANDOM[5'h18][2:0]};
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h1C][3];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1C][4];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1C][13:5];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1C][21:14];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1C][22];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1C][23];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[5'h1C][24];
      `endif // RANDOMIZE_REG_INIT
    end // initial
