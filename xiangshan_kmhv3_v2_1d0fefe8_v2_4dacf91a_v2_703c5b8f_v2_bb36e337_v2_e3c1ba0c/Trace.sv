  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_out_blocks_0_valid_r = _RANDOM[4'h0][0];
        s1_out_blocks_0_bits_r_ftqIdx_value = _RANDOM[4'h0][7:2];
        s1_out_blocks_0_bits_r_ftqOffset = _RANDOM[4'h0][12:8];
        s1_out_blocks_0_bits_r_tracePipe_itype = _RANDOM[4'h0][16:13];
        s1_out_blocks_0_bits_r_tracePipe_iretire = _RANDOM[4'h0][21:17];
        s1_out_blocks_0_bits_r_tracePipe_ilastsize = _RANDOM[4'h0][22];
        s1_out_blocks_1_valid_r = _RANDOM[4'h0][23];
        s1_out_blocks_1_bits_r_ftqIdx_value = _RANDOM[4'h0][30:25];
        s1_out_blocks_1_bits_r_ftqOffset = {_RANDOM[4'h0][31], _RANDOM[4'h1][3:0]};
        s1_out_blocks_1_bits_r_tracePipe_itype = _RANDOM[4'h1][7:4];
        s1_out_blocks_1_bits_r_tracePipe_iretire = _RANDOM[4'h1][12:8];
        s1_out_blocks_1_bits_r_tracePipe_ilastsize = _RANDOM[4'h1][13];
        s1_out_blocks_2_valid_r = _RANDOM[4'h1][14];
        s1_out_blocks_2_bits_r_ftqIdx_value = _RANDOM[4'h1][21:16];
        s1_out_blocks_2_bits_r_ftqOffset = _RANDOM[4'h1][26:22];
        s1_out_blocks_2_bits_r_tracePipe_itype = _RANDOM[4'h1][30:27];
        s1_out_blocks_2_bits_r_tracePipe_iretire =
          {_RANDOM[4'h1][31], _RANDOM[4'h2][3:0]};
        s1_out_blocks_2_bits_r_tracePipe_ilastsize = _RANDOM[4'h2][4];
        s1_out_blocks_3_valid_r = _RANDOM[4'h2][5];
        s1_out_blocks_3_bits_r_ftqIdx_value = _RANDOM[4'h2][12:7];
        s1_out_blocks_3_bits_r_ftqOffset = _RANDOM[4'h2][17:13];
        s1_out_blocks_3_bits_r_tracePipe_itype = _RANDOM[4'h2][21:18];
        s1_out_blocks_3_bits_r_tracePipe_iretire = _RANDOM[4'h2][26:22];
        s1_out_blocks_3_bits_r_tracePipe_ilastsize = _RANDOM[4'h2][27];
        s1_out_blocks_4_valid_r = _RANDOM[4'h2][28];
        s1_out_blocks_4_bits_r_ftqIdx_value = {_RANDOM[4'h2][31:30], _RANDOM[4'h3][3:0]};
        s1_out_blocks_4_bits_r_ftqOffset = _RANDOM[4'h3][8:4];
        s1_out_blocks_4_bits_r_tracePipe_itype = _RANDOM[4'h3][12:9];
        s1_out_blocks_4_bits_r_tracePipe_iretire = _RANDOM[4'h3][17:13];
        s1_out_blocks_4_bits_r_tracePipe_ilastsize = _RANDOM[4'h3][18];
        s1_out_blocks_5_valid_r = _RANDOM[4'h3][19];
        s1_out_blocks_5_bits_r_ftqIdx_value = _RANDOM[4'h3][26:21];
        s1_out_blocks_5_bits_r_ftqOffset = _RANDOM[4'h3][31:27];
        s1_out_blocks_5_bits_r_tracePipe_itype = _RANDOM[4'h4][3:0];
        s1_out_blocks_5_bits_r_tracePipe_iretire = _RANDOM[4'h4][8:4];
        s1_out_blocks_5_bits_r_tracePipe_ilastsize = _RANDOM[4'h4][9];
        s1_out_blocks_6_valid_r = _RANDOM[4'h4][10];
        s1_out_blocks_6_bits_r_ftqIdx_value = _RANDOM[4'h4][17:12];
        s1_out_blocks_6_bits_r_ftqOffset = _RANDOM[4'h4][22:18];
        s1_out_blocks_6_bits_r_tracePipe_itype = _RANDOM[4'h4][26:23];
        s1_out_blocks_6_bits_r_tracePipe_iretire = _RANDOM[4'h4][31:27];
        s1_out_blocks_6_bits_r_tracePipe_ilastsize = _RANDOM[4'h5][0];
        s1_out_blocks_7_valid_r = _RANDOM[4'h5][1];
        s1_out_blocks_7_bits_r_ftqIdx_value = _RANDOM[4'h5][8:3];
        s1_out_blocks_7_bits_r_ftqOffset = _RANDOM[4'h5][13:9];
        s1_out_blocks_7_bits_r_tracePipe_itype = _RANDOM[4'h5][17:14];
        s1_out_blocks_7_bits_r_tracePipe_iretire = _RANDOM[4'h5][22:18];
        s1_out_blocks_7_bits_r_tracePipe_ilastsize = _RANDOM[4'h5][23];
        s3_out_groups_blocks_0_valid = _RANDOM[4'h5][24];
        s3_out_groups_blocks_0_bits_ftqOffset = _RANDOM[4'h6][4:0];
        s3_out_groups_blocks_0_bits_tracePipe_itype = _RANDOM[4'h6][8:5];
        s3_out_groups_blocks_0_bits_tracePipe_iretire = _RANDOM[4'h6][16:9];
        s3_out_groups_blocks_0_bits_tracePipe_ilastsize = _RANDOM[4'h6][17];
        s3_out_groups_blocks_1_valid = _RANDOM[4'h6][18];
        s3_out_groups_blocks_1_bits_ftqOffset = _RANDOM[4'h6][30:26];
        s3_out_groups_blocks_1_bits_tracePipe_itype =
          {_RANDOM[4'h6][31], _RANDOM[4'h7][2:0]};
        s3_out_groups_blocks_1_bits_tracePipe_iretire = _RANDOM[4'h7][10:3];
        s3_out_groups_blocks_1_bits_tracePipe_ilastsize = _RANDOM[4'h7][11];
        s3_out_groups_blocks_2_valid = _RANDOM[4'h7][12];
        s3_out_groups_blocks_2_bits_ftqOffset = _RANDOM[4'h7][24:20];
        s3_out_groups_blocks_2_bits_tracePipe_itype = _RANDOM[4'h7][28:25];
        s3_out_groups_blocks_2_bits_tracePipe_iretire =
          {_RANDOM[4'h7][31:29], _RANDOM[4'h8][4:0]};
        s3_out_groups_blocks_2_bits_tracePipe_ilastsize = _RANDOM[4'h8][5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_out_blocks_0_valid_r = 1'h0;
        s1_out_blocks_0_bits_r_ftqIdx_value = 6'h0;
