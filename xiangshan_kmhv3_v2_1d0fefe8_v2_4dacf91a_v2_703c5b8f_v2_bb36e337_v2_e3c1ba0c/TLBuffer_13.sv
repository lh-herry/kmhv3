...
module TLBuffer_13(
  ...
  Queue2_TLBundleA_19 nodeOut_a_q_1 (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleA_19 nodeOut_a_q_2 (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleD_20 nodeIn_d_q_2 (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleA_19 nodeOut_a_q_3 (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleD_20 nodeIn_d_q_3 (
    .clock                      (clock),
    .reset                      (reset),
