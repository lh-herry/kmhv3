...
module TLBNonBlock_1(
  ...
  wire [9:0]       _readResult_flushItself_T_5 =
  ...
  wire             _readResult_T_26 =
    ...
    & hasGpf_0 & ~need_gpa & ~req_out_0_isPrefetch
    & ~(io_redirect_valid
  ...
  wire             _io_requestor_0_resp_bits_excp_0_pf_ld_T_1 =
    (~(~_modeCheck_T_8
       & (readResult_0_4_0_r
          | (_s2xlateEnable_T & _csr_delay_io_out_priv_vmxr | _csr_delay_io_out_priv_mxr)
  ...
  wire [3:0][1:0]  _GEN_22 =
    {{(|readResult_1_6_0) ? readResult_1_6_0 : readResult_1_7_0},
     ...
     {readResult_1_6_0},
     {readResult_1_6_0}};
  wire             _s1_valid_T_1 = req_out_s2xlate_1 != 2'h2;
  wire             _s2_valid_T_1 = req_out_s2xlate_1 == 2'h2 | (&req_out_s2xlate_1);
  wire             af_3 =
    _s1_valid_T_1 & readResult_1_4_0_af | _s2_valid_T_1
    & (readResult_p_hit_last_REG_1
         ? readResult_p_g_perm_1_af
         : _entries_io_r_resp_1_bits_g_perm_0_af);
  wire             isLd_1 = ~(|(req_out_1_cmd[1:0])) & req_out_1_cmd != 3'h5;
  wire             isSt_1 = req_out_1_cmd[1:0] == 2'h1 | req_out_1_cmd == 3'h5;
  ...
  wire             isFakePte_1 =
    ~readResult_1_4_0_v & ~readResult_1_4_0_pf & ~readResult_1_4_0_af & _s1_valid_T_1;
  wire             isNonLeaf_1 =
    ~(readResult_1_4_0_r | readResult_1_4_0_w | readResult_1_4_0_x) & readResult_1_4_0_v
    & ~readResult_1_4_0_pf & ~readResult_1_4_0_af;
  wire             s1_valid_1 = privNeedTranslate_1 & _s1_valid_T_1;
  wire             s2_valid_1 = privNeedTranslate_1 & _s2_valid_T_1;
  ...
  wire             _GEN_29 = prevmEnable_0 | pres2xlateEnable_0;
  wire             _GEN_30 = req_in_s2xlate_0 == 2'h2;
  wire             pregpf_0 =
  ...
  wire             preaf_0 = _GEN_28 & ~_GEN_29 & (|(EffectiveVa_0[63:48]));
  wire             _GEN_31 = premode_1 == 2'h1;
  wire [1:0]       pmm_1 =
    (&premode_1)
      ? _csr_delay_io_out_pmm_mseccfg
      : _pres2xlateEnable_T_6 & _csr_delay_io_out_priv_vmxr | _csr_delay_io_out_priv_mxr
          ? 2'h0
          : ~_pres2xlateEnable_T_6 & _GEN_31
              ? _csr_delay_io_out_pmm_menvcfg
              : _pres2xlateEnable_T_6 & _GEN_31
                  ? _csr_delay_io_out_pmm_henvcfg
  ...
  wire             _GEN_34 = prevmEnable_1 | pres2xlateEnable_1;
  wire             _GEN_35 = req_in_s2xlate_1 == 2'h2;
  wire             pregpf_1 =
  ...
  wire             preaf_1 = _GEN_33 & ~_GEN_34 & (|(EffectiveVa_1[63:48]));
  ...
  wire [43:0]      _GEN_37 = {6'h0, io_ptw_resp_bits_s2_entry_tag};
  wire [2:0]       _GEN_38 = _GEN_36[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_40 = _GEN_36[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_42 = _GEN_36[io_requestor_0_req_bits_vaddr[14:12]];
  ...
  wire [2:0]       _GEN_44 = _GEN_36[io_requestor_1_req_bits_vaddr[14:12]];
  ...
  always @(posedge clock) begin
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        readResult_onlyS2 | (&req_in_s2xlate_0)
          ...
          : _GEN_43[io_ptw_resp_bits_s1_entry_level][35:0];
      ...
      readResult_p_ppn_1 <=
        readResult_onlyS2_1 | (&req_in_s2xlate_1)
          ...
          : _GEN_45[io_ptw_resp_bits_s1_entry_level][35:0];
    ...
    io_perf_0_value_REG <=
      2'({1'h0, privNeedTranslate_0 & result_ok_last_REG}
         + {1'h0, privNeedTranslate_1 & result_ok_last_REG_1});
    io_perf_0_value_REG_1 <= io_perf_0_value_REG;
    io_perf_1_value_REG <=
      2'({1'h0, io_ptw_req_0_valid_0} + {1'h0, io_ptw_req_1_valid_0});
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      resp_gpa_refill <=
        ~_GEN_18 & (_readResult_T_68 | ~_GEN_11 & (_readResult_T_32 | resp_gpa_refill));
      if (_GEN_18) begin
        if (_GEN_12) begin
        end
        else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_out_0_debug_robIdx_value = {_RANDOM[7'h7][31:24], _RANDOM[7'h8][0]};
        req_out_1_vaddr = {_RANDOM[7'h8][31:2], _RANDOM[7'h9][19:0]};
        req_out_1_fullva = {_RANDOM[7'h9][31:20], _RANDOM[7'hA], _RANDOM[7'hB][19:0]};
        ...
        need_gpa_robidx_value = _RANDOM[7'h10][19:11];
        need_gpa_vpn = {_RANDOM[7'h10][31:20], _RANDOM[7'h11][25:0]};
        resp_gpa_gvpn = {_RANDOM[7'h11][31:26], _RANDOM[7'h12], _RANDOM[7'h13][5:0]};
        resp_gpa_refill = _RANDOM[7'h13][6];
        resp_s1_level = _RANDOM[7'h13][8:7];
        resp_s1_isLeaf = _RANDOM[7'h13][9];
        resp_s1_isFakePte = _RANDOM[7'h13][10];
        io_requestor_0_resp_bits_fullva_r =
          {_RANDOM[7'h13][31:13], _RANDOM[7'h14], _RANDOM[7'h15][12:0]};
        io_requestor_1_resp_bits_fullva_r =
          {_RANDOM[7'h15][31:13], _RANDOM[7'h16], _RANDOM[7'h17][12:0]};
        ...
        readResult_p_perm_d = _RANDOM[7'h19][13];
        ...
        readResult_p_gvpn = {_RANDOM[7'h19][31:20], _RANDOM[7'h1A]};
        readResult_p_g_pbmt = _RANDOM[7'h1B][1:0];
        readResult_p_g_perm_pf = _RANDOM[7'h1B][2];
        readResult_p_g_perm_af = _RANDOM[7'h1B][3];
        readResult_p_g_perm_d = _RANDOM[7'h1B][5];
        readResult_p_g_perm_a = _RANDOM[7'h1B][6];
        readResult_p_g_perm_x = _RANDOM[7'h1B][9];
        readResult_p_g_perm_w = _RANDOM[7'h1B][10];
        readResult_p_g_perm_r = _RANDOM[7'h1B][11];
        readResult_p_s2xlate = _RANDOM[7'h1B][13:12];
        readResult_p_s1_level = _RANDOM[7'h1B][15:14];
        readResult_p_s1_isLeaf = _RANDOM[7'h1B][16];
        readResult_p_s1_isFakePte = _RANDOM[7'h1B][17];
        readResult_lastCycleRedirect_REG_valid = _RANDOM[7'h1B][18];
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[7'h1F][9];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[7'h1F][13];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[7'h1F][22:14];
        readResult_p_hit_last_REG_1 = _RANDOM[7'h24][17];
        readResult_p_ppn_1 = {_RANDOM[7'h24][31:18], _RANDOM[7'h25][21:0]};
        readResult_p_pbmt_1 = _RANDOM[7'h25][23:22];
        readResult_p_perm_1_pf = _RANDOM[7'h25][24];
        readResult_p_perm_1_af = _RANDOM[7'h25][25];
        readResult_p_perm_1_v = _RANDOM[7'h25][26];
        readResult_p_perm_1_d = _RANDOM[7'h25][27];
        readResult_p_perm_1_a = _RANDOM[7'h25][28];
        readResult_p_perm_1_u = _RANDOM[7'h25][30];
        readResult_p_perm_1_x = _RANDOM[7'h25][31];
        readResult_p_perm_1_w = _RANDOM[7'h26][0];
        readResult_p_perm_1_r = _RANDOM[7'h26][1];
        readResult_p_gvpn_1 = {_RANDOM[7'h26][31:2], _RANDOM[7'h27][13:0]};
        readResult_p_g_pbmt_1 = _RANDOM[7'h27][15:14];
        readResult_p_g_perm_1_pf = _RANDOM[7'h27][16];
        readResult_p_g_perm_1_af = _RANDOM[7'h27][17];
        readResult_p_g_perm_1_d = _RANDOM[7'h27][19];
        readResult_p_g_perm_1_a = _RANDOM[7'h27][20];
        readResult_p_g_perm_1_x = _RANDOM[7'h27][23];
        readResult_p_g_perm_1_w = _RANDOM[7'h27][24];
        readResult_p_g_perm_1_r = _RANDOM[7'h27][25];
        readResult_p_s2xlate_1 = _RANDOM[7'h27][27:26];
        readResult_p_s1_level_1 = _RANDOM[7'h27][29:28];
        readResult_p_s1_isLeaf_1 = _RANDOM[7'h27][30];
        readResult_p_s1_isFakePte_1 = _RANDOM[7'h27][31];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[7'h28][0];
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[7'h2B][23];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[7'h2B][27];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[7'h2B][31:28], _RANDOM[7'h2C][4:0]};
        REG = _RANDOM[7'h31][0];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h31][1];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h31][2];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h31][3];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h31][4];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h31][5];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[7'h31][6];
        REG_1 = _RANDOM[7'h31][8];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h31][9];
        io_requestor_1_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h31][10];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h31][11];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h31][12];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h31][13];
        io_requestor_1_resp_bits_excp_0_af_st_REG = _RANDOM[7'h31][14];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h31][16:15];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h31][31:17], _RANDOM[7'h32][19:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[7'h32][31:20], _RANDOM[7'h33][3:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[7'h33][17:4];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[7'h33][18];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[7'h33][23];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h33][29:28];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h35][11:9];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h36][4];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h36][5];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h36][6];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h36][7];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h36][8];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h36][9];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h36][10];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h36][11];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h36][31:22], _RANDOM[7'h37][27:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h38][25:12];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[7'h38][26];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h3A][11:10];
        ptw_already_back_last_REG = _RANDOM[7'h3A][26];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h3A][29:28];
        ptw_resp_bits_reg_1_s1_entry_tag =
          {_RANDOM[7'h3A][31:30], _RANDOM[7'h3B], _RANDOM[7'h3C][0]};
        ptw_resp_bits_reg_1_s1_entry_asid = _RANDOM[7'h3C][16:1];
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h3C][30:17];
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[7'h3C][31];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[7'h3D][4];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h3D][10:9];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h3E][24:22];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h3F][17];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h3F][18];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h3F][19];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h3F][20];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h3F][21];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h3F][22];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h3F][23];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h3F][24];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[7'h40][31:3], _RANDOM[7'h41][8:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h41][31:25], _RANDOM[7'h42][6:0]};
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[7'h42][7];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h43][24:23];
        ptw_already_back_last_REG_1 = _RANDOM[7'h44][7];
        result_ok_last_REG = _RANDOM[7'h44][9];
        result_ok_last_REG_1 = _RANDOM[7'h44][10];
        io_perf_0_value_REG = _RANDOM[7'h44][12:11];
        io_perf_0_value_REG_1 = _RANDOM[7'h44][14:13];
        io_perf_1_value_REG = _RANDOM[7'h44][16:15];
        io_perf_1_value_REG_1 = _RANDOM[7'h44][18:17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
  ...
  assign io_requestor_0_resp_bits_pbmt_0 =
    privNeedTranslate_0 ? _GEN_21[req_out_s2xlate_0] : 2'h0;
  ...
  assign io_requestor_1_resp_bits_pbmt_0 =
    privNeedTranslate_1 ? _GEN_22[req_out_s2xlate_1] : 2'h0;
