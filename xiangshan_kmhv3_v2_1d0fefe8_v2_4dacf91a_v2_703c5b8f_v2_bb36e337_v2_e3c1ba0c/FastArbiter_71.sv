...
module FastArbiter_71(
  ...
  assign io_out_bits_homeNID = io_in_0_bits_homeNID;
  ...
  assign io_out_bits_dataSource = io_in_0_bits_dataSource;
  assign io_out_bits_cBusy = io_in_0_bits_cBusy;
  assign io_out_bits_dbID = io_in_0_bits_dbID;
  assign io_out_bits_ccID = io_in_0_bits_ccID;
  assign io_out_bits_dataID = io_in_0_bits_dataID;
  assign io_out_bits_tagOp = io_in_0_bits_tagOp;
  assign io_out_bits_tag = io_in_0_bits_tag;
  assign io_out_bits_tu = io_in_0_bits_tu;
  assign io_out_bits_traceTag = io_in_0_bits_traceTag;
  assign io_out_bits_rsvdc = io_in_0_bits_rsvdc;
  assign io_out_bits_be = io_in_0_bits_be;
  assign io_out_bits_data = io_in_0_bits_data;
  assign io_out_bits_dataCheck = io_in_0_bits_dataCheck;
  assign io_out_bits_poison = io_in_0_bits_poison;
endmodule
