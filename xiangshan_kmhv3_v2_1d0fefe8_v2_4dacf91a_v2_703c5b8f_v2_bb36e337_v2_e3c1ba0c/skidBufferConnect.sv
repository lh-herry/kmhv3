  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataBuffer_uop_ftqPtr_value = _RANDOM[6'h13][7:2];
        dataBuffer_uop_ftqOffset = _RANDOM[6'h13][12:8];
        dataBuffer_uop_fuOpType = _RANDOM[6'h15][21:13];
        dataBuffer_uop_vpu_vstart = {_RANDOM[6'h17][31:29], _RANDOM[6'h18][4:0]};
        dataBuffer_uop_vpu_vuopIdx = _RANDOM[6'h18][23:17];
        dataBuffer_uop_vpu_veew = _RANDOM[6'h1D][5:4];
        dataBuffer_uop_pdest = {_RANDOM[6'h20][31:29], _RANDOM[6'h21][4:0]};
        dataBuffer_uop_robIdx_flag = _RANDOM[6'h21][26];
        dataBuffer_uop_robIdx_value = {_RANDOM[6'h21][31:27], _RANDOM[6'h22][3:0]};
        dataBuffer_uop_lqIdx_flag = _RANDOM[6'h37][7];
        dataBuffer_uop_lqIdx_value = _RANDOM[6'h37][14:8];
        dataBuffer_uop_sqIdx_flag = _RANDOM[6'h37][15];
        dataBuffer_uop_sqIdx_value = _RANDOM[6'h37][21:16];
        dataBuffer_preIsSplit = _RANDOM[6'h3C][1];
        dataBuffer_mBIndex = _RANDOM[6'h3C][5:2];
        dataBuffer_alignedType = _RANDOM[6'h3C][8:6];
        dataBuffer_indexVlMaxInVd = _RANDOM[6'h3C][16:9];
        dataBuffer_usLowBitsAddr = _RANDOM[6'h3C][20:17];
        dataBuffer_usAligned128 = _RANDOM[6'h3C][21];
        dataBuffer_usMask = {_RANDOM[6'h3C][31:22], _RANDOM[6'h3D][21:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 1'h0;
    end // initial
