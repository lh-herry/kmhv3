...
module SMSPrefetcher(
  ...
  input  [49:0]  io_ld_in_2_bits_pc,
  input          io_st_in_0_valid,
  input          io_st_in_0_bits_robIdx_flag,
  input  [8:0]   io_st_in_0_bits_robIdx_value,
  input  [49:0]  io_st_in_0_bits_vaddr,
  input  [47:0]  io_st_in_0_bits_paddr,
  input          io_st_in_1_valid,
  input          io_st_in_1_bits_robIdx_flag,
  input  [8:0]   io_st_in_1_bits_robIdx_value,
  ...
  wire        _train_filter_io_trainReq_valid;
  wire [49:0] _train_filter_io_trainReq_bits_vaddr;
  wire [47:0] _train_filter_io_trainReq_bits_paddr;
  wire [49:0] _train_filter_io_trainReq_bits_pc;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset)
      ...
      train_vld_s0_last_REG <= _train_filter_io_trainReq_valid;
  end // always @(posedge, posedge)
  wire [21:0] _GEN = {1'h0, _train_filter_io_trainReq_bits_vaddr[30:10]};
  wire [21:0] _train_region_addr_p1_T_1 = 22'(_GEN + 22'h1);
  wire [21:0] _train_region_addr_m1_T_1 = 22'(_GEN - 22'h1);
  always @(posedge clock) begin
    if (_train_filter_io_trainReq_valid) begin
      train_region_tag_s0 <=
        {_train_filter_io_trainReq_bits_vaddr[20:16]
           ^ _train_filter_io_trainReq_bits_vaddr[25:21]
           ^ _train_filter_io_trainReq_bits_vaddr[30:26],
         _train_filter_io_trainReq_bits_vaddr[15:10]};
      ...
      train_pht_tag_s0 <= _train_filter_io_trainReq_bits_pc[19:7];
      train_pht_index_s0 <=
        {_train_filter_io_trainReq_bits_pc[1] ^ _train_filter_io_trainReq_bits_pc[6],
         _train_filter_io_trainReq_bits_pc[5:2]};
      train_region_offset_s0 <= _train_filter_io_trainReq_bits_vaddr[9:6];
      train_region_paddr_s0 <= _train_filter_io_trainReq_bits_paddr[47:10];
      train_region_vaddr_s0 <= _train_filter_io_trainReq_bits_vaddr[49:10];
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        train_region_tag_s0 = _RANDOM[4'h5][31:21];
        train_region_p1_tag_s0 = _RANDOM[4'h6][10:0];
        train_region_m1_tag_s0 = _RANDOM[4'h6][21:11];
        train_allow_cross_region_p1_s0 = _RANDOM[4'h6][22];
        train_allow_cross_region_m1_s0 = _RANDOM[4'h6][23];
        train_pht_tag_s0 = {_RANDOM[4'h6][31:24], _RANDOM[4'h7][4:0]};
        train_pht_index_s0 = _RANDOM[4'h7][9:5];
        train_region_offset_s0 = _RANDOM[4'h7][13:10];
        train_region_paddr_s0 = {_RANDOM[4'h7][31:16], _RANDOM[4'h8][21:0]};
        train_region_vaddr_s0 = {_RANDOM[4'h8][31:22], _RANDOM[4'h9][29:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        train_vld_s0_last_REG = 1'h0;
    end // initial
  ...
  TrainFilter train_filter (
    .clock                             (clock),
    .reset                             (reset),
    .io_ldTrainOpt_0_valid             (io_ld_in_0_valid),
    ...
    .io_ldTrainOpt_0_bits_paddr        (io_ld_in_0_bits_paddr),
    .io_ldTrainOpt_0_bits_pc           (io_ld_in_0_bits_pc),
    .io_ldTrainOpt_1_valid             (io_ld_in_1_valid),
    ...
    .io_ldTrainOpt_1_bits_paddr        (io_ld_in_1_bits_paddr),
    .io_ldTrainOpt_1_bits_pc           (io_ld_in_1_bits_pc),
    .io_ldTrainOpt_2_valid             (io_ld_in_2_valid),
    ...
    .io_ldTrainOpt_2_bits_paddr        (io_ld_in_2_bits_paddr),
    .io_ldTrainOpt_2_bits_pc           (io_ld_in_2_bits_pc),
    .io_stTrainOpt_0_valid             (io_st_in_0_valid),
    .io_stTrainOpt_0_bits_robIdx_flag  (io_st_in_0_bits_robIdx_flag),
    .io_stTrainOpt_0_bits_robIdx_value (io_st_in_0_bits_robIdx_value),
    .io_stTrainOpt_0_bits_vaddr        (io_st_in_0_bits_vaddr),
    .io_stTrainOpt_0_bits_paddr        (io_st_in_0_bits_paddr),
    .io_stTrainOpt_1_valid             (io_st_in_1_valid),
    .io_stTrainOpt_1_bits_robIdx_flag  (io_st_in_1_bits_robIdx_flag),
    .io_stTrainOpt_1_bits_robIdx_value (io_st_in_1_bits_robIdx_value),
    .io_stTrainOpt_1_bits_vaddr        (io_st_in_1_bits_vaddr),
    .io_stTrainOpt_1_bits_paddr        (io_st_in_1_bits_paddr),
    .io_trainReq_valid                 (_train_filter_io_trainReq_valid),
    .io_trainReq_bits_vaddr            (_train_filter_io_trainReq_bits_vaddr),
    .io_trainReq_bits_paddr            (_train_filter_io_trainReq_bits_paddr),
    .io_trainReq_bits_pc               (_train_filter_io_trainReq_bits_pc)
  );
  ...
  PrefetchFilter pf_filter (
    ...
    .io_l2_pf_addr_ready                (io_l2_req_ready),
    .io_l2_pf_addr_valid                (_pf_filter_io_l2_pf_addr_valid),
    .io_l2_pf_addr_bits                 (io_l2_req_bits_addr)
  );
  ...
  assign io_l2_req_valid = _pf_filter_io_l2_pf_addr_valid & io_enable;
endmodule
