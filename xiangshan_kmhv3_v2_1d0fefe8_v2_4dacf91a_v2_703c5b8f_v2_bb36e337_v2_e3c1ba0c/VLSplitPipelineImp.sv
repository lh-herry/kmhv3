...
module VLSplitPipelineImp(
  ...
  wire          s1_ready;
  wire          _s0_valid_T;
  wire [9:0]    _s1_kill_flushItself_T_2 =
  ...
  assign _s0_valid_T =
    ~(io_redirect_valid
      & (io_redirect_bits_level
         ...
         ^ io_in_bits_robIdx_value > io_redirect_bits_robIdx_value));
  reg           s1_valid;
  ...
  reg  [8:0]    s1_in_r_uop_robIdx_value;
  ...
  wire          _isSegment_T_1 = io_in_bits_fuOpType == 9'h88;
  wire [2:0]    s0_nf = _isSegment_T_1 ? 3'h0 : io_in_bits_vpu_nf;
  wire          _isMaskReg_T_2 = io_in_bits_fuOpType == 9'h8B;
  wire [2:0]    _GEN_5 = {1'h0, io_in_bits_vpu_veew};
  wire [2:0]    _GEN_6 = {1'h0, io_in_bits_vpu_vsew};
  wire [2:0]    s0_emul =
    _isSegment_T_1
      ? {2'h0, io_in_bits_vpu_nf == 3'h1} | {1'h0, io_in_bits_vpu_nf == 3'h3, 1'h0}
        | ((&io_in_bits_vpu_nf) ? 3'h3 : 3'h0)
      : _isMaskReg_T_2 ? 3'h0 : 3'(3'(_GEN_5 - _GEN_6) + io_in_bits_vpu_vlmul);
  wire          isUsWholeReg = ~(|(io_in_bits_fuOpType[6:5])) & _isSegment_T_1;
  wire [2:0]    instType =
    {(|s0_nf) & io_in_bits_fuOpType != 9'h88, io_in_bits_fuOpType[6:5]};
  ...
  wire [5:0]    _GEN_9 =
    _GEN_8[5:0] | (io_in_bits_vpu_veew == 2'h2 ? {_evl_T, 2'h0} : 6'h0);
  wire [7:0]    _evl_T_15 =
    {_evl_T_9[7],
     _GEN_8[6],
     _GEN_9[5],
     _GEN_9[4:0] | ((&io_in_bits_vpu_veew) ? {_evl_T, 1'h0} : 5'h0)};
  wire [7:0]    evl =
    isUsWholeReg
      ? _evl_T_15
  ...
  wire [9:0]    flowsPrevThisVd =
    {7'h0, vdIdxInField}
    << (io_in_bits_fuOpType[5] ? 3'(3'h4 - _GEN_6) : 3'(3'h4 - _GEN_5));
  ...
  always @(posedge clock) begin
    if (s0_fire) begin
      ...
      s1_in_r_vlmax <=
        isUsWholeReg ? _evl_T_15 : 8'h1 << 3'(3'(io_in_bits_vpu_vlmul - 3'h4) - _GEN_6);
      ...
      s1_in_r_uop_pdest <= {1'h0, io_in_bits_pdest};
      ...
      s1_in_r_uop_sqIdx_flag <= io_in_bits_sqIdx_flag;
      s1_in_r_uop_sqIdx_value <= io_in_bits_sqIdx_value;
      s1_in_r_fof <= ~(|(io_in_bits_fuOpType[6:5])) & io_in_bits_fuOpType == 9'h90;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_ftqPtr_value = _RANDOM[6'h13][10:5];
        s1_in_r_uop_ftqOffset = _RANDOM[6'h13][15:11];
        s1_in_r_uop_fuOpType = _RANDOM[6'h15][24:16];
        s1_in_r_uop_vecWen = _RANDOM[6'h15][27];
        s1_in_r_uop_v0Wen = _RANDOM[6'h15][28];
        s1_in_r_uop_vlWen = _RANDOM[6'h15][29];
        s1_in_r_uop_vpu_vma = _RANDOM[6'h17][16];
        s1_in_r_uop_vpu_vta = _RANDOM[6'h17][17];
        s1_in_r_uop_vpu_vsew = _RANDOM[6'h17][19:18];
        s1_in_r_uop_vpu_vlmul = _RANDOM[6'h17][22:20];
        s1_in_r_uop_vpu_vm = _RANDOM[6'h17][31];
        s1_in_r_uop_vpu_vstart = _RANDOM[6'h18][7:0];
        s1_in_r_uop_vpu_vuopIdx = _RANDOM[6'h18][26:20];
        s1_in_r_uop_vpu_vl = {_RANDOM[6'h1C][31:28], _RANDOM[6'h1D][3:0]};
        s1_in_r_uop_vpu_nf = _RANDOM[6'h1D][6:4];
        s1_in_r_uop_vpu_veew = _RANDOM[6'h1D][8:7];
        s1_in_r_uop_uopIdx = _RANDOM[6'h1E][16:10];
        s1_in_r_uop_pdest = _RANDOM[6'h21][7:0];
        s1_in_r_uop_robIdx_flag = _RANDOM[6'h21][29];
        s1_in_r_uop_robIdx_value = {_RANDOM[6'h21][31:30], _RANDOM[6'h22][6:0]};
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h37][10];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h37][17:11];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h37][18];
        s1_in_r_uop_sqIdx_value = _RANDOM[6'h37][24:19];
        s1_in_r_fof = _RANDOM[6'h38][0];
        s1_in_r_vdIdxInField = _RANDOM[6'h38][3:1];
        s1_in_r_preIsSplit = _RANDOM[6'h3C][4];
        s1_in_r_alignedType = _RANDOM[6'h3C][11:9];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3C][19:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
  ...
  assign io_out_valid = s1_valid & io_toMergeBuffer_resp_valid;
