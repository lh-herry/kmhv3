...
module TLXbar_6(
  ...
  input         auto_in_0_a_bits_user_memPageType_NC,
  input         auto_in_0_a_bits_user_memBackType_MM,
  ...
  wire       allowed_1;
  wire       allowed_0;
  wire [4:0] in_0_a_bits_source = {4'h8, auto_in_0_a_bits_source};
  wire [4:0] _GEN = {1'h0, auto_in_1_a_bits_source};
  wire       requestAIO_0_0 =
  ...
  wire       requestDOI_0_0 = auto_out_0_d_bits_source == 5'h10;
  wire       requestDOI_1_0 = auto_out_1_d_bits_source == 5'h10;
  wire       requestDOI_2_0 = auto_out_2_d_bits_source == 5'h10;
  ...
  wire       _GEN_0 = portsDIO_filtered_2_0_valid & _readys_filter_T_6[2];
  wire [3:0] _GEN_1 =
  ...
  wire [5:0] readys_unready_3 =
    {1'h0, _GEN_0, _GEN_1[3], _GEN_1[2:0] | {_GEN_0, _GEN_1[3:2]}}
    | {readys_mask_3, 3'h0};
  ...
  wire       _GEN_2 = portsDIO_filtered_2_1_valid & _readys_filter_T_8[2];
  wire [3:0] _GEN_3 =
  ...
  wire [5:0] readys_unready_4 =
    {1'h0, _GEN_2, _GEN_3[3], _GEN_3[2:0] | {_GEN_2, _GEN_3[3:2]}}
    | {readys_mask_4, 3'h0};
  ...
  wire       latch_3 = ~beatsLeft_3 & auto_in_0_d_ready;
  wire       latch_4 = ~beatsLeft_4 & auto_in_1_d_ready;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatsLeft_3 <= ~latch_3 & 1'(beatsLeft_3 - (auto_in_0_d_ready & in_0_d_valid));
      ...
      beatsLeft_4 <= ~latch_4 & 1'(beatsLeft_4 - (auto_in_1_d_ready & in_1_d_valid));
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask_3 = _RANDOM[/*Zero width*/ 1'b0][18:16];
        state_3_0 = _RANDOM[/*Zero width*/ 1'b0][19];
        state_3_1 = _RANDOM[/*Zero width*/ 1'b0][20];
        state_3_2 = _RANDOM[/*Zero width*/ 1'b0][21];
        beatsLeft_4 = _RANDOM[/*Zero width*/ 1'b0][22];
        readys_mask_4 = _RANDOM[/*Zero width*/ 1'b0][25:23];
        state_4_0 = _RANDOM[/*Zero width*/ 1'b0][26];
        state_4_1 = _RANDOM[/*Zero width*/ 1'b0][27];
        state_4_2 = _RANDOM[/*Zero width*/ 1'b0][28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        beatsLeft = 1'h0;
        readys_mask = 2'h3;
  ...
  assign auto_in_0_d_bits_size =
    ...
    | (muxState_3_2 ? auto_out_2_d_bits_size : 2'h0);
  ...
  assign auto_out_2_a_bits_source =
    (muxState_2_0 ? in_0_a_bits_source : 5'h0) | (muxState_2_1 ? _GEN : 5'h0);
  assign auto_out_2_a_bits_address =
    (muxState_2_0 ? auto_in_0_a_bits_address : 48'h0)
    | (muxState_2_1 ? auto_in_1_a_bits_address : 48'h0);
  assign auto_out_2_a_bits_user_memBackType_MM =
    muxState_2_0 & auto_in_0_a_bits_user_memBackType_MM | muxState_2_1
    & auto_in_1_a_bits_user_memBackType_MM;
  assign auto_out_2_a_bits_user_memPageType_NC =
    muxState_2_0 & auto_in_0_a_bits_user_memPageType_NC | muxState_2_1
  ...
  assign auto_out_2_d_ready =
    requestDOI_2_0 & auto_in_0_d_ready & allowed_3_2 | ~(auto_out_2_d_bits_source[4])
  ...
  assign auto_out_1_a_bits_source =
    (muxState_1_0 ? in_0_a_bits_source : 5'h0) | (muxState_1_1 ? _GEN : 5'h0);
  ...
  assign auto_out_1_d_ready =
    requestDOI_1_0 & auto_in_0_d_ready & allowed_3_1 | ~(auto_out_1_d_bits_source[4])
  ...
  assign auto_out_0_a_bits_source =
    (muxState_0 ? in_0_a_bits_source : 5'h0) | (muxState_1 ? _GEN : 5'h0);
  ...
  assign auto_out_0_d_ready =
    requestDOI_0_0 & auto_in_0_d_ready & allowed_3_0 | ~(auto_out_0_d_bits_source[4])
