...
module FloatAdderF64WidenPipeline(
  ...
  wire        fp_b_is_greater =
    ...
    & (~_U_far_path_io_isEfp_bGreater & fp_a_to64[62:52] != fp_b_to64[62:52]
       | fp_b_exponent_is_equal & ~fp_b_significand_is_greater
       & fp_a_to64[51:0] != fp_b_to64[51:0]);
  wire        fp_b_is_equal =
    io_fp_a[63] == io_fp_b[63] & fp_b_exponent_is_equal
    & fp_a_to64[51:0] == fp_b_to64[51:0] | _fp_b_is_equal_T_2;
  ...
  always @(posedge clock) begin
    if (io_fire) begin
      ...
      io_fp_c_r_1 <=
        (is_min ? result_min : 64'h0) | (is_max ? result_max : 64'h0)
