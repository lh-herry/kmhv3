...
module L2Slice_3(
  ...
  wire         activated =
    ...
    & (mbist_array == 6'h23 | mbist_array == 6'h24 | mbist_array == 6'h25
       ...
       | mbist_array == 6'h29 | mbist_array == 6'h2A | mbist_array == 6'h2B
       | mbist_array == 6'h2C | mbist_array == 6'h2D);
  reg  [5:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  wire         selected =
    ...
    | arrayReg == 6'h27 | arrayReg == 6'h28 | arrayReg == 6'h29;
  wire         doSpread = selected | allReg;
  wire         selected_1 =
    arrayReg == 6'h2A | arrayReg == 6'h2B | arrayReg == 6'h2C | arrayReg == 6'h2D;
