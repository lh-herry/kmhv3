      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[3'h0][31:26],
           ...
           _RANDOM[3'h3],
           _RANDOM[3'h4][9:0]};
        renReg = _RANDOM[3'h4][10];
        addrRdReg = _RANDOM[3'h4][20:11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 5'h0;
        reqReg = 1'h0;
