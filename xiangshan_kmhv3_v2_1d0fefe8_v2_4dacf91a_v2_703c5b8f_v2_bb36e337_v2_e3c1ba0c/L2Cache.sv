...
module L2Cache(
  ...
  output [136:0] toNextPipeline_3_indata,
  output         toNextPipeline_3_readen,
  output [12:0]  toNextPipeline_3_addr_rd,
  input  [136:0] toNextPipeline_3_outdata,
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        {124'h0, selected ? toNextPipeline_0_outdata : 13'h0}
        | (selected_1 ? toNextPipeline_1_outdata : 137'h0)
        | (selected_2 ? toNextPipeline_2_outdata : 137'h0)
        | (selected_3 ? toNextPipeline_3_outdata : 137'h0)
