  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'hA][31:30];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'hB][1:0];
        lastConnect_bits_loadDependencyCopy_0_2 = _RANDOM[4'hB][3:2];
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'hB][5:4];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'hB][7:6];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'hB][9:8];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'hB][11:10];
        lastConnect_bits_loadDependencyCopy_2_1 = _RANDOM[4'hB][13:12];
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'hB][15:14];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'hB][17:16];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'hB][19:18];
        lastConnect_bits_loadDependencyCopy_3_2 = _RANDOM[4'hB][21:20];
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'hB][23:22];
        lastConnect_bits_loadDependencyCopy_4_1 = _RANDOM[4'hB][25:24];
        lastConnect_bits_loadDependencyCopy_4_2 = _RANDOM[4'hB][27:26];
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'hB][29:28];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'hB][31:30];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'hC][1:0];
        lastConnect_bits_loadDependencyCopy_6_0 = _RANDOM[4'hC][3:2];
        lastConnect_bits_loadDependencyCopy_6_1 = _RANDOM[4'hC][5:4];
        lastConnect_bits_loadDependencyCopy_6_2 = _RANDOM[4'hC][7:6];
        lastConnect_bits_pdest = _RANDOM[4'hC][15:8];
        lastConnect_bits_rfWen = _RANDOM[4'hC][21];
        lastConnect_bits_vecWen = _RANDOM[4'hC][23];
        lastConnect_bits_v0Wen = _RANDOM[4'hC][24];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hF][9:8];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hF][11:10];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hF][13:12];
      `endif // RANDOMIZE_REG_INIT
    end // initial
