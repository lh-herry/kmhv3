  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_ftqPtr_value = _RANDOM[7'h13][6:1];
        uopq_uop_ftqOffset = _RANDOM[7'h13][11:7];
        uopq_uop_fuOpType = _RANDOM[7'h15][20:12];
        uopq_uop_vpu_vuopIdx = _RANDOM[7'h18][22:16];
        uopq_uop_robIdx_flag = _RANDOM[7'h21][25];
        uopq_uop_robIdx_value = {_RANDOM[7'h21][31:26], _RANDOM[7'h22][2:0]};
        uopq_uop_sqIdx_flag = _RANDOM[7'h37][14];
        uopq_uop_sqIdx_value = _RANDOM[7'h37][20:15];
        uopq_preIsSplit = _RANDOM[7'h3C][0];
        uopq_mBIndex = _RANDOM[7'h3C][4:1];
        uopq_alignedType = _RANDOM[7'h3C][7:5];
        uopq_indexVlMaxInVd = _RANDOM[7'h3C][15:8];
        uopq_usAligned128 = _RANDOM[7'h3C][20];
        uopq_usMask = {_RANDOM[7'h3C][31:21], _RANDOM[7'h3D][20:0]};
        allocated = _RANDOM[7'h3D][21];
        splitIdx = _RANDOM[7'h3D][26:22];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:27],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
