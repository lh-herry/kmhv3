  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hD][30:29];
        lastConnect_bits_loadDependency_1 = {_RANDOM[4'hD][31], _RANDOM[4'hE][0]};
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hE][2:1];
      `endif // RANDOMIZE_REG_INIT
    end // initial
