...
module MSHR_64(
  ...
  wire            _new_clients_meta_0_state_T_5 = iam == 2'h0;
  reg             inv_self_dir;
  ...
  wire            prefetch_miss_need_probe =
    ...
    & (~meta_self_hit | ~(meta_self_state[1]));
  wire            prefetch_miss =
    _probe_clients_T_1
  ...
  wire            _transmit_from_other_client_T_6 =
    (|{_io_tasks_source_a_bits_param_T_1 | ~(|(req_opcode[2:1])), iam}) & clients_hit;
  reg             transmit_from_other_client_reg;
  wire            transmit_from_other_client =
    ~meta_self_hit & (_transmit_from_other_client_T_6 | transmit_from_other_client_reg)
  ...
  wire            _new_self_meta_state_T_8 = req_param == 3'h3;
  wire            _new_self_meta_clientStates_0_T_21 = req_param != 3'h2;
  wire            _new_self_meta_state_T_36 = req_acquire & promoteT_safe;
  wire            _perm_after_probe_T_10 = client_probeack_param_vec_0 == 3'h4;
  wire            _perm_after_probe_T_5 =
    ~(|client_probeack_param_vec_0) | _perm_after_probe_T_10;
  wire            _GEN =
    meta_reg_clients_states_0_hit & a_do_probe & _perm_after_probe_T_5;
  wire            _perm_after_probe_T_11 =
    ~(|client_probeack_param_vec_0) | _perm_after_probe_T_10;
  wire [1:0]      perm_after_probe_1 = {1'h0, _perm_after_probe_T_11};
  reg  [2:0]      sink;
  reg             bad_grant;
  ...
  wire            bypassPut = ~(|(req_opcode[2:1])) & ~meta_self_hit & ~clients_hit;
  reg             bypassPut_latch;
  wire            preferCache =
    req_preferCache & ~(io_dirResult_valid ? bypassPut : bypassPut_latch);
  ...
  wire            will_release_through =
    _GEN_0 & ~((|iam) & clients_hit) & req_param < 3'h3;
  ...
  wire            _io_tasks_source_d_bits_param_T_4 = req_param == 3'h2;
  ...
  wire            a_c_through =
    req_channel[0]
    & (nest_c_tag_match & ~meta_self_hit & io_c_status_way != meta_self_way
       | io_c_status_tag != req_tag & nest_c_way_match
  ...
  always @(posedge clock) begin
    ...
    if (io_dirResult_valid) begin
      ...
      client_dir_conflict <=
        req_channel[0] & req_acquire & ~clients_hit & (|meta_clients_states_0_state);
      probe_clients <=
        req_channel[0] & _probe_clients_T_1
          ...
          : req_channel[0]
              ...
              : (~(req_fromCmoHelper & _x_probe_clients_T)
                 | meta_clients_states_0_state[1]) & clients_hit;
    end
    meta_reg_self_hit <=
  ...
  wire [1:0]      _highest_perm_except_me_T_6 =
    req_acquire & _new_clients_meta_0_state_T_5 | ~clients_hit
      ? 2'h0
  ...
  wire            _GEN_14 = meta_self_hit & meta_self_state[0] & _GEN_13 | ~clients_hit;
  wire            _GEN_15 = _probe_clients_T_1 & clients_hit;
  wire            _GEN_16 = _acquire_param_T_4 | _io_tasks_source_a_bits_param_T_1;
  wire            _GEN_17 =
    ~meta_self_hit & (|meta_self_state) & replace_need_release
    & (preferCache & _GEN_16 | prefetch_need_data | transmit_from_other_client);
  wire            _GEN_18 = req_channel[1] | _GEN_15 | ~_GEN_17;
  wire            _GEN_19 =
    io_dirResult_valid
      ? _GEN_8
        | (req_channel[2]
             ...
             : _GEN_18)
      : w_releaseack;
  wire            _GEN_20 = req_channel[2] | req_channel[1];
  ...
  wire            _GEN_23 = _GEN_21 | _GEN_15 | ~_GEN_22;
  wire            _GEN_24 = req_opcode != 3'h4;
  wire            _GEN_25 =
    ~_GEN_22 | ~(~acquirePermMiss & (meta_self_hit & _GEN_24 | preferCache));
  wire            _GEN_26 = _GEN_24 & (|(req_opcode[2:1]));
  wire            _GEN_27 =
    clients_hit
  ...
  wire            _GEN_29 = _GEN_26 ? ~(|iam) | ~_GEN_27 : ~_GEN_28;
  wire            _GEN_30 =
    _GEN_8
    | (req_channel[2]
         ? ~req_fromCmoHelper | ~clients_hit
         : req_channel[1] ? _GEN_14 : _GEN_15 | _GEN_29);
  wire            _GEN_31 = meta_self_hit | preferCache;
  wire            _GEN_32 =
    io_dirResult_valid
      ? _GEN_8
        | (req_channel[2]
             ...
             : req_channel[1] | _GEN_15
               | ~(~meta_self_hit & preferCache & (_GEN_16 | prefetch_need_data))
               & (_GEN_26
                    ? ~((|iam) & _GEN_27) | meta_self_hit
                    : ~_GEN_28 | meta_self_hit))
      : s_wbselftag;
  wire            _GEN_33 = io_tasks_source_a_ready & io_tasks_source_a_valid_0;
  wire            _GEN_34 = io_tasks_source_c_ready & io_tasks_source_c_valid_0;
  wire            _GEN_35 = io_tasks_tag_write_ready & io_tasks_tag_write_valid_0;
  wire            _GEN_36 = io_tasks_sink_c_ready & io_tasks_sink_c_valid_0;
  wire            _GEN_37 = someClientHasProbeAckData | io_resps_sink_c_bits_hasData;
  wire            _GEN_38 = _GEN_3 & _GEN_37;
  wire            _GEN_39 =
    req_channel[1]
    & (probeAckDataThrough & io_resps_sink_c_bits_param != 3'h5 | ~req_fromProbeHelper);
  wire            _GEN_40 = req_valid & sink_c_resp_valid;
  wire            _GEN_41 =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      promoteT_safe <= ~_GEN_42 & (io_dirResult_valid | promoteT_safe);
      gotT <= _GEN_6 ? io_resps_sink_d_bits_param == 3'h0 : ~io_dirResult_valid & gotT;
      if (io_dirResult_valid) begin
        a_do_release <= ~_GEN_21 & ~_GEN_15 & _GEN_17;
        a_do_probe <= ~_GEN_21 & ~_GEN_15 & (_GEN_26 ? (|iam) & _GEN_27 : _GEN_28);
        highest_perm_reg_reg <= highest_perm;
      end
      else if (will_be_free)
        highest_perm_reg_reg <= 2'h0;
      probe_dirty <=
        _GEN_40
          ? probe_dirty | io_resps_sink_c_bits_hasData | nested_c_hit
          : ~io_dirResult_valid & probe_dirty;
      inv_self_dir <= _GEN_40 & _GEN_43 & ~_GEN_31 | ~io_dirResult_valid & inv_self_dir;
      if (_GEN_3)
        client_probeack_param_vec_reg_0 <= io_resps_sink_c_bits_param;
      transmit_from_other_client_reg <=
        io_dirResult_valid
          ? _transmit_from_other_client_T_6
          : ~will_be_free & transmit_from_other_client_reg;
      releaseThrough <= ~will_be_free & (_GEN_0 ? will_release_through : releaseThrough);
      releaseDrop <= ~will_be_free & (_GEN_0 ? ~will_release_through : releaseDrop);
      probeAckDataThrough <=
        ~will_be_free
        & (io_dirResult_valid
             ? (req_fromCmoHelper
      ...
      bad_grant <= _GEN_6 ? io_resps_sink_d_bits_denied : ~io_dirResult_valid & bad_grant;
      s_acquire <= ~_GEN_42 & (_GEN_33 | (io_dirResult_valid ? _GEN_23 : s_acquire));
      s_probe <=
        io_tasks_source_b_ready & io_tasks_source_b_valid_0
        | (io_dirResult_valid ? _GEN_30 : s_probe);
      s_release <=
        _GEN_34
        | (io_dirResult_valid
             ? _GEN_8
               | (req_channel[2] ? (req_fromCmoHelper ? ~_GEN_9 : _GEN_11) : _GEN_18)
             : s_release);
      s_probeack <=
        (~_GEN_3 | _GEN_37 | ~_GEN_39)
        & (_GEN_34
           | (io_dirResult_valid
                ? (_GEN_8
                     ? ~(req_channel[1])
      ...
      s_execute <=
        ...
        | (io_dirResult_valid
             ...
             : s_execute);
      s_grantack <=
        ~(_GEN_40 & _GEN_41 & ~bypassGet & ~bypassPut_latch)
        & (io_tasks_source_e_ready & io_tasks_source_e_valid_0
           | (io_dirResult_valid
                ? _GEN_21 | ~(~_GEN_15 & _GEN_22) | ~(~bypassGet & ~bypassPut)
                : s_grantack));
      s_wbselfdir <=
                    ...
                    : req_channel[1]
                        ...
                        : _GEN_15
                          | ~(~(|(req_opcode[2:1])) & meta_self_hit & ~meta_self_dirty
                              | req_acquire & ~acquirePermMiss & _GEN_31)
                          & (_GEN_26
                               ? ~((|iam) & _GEN_27 & ~meta_self_hit) & _GEN_25
                               : ~_GEN_28 & _GEN_25))
             : s_wbselfdir);
      s_wbselftag <= _GEN_40 & _GEN_43 ? ~_GEN_31 | _GEN_35 | _GEN_32 : _GEN_35 | _GEN_32;
      s_wbclientsdir <=
        ...
        | (io_dirResult_valid
             ? _GEN_8
               | (req_channel[2]
                    ...
                    : req_channel[1] ? _GEN_14 : _GEN_15 | ~req_acquire & _GEN_29)
             : s_wbclientsdir);
      s_wbclientstag <=
        io_tasks_client_tag_write_ready & io_tasks_client_tag_write_valid_0
        | (io_dirResult_valid
             ? _GEN_21 | ~(~_GEN_15 & req_acquire) | clients_hit
             : s_wbclientstag);
      s_transferput <=
        _GEN_33 | (io_dirResult_valid ? _GEN_21 | _GEN_15 | ~bypassPut : s_transferput);
      s_writerelease <=
        _GEN_36 & s_writeprobe | (io_dirResult_valid ? _GEN_12 : s_writerelease);
      s_writeprobe <= ~_GEN_38 & (_GEN_36 | io_dirResult_valid | s_writeprobe);
      s_triggerprefetch <=
      ...
      s_prefetchack <=
        ...
        | (io_dirResult_valid
             ? _GEN_21 | _GEN_15 | ~(_probe_clients_T_1 & req_isBop)
             : s_prefetchack);
      if (_GEN_40) begin
        ...
        w_probeackfirst <= _GEN_30;
        w_probeacklast <= _GEN_30;
        w_probeack <= _GEN_30;
      end
      w_grantfirst <= _GEN_6 | ~_GEN_42 & (io_dirResult_valid ? _GEN_23 : w_grantfirst);
      w_grantlast <=
        _GEN_6
          ? w_grantlast | io_resps_sink_d_bits_last
          : ~_GEN_42 & (io_dirResult_valid ? _GEN_23 : w_grantlast);
      w_grant <=
        _GEN_6
          ? ~(|req_off) & req_size == 3'h6 | io_resps_sink_d_bits_last
          : ~_GEN_42 & (io_dirResult_valid ? _GEN_23 : w_grant);
      w_releaseack <=
        _GEN_4 & io_resps_sink_d_bits_opcode == 3'h6
        | (_GEN_3
             ? (_GEN_37
                  ? ~(req_channel[1] & req_fromProbeHelper & probeAckDataThrough
                      | req_fromCmoHelper & probeAckDataThrough) & _GEN_19
                  : ~(_GEN_39 & req_fromProbeHelper) & _GEN_19)
             : _GEN_19);
      w_grantack <=
        ...
        | (io_dirResult_valid
             ? (_GEN_8
                  ...
                  : _GEN_20 | _GEN_15 | ~req_acquire)
             : w_grantack);
      w_putwritten <=
        io_resps_source_d_valid
        | (io_dirResult_valid
             ? _GEN_21 | _GEN_15 | ~(~(|(req_opcode[2:1])) & ~bypassPut)
             : w_putwritten);
      w_sinkcack <=
        io_resps_sink_c_ack_valid | ~_GEN_38
      ...
      bypassPut_latch <= io_dirResult_valid ? bypassPut : ~will_be_free & bypassPut_latch;
      probe_helper_finish <=
        ~will_be_free
      ...
      a_c_through_reg <=
        io_dirResult_valid ? meta_self_hit : ~will_be_free & a_c_through_reg;
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bypassPut_latch = _RANDOM[4'h9][20];
  ...
  assign io_tasks_source_d_bits_bypassPut = bypassPut_latch;
    ...
    s_transferput
      ? (_io_tasks_source_a_bits_param_T_1
           ...
           : _probe_clients_T_1
               ...
               : _acquire_param_T_4 & _io_tasks_source_d_bits_param_T_4
                 | ~(|(req_opcode[2:1]))
                   ? 3'h1
                   : req_param)
      : req_param;
  ...
  assign io_tasks_source_a_bits_putData = bypassPut_latch;
  assign io_tasks_source_a_bits_reqSource = _probe_clients_T_1 ? 5'h14 : req_reqSource;
