...
module Queue40_L2TlbMQBundle(
  ...
  assign io_deq_bits_req_info_vpn = _ram_ext_R0_data[46:9];
  assign io_deq_bits_req_info_s2xlate = _ram_ext_R0_data[8:7];
  assign io_deq_bits_req_info_source = _ram_ext_R0_data[6:5];
  assign io_deq_bits_isHptwReq = _ram_ext_R0_data[4];
  assign io_deq_bits_isLLptw = _ram_ext_R0_data[3];
  assign io_deq_bits_hptwId = _ram_ext_R0_data[2:0];
endmodule
