...
module TLXbar_8(
  ...
  wire [2:0]  _GEN_0 = {1'h0, auto_out_0_d_bits_size};
  wire [2:0]  _GEN_1 = {1'h0, auto_out_1_d_bits_size};
  wire        requestAIO_0_0 =
  ...
  wire        _GEN_2 = portsDIO_filtered_2_0_valid & _readys_filter_T_6[2];
  wire [3:0]  _GEN_3 =
  ...
  wire        _GEN_4 = portsDIO_filtered_2_1_valid & _readys_filter_T_8[2];
  wire [3:0]  _GEN_5 =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatsLeft_3 <=
        latch_3
          ? (winner_3_2 & auto_out_2_d_bits_opcode[0]
               ? ~(_beatsDO_decode_T_6[5:3])
               : 3'h0)
      ...
      beatsLeft_4 <=
        latch_4
          ? (winner_4_2 & auto_out_2_d_bits_opcode[0]
               ? ~(_beatsDO_decode_T_6[5:3])
               : 3'h0)
  ...
  assign auto_in_1_d_bits_size =
    (muxState_4_0 ? _GEN_0 : 3'h0) | (muxState_4_1 ? _GEN_1 : 3'h0)
  ...
  assign auto_in_0_d_bits_size =
    (muxState_3_0 ? _GEN_0 : 3'h0) | (muxState_3_1 ? _GEN_1 : 3'h0)
