...
module NfMappedElemIdx(
  ...
  wire [7:0]      _GEN =
    {3'h0, in_eewOH[0], 4'h0} | {4'h0, in_eewOH[1], 3'h0} | {5'h0, in_eewOH[2], 2'h0}
    | {6'h0, in_eewOH[3], 1'h0};
  wire [7:0]      _GEN_0 =
    {2'h0, in_eewOH[0], 5'h0} | {3'h0, in_eewOH[1], 4'h0} | {4'h0, in_eewOH[2], 3'h0}
    | {5'h0, in_eewOH[3], 2'h0};
  wire [7:0]      _GEN_1 =
    (in_eewOH[0] ? 8'h30 : 8'h0) | (in_eewOH[1] ? 8'h18 : 8'h0)
    | (in_eewOH[2] ? 8'hC : 8'h0) | (in_eewOH[3] ? 8'h6 : 8'h0);
  wire [7:0]      _GEN_2 =
    {1'h0, in_eewOH[0], 6'h0} | {2'h0, in_eewOH[1], 5'h0} | {3'h0, in_eewOH[2], 4'h0}
    | {4'h0, in_eewOH[3], 3'h0};
  wire [7:0]      _GEN_3 =
  ...
  wire [7:0][7:0] _GEN_19 =
    {{_GEN},
     ...
     {_GEN_1},
     {_GEN_2},
     {{in_eewOH[0], 7'h0} | {1'h0, in_eewOH[1], 6'h0} | {2'h0, in_eewOH[2], 5'h0}
        | {3'h0, in_eewOH[3], 4'h0}}};
