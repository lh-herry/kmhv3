...
module PrefetchFilter(
  ...
  wire        s3_drop =
    s3_update_valid
    & (~((|(s3_tlb_resp_paddr_0[47:31])) & s3_tlb_resp_paddr_0 < 48'h80000000000)
  ...
  always @(posedge clock) begin
    ...
    else if (~tlb_fired | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_1 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_2 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_3 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_4 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_5 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_6 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_7 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_8 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_9 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_10 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_11 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_12 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_13 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_14 | s3_drop) begin
    end
    else begin
    ...
    else if (~tlb_fired_15 | s3_drop) begin
    end
    else begin
  ...
  wire [15:0] s2_tlb_fire_vec =
    {s2_tlb_fire_vec_r_r_15,
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if ({s0_tlb_fire_vec_15,
           ...
           s0_tlb_fire_vec_2,
           s0_tlb_fire_vec_1,
           s0_tlb_fire_vec_0} != s1_tlb_fire_vec) begin
      ...
      if (s1_tlb_fire_vec != s2_tlb_fire_vec) begin
      ...
      if (s2_tlb_fire_vec != {s3_tlb_fire_vec_r_r_15,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tlb_fire_vec_r_r_0 = _RANDOM[7'h3C][27];
        s2_tlb_fire_vec_r_r_1 = _RANDOM[7'h3C][28];
        s2_tlb_fire_vec_r_r_2 = _RANDOM[7'h3C][29];
        s2_tlb_fire_vec_r_r_3 = _RANDOM[7'h3C][30];
        s2_tlb_fire_vec_r_r_4 = _RANDOM[7'h3C][31];
        s2_tlb_fire_vec_r_r_5 = _RANDOM[7'h3D][0];
        s2_tlb_fire_vec_r_r_6 = _RANDOM[7'h3D][1];
        s2_tlb_fire_vec_r_r_7 = _RANDOM[7'h3D][2];
        s2_tlb_fire_vec_r_r_8 = _RANDOM[7'h3D][3];
        s2_tlb_fire_vec_r_r_9 = _RANDOM[7'h3D][4];
        s2_tlb_fire_vec_r_r_10 = _RANDOM[7'h3D][5];
        s2_tlb_fire_vec_r_r_11 = _RANDOM[7'h3D][6];
        s2_tlb_fire_vec_r_r_12 = _RANDOM[7'h3D][7];
        s2_tlb_fire_vec_r_r_13 = _RANDOM[7'h3D][8];
        s2_tlb_fire_vec_r_r_14 = _RANDOM[7'h3D][9];
        s2_tlb_fire_vec_r_r_15 = _RANDOM[7'h3D][10];
        s3_tlb_fire_vec_r_r_0 = _RANDOM[7'h3D][11];
        s3_tlb_fire_vec_r_r_1 = _RANDOM[7'h3D][12];
        s3_tlb_fire_vec_r_r_2 = _RANDOM[7'h3D][13];
        s3_tlb_fire_vec_r_r_3 = _RANDOM[7'h3D][14];
        s3_tlb_fire_vec_r_r_4 = _RANDOM[7'h3D][15];
        s3_tlb_fire_vec_r_r_5 = _RANDOM[7'h3D][16];
        s3_tlb_fire_vec_r_r_6 = _RANDOM[7'h3D][17];
        s3_tlb_fire_vec_r_r_7 = _RANDOM[7'h3D][18];
        s3_tlb_fire_vec_r_r_8 = _RANDOM[7'h3D][19];
        s3_tlb_fire_vec_r_r_9 = _RANDOM[7'h3D][20];
        s3_tlb_fire_vec_r_r_10 = _RANDOM[7'h3D][21];
        s3_tlb_fire_vec_r_r_11 = _RANDOM[7'h3D][22];
        s3_tlb_fire_vec_r_r_12 = _RANDOM[7'h3D][23];
        s3_tlb_fire_vec_r_r_13 = _RANDOM[7'h3D][24];
        s3_tlb_fire_vec_r_r_14 = _RANDOM[7'h3D][25];
        s3_tlb_fire_vec_r_r_15 = _RANDOM[7'h3D][26];
        s3_tlb_resp_fire = _RANDOM[7'h3D][27];
        s3_tlb_resp_paddr_0 =
          {_RANDOM[7'h3D][31:28], _RANDOM[7'h3E], _RANDOM[7'h3F][11:0]};
        s3_tlb_resp_pbmt_0 = _RANDOM[7'h46][29:28];
        s3_tlb_resp_miss = _RANDOM[7'h47][0];
        s3_tlb_resp_excp_0_gpf_ld = _RANDOM[7'h47][5];
        s3_tlb_resp_excp_0_pf_ld = _RANDOM[7'h47][8];
        s3_tlb_resp_excp_0_af_ld = _RANDOM[7'h47][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
