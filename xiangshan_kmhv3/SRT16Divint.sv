...
module SRT16Divint(
  ...
  reg              early_finish_q;
  wire [3:0]       r_shift_hb = 4'h1 << iterB_reg_0[1:0];
  ...
  wire [18:0]      _GEN = 19'(19'h0 - norm_d);
  ...
  wire [7:0]       sel_cons_0_0 = 8'(_GEN[15:8] + _qds_cons_io_m_neg_1[8:1]);
  wire [7:0]       sel_cons_0_1 = 8'(_GEN[15:8] + _qds_cons_io_m_neg_0[8:1]);
  wire [7:0]       sel_cons_0_2 = 8'(_GEN[15:8] + _qds_cons_io_m_pos_1[8:1]);
  wire [7:0]       sel_cons_0_3 = 8'(_GEN[15:8] + _qds_cons_io_m_pos_2[8:1]);
  wire [7:0]       sel_cons_1_0 = 8'(_GEN[16:9] + _qds_cons_io_m_neg_1[8:1]);
  wire [7:0]       sel_cons_1_1 = 8'(_GEN[16:9] + _qds_cons_io_m_neg_0[8:1]);
  wire [7:0]       sel_cons_1_2 = 8'(_GEN[16:9] + _qds_cons_io_m_pos_1[8:1]);
  wire [7:0]       sel_cons_1_3 = 8'(_GEN[16:9] + _qds_cons_io_m_pos_2[8:1]);
  ...
  wire [21:0]      rem_adjust_ralign =
    $unsigned($signed($signed(rem_adjust) >>> 5'({1'h0, lzc_d_reg} + 5'h5)));
  ...
  wire [21:0]      _GEN_0 = {4'h0, _early_rem_T ? {abs_x_reg, 2'h0} : 18'h0};
  wire [3:0]       _GEN_1 = {{1'h0}, {1'h0}, {io_dividend[15]}, {io_dividend[7]}};
  wire             x_sign = io_sign & _GEN_1[io_sew];
  wire [3:0]       _GEN_2 = {{1'h0}, {1'h0}, {io_divisor[15]}, {io_divisor[7]}};
  wire             d_sign = io_sign & _GEN_2[io_sew];
  ...
  wire [15:0]      neg_x_q =
    16'(16'h0 - (in_handshake ? _GEN_3[io_sew][15:0] : iter_q_A_reg));
  ...
  wire [15:0]      neg_d_q =
    16'(16'h0 - (in_handshake ? _GEN_4[io_sew][15:0] : iter_q_B_reg));
  wire [3:0]       lzc_x =
    abs_x_reg[15]
      ? 4'h0
      : abs_x_reg[14]
  ...
  wire [78:0]      _norm_x_part_T_2 = {63'h0, abs_x_reg} << {75'h0, lzc_x[3:2], 2'h0};
  wire [78:0]      _norm_d_part_T_2 = {63'h0, abs_d_reg} << {75'h0, lzc_d[3:2], 2'h0};
  wire [4:0]       _lzc_diff_T_2 = 5'({1'h0, lzc_d} - {1'h0, lzc_x});
  wire [21:0]      _GEN_5 =
    {8'h0,
     abs_x_reg == 16'h0,
     lzc_x[1:0],
  ...
  always @(posedge clock) begin
    ...
    if (stateReg[1] | stateReg[2] | stateReg[3]) begin
      iterB_reg_0 <=
        stateReg[1]
          ? _GEN_5
          : stateReg[2]
              ? (early_finish ? _GEN_0 : w_align_init_0)
              : _IterBlock_io_nxt_iterB_0;
      iterB_reg_1 <=
        stateReg[1]
          ? _GEN_5
          : stateReg[2] ? (early_finish ? _GEN_0 : 22'h0) : _IterBlock_io_nxt_iterB_1;
    end
    if (in_handshake) begin
      abs_x_reg <= x_sign ? neg_x_q : _GEN_3[io_sew][15:0];
      abs_d_reg <= d_sign ? neg_d_q : _GEN_4[io_sew][15:0];
    end
    if (stateReg[1])
      lzc_d_reg <= lzc_d;
    if (stateReg[1])
    ...
    if (stateReg[2] | stateReg[3])
      iter_num_reg <=
        stateReg[2]
          ...
          : 2'(iter_num_reg - 2'h1);
    if (stateReg[2]) begin
      iter_cons_reg_0 <= {_GEN[17:0], 4'h0};
      iter_cons_reg_1 <= {_GEN, 3'h0};
      iter_cons_reg_3 <= {norm_d, 3'h0};
      iter_cons_reg_4 <= {norm_d[17:0], 4'h0};
    end
    if (stateReg[2]) begin
      spec_r2ud_reg_0 <= _GEN[13:3];
      spec_r2ud_reg_1 <= _GEN[14:4];
      spec_r2ud_reg_3 <= norm_d[14:4];
      spec_r2ud_reg_4 <= norm_d[13:3];
    end
    if (stateReg[2]) begin
      d_trunc_reg_0 <= _GEN[15:7];
      d_trunc_reg_1 <= _GEN[16:8];
    ...
    if (stateReg[2]) begin
      spec_cons_reg_0_0 <= 9'(_GEN[13:5] + _qds_cons_io_m_neg_1);
      spec_cons_reg_0_1 <= 9'(_GEN[13:5] + _qds_cons_io_m_neg_0);
      spec_cons_reg_0_2 <= 9'(_GEN[13:5] + _qds_cons_io_m_pos_1);
      spec_cons_reg_0_3 <= 9'(_GEN[13:5] + _qds_cons_io_m_pos_2);
      spec_cons_reg_1_0 <= 9'(_GEN[14:6] + _qds_cons_io_m_neg_1);
      spec_cons_reg_1_1 <= 9'(_GEN[14:6] + _qds_cons_io_m_neg_0);
      spec_cons_reg_1_2 <= 9'(_GEN[14:6] + _qds_cons_io_m_pos_1);
      spec_cons_reg_1_3 <= 9'(_GEN[14:6] + _qds_cons_io_m_pos_2);
