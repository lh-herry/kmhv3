  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enqDelayValidReg_last_REG = _RANDOM[4'h7][23];
        io_commonOut_entry_bits_payload_og1Payload_REG_isRVC = _RANDOM[4'h7][24];
        io_commonOut_entry_bits_payload_og1Payload_REG_fixedTaken = _RANDOM[4'h7][25];
        io_commonOut_entry_bits_payload_og1Payload_REG_predTaken = _RANDOM[4'h7][26];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType =
          {_RANDOM[4'h7][31:27], _RANDOM[4'h8][3:0]};
        io_commonOut_entry_bits_payload_og1Payload_REG_selImm = _RANDOM[4'h8][7:4];
        io_commonOut_entry_bits_payload_og1Payload_REG_imm =
          {_RANDOM[4'h8][31:8], _RANDOM[4'h9][7:0]};
        io_commonOut_entry_bits_payload_og1Payload_REG_rasAction = _RANDOM[4'h9][9:8];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[4'h9][17:10];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG = _RANDOM[4'h9][25:18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
