...
module TLDebugModuleOuter(
  ...
  wire hrmask_0 =
    ...
    & (resumereqWrEn & DMCONTROLWrData_setresethaltreq | hrmaskReg_0);
  ...
  wire io_innerCtrl_valid_0 = resumereqWrEn | innerCtrlValidReg;
  wire io_innerCtrl_bits_resumereq_0 =
    resumereqWrEn & auto_dmi_in_a_bits_data[30] | innerCtrlResumeReqReg;
  wire io_innerCtrl_bits_ackhavereset_0 =
    resumereqWrEn & auto_dmi_in_a_bits_data[28] | innerCtrlAckHaveResetReg;
  reg  hartResetReg_0;
  wire DMCONTROLNxt_hartreset =
    DMCONTROLReg_dmactive
    & (resumereqWrEn ? auto_dmi_in_a_bits_data[29] : DMCONTROLReg_hartreset);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      DMCONTROLReg_haltreq <=
        DMCONTROLReg_dmactive
        & (resumereqWrEn ? auto_dmi_in_a_bits_data[31] : DMCONTROLReg_haltreq);
      DMCONTROLReg_hartreset <= DMCONTROLNxt_hartreset;
      DMCONTROLReg_ndmreset <=
        DMCONTROLReg_dmactive
        & (resumereqWrEn ? auto_dmi_in_a_bits_data[1] : DMCONTROLReg_ndmreset);
      if (resumereqWrEn)
        DMCONTROLReg_dmactive <= auto_dmi_in_a_bits_data[0];
      hrmaskReg_0 <= hrmask_0;
      debugIntRegs_0 <=
        DMCONTROLReg_dmactive
        & (resumereqWrEn ? auto_dmi_in_a_bits_data[31] : debugIntRegs_0);
      ...
      hartResetReg_0 <= DMCONTROLNxt_hartreset;
    end
