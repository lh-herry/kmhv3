...
module CtrlUnit(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_out_wofireMux_T_2 & _out_backSel_T[1] & (&out_backMask)) begin
        ...
        counterRegs_0 <= ctrlRegs_0[1] ? delayRegs_0 : 64'h0;
      if (_out_wofireMux_T_2 & _out_backSel_T[2] & (&out_backMask))
        maskRegs_0 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[3] & (&out_backMask))
        maskRegs_1 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[4] & (&out_backMask))
        maskRegs_2 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[5] & (&out_backMask))
        maskRegs_3 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[6] & (&out_backMask))
        maskRegs_4 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[7] & (&out_backMask))
        maskRegs_5 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[8] & (&out_backMask))
        maskRegs_6 <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[9] & (&out_backMask))
  ...
  NewPipelineConnectPipe_15 CtrlUnitPseudoErrorPipelineConnect0 (
    ...
    .io_in_bits_0_mask   (maskRegs_0),
    .io_in_bits_1_valid  (ctrlRegs_0[5]),
    .io_in_bits_1_mask   (maskRegs_1),
    .io_in_bits_2_valid  (ctrlRegs_0[6]),
    .io_in_bits_2_mask   (maskRegs_2),
    .io_in_bits_3_valid  (ctrlRegs_0[7]),
    .io_in_bits_3_mask   (maskRegs_3),
    .io_in_bits_4_valid  (ctrlRegs_0[8]),
    .io_in_bits_4_mask   (maskRegs_4),
    .io_in_bits_5_valid  (ctrlRegs_0[9]),
    .io_in_bits_5_mask   (maskRegs_5),
    .io_in_bits_6_valid  (ctrlRegs_0[10]),
    .io_in_bits_6_mask   (maskRegs_6),
    .io_in_bits_7_valid  (ctrlRegs_0[11]),
    .io_in_bits_7_mask   (maskRegs_7),
