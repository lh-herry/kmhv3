  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_fpWen = _RANDOM[6'hA][12];
        bits_1_loadDependency_0 = _RANDOM[6'hB][9:8];
        bits_1_loadDependency_1 = _RANDOM[6'hB][11:10];
        bits_1_loadDependency_2 = _RANDOM[6'hB][13:12];
        bits_2_robIdx_flag = _RANDOM[6'h14][31];
        bits_2_robIdx_value = _RANDOM[6'h15][8:0];
        bits_2_pdest = _RANDOM[6'h15][22:15];
        bits_2_fpWen = _RANDOM[6'h15][23];
        bits_2_loadDependency_0 = _RANDOM[6'h16][20:19];
        bits_2_loadDependency_1 = _RANDOM[6'h16][22:21];
        bits_2_loadDependency_2 = _RANDOM[6'h16][24:23];
        bits_3_robIdx_flag = _RANDOM[6'h20][10];
        bits_3_robIdx_value = _RANDOM[6'h20][19:11];
        bits_3_pdest = {_RANDOM[6'h20][31:26], _RANDOM[6'h21][1:0]};
        bits_3_fpWen = _RANDOM[6'h21][2];
        bits_3_loadDependency_0 = _RANDOM[6'h21][31:30];
        bits_3_loadDependency_1 = _RANDOM[6'h22][1:0];
        bits_3_loadDependency_2 = _RANDOM[6'h22][3:2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
