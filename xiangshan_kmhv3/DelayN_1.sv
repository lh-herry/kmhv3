...
module DelayN_1(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_priv_sum = _RANDOM[4'h8][2];
        REG_priv_vmxr = _RANDOM[4'h8][3];
        REG_priv_vsum = _RANDOM[4'h8][4];
        REG_priv_virt = _RANDOM[4'h8][5];
        REG_priv_virt_changed = _RANDOM[4'h8][6];
        REG_priv_spvp = _RANDOM[4'h8][7];
        REG_priv_imode = _RANDOM[4'h8][9:8];
        REG_priv_dmode = _RANDOM[4'h8][11:10];
        REG_mPBMTE = _RANDOM[4'h8][12];
        REG_hPBMTE = _RANDOM[4'h8][13];
        REG_pmm_mseccfg = _RANDOM[4'h8][15:14];
        REG_pmm_menvcfg = _RANDOM[4'h8][17:16];
        REG_pmm_henvcfg = _RANDOM[4'h8][19:18];
        REG_pmm_hstatus = _RANDOM[4'h8][21:20];
        REG_pmm_senvcfg = _RANDOM[4'h8][23:22];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_priv_sum = REG_priv_sum;
  assign io_out_priv_vmxr = REG_priv_vmxr;
  assign io_out_priv_vsum = REG_priv_vsum;
  assign io_out_priv_virt = REG_priv_virt;
  assign io_out_priv_virt_changed = REG_priv_virt_changed;
  assign io_out_priv_spvp = REG_priv_spvp;
  assign io_out_priv_imode = REG_priv_imode;
  assign io_out_priv_dmode = REG_priv_dmode;
  assign io_out_mPBMTE = REG_mPBMTE;
  assign io_out_hPBMTE = REG_hPBMTE;
  assign io_out_pmm_mseccfg = REG_pmm_mseccfg;
  assign io_out_pmm_menvcfg = REG_pmm_menvcfg;
  assign io_out_pmm_henvcfg = REG_pmm_henvcfg;
  assign io_out_pmm_hstatus = REG_pmm_hstatus;
  assign io_out_pmm_senvcfg = REG_pmm_senvcfg;
endmodule
