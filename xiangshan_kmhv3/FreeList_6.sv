...
module FreeList_6(
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T =
    freeMask[0] & _remFreeSelMaskVec_T_21[0];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_1 =
    freeMask[4] & _remFreeSelMaskVec_T_21[4];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_2 =
    freeMask[8] & _remFreeSelMaskVec_T_21[8];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_3 =
    freeMask[12] & _remFreeSelMaskVec_T_21[12];
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T_7 =
    freeMask[1] & _remFreeSelMaskVec_T_21[1];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_8 =
    freeMask[5] & _remFreeSelMaskVec_T_21[5];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_9 =
    freeMask[9] & _remFreeSelMaskVec_T_21[9];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_10 =
    freeMask[13] & _remFreeSelMaskVec_T_21[13];
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T_14 =
    freeMask[2] & _remFreeSelMaskVec_T_21[2];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_15 =
    freeMask[6] & _remFreeSelMaskVec_T_21[6];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_16 =
    freeMask[10] & _remFreeSelMaskVec_T_21[10];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_17 =
    freeMask[14] & _remFreeSelMaskVec_T_21[14];
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T_21 =
    freeMask[3] & _remFreeSelMaskVec_T_21[3];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_22 =
    freeMask[7] & _remFreeSelMaskVec_T_21[7];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_23 =
    freeMask[11] & _remFreeSelMaskVec_T_21[11];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_24 =
    freeMask[15] & _remFreeSelMaskVec_T_21[15];
  ...
  wire [3:0]       remFreeSelIndexOHVec_highIndexOH =
    _remFreeSelIndexOHVec_highIndexOH_T
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_1
          ...
          : _remFreeSelIndexOHVec_highIndexOH_T_2
              ? 4'h4
              : {_remFreeSelIndexOHVec_highIndexOH_T_3, 3'h0};
  ...
  wire [3:0]       remFreeSelIndexOHVec_highIndexOH_1 =
    _remFreeSelIndexOHVec_highIndexOH_T_7
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_8
          ...
          : _remFreeSelIndexOHVec_highIndexOH_T_9
              ? 4'h4
              : {_remFreeSelIndexOHVec_highIndexOH_T_10, 3'h0};
  ...
  wire [3:0]       remFreeSelIndexOHVec_highIndexOH_2 =
    _remFreeSelIndexOHVec_highIndexOH_T_14
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_15
          ...
          : _remFreeSelIndexOHVec_highIndexOH_T_16
              ? 4'h4
              : {_remFreeSelIndexOHVec_highIndexOH_T_17, 3'h0};
  ...
  wire [3:0]       remFreeSelIndexOHVec_highIndexOH_3 =
    _remFreeSelIndexOHVec_highIndexOH_T_21
      ...
      : _remFreeSelIndexOHVec_highIndexOH_T_22
          ...
          : _remFreeSelIndexOHVec_highIndexOH_T_23
              ? 4'h4
              : {_remFreeSelIndexOHVec_highIndexOH_T_24, 3'h0};
  ...
  wire [3:0]       _enqPtr_new_ptr_T_13 = 4'(tailPtr_value + {2'h0, offset});
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h0)
        freeList_0 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h0)
        freeList_0 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h0)
        freeList_0 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h0)
        freeList_0 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h1)
        freeList_1 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h1)
        freeList_1 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h1)
        freeList_1 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h1)
        freeList_1 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h2)
        freeList_2 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h2)
        freeList_2 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h2)
        freeList_2 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h2)
        freeList_2 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h3)
        freeList_3 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h3)
        freeList_3 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h3)
        freeList_3 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h3)
        freeList_3 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h4)
        freeList_4 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h4)
        freeList_4 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h4)
        freeList_4 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h4)
        freeList_4 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h5)
        freeList_5 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h5)
        freeList_5 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h5)
        freeList_5 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h5)
        freeList_5 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h6)
        freeList_6 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h6)
        freeList_6 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h6)
        freeList_6 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h6)
        freeList_6 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h7)
        freeList_7 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h7)
        freeList_7 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h7)
        freeList_7 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h7)
        freeList_7 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h8)
        freeList_8 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h8)
        freeList_8 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h8)
        freeList_8 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h8)
        freeList_8 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'h9)
        freeList_9 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'h9)
        freeList_9 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'h9)
        freeList_9 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'h9)
        freeList_9 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'hA)
        freeList_10 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'hA)
        freeList_10 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'hA)
        freeList_10 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'hA)
        freeList_10 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'hB)
        freeList_11 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'hB)
        freeList_11 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'hB)
        freeList_11 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'hB)
        freeList_11 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'hC)
        freeList_12 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'hC)
        freeList_12 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'hC)
        freeList_12 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'hC)
        freeList_12 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'hD)
        freeList_13 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'hD)
        freeList_13 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'hD)
        freeList_13 <= _freeList_T_19;
      else if (freeReq_next_nextVec_0_r & tailPtr_value == 4'hD)
        freeList_13 <= _freeList_T_9;
      if (freeReq_next_nextVec_3_r & _enqPtr_new_ptr_T_19 == 4'hE)
        freeList_14 <= _freeList_T_39;
      else if (freeReq_next_nextVec_2_r & _enqPtr_new_ptr_T_13 == 4'hE)
        freeList_14 <= _freeList_T_29;
      else if (freeReq_next_nextVec_1_r & _enqPtr_new_ptr_T_7 == 4'hE)
  ...
  wire [15:0][3:0] _GEN_4 =
    {{freeList_15},
     ...
     {freeList_1},
     {freeList_0}};
  wire [4:0]       _deqPtr_new_ptr_T_19 = 5'(_GEN + 5'(_GEN_0 + 5'h1));
  wire [4:0]       _deqPtr_new_ptr_T_31 = 5'(_GEN + 5'(_GEN_0 + 5'h2));
  always @(posedge clock) begin
    ...
    io_canAllocate_1_r <=
      _deqPtr_new_ptr_T_19[4] ^ tailPtr_flag ^ _deqPtr_new_ptr_T_19[3:0] < tailPtr_value;
    io_allocateSlot_1_r <= _GEN_4[_deqPtr_new_ptr_T_19[3:0]];
    io_canAllocate_2_r <=
      _deqPtr_new_ptr_T_31[4] ^ tailPtr_flag ^ _deqPtr_new_ptr_T_31[3:0] < tailPtr_value;
    io_allocateSlot_2_r <= _GEN_4[_deqPtr_new_ptr_T_31[3:0]];
  end // always @(posedge)
