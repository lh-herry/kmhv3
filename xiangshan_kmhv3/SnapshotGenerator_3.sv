...
module SnapshotGenerator_3(
  ...
  output [8:0] io_snapshots_0_0_value,
  output       io_snapshots_1_0_flag,
  output [8:0] io_snapshots_1_0_value,
  output       io_snapshots_2_0_flag,
  output [8:0] io_snapshots_2_0_value,
  output       io_snapshots_3_0_flag,
  output [8:0] io_snapshots_3_0_value
);

  reg        snapshots_0_0_flag;
  reg  [8:0] snapshots_0_0_value;
  reg        snapshots_1_0_flag;
  reg  [8:0] snapshots_1_0_value;
  reg        snapshots_2_0_flag;
  reg  [8:0] snapshots_2_0_value;
  reg        snapshots_3_0_flag;
  reg  [8:0] snapshots_3_0_value;
  reg        snptEnqPtr_flag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        snapshots_0_0_value = _RANDOM[4'h0][9:1];
        snapshots_1_0_flag = _RANDOM[4'h2][16];
        snapshots_1_0_value = _RANDOM[4'h2][25:17];
        snapshots_2_0_flag = _RANDOM[4'h5][0];
        snapshots_2_0_value = _RANDOM[4'h5][9:1];
        snapshots_3_0_flag = _RANDOM[4'h7][16];
        snapshots_3_0_value = _RANDOM[4'h7][25:17];
        snptEnqPtr_flag = _RANDOM[4'hA][0];
        snptEnqPtr_value = _RANDOM[4'hA][2:1];
        snptDeqPtr_flag = _RANDOM[4'hA][3];
        snptDeqPtr_value = _RANDOM[4'hA][5:4];
        snptValids_0 = _RANDOM[4'hA][6];
        snptValids_1 = _RANDOM[4'hA][7];
        snptValids_2 = _RANDOM[4'hA][8];
        snptValids_3 = _RANDOM[4'hA][9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        snptEnqPtr_flag = 1'h0;
        snptEnqPtr_value = 2'h0;
