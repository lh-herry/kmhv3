  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_ftqPtr_value = _RANDOM[6'h13][12:7];
        s1_in_r_uop_ftqOffset = _RANDOM[6'h13][17:13];
        ...
        s1_in_r_uop_vpu_vma = _RANDOM[6'h17][18];
        s1_in_r_uop_vpu_vta = _RANDOM[6'h17][19];
        s1_in_r_uop_vpu_vsew = _RANDOM[6'h17][21:20];
        s1_in_r_uop_vpu_vlmul = _RANDOM[6'h17][24:22];
        s1_in_r_uop_vpu_vm = _RANDOM[6'h18][1];
        s1_in_r_uop_vpu_vstart = _RANDOM[6'h18][9:2];
        s1_in_r_uop_vpu_vuopIdx = _RANDOM[6'h18][28:22];
        s1_in_r_uop_vpu_vl = {_RANDOM[6'h1C][31:30], _RANDOM[6'h1D][5:0]};
        s1_in_r_uop_vpu_nf = _RANDOM[6'h1D][8:6];
        s1_in_r_uop_vpu_veew = _RANDOM[6'h1D][10:9];
        s1_in_r_uop_uopIdx = _RANDOM[6'h1E][18:12];
        s1_in_r_uop_pdest = _RANDOM[6'h21][9:2];
        s1_in_r_uop_robIdx_flag = _RANDOM[6'h21][31];
        s1_in_r_uop_robIdx_value = _RANDOM[6'h22][8:0];
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h37][12];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h37][19:13];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h37][20];
        s1_in_r_uop_sqIdx_value = _RANDOM[6'h37][26:21];
        s1_in_r_fof = _RANDOM[6'h38][2];
        s1_in_r_vdIdxInField = _RANDOM[6'h38][5:3];
        s1_in_r_preIsSplit = _RANDOM[6'h3C][6];
        s1_in_r_alignedType = _RANDOM[6'h3C][13:11];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3C][21:14];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
