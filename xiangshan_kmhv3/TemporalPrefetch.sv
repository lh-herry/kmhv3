...
module TemporalPrefetch(
  ...
  wire              _sending_valid_T = _tpDataQueue_io_count != 4'h8;
  ...
  wire              tpDataQueue_io_deq_ready =
    _tpDataQueue_io_count == 4'h8 | ~do_sending;
  wire              _GEN_2 = tpDataQueue_io_deq_ready & _tpDataQueue_io_deq_valid;
  wire              io_req_valid_0 =
    io_enable & do_sending & _sending_valid_T & sending_throttle == 4'h4;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (s1_valid)
        hit_s2 <= |_hit_s1_T;
      if (dorecord_s2)
        recorder_idx <= _GEN ? 6'h0 : 6'(recorder_idx + 6'h1);
      ...
      if (_GEN_4) begin
        ...
        if (_GEN_2)
          sending_idx <= 6'h1;
        if ((|{do_sending & _sending_valid_T, sending_throttle})
            & sending_throttle != 4'h4)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pending_valid_s0 = _RANDOM[6'h3][20];
        s1_valid = _RANDOM[6'h3][21];
        train_s1_tag = {_RANDOM[6'h3][31:22], _RANDOM[6'h4][22:0]};
        train_s1_set = _RANDOM[6'h4][31:23];
        train_s1_vaddr = {_RANDOM[6'h5][31:8], _RANDOM[6'h6][19:0]};
        s2_valid = _RANDOM[6'h6][31];
        hit_s2 = _RANDOM[6'h7][0];
        way_s2 = _RANDOM[6'h7][4:1];
        pset_s2 = _RANDOM[6'h7][24:15];
        train_s2_tag = {_RANDOM[6'h7][31:25], _RANDOM[6'h8][25:0]};
        train_s2_set = {_RANDOM[6'h8][31:26], _RANDOM[6'h9][2:0]};
        train_s2_vaddr = {_RANDOM[6'h9][31:11], _RANDOM[6'hA][22:0]};
        recorder_idx = _RANDOM[6'hB][8:3];
        recorder_data_0 = {_RANDOM[6'hB][31:9], _RANDOM[6'hC][24:0]};
        recorder_data_1 = {_RANDOM[6'hC][31:25], _RANDOM[6'hD], _RANDOM[6'hE][8:0]};
        recorder_data_2 = {_RANDOM[6'hE][31:9], _RANDOM[6'hF][24:0]};
        recorder_data_3 = {_RANDOM[6'hF][31:25], _RANDOM[6'h10], _RANDOM[6'h11][8:0]};
        recorder_data_4 = {_RANDOM[6'h11][31:9], _RANDOM[6'h12][24:0]};
        recorder_data_5 = {_RANDOM[6'h12][31:25], _RANDOM[6'h13], _RANDOM[6'h14][8:0]};
        recorder_data_6 = {_RANDOM[6'h14][31:9], _RANDOM[6'h15][24:0]};
        recorder_data_7 = {_RANDOM[6'h15][31:25], _RANDOM[6'h16], _RANDOM[6'h17][8:0]};
        recorder_data_8 = {_RANDOM[6'h17][31:9], _RANDOM[6'h18][24:0]};
        recorder_data_9 = {_RANDOM[6'h18][31:25], _RANDOM[6'h19], _RANDOM[6'h1A][8:0]};
        recorder_data_10 = {_RANDOM[6'h1A][31:9], _RANDOM[6'h1B][24:0]};
        recorder_data_11 = {_RANDOM[6'h1B][31:25], _RANDOM[6'h1C], _RANDOM[6'h1D][8:0]};
        write_record = _RANDOM[6'h1D][9];
        write_record_trigger_paddr =
          {_RANDOM[6'h1E][31:28], _RANDOM[6'h1F], _RANDOM[6'h20][11:0]};
        write_record_trigger_way = _RANDOM[6'h20][15:12];
        do_sending = _RANDOM[6'h20][17];
        sending_idx = _RANDOM[6'h20][23:18];
        sending_data_0 = {_RANDOM[6'h20][31:24], _RANDOM[6'h21], _RANDOM[6'h22][1:0]};
        sending_data_1 = {_RANDOM[6'h22][31:2], _RANDOM[6'h23][11:0]};
        sending_data_2 = {_RANDOM[6'h23][31:12], _RANDOM[6'h24][21:0]};
        sending_data_3 = {_RANDOM[6'h24][31:22], _RANDOM[6'h25]};
        sending_data_4 = {_RANDOM[6'h26], _RANDOM[6'h27][9:0]};
        sending_data_5 = {_RANDOM[6'h27][31:10], _RANDOM[6'h28][19:0]};
        sending_data_6 = {_RANDOM[6'h28][31:20], _RANDOM[6'h29][29:0]};
        sending_data_7 = {_RANDOM[6'h29][31:30], _RANDOM[6'h2A], _RANDOM[6'h2B][7:0]};
        sending_data_8 = {_RANDOM[6'h2B][31:8], _RANDOM[6'h2C][17:0]};
        sending_data_9 = {_RANDOM[6'h2C][31:18], _RANDOM[6'h2D][27:0]};
        sending_data_10 = {_RANDOM[6'h2D][31:28], _RANDOM[6'h2E], _RANDOM[6'h2F][5:0]};
        sending_data_11 = {_RANDOM[6'h2F][31:6], _RANDOM[6'h30][15:0]};
        sending_throttle = _RANDOM[6'h30][19:16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 10'h3FF;
  ...
  Queue9_tpDataEntry tpDataQueue (
    ...
    .io_deq_ready           (tpDataQueue_io_deq_ready),
