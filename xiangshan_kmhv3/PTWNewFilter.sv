...
module PTWNewFilter(
  ...
  input         io_tlb_req_8_valid,
  input  [37:0] io_tlb_req_8_bits_vpn,
  input  [1:0]  io_tlb_req_8_bits_s2xlate,
  input         io_tlb_req_8_bits_getGpa,
  ...
  reg         ptwResp_s2_gpf;
  reg         ptwResp_s2_gaf;
  reg         load_filter_0_ptw_resp_valid_REG;
  reg         store_filter_0_ptw_resp_valid_REG;
  reg         prefetch_filter_0_ptw_resp_valid_REG;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      load_filter_0_ptw_resp_valid_REG <= 1'h0;
      store_filter_0_ptw_resp_valid_REG <= 1'h0;
      prefetch_filter_0_ptw_resp_valid_REG <= 1'h0;
    end
    else begin
      load_filter_0_ptw_resp_valid_REG <= io_ptw_resp_valid;
      store_filter_0_ptw_resp_valid_REG <= io_ptw_resp_valid;
      prefetch_filter_0_ptw_resp_valid_REG <= io_ptw_resp_valid;
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        load_filter_0_ptw_resp_valid_REG = _RANDOM[4'h9][1];
        store_filter_0_ptw_resp_valid_REG = _RANDOM[4'h9][2];
        prefetch_filter_0_ptw_resp_valid_REG = _RANDOM[4'h9][3];
  ...
  PTWFilterEntry load_filter_load_entry (
    ...
    .io_ptw_resp_valid                (load_filter_0_ptw_resp_valid_REG),
    ...
    .io_ptw_resp_bits_s1_entry_perm_g (ptwResp_s1_entry_perm_g),
  ...
  PTWFilterEntry_1 store_filter_store_entry (
    ...
    .io_ptw_resp_valid                (store_filter_0_ptw_resp_valid_REG),
    .io_ptw_resp_bits_s2xlate         (ptwResp_s2xlate),
    .io_ptw_resp_bits_s1_entry_tag    (ptwResp_s1_entry_tag),
    .io_ptw_resp_bits_s1_entry_asid   (ptwResp_s1_entry_asid),
    .io_ptw_resp_bits_s1_entry_vmid   (ptwResp_s1_entry_vmid),
  ...
  PTWFilterEntry_2 prefetch_filter_prefetch_entry (
    .clock                            (clock),
    .reset                            (reset),
    .io_csr_satp_asid                 (io_csr_satp_asid),
    .io_csr_vsatp_asid                (io_csr_vsatp_asid),
    ...
    .io_tlb_req_2_valid               (io_tlb_req_8_valid),
    .io_tlb_req_2_bits_vpn            (io_tlb_req_8_bits_vpn),
    .io_tlb_req_2_bits_s2xlate        (io_tlb_req_8_bits_s2xlate),
    .io_tlb_req_2_bits_getGpa         (io_tlb_req_8_bits_getGpa),
    .io_ptw_req_0_ready               (_ptw_arb_io_in_2_ready),
    .io_ptw_req_0_valid
      (_prefetch_filter_prefetch_entry_io_ptw_req_0_valid),
    ...
    .io_ptw_resp_valid                (prefetch_filter_0_ptw_resp_valid_REG),
    .io_ptw_resp_bits_s2xlate         (ptwResp_s2xlate),
    .io_ptw_resp_bits_s1_entry_tag    (ptwResp_s1_entry_tag),
    .io_ptw_resp_bits_s1_entry_asid   (ptwResp_s1_entry_asid),
    .io_ptw_resp_bits_s1_entry_vmid   (ptwResp_s1_entry_vmid),
