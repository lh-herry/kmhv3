...
module Estimate7(
  ...
  wire         _recResultMap_T_88 = isZeroSrc | isSubnormalRec2 & ~rmin;
  wire         _recResultMap_T_85 = isNormalRec2 | isSubnormalRec0 | isSubnormalRec1;
  wire         _recResultMap_T_84 = isSubnormalRec2 & rmin;
  wire         _sqrtResultMap_T_45 = signSrc & ~isZeroSrc | isNaNSrc;
  wire         _sqrtResultMap_T_43 = ~signSrc & ~isZeroSrc & ~expIsOnesSrc;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_fire) begin
        ...
        expNormaled0 <=
          isSubnormalSrcNext ? _leadZerosNext_lzc_io_out_data[0] : input_0[52];
        fracSrcLeft <= clzIn;
      end
        ...
        result <=
          isRec
                ...
                output1HReg[1]
                  ? (isNaNSrc ? 16'h7E00 : 16'h0) | (isInfSrc ? {signSrc, 15'h0} : 16'h0)
                    ...
                    | (_recResultMap_T_85
                         ...
                         : 16'h0) | (_recResultMap_T_84 ? {signSrc, 15'h7BFF} : 16'h0)
                  : 16'h0}
                 | (output1HReg[2]
            ...
            : {32'h0,
               {16'h0,
                output1HReg[1]
                  ? (_sqrtResultMap_T_45 ? 16'h7E00 : 16'h0)
                  ...
                  : 16'h0}
                 | (output1HReg[2]
                      ? (_sqrtResultMap_T_45 ? 32'h7FC00000 : 32'h0)
  ...
  always @(posedge clock) begin
    if (io_fire) begin
      ...
      expAdderIn1 <=
        isSubnormalSrcNext
          ? {7'h0, _leadZerosNext_lzc_io_out_data}
