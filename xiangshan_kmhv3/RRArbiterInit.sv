...
module RRArbiterInit(
  ...
  input         io_in_2_valid,
  input  [35:0] io_in_2_bits_ppn,
  input         io_in_3_valid,
  input  [35:0] io_in_3_bits_ppn,
  input         io_in_4_valid,
  input  [35:0] io_in_4_bits_ppn,
  input         io_in_5_valid,
  input  [35:0] io_in_5_bits_ppn,
  input         io_in_6_valid,
  input  [35:0] io_in_6_bits_ppn,
  input         io_in_7_valid,
  input  [35:0] io_in_7_bits_ppn,
  input         io_out_ready,
  output        io_out_valid,
  ...
  assign io_out_bits_ppn = _GEN_0[io_chosen_choice];
