...
module Reduction(
  ...
  wire [1:0]        _widen_T_2 = 2'(io_in_bits_srcType_0[1:0] + 2'h1);
  wire              widen = io_in_bits_vdType[1:0] == _widen_T_2;
  ...
  wire              _alu_uop_T = io_in_bits_vdType[1:0] != _widen_T_2;
  ...
  wire              _cin_15_T = vdType_reg == 2'h0;
  wire              _cin_15_T_1 = vdType_reg == 2'h1;
  wire              _cin_15_T_2 = vdType_reg == 2'h2;
  ...
  wire [9:0]        _bits_T_2 =
    10'({1'h0, vs_lo_adjust[7:0], cin_0} + {1'h0, vd_reg[7:0], cin_0});
  assign cout_0 = _bits_T_2[9];
  assign cin_0 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & sub_reg | (&vdType_reg)
    & sub_reg;
  wire [9:0]        _bits_T_5 =
    10'({1'h0, vs_lo_adjust[15:8], cin_1} + {1'h0, vd_reg[15:8], cin_1});
  assign cout_1 = _bits_T_5[9];
  assign cin_1 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_0 | _cin_15_T_2 & cout_0 | (&vdType_reg)
    & cout_0;
  wire [9:0]        _bits_T_8 =
    10'({1'h0, vs_lo_adjust[23:16], cin_2} + {1'h0, vd_reg[23:16], cin_2});
  assign cout_2 = _bits_T_8[9];
  assign cin_2 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & cout_1 | (&vdType_reg)
    & cout_1;
  wire [9:0]        _bits_T_11 =
    10'({1'h0, vs_lo_adjust[31:24], cin_3} + {1'h0, vd_reg[31:24], cin_3});
  assign cout_3 = _bits_T_11[9];
  assign cin_3 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_2 | _cin_15_T_2 & cout_2 | (&vdType_reg)
    & cout_2;
  wire [9:0]        _bits_T_14 =
    10'({1'h0, vs_lo_adjust[39:32], cin_4} + {1'h0, vd_reg[39:32], cin_4});
  assign cout_4 = _bits_T_14[9];
  assign cin_4 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & sub_reg | (&vdType_reg)
    & cout_3;
  wire [9:0]        _bits_T_17 =
    10'({1'h0, vs_lo_adjust[47:40], cin_5} + {1'h0, vd_reg[47:40], cin_5});
  assign cout_5 = _bits_T_17[9];
  assign cin_5 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_4 | _cin_15_T_2 & cout_4 | (&vdType_reg)
    & cout_4;
  wire [9:0]        _bits_T_20 =
    10'({1'h0, vs_lo_adjust[55:48], cin_6} + {1'h0, vd_reg[55:48], cin_6});
  assign cout_6 = _bits_T_20[9];
  assign cin_6 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & cout_5 | (&vdType_reg)
    & cout_5;
  wire [9:0]        _bits_T_23 =
    10'({1'h0, vs_lo_adjust[63:56], cin_7} + {1'h0, vd_reg[63:56], cin_7});
  assign cout_7 = _bits_T_23[9];
  assign cin_7 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_6 | _cin_15_T_2 & cout_6 | (&vdType_reg)
    & cout_6;
  wire [9:0]        _bits_T_26 =
    10'({1'h0, vs_lo_adjust[71:64], cin_8} + {1'h0, vd_reg[71:64], cin_8});
  assign cout_8 = _bits_T_26[9];
  assign cin_8 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & sub_reg | (&vdType_reg)
    & sub_reg;
  wire [9:0]        _bits_T_29 =
    10'({1'h0, vs_lo_adjust[79:72], cin_9} + {1'h0, vd_reg[79:72], cin_9});
  assign cout_9 = _bits_T_29[9];
  assign cin_9 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_8 | _cin_15_T_2 & cout_8 | (&vdType_reg)
    & cout_8;
  wire [9:0]        _bits_T_32 =
    10'({1'h0, vs_lo_adjust[87:80], cin_10} + {1'h0, vd_reg[87:80], cin_10});
  assign cout_10 = _bits_T_32[9];
  assign cin_10 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & cout_9 | (&vdType_reg)
    & cout_9;
  wire [9:0]        _bits_T_35 =
    10'({1'h0, vs_lo_adjust[95:88], cin_11} + {1'h0, vd_reg[95:88], cin_11});
  assign cout_11 = _bits_T_35[9];
  assign cin_11 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_10 | _cin_15_T_2 & cout_10 | (&vdType_reg)
    & cout_10;
  wire [9:0]        _bits_T_38 =
    10'({1'h0, vs_lo_adjust[103:96], cin_12} + {1'h0, vd_reg[103:96], cin_12});
  assign cout_12 = _bits_T_38[9];
  assign cin_12 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & sub_reg | (&vdType_reg)
    & cout_11;
  wire [9:0]        _bits_T_41 =
    10'({1'h0, vs_lo_adjust[111:104], cin_13} + {1'h0, vd_reg[111:104], cin_13});
  assign cout_13 = _bits_T_41[9];
  assign cin_13 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_12 | _cin_15_T_2 & cout_12 | (&vdType_reg)
    & cout_12;
  wire [9:0]        _bits_T_44 =
    10'({1'h0, vs_lo_adjust[119:112], cin_14} + {1'h0, vd_reg[119:112], cin_14});
  assign cout_14 = _bits_T_44[9];
  assign cin_14 =
    _cin_15_T & sub_reg | _cin_15_T_1 & sub_reg | _cin_15_T_2 & cout_13 | (&vdType_reg)
    & cout_13;
  wire [9:0]        _bits_T_47 =
    10'({1'h0, vs_lo_adjust[127:120], cin_15} + {1'h0, vd_reg[127:120], cin_15});
  assign cout_15 = _bits_T_47[9];
  assign cin_15 =
    _cin_15_T & sub_reg | _cin_15_T_1 & cout_14 | _cin_15_T_2 & cout_14 | (&vdType_reg)
    & cout_14;
  ...
  wire              _vs1_zero_logical_T_31 = io_in_bits_vdType[1:0] == 2'h0;
  wire              _vs1_zero_logical_T_32 = io_in_bits_vdType[1:0] == 2'h1;
  wire              _vs1_zero_logical_T_33 = io_in_bits_vdType[1:0] == 2'h2;
        ...
        vs1_zero_logical_reg_s1 <=
          vredand_vs
            ? (_vs1_zero_logical_T_31 ? {56'hFFFFFFFFFFFFFF, io_in_bits_vs1[7:0]} : 64'h0)
              | (_vs1_zero_logical_T_32
                   ? {48'hFFFFFFFFFFFF, io_in_bits_vs1[15:0]}
                   : 64'h0)
  ...
  assign io_out_vd =
    alu_uop_reg | widen_alu_uop_reg
      ? (_reg_vred_logical_T | reg_vredxor_vs
           ? vd_reg
           : sub_reg
               ? {_cin_15_T & sel_lo_15 | _cin_15_T_1 & sel_lo_15 | _cin_15_T_2
                  & sel_lo_15 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[127:120]
                    : vd_reg[127:120],
                  _cin_15_T
                  & (signed_reg
                       ? vd_reg[119] ^ vs_lo_adjust[119] ^ cout_14
                       : ~cout_14) == isVredmax_reg | _cin_15_T_1 & sel_lo_15
                  | _cin_15_T_2 & sel_lo_15 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[119:112]
                    : vd_reg[119:112],
                  _cin_15_T & sel_lo_13 | _cin_15_T_1 & sel_lo_13 | _cin_15_T_2
                  & sel_lo_15 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[111:104]
                    : vd_reg[111:104],
                  _cin_15_T
                  & (signed_reg
                       ...
                       : ~cout_12) == isVredmax_reg | _cin_15_T_1 & sel_lo_13
                  | _cin_15_T_2 & sel_lo_15 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[103:96]
                    : vd_reg[103:96],
                  _cin_15_T & sel_lo_11 | _cin_15_T_1 & sel_lo_11 | _cin_15_T_2
                  & sel_lo_11 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[95:88]
                    : vd_reg[95:88],
                  _cin_15_T
                  & (signed_reg
                       ? vd_reg[87] ^ vs_lo_adjust[87] ^ cout_10
                       : ~cout_10) == isVredmax_reg | _cin_15_T_1 & sel_lo_11
                  | _cin_15_T_2 & sel_lo_11 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[87:80]
                    : vd_reg[87:80],
                  _cin_15_T & sel_lo_9 | _cin_15_T_1 & sel_lo_9 | _cin_15_T_2 & sel_lo_11
                  | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[79:72]
                    : vd_reg[79:72],
                  _cin_15_T
                  & (signed_reg
                       ? vd_reg[71] ^ vs_lo_adjust[71] ^ cout_8
                       : ~cout_8) == isVredmax_reg | _cin_15_T_1 & sel_lo_9 | _cin_15_T_2
                  & sel_lo_11 | (&vdType_reg) & sel_lo_15
                    ? old_vd_reg[71:64]
                    : vd_reg[71:64],
                  _cin_15_T & sel_lo_7 | _cin_15_T_1 & sel_lo_7 | _cin_15_T_2 & sel_lo_7
                  | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[63:56]
                    : vd_reg[63:56],
                  _cin_15_T
                  & (signed_reg
                       ...
                       : ~cout_6) == isVredmax_reg | _cin_15_T_1 & sel_lo_7 | _cin_15_T_2
                  & sel_lo_7 | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[55:48]
                    : vd_reg[55:48],
                  _cin_15_T & sel_lo_5 | _cin_15_T_1 & sel_lo_5 | _cin_15_T_2 & sel_lo_7
                  | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[47:40]
                    : vd_reg[47:40],
                  _cin_15_T
                  & (signed_reg
                       ...
                       : ~cout_4) == isVredmax_reg | _cin_15_T_1 & sel_lo_5 | _cin_15_T_2
                  & sel_lo_7 | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[39:32]
                    : vd_reg[39:32],
                  _cin_15_T & sel_lo_3 | _cin_15_T_1 & sel_lo_3 | _cin_15_T_2 & sel_lo_3
                  | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[31:24]
                    : vd_reg[31:24],
                  _cin_15_T
                  & (signed_reg
                       ...
                       : ~cout_2) == isVredmax_reg | _cin_15_T_1 & sel_lo_3 | _cin_15_T_2
                  & sel_lo_3 | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[23:16]
                    : vd_reg[23:16],
                  _cin_15_T & sel_lo_1 | _cin_15_T_1 & sel_lo_1 | _cin_15_T_2 & sel_lo_3
                  | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[15:8]
                    : vd_reg[15:8],
                  _cin_15_T
                  & (signed_reg
                       ...
                       : ~cout_0) == isVredmax_reg | _cin_15_T_1 & sel_lo_1 | _cin_15_T_2
                  & sel_lo_3 | (&vdType_reg) & sel_lo_7
                    ? old_vd_reg[7:0]
                    : vd_reg[7:0]}
               : {_bits_T_47[8:1],
