...
module FarPathF32WidenF16MixedPipeline(
  ...
  wire        _far_case_overflow_round_up_reg_T_22 =
    grs_overflow_reg[1] | grs_overflow_reg[0];
  reg         far_case_overflow_round_up_reg_r;
  wire        far_case_overflow_round_up_reg =
    far_case_overflow_round_up_reg_r & ~(grs_overflow_reg[2])
    & ~_far_case_overflow_round_up_reg_T_22 | RNE_reg & grs_overflow_reg[2]
    & (FS0_1_reg | _far_case_overflow_round_up_reg_T_22)
    | _far_case_overflow_round_up_reg_T_13
    & (grs_overflow_reg[2] | _far_case_overflow_round_up_reg_T_22) | RUP_reg
    & ~far_sign_result_reg & (grs_overflow_reg[2] | _far_case_overflow_round_up_reg_T_22)
