  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_ctrl_toRobValid_r = _RANDOM[3'h7][3];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[3'h7][4];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[3'h7][13:5];
        io_out_bits_ctrl_pdest_r = _RANDOM[3'h7][21:14];
        io_out_bits_ctrl_fpWen_r = _RANDOM[3'h7][22];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[3'h7][23];
      `endif // RANDOMIZE_REG_INIT
    end // initial
