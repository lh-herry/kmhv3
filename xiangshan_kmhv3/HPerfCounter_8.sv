...
module HPerfCounter_8(
  ...
  always @(posedge clock) begin
    events_incr_0_value <= _GEN[io_hpm_event[6:0]];
    events_incr_1_value <= _GEN[io_hpm_event[16:10]];
    events_incr_2_value <= _GEN[io_hpm_event[26:20]];
    events_incr_3_value <= _GEN[io_hpm_event[36:30]];
