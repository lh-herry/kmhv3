  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_ftqPtr_value = _RANDOM[6'h4][19:14];
        data_uop_ftqOffset = _RANDOM[6'h4][24:20];
        data_uop_fuOpType = {_RANDOM[6'h6][31:25], _RANDOM[6'h7][1:0]};
        data_uop_rfWen = _RANDOM[6'h7][2];
        data_uop_fpWen = _RANDOM[6'h7][3];
        data_uop_vpu_vstart = _RANDOM[6'h9][16:9];
        data_uop_vpu_veew = _RANDOM[6'hE][17:16];
        data_uop_pdest = _RANDOM[6'h12][16:9];
        data_uop_robIdx_flag = _RANDOM[6'h13][6];
        data_uop_robIdx_value = _RANDOM[6'h13][15:7];
        data_uop_storeSetHit = _RANDOM[6'h27][31];
        data_uop_waitForRobIdx_flag = _RANDOM[6'h28][0];
        data_uop_waitForRobIdx_value = _RANDOM[6'h28][9:1];
        data_uop_loadWaitBit = _RANDOM[6'h28][10];
        data_uop_loadWaitStrict = _RANDOM[6'h28][11];
        data_uop_lqIdx_flag = _RANDOM[6'h28][19];
        data_uop_lqIdx_value = _RANDOM[6'h28][26:20];
        data_uop_sqIdx_flag = _RANDOM[6'h28][27];
        data_uop_sqIdx_value = {_RANDOM[6'h28][31:28], _RANDOM[6'h29][1:0]};
        data_vaddr = {_RANDOM[6'h29][31:9], _RANDOM[6'h2A][26:0]};
        data_fullva = {_RANDOM[6'h2A][31:27], _RANDOM[6'h2B], _RANDOM[6'h2C][26:0]};
        data_size = _RANDOM[6'h2C][29:27];
        data_mask = {_RANDOM[6'h2C][31:30], _RANDOM[6'h2D][13:0]};
        data_elemIdx = _RANDOM[6'h2D][21:14];
        data_mbIndex = _RANDOM[6'h2D][25:22];
        data_regOffset = _RANDOM[6'h2D][29:26];
        data_elemIdxInsideVd = {_RANDOM[6'h2D][31:30], _RANDOM[6'h2E][5:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
