...
module HPerfCounter(
  ...
  wire [4:0][5:0]  _GEN = '{6'h0, 6'h0, 6'h0, 6'h0, 6'h0};
  ...
  always @(posedge clock) begin
    events_incr_0_value <= _GEN_0[io_hpm_event[4:0]];
    events_incr_1_value <= _GEN_0[io_hpm_event[14:10]];
    events_incr_2_value <= _GEN_0[io_hpm_event[24:20]];
    events_incr_3_value <= _GEN_0[io_hpm_event[34:30]];
