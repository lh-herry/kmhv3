...
module RequestBuffer_4(
  ...
  reg          rdys_2;
  reg          rdys_3;
  wire         issue_arb_io_in_0_valid = valids_0 & rdys_0;
  wire         issue_arb_io_in_1_valid = valids_1 & rdys_1;
  wire         issue_arb_io_in_2_valid = valids_2 & rdys_2;
  wire         issue_arb_io_in_3_valid = valids_3 & rdys_3;
  ...
  wire         req_deps_0 = valids_0 & _buffer_ext_R3_data[92:84] == io_in_bits_set[8:0];
  wire         req_deps_1 = valids_1 & _buffer_ext_R2_data[92:84] == io_in_bits_set[8:0];
  wire         req_deps_2 = valids_2 & _buffer_ext_R1_data[92:84] == io_in_bits_set[8:0];
  wire         req_deps_3 = valids_3 & _buffer_ext_R0_data[92:84] == io_in_bits_set[8:0];
  ...
  wire         alloc =
    ...
    & ~(io_in_valid & io_in_bits_isPrefetch
        & (|{valids_0
               & {_buffer_ext_R3_data[83:56],
                  _buffer_ext_R3_data[95:84]} == _dup_mask_T_10,
             valids_1
               & {_buffer_ext_R2_data[83:56],
                  _buffer_ext_R2_data[95:84]} == _dup_mask_T_10,
             valids_2
               & {_buffer_ext_R1_data[83:56],
                  _buffer_ext_R1_data[95:84]} == _dup_mask_T_10,
             valids_3
               & {_buffer_ext_R0_data[83:56],
                  _buffer_ext_R0_data[95:84]} == _dup_mask_T_10}));
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      valids_0 <= _GEN | ~(_issue_arb_io_in_0_ready & issue_arb_io_in_0_valid) & valids_0;
      valids_1 <=
        _GEN_0 | ~(_issue_arb_io_in_1_ready & issue_arb_io_in_1_valid) & valids_1;
      valids_2 <=
        _GEN_1 | ~(_issue_arb_io_in_2_ready & issue_arb_io_in_2_valid) & valids_2;
      valids_3 <=
        _GEN_2 | ~(_issue_arb_io_in_3_ready & issue_arb_io_in_3_valid) & valids_3;
      if (valids_0)
        rdys_0 <=
          wait_next == 14'h0
  ...
  FastArbiter_57 issue_arb (
    .clock                         (clock),
    .reset                         (reset),
    .io_in_0_ready                 (_issue_arb_io_in_0_ready),
    .io_in_0_valid                 (issue_arb_io_in_0_valid),
    .io_in_0_bits_channel          (_buffer_ext_R3_data[118:116]),
    .io_in_0_bits_opcode           (_buffer_ext_R3_data[115:113]),
    .io_in_0_bits_param            (_buffer_ext_R3_data[112:110]),
    .io_in_0_bits_size             (_buffer_ext_R3_data[109:107]),
    .io_in_0_bits_source           (_buffer_ext_R3_data[106:96]),
    .io_in_0_bits_set              (_buffer_ext_R3_data[95:84]),
    .io_in_0_bits_tag              (_buffer_ext_R3_data[83:56]),
    .io_in_0_bits_off              (_buffer_ext_R3_data[55:50]),
    .io_in_0_bits_mask             (_buffer_ext_R3_data[49:18]),
    .io_in_0_bits_bufIdx           (_buffer_ext_R3_data[17:14]),
    .io_in_0_bits_needHint         (_buffer_ext_R3_data[13]),
    .io_in_0_bits_isPrefetch       (_buffer_ext_R3_data[12]),
    .io_in_0_bits_isBop            (_buffer_ext_R3_data[11]),
    .io_in_0_bits_preferCache      (_buffer_ext_R3_data[10]),
    .io_in_0_bits_dirty            (_buffer_ext_R3_data[9]),
    .io_in_0_bits_isHit            (_buffer_ext_R3_data[8]),
    .io_in_0_bits_fromProbeHelper  (_buffer_ext_R3_data[7]),
    .io_in_0_bits_fromCmoHelper    (_buffer_ext_R3_data[6]),
    .io_in_0_bits_needProbeAckData (_buffer_ext_R3_data[5]),
    .io_in_0_bits_reqSource        (_buffer_ext_R3_data[4:0]),
    .io_in_1_ready                 (_issue_arb_io_in_1_ready),
    .io_in_1_valid                 (issue_arb_io_in_1_valid),
    .io_in_1_bits_channel          (_buffer_ext_R2_data[118:116]),
    .io_in_1_bits_opcode           (_buffer_ext_R2_data[115:113]),
    .io_in_1_bits_param            (_buffer_ext_R2_data[112:110]),
    .io_in_1_bits_size             (_buffer_ext_R2_data[109:107]),
    .io_in_1_bits_source           (_buffer_ext_R2_data[106:96]),
    .io_in_1_bits_set              (_buffer_ext_R2_data[95:84]),
    .io_in_1_bits_tag              (_buffer_ext_R2_data[83:56]),
    .io_in_1_bits_off              (_buffer_ext_R2_data[55:50]),
    .io_in_1_bits_mask             (_buffer_ext_R2_data[49:18]),
    .io_in_1_bits_bufIdx           (_buffer_ext_R2_data[17:14]),
    .io_in_1_bits_needHint         (_buffer_ext_R2_data[13]),
    .io_in_1_bits_isPrefetch       (_buffer_ext_R2_data[12]),
    .io_in_1_bits_isBop            (_buffer_ext_R2_data[11]),
    .io_in_1_bits_preferCache      (_buffer_ext_R2_data[10]),
    .io_in_1_bits_dirty            (_buffer_ext_R2_data[9]),
    .io_in_1_bits_isHit            (_buffer_ext_R2_data[8]),
    .io_in_1_bits_fromProbeHelper  (_buffer_ext_R2_data[7]),
    .io_in_1_bits_fromCmoHelper    (_buffer_ext_R2_data[6]),
    .io_in_1_bits_needProbeAckData (_buffer_ext_R2_data[5]),
    .io_in_1_bits_reqSource        (_buffer_ext_R2_data[4:0]),
    .io_in_2_ready                 (_issue_arb_io_in_2_ready),
    .io_in_2_valid                 (issue_arb_io_in_2_valid),
    .io_in_2_bits_channel          (_buffer_ext_R1_data[118:116]),
    .io_in_2_bits_opcode           (_buffer_ext_R1_data[115:113]),
    .io_in_2_bits_param            (_buffer_ext_R1_data[112:110]),
    .io_in_2_bits_size             (_buffer_ext_R1_data[109:107]),
    .io_in_2_bits_source           (_buffer_ext_R1_data[106:96]),
    .io_in_2_bits_set              (_buffer_ext_R1_data[95:84]),
    .io_in_2_bits_tag              (_buffer_ext_R1_data[83:56]),
    .io_in_2_bits_off              (_buffer_ext_R1_data[55:50]),
    .io_in_2_bits_mask             (_buffer_ext_R1_data[49:18]),
    .io_in_2_bits_bufIdx           (_buffer_ext_R1_data[17:14]),
    .io_in_2_bits_needHint         (_buffer_ext_R1_data[13]),
    .io_in_2_bits_isPrefetch       (_buffer_ext_R1_data[12]),
    .io_in_2_bits_isBop            (_buffer_ext_R1_data[11]),
    .io_in_2_bits_preferCache      (_buffer_ext_R1_data[10]),
    .io_in_2_bits_dirty            (_buffer_ext_R1_data[9]),
    .io_in_2_bits_isHit            (_buffer_ext_R1_data[8]),
    .io_in_2_bits_fromProbeHelper  (_buffer_ext_R1_data[7]),
    .io_in_2_bits_fromCmoHelper    (_buffer_ext_R1_data[6]),
    .io_in_2_bits_needProbeAckData (_buffer_ext_R1_data[5]),
    .io_in_2_bits_reqSource        (_buffer_ext_R1_data[4:0]),
    .io_in_3_ready                 (_issue_arb_io_in_3_ready),
    .io_in_3_valid                 (issue_arb_io_in_3_valid),
    .io_in_3_bits_channel          (_buffer_ext_R0_data[118:116]),
    .io_in_3_bits_opcode           (_buffer_ext_R0_data[115:113]),
    .io_in_3_bits_param            (_buffer_ext_R0_data[112:110]),
    .io_in_3_bits_size             (_buffer_ext_R0_data[109:107]),
    .io_in_3_bits_source           (_buffer_ext_R0_data[106:96]),
    .io_in_3_bits_set              (_buffer_ext_R0_data[95:84]),
    .io_in_3_bits_tag              (_buffer_ext_R0_data[83:56]),
    .io_in_3_bits_off              (_buffer_ext_R0_data[55:50]),
    .io_in_3_bits_mask             (_buffer_ext_R0_data[49:18]),
    .io_in_3_bits_bufIdx           (_buffer_ext_R0_data[17:14]),
    .io_in_3_bits_needHint         (_buffer_ext_R0_data[13]),
    .io_in_3_bits_isPrefetch       (_buffer_ext_R0_data[12]),
    .io_in_3_bits_isBop            (_buffer_ext_R0_data[11]),
    .io_in_3_bits_preferCache      (_buffer_ext_R0_data[10]),
    .io_in_3_bits_dirty            (_buffer_ext_R0_data[9]),
    .io_in_3_bits_isHit            (_buffer_ext_R0_data[8]),
    .io_in_3_bits_fromProbeHelper  (_buffer_ext_R0_data[7]),
    .io_in_3_bits_fromCmoHelper    (_buffer_ext_R0_data[6]),
    .io_in_3_bits_needProbeAckData (_buffer_ext_R0_data[5]),
    .io_in_3_bits_reqSource        (_buffer_ext_R0_data[4:0]),
