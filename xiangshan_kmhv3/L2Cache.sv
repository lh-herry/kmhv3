...
module L2Cache(
  ...
  output [111:0] toNextPipeline_1_indata,
  output         toNextPipeline_1_readen,
  output [9:0]   toNextPipeline_1_addr_rd,
  input  [111:0] toNextPipeline_1_outdata,
  ...
  output [111:0] toNextPipeline_3_indata,
  output         toNextPipeline_3_readen,
  output [9:0]   toNextPipeline_3_addr_rd,
  input  [111:0] toNextPipeline_3_outdata,
  ...
  output [111:0] toNextPipeline_5_indata,
  output         toNextPipeline_5_readen,
  output [9:0]   toNextPipeline_5_addr_rd,
  input  [111:0] toNextPipeline_5_outdata,
  ...
  output [111:0] toNextPipeline_7_indata,
  output         toNextPipeline_7_readen,
  output [9:0]   toNextPipeline_7_addr_rd,
  input  [111:0] toNextPipeline_7_outdata,
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        {5'h0, selected ? toNextPipeline_0_outdata : 132'h0}
        | {25'h0, selected_1 ? toNextPipeline_1_outdata : 112'h0}
        | (selected_2 ? toNextPipeline_2_outdata : 137'h0)
        | {25'h0, selected_3 ? toNextPipeline_3_outdata : 112'h0}
        | (selected_4 ? toNextPipeline_4_outdata : 137'h0)
        | {25'h0, selected_5 ? toNextPipeline_5_outdata : 112'h0}
        | (selected_6 ? toNextPipeline_6_outdata : 137'h0)
        | {25'h0, selected_7 ? toNextPipeline_7_outdata : 112'h0}
  ...
  assign toNextPipeline_1_indata = dataInReg[111:0];
  ...
  assign toNextPipeline_3_indata = dataInReg[111:0];
  ...
  assign toNextPipeline_5_indata = dataInReg[111:0];
  ...
  assign toNextPipeline_7_indata = dataInReg[111:0];
