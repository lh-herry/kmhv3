...
module TLXbar_1(
  ...
  wire [2:0]  _GEN = {1'h0, auto_in_1_a_bits_source};
  wire        requestAIO_0_0 =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatsLeft_2 <=
        latch_2
          ? winner_2_0 & auto_out_0_d_bits_opcode[0] & ~(_beatsDO_decode_T[5])
            | winner_2_1 & auto_out_1_d_bits_opcode[0] & ~(_beatsDO_decode_T_3[5])
          : 1'(beatsLeft_2 - (auto_in_0_d_ready & in_0_d_valid));
      ...
      beatsLeft_3 <=
        latch_3
          ? winner_3_0 & auto_out_0_d_bits_opcode[0] & ~(_beatsDO_decode_T[5])
            | winner_3_1 & auto_out_1_d_bits_opcode[0] & ~(_beatsDO_decode_T_3[5])
          : 1'(beatsLeft_3 - (auto_in_1_d_ready & in_1_d_valid));
  ...
  assign auto_out_1_a_bits_source =
    (muxState_1_0 ? in_0_a_bits_source : 3'h0) | (muxState_1_1 ? _GEN : 3'h0);
  ...
  assign auto_out_0_a_bits_source =
    (muxState_0 ? in_0_a_bits_source : 3'h0) | (muxState_1 ? _GEN : 3'h0);
