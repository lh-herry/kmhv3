  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_fpWen = _RANDOM[4'hA][10];
        bits_1_loadDependency_0 = _RANDOM[4'hB][7:6];
        bits_1_loadDependency_1 = _RANDOM[4'hB][9:8];
        bits_1_loadDependency_2 = _RANDOM[4'hB][11:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valids_1 = 1'h0;
    end // initial
