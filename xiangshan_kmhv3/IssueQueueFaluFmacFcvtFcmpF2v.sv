  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_exuSources_0_value = _RANDOM[2'h3][9:7];
        deqDelay_0_bits_exuSources_1_value = _RANDOM[2'h3][12:10];
        deqDelay_0_bits_exuSources_2_value = _RANDOM[2'h3][15:13];
        deqDelay_0_bits_loadDependency_0 = _RANDOM[2'h3][17:16];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[2'h3][19:18];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[2'h3][21:20];
        enqReady_last_REG = _RANDOM[2'h3][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
