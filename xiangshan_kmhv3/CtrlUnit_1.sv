...
module CtrlUnit_1(
  ...
  input  [4:0]  auto_ctl_in_a_bits_source,
  ...
  output [4:0]  auto_ctl_in_d_bits_source,
  ...
  wire         _out_T_33 =
    {_out_back_q_io_deq_bits_index[12:10],
     ...
     _out_back_q_io_deq_bits_index[4]} == 6'h0;
  ...
  wire [127:0] _out_backSel_T =
    ...
    << {121'h0,
        ...
        _out_back_q_io_deq_bits_index[6:5],
        _out_back_q_io_deq_bits_index[3:0]};
  assign out_backSel_32 = _out_backSel_T[32];
  wire [127:0] _GEN =
    {{1'h1},
     {1'h1},
     {1'h1},
  ...
  wire         out_iready =
    in_bits_read
    | _GEN[{auto_ctl_in_a_bits_address[12],
  ...
  wire         out_f_wivalid_18 =
    auto_ctl_in_a_valid & _out_back_q_io_enq_ready & auto_ctl_in_a_bits_opcode != 4'h4
    & {auto_ctl_in_a_bits_address[12],
       auto_ctl_in_a_bits_address[9:8],
       auto_ctl_in_a_bits_address[6:3]} == 7'h20
    & {auto_ctl_in_a_bits_address[15:13],
       auto_ctl_in_a_bits_address[11:10],
       auto_ctl_in_a_bits_address[7]} == 6'h0 & (&out_frontMask);
  wire         _GEN_1 = ~cmd_out_valid & io_resp_valid;
  wire         _GEN_2 = io_resp_bits_cmd == 8'h0;
  wire         _GEN_3 = io_resp_bits_cmd == 8'h1;
  wire         _GEN_4 = _GEN_2 | _GEN_3;
  wire         _GEN_5 = io_resp_bits_cmd == 8'h2;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      else if (_out_wofireMux_T_2 & _out_backSel_T[16] & _out_T_33 & (&out_backMask))
        ctl_tag <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[17] & _out_T_33 & (&out_backMask))
        ctl_set <= _out_back_q_io_deq_bits_data;
      if (_out_wofireMux_T_2 & _out_backSel_T[18] & _out_T_33 & (&out_backMask))
        ctl_way <= _out_back_q_io_deq_bits_data;
      if (~_GEN_1 | _GEN_2 | _GEN_3 | _GEN_5
          | ~(io_resp_bits_cmd == 8'h3 | io_resp_bits_cmd == 8'h4)) begin
        if (_out_wofireMux_T_2 & _out_backSel_T[27] & _out_T_33 & (&out_backMask))
          ctl_dir <= _out_back_q_io_deq_bits_data;
      end
      else
        ctl_dir <= io_resp_bits_data_0;
      if (~_GEN_1 | _GEN_4 | ~_GEN_5) begin
        if (_out_wofireMux_T_2 & _out_backSel_T[19] & _out_T_33 & (&out_backMask))
          ctl_data_0 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[20] & _out_T_33 & (&out_backMask))
          ctl_data_1 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[21] & _out_T_33 & (&out_backMask))
          ctl_data_2 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[22] & _out_T_33 & (&out_backMask))
          ctl_data_3 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[23] & _out_T_33 & (&out_backMask))
          ctl_data_4 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[24] & _out_T_33 & (&out_backMask))
          ctl_data_5 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[25] & _out_T_33 & (&out_backMask))
          ctl_data_6 <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[26] & _out_T_33 & (&out_backMask))
      ...
      if (io_ecc_ready_0 & io_ecc_valid) begin
        ...
        if (_out_wofireMux_T_2 & _out_backSel_T[28] & _out_T_33 & (&out_backMask))
          ecc_code <= _out_back_q_io_deq_bits_data;
        if (_out_wofireMux_T_2 & _out_backSel_T[29] & _out_T_33 & (&out_backMask))
          ecc_addr <= _out_back_q_io_deq_bits_data;
      end
      if (_out_wofireMux_T_2 & _out_backSel_T[64] & _out_T_33 & (&out_backMask))
        core_reset_0 <= {63'h0, _out_back_q_io_deq_bits_data[0]};
      cmd_in_valid <= out_f_wivalid_18 | ~io_req_ready & cmd_in_valid;
      cmd_out_valid <=
        _GEN_1 | ~(_out_wofireMux_T_2 & out_backSel_32 & _out_T_33 & (&out_backMask))
        & cmd_out_valid;
    end
  ...
  assign auto_ctl_in_d_bits_data =
    ~(_out_out_bits_data_T_17 | out_oindex == 7'h10 | out_oindex == 7'h11
      ...
      | out_oindex == 7'h20 | out_oindex == 7'h40) | _out_T_33
