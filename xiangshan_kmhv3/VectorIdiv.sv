...
module VectorIdiv(
  ...
  SRT16Divint _16bit_divide_0 (
    ...
    .reset            (reset),
    .io_sign          (sign_reg),
    .io_dividend      (sew_hb[0] ? {8'h0, x_reg[71:64]} : x_reg[15:0]),
    .io_divisor       (sew_hb[0] ? {8'h0, d_reg[71:64]} : d_reg[15:0]),
    .io_flush         (io_flush),
    .io_sew           (sew_reg),
    .io_div_in_valid  (stateReg[1]),
    .io_div_out_ready (stateReg[2]),
  ...
  SRT16Divint _16bit_divide_1 (
    ...
    .reset            (reset),
    .io_sign          (sign_reg),
    .io_dividend      (sew_hb[0] ? {8'h0, x_reg[79:72]} : x_reg[31:16]),
    .io_divisor       (sew_hb[0] ? {8'h0, d_reg[79:72]} : d_reg[31:16]),
    .io_flush         (io_flush),
    .io_sew           (sew_reg),
    .io_div_in_valid  (stateReg[1]),
    .io_div_out_ready (stateReg[2]),
  ...
  SRT16Divint _16bit_divide_2 (
    ...
    .reset            (reset),
    .io_sign          (sign_reg),
    .io_dividend      (sew_hb[0] ? {8'h0, x_reg[87:80]} : x_reg[47:32]),
    .io_divisor       (sew_hb[0] ? {8'h0, d_reg[87:80]} : d_reg[47:32]),
    .io_flush         (io_flush),
    .io_sew           (sew_reg),
    .io_div_in_valid  (stateReg[1]),
    .io_div_out_ready (stateReg[2]),
  ...
  SRT16Divint _16bit_divide_3 (
    ...
    .reset            (reset),
    .io_sign          (sign_reg),
    .io_dividend      (sew_hb[0] ? {8'h0, x_reg[95:88]} : x_reg[63:48]),
    .io_divisor       (sew_hb[0] ? {8'h0, d_reg[95:88]} : d_reg[63:48]),
    .io_flush         (io_flush),
    .io_sew           (sew_reg),
    .io_div_in_valid  (stateReg[1]),
    .io_div_out_ready (stateReg[2]),
