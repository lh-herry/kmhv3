...
module SMSPrefetcher(
  ...
  SMSTrainFilter train_filter (
    ...
    .io_st_in_0_valid                 (io_st_in_0_valid),
    .io_st_in_0_bits_uop_robIdx_flag  (io_st_in_0_bits_uop_robIdx_flag),
    .io_st_in_0_bits_uop_robIdx_value (io_st_in_0_bits_uop_robIdx_value),
    .io_st_in_0_bits_vaddr            (io_st_in_0_bits_vaddr),
    .io_st_in_0_bits_paddr            (io_st_in_0_bits_paddr),
    .io_st_in_1_valid                 (io_st_in_1_valid),
    .io_st_in_1_bits_uop_robIdx_flag  (io_st_in_1_bits_uop_robIdx_flag),
    .io_st_in_1_bits_uop_robIdx_value (io_st_in_1_bits_uop_robIdx_value),
    .io_st_in_1_bits_vaddr            (io_st_in_1_bits_vaddr),
    .io_st_in_1_bits_paddr            (io_st_in_1_bits_paddr),
