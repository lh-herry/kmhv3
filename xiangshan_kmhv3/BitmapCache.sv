...
module BitmapCache(
  ...
  reg  [127:0]     bcv;
  wire             bitmapcache_io_r_req_valid = stageReq_ready & io_req_valid;
  ...
  wire [7:0]       _GEN_2 = _GEN_1[data_1_tag[5:3]];
  wire [2:0]       _GEN_3 = _GEN_0[io_refill_bits_tag[10:6]];
  wire [3:0]       _GEN_4 = _GEN[io_refill_bits_tag[10:6]];
  ...
  wire [2:0]       _GEN_6 = _GEN_0[data_1_tag[10:6]];
  ...
  wire [2:0]       _state_vec_T_17 =
    {~(bc_victimWay[1]),
     ...
     bc_victimWay[1] ? _GEN_3[0] : ~(bc_victimWay[0])};
  ...
  always @(posedge clock) begin
    ...
    if (bitmapcache_io_r_req_valid)
      vVec_delay <= _GEN[io_req_bits_tag[10:6]];
  ...
  SplittedSRAM bitmapcache (
    .clock                            (_ClockGate_Q),
    .reset                            (reset),
    .io_r_req_valid                   (bitmapcache_io_r_req_valid),
  ...
  ClockGate ClockGate (
    .TE (te_cgen),
    .E  (bitmapcache_io_r_req_valid | ~flush & io_refill_valid | bd_req),
    .CK (clock),
    .Q  (_ClockGate_Q)
  );
  ...
  assign io_resp_bits_cfs_0 = _GEN_2[0];
  assign io_resp_bits_cfs_1 = _GEN_2[1];
  assign io_resp_bits_cfs_2 = _GEN_2[2];
  assign io_resp_bits_cfs_3 = _GEN_2[3];
  assign io_resp_bits_cfs_4 = _GEN_2[4];
  assign io_resp_bits_cfs_5 = _GEN_2[5];
  assign io_resp_bits_cfs_6 = _GEN_2[6];
  assign io_resp_bits_cfs_7 = _GEN_2[7];
