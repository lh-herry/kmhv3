...
module SRT16Divint_6(
  ...
  wire [66:0]      _GEN = 67'(67'h0 - norm_d);
  ...
  wire [7:0]       sel_cons_0_0 = 8'(_GEN[63:56] + _qds_cons_io_m_neg_1[8:1]);
  wire [7:0]       sel_cons_0_1 = 8'(_GEN[63:56] + _qds_cons_io_m_neg_0[8:1]);
  wire [7:0]       sel_cons_0_2 = 8'(_GEN[63:56] + _qds_cons_io_m_pos_1[8:1]);
  wire [7:0]       sel_cons_0_3 = 8'(_GEN[63:56] + _qds_cons_io_m_pos_2[8:1]);
  wire [7:0]       sel_cons_1_0 = 8'(_GEN[64:57] + _qds_cons_io_m_neg_1[8:1]);
  wire [7:0]       sel_cons_1_1 = 8'(_GEN[64:57] + _qds_cons_io_m_neg_0[8:1]);
  wire [7:0]       sel_cons_1_2 = 8'(_GEN[64:57] + _qds_cons_io_m_pos_1[8:1]);
  wire [7:0]       sel_cons_1_3 = 8'(_GEN[64:57] + _qds_cons_io_m_pos_2[8:1]);
  ...
  wire [69:0]      rem_adjust_ralign =
    $unsigned($signed($signed(rem_adjust) >>> 7'({1'h0, lzc_d_reg} + 7'h5)));
  ...
  wire [69:0]      _GEN_0 = {4'h0, _early_rem_T ? {abs_x_reg, 2'h0} : 66'h0};
  ...
  wire             x_sign = io_sign & _GEN_3[io_sew];
  wire [3:0]       _GEN_4 =
    {{io_divisor[63]}, {io_divisor[31]}, {io_divisor[15]}, {io_divisor[7]}};
  wire             d_sign = io_sign & _GEN_4[io_sew];
  wire [63:0]      neg_x_q = 64'(64'h0 - (in_handshake ? _GEN_1[io_sew] : iter_q_A_reg));
  wire [63:0]      neg_d_q = 64'(64'h0 - (in_handshake ? _GEN_2[io_sew] : iter_q_B_reg));
  wire [5:0]       lzc_x =
    abs_x_reg[63]
      ? 6'h0
      : abs_x_reg[62]
  ...
  wire [126:0]     _norm_x_part_T_2 = {63'h0, abs_x_reg} << {121'h0, lzc_x[5:2], 2'h0};
  wire [126:0]     _norm_d_part_T_2 = {63'h0, abs_d_reg} << {121'h0, lzc_d[5:2], 2'h0};
  wire [69:0]      _GEN_5 =
    {56'h0,
     abs_x_reg == 64'h0,
     lzc_x[1:0],
  ...
  always @(posedge clock) begin
    ...
    if (stateReg[1] | stateReg[2] | stateReg[3]) begin
      ...
      iterB_reg_1 <=
        stateReg[1]
          ? _GEN_5
          : stateReg[2] ? (early_finish ? _GEN_0 : 70'h0) : _IterBlock_io_nxt_iterB_1;
    end
    if (in_handshake) begin
      abs_x_reg <= x_sign ? neg_x_q : _GEN_1[io_sew];
      abs_d_reg <= d_sign ? neg_d_q : _GEN_2[io_sew];
    end
    if (stateReg[1])
      lzc_d_reg <= lzc_d;
    if (stateReg[1])
    ...
    if (stateReg[2]) begin
      spec_cons_reg_0_0 <= 9'(_GEN[61:53] + _qds_cons_io_m_neg_1);
      spec_cons_reg_0_1 <= 9'(_GEN[61:53] + _qds_cons_io_m_neg_0);
      spec_cons_reg_0_2 <= 9'(_GEN[61:53] + _qds_cons_io_m_pos_1);
      spec_cons_reg_0_3 <= 9'(_GEN[61:53] + _qds_cons_io_m_pos_2);
      spec_cons_reg_1_0 <= 9'(_GEN[62:54] + _qds_cons_io_m_neg_1);
      spec_cons_reg_1_1 <= 9'(_GEN[62:54] + _qds_cons_io_m_neg_0);
      spec_cons_reg_1_2 <= 9'(_GEN[62:54] + _qds_cons_io_m_pos_1);
      spec_cons_reg_1_3 <= 9'(_GEN[62:54] + _qds_cons_io_m_pos_2);
