...
module SRAMTemplate_342(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[5'h4][11];
        rdataReg =
          {_RANDOM[5'h14][31:12], _RANDOM[5'h15], _RANDOM[5'h16], _RANDOM[5'h17][27:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        respReg = 1'h0;
    end // initial
  ...
  sram_array_1p512x112m14s1h0l1b_l2_meta array (
