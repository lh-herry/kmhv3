...
module Queue4_triggerBundle(
  ...
  ram_4x52 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_paddr, io_enq_bits_way})
  );
  assign io_enq_ready = ~full;
  assign io_deq_valid = ~empty;
  assign io_deq_bits_paddr = _ram_ext_R0_data[51:4];
  assign io_deq_bits_way = _ram_ext_R0_data[3:0];
