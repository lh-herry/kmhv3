...
module AXI4UserYanker_3(
  ...
  Queue1_BundleMap_162 Queue1_BundleMap (
    .clock                 (clock),
    .reset                 (reset),
  ...
  Queue1_BundleMap_162 Queue1_BundleMap_1 (
    .clock                 (clock),
    .reset                 (reset),
  ...
  Queue1_BundleMap_162 Queue1_BundleMap_2 (
    .clock                 (clock),
    .reset                 (reset),
  ...
  Queue1_BundleMap_162 Queue1_BundleMap_3 (
    .clock                 (clock),
    .reset                 (reset),
