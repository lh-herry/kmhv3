...
module TLWidthWidget(
  ...
  wire [4:0]       _repeated_repeater_io_deq_bits_source;
  ...
  wire [7:0]       _nodeOut_a_bits_mask_sizeOH_T_1 = 8'h1 << auto_in_a_bits_size;
  wire             nodeOut_a_bits_mask_sub_sub_sub_sub_sub_0_1 =
    auto_in_a_bits_size > 3'h4;
  wire             nodeOut_a_bits_mask_sub_sub_sub_sub_0_1 =
    nodeOut_a_bits_mask_sub_sub_sub_sub_sub_0_1 | _nodeOut_a_bits_mask_sizeOH_T_1[4]
  ...
  wire             nodeOut_a_bits_mask_sub_sub_sub_0_1 =
    nodeOut_a_bits_mask_sub_sub_sub_sub_0_1 | _nodeOut_a_bits_mask_sizeOH_T_1[3]
  ...
  wire             nodeOut_a_bits_mask_sub_sub_sub_2_1 =
    nodeOut_a_bits_mask_sub_sub_sub_sub_1_1 | _nodeOut_a_bits_mask_sizeOH_T_1[3]
  ...
  wire             nodeOut_a_bits_mask_sub_sub_0_1 =
    nodeOut_a_bits_mask_sub_sub_sub_0_1 | _nodeOut_a_bits_mask_sizeOH_T_1[2]
  ...
  wire             nodeOut_a_bits_mask_sub_sub_2_1 =
    nodeOut_a_bits_mask_sub_sub_sub_1_1 | _nodeOut_a_bits_mask_sizeOH_T_1[2]
  ...
  wire             nodeOut_a_bits_mask_sub_sub_4_1 =
    nodeOut_a_bits_mask_sub_sub_sub_2_1 | _nodeOut_a_bits_mask_sizeOH_T_1[2]
  ...
  wire             nodeOut_a_bits_mask_sub_sub_6_1 =
    nodeOut_a_bits_mask_sub_sub_sub_3_1 | _nodeOut_a_bits_mask_sizeOH_T_1[2]
  ...
  wire             nodeOut_a_bits_mask_sub_0_1 =
    nodeOut_a_bits_mask_sub_sub_0_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_2_1 =
    nodeOut_a_bits_mask_sub_sub_1_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_4_1 =
    nodeOut_a_bits_mask_sub_sub_2_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_6_1 =
    nodeOut_a_bits_mask_sub_sub_3_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_8_1 =
    nodeOut_a_bits_mask_sub_sub_4_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_10_1 =
    nodeOut_a_bits_mask_sub_sub_5_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_12_1 =
    nodeOut_a_bits_mask_sub_sub_6_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  wire             nodeOut_a_bits_mask_sub_14_1 =
    nodeOut_a_bits_mask_sub_sub_7_1 | _nodeOut_a_bits_mask_sizeOH_T_1[1]
  ...
  reg  [1:0]       repeat_sel_sel_sources_5;
  reg  [1:0]       repeat_sel_sel_sources_6;
  reg  [1:0]       repeat_sel_sel_sources_7;
  reg  [1:0]       repeat_sel_sel_sources_8;
  reg  [1:0]       repeat_sel_sel_sources_9;
  reg  [1:0]       repeat_sel_sel_sources_10;
  reg  [1:0]       repeat_sel_sel_sources_11;
  reg  [1:0]       repeat_sel_sel_sources_12;
  reg  [1:0]       repeat_sel_sel_sources_13;
  reg  [1:0]       repeat_sel_sel_sources_14;
  reg  [1:0]       repeat_sel_sel_sources_15;
  reg  [1:0]       repeat_sel_sel_sources_16;
  ...
  always @(posedge clock) begin
    ...
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h0)
      repeat_sel_sel_sources_0 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h1)
      repeat_sel_sel_sources_1 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h2)
      repeat_sel_sel_sources_2 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h3)
      repeat_sel_sel_sources_3 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h4)
      repeat_sel_sel_sources_4 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h5)
      repeat_sel_sel_sources_5 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h6)
      repeat_sel_sel_sources_6 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h7)
      repeat_sel_sel_sources_7 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h8)
      repeat_sel_sel_sources_8 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h9)
      repeat_sel_sel_sources_9 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'hA)
      repeat_sel_sel_sources_10 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'hB)
      repeat_sel_sel_sources_11 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'hC)
      repeat_sel_sel_sources_12 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'hD)
      repeat_sel_sel_sources_13 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'hE)
      repeat_sel_sel_sources_14 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'hF)
      repeat_sel_sel_sources_15 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h10)
      repeat_sel_sel_sources_16 <= auto_in_a_bits_address[4:3];
    if (repeat_first)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        count = _RANDOM[4'h0][1:0];
        corrupt_reg = _RANDOM[4'h0][2];
        nodeOut_a_bits_data_rdata_written_once = _RANDOM[4'h0][3];
        nodeOut_a_bits_data_rdata_0 =
          {_RANDOM[4'h0][31:4], _RANDOM[4'h1], _RANDOM[4'h2][3:0]};
        nodeOut_a_bits_data_rdata_1 =
          {_RANDOM[4'h2][31:4], _RANDOM[4'h3], _RANDOM[4'h4][3:0]};
        nodeOut_a_bits_data_rdata_2 =
          {_RANDOM[4'h4][31:4], _RANDOM[4'h5], _RANDOM[4'h6][3:0]};
        nodeOut_a_bits_mask_rdata_written_once = _RANDOM[4'h6][4];
        nodeOut_a_bits_mask_rdata_0 = _RANDOM[4'h6][12:5];
        nodeOut_a_bits_mask_rdata_1 = _RANDOM[4'h6][20:13];
        nodeOut_a_bits_mask_rdata_2 = _RANDOM[4'h6][28:21];
        repeat_count = _RANDOM[4'h6][30:29];
        repeat_sel_sel_sources_0 = {_RANDOM[4'h6][31], _RANDOM[4'h7][0]};
        repeat_sel_sel_sources_1 = _RANDOM[4'h7][2:1];
        repeat_sel_sel_sources_2 = _RANDOM[4'h7][4:3];
        repeat_sel_sel_sources_3 = _RANDOM[4'h7][6:5];
        repeat_sel_sel_sources_4 = _RANDOM[4'h7][8:7];
        repeat_sel_sel_sources_5 = _RANDOM[4'h7][10:9];
        repeat_sel_sel_sources_6 = _RANDOM[4'h7][12:11];
        repeat_sel_sel_sources_7 = _RANDOM[4'h7][14:13];
        repeat_sel_sel_sources_8 = _RANDOM[4'h7][16:15];
        repeat_sel_sel_sources_9 = _RANDOM[4'h7][18:17];
        repeat_sel_sel_sources_10 = _RANDOM[4'h7][20:19];
        repeat_sel_sel_sources_11 = _RANDOM[4'h7][22:21];
        repeat_sel_sel_sources_12 = _RANDOM[4'h7][24:23];
        repeat_sel_sel_sources_13 = _RANDOM[4'h7][26:25];
        repeat_sel_sel_sources_14 = _RANDOM[4'h7][28:27];
        repeat_sel_sel_sources_15 = _RANDOM[4'h7][30:29];
        repeat_sel_sel_sources_16 = {_RANDOM[4'h7][31], _RANDOM[4'h8][0]};
        repeat_sel_hold_r = _RANDOM[4'h8][2:1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        count = 2'h0;
        corrupt_reg = 1'h0;
