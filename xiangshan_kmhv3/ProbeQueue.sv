...
module ProbeQueue(
  ...
  wire [49:0] entries_7_io_req_bits_vaddr =
    {2'h0,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        selected_req_bits_probe_param = _RANDOM[5'h0][16:15];
        selected_req_bits_probe_need_data = _RANDOM[5'h0][17];
        selected_req_bits_vaddr =
          {_RANDOM[5'h0][31:27], _RANDOM[5'h1], _RANDOM[5'h2][12:0]};
        selected_req_bits_addr = {_RANDOM[5'h2][31:13], _RANDOM[5'h3][28:0]};
        selected_req_bits_id = _RANDOM[5'h1E][31:26];
        resvsetProbeBlock = _RANDOM[5'h1F][0];
        perfValidCount = _RANDOM[5'h1F][4:1];
        io_perf_0_value_REG = _RANDOM[5'h1F][5];
        io_perf_0_value_REG_1 = _RANDOM[5'h1F][6];
        io_perf_1_value_REG = _RANDOM[5'h1F][7];
        io_perf_1_value_REG_1 = _RANDOM[5'h1F][8];
        io_perf_2_value_REG = _RANDOM[5'h1F][9];
        io_perf_2_value_REG_1 = _RANDOM[5'h1F][10];
        io_perf_3_value_REG = _RANDOM[5'h1F][11];
        io_perf_3_value_REG_1 = _RANDOM[5'h1F][12];
        io_perf_4_value_REG = _RANDOM[5'h1F][13];
        io_perf_4_value_REG_1 = _RANDOM[5'h1F][14];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        selected_req_valid = 1'h0;
    end // initial
