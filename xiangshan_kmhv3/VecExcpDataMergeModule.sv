...
module VecExcpDataMergeModule(
  ...
  input          i_fromRab_logicPhyRegMap_6_valid,
  input  [5:0]   i_fromRab_logicPhyRegMap_6_bits_lreg,
  input  [6:0]   i_fromRab_logicPhyRegMap_6_bits_preg,
  input          i_fromRab_logicPhyRegMap_7_valid,
  input  [5:0]   i_fromRab_logicPhyRegMap_7_bits_lreg,
  input  [6:0]   i_fromRab_logicPhyRegMap_7_bits_preg,
  ...
  input          i_fromRat_vecOldVdPdest_6_valid,
  input  [6:0]   i_fromRat_vecOldVdPdest_6_bits,
  input          i_fromRat_vecOldVdPdest_7_valid,
  input  [6:0]   i_fromRat_vecOldVdPdest_7_bits,
  ...
  input          i_fromRat_v0OldVdPdest_6_valid,
  input  [6:0]   i_fromRat_v0OldVdPdest_6_bits,
  input          i_fromRat_v0OldVdPdest_7_valid,
  input  [6:0]   i_fromRat_v0OldVdPdest_7_bits,
  ...
  wire            oldPregVecFromRat_6_valid =
    i_fromRat_vecOldVdPdest_6_valid | i_fromRat_v0OldVdPdest_6_valid;
  wire            oldPregVecFromRat_7_valid =
    i_fromRat_vecOldVdPdest_7_valid | i_fromRat_v0OldVdPdest_7_valid;
  ...
  wire            _o_status_busy_WIRE_1 = state == 3'h2;
  ...
  wire            _GEN_54 = _o_status_busy_WIRE_1 | _GEN_33;
      ...
      if (_GEN_31) begin
          ...
          if (_GEN_37) begin
            rabCommitted_0 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ...
                : i_fromRab_logicPhyRegMap_1_valid | rabCommitted_0;
            rabCommitted_1 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? i_fromRab_logicPhyRegMap_3_valid | rabCommitted_1
                : i_fromRab_logicPhyRegMap_2_valid | rabCommitted_1;
            rabCommitted_2 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? i_fromRab_logicPhyRegMap_4_valid | rabCommitted_2
                : i_fromRab_logicPhyRegMap_3_valid | rabCommitted_2;
            rabCommitted_3 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? i_fromRab_logicPhyRegMap_5_valid | rabCommitted_3
                : i_fromRab_logicPhyRegMap_4_valid | rabCommitted_3;
            rabCommitted_4 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
            ...
            rabCommitted_5 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ...
                : i_fromRab_logicPhyRegMap_6_valid | rabCommitted_5;
          end
          else
            rabCommitted_7 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? i_fromRab_logicPhyRegMap_1_valid | rabCommitted_7
                : i_fromRab_logicPhyRegMap_0_valid | rabCommitted_7;
          if (_GEN_39) begin
            ratCommitted_0 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_2_valid | ratCommitted_0
                : oldPregVecFromRat_1_valid | ratCommitted_0;
            ratCommitted_1 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_3_valid | ratCommitted_1
                : oldPregVecFromRat_2_valid | ratCommitted_1;
            ratCommitted_2 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_4_valid | ratCommitted_2
                : oldPregVecFromRat_3_valid | ratCommitted_2;
            ratCommitted_3 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_5_valid | ratCommitted_3
                : oldPregVecFromRat_4_valid | ratCommitted_3;
            ratCommitted_4 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_6_valid | ratCommitted_4
                : oldPregVecFromRat_5_valid | ratCommitted_4;
            ratCommitted_5 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_7_valid | ratCommitted_5
                : oldPregVecFromRat_6_valid | ratCommitted_5;
          end
          else
            ratCommitted_7 <=
              sWaitRab_vecExcpInfo_next_bits_r_isStride
                ? oldPregVecFromRat_1_valid | ratCommitted_7
                : oldPregVecFromRat_0_valid | ratCommitted_7;
        end
        else begin
        ...
        rabCommitted_6 <=
          _GEN_32
            ? (_GEN_37
                 ? ~sWaitRab_vecExcpInfo_next_bits_r_isStride
                   & i_fromRab_logicPhyRegMap_7_valid | rabCommitted_6
                 : _GEN_38 | rabCommitted_6)
            : ~_GEN_34 & rabCommitted_6;
        ratCommitted_6 <=
          _GEN_32
            ? (_GEN_39
                 ? ~sWaitRab_vecExcpInfo_next_bits_r_isStride & oldPregVecFromRat_7_valid
                   | ratCommitted_6
                 : _GEN_40 | ratCommitted_6)
            : ~_GEN_34 & ratCommitted_6;
      end
      hasReadRf_0 <=
        _o_status_busy_WIRE_1
          ? (_GEN_90
               ...
               : _GEN_83
                   ? _hasReadRf_T_5
                   : _GEN_76 ? _hasReadRf_T_3 : _GEN_69 ? _hasReadRf_T_1 : _GEN_61)
          : _GEN_33
              ? (_GEN_90
                   ? _hasReadRf_T_15
                   : _GEN_83
                       ? _hasReadRf_T_13
                       : _GEN_76 ? _hasReadRf_T_11 : _GEN_69 ? _hasReadRf_T_9 : _GEN_61)
              : _GEN_61;
      hasReadRf_1 <=
        _o_status_busy_WIRE_1
          ? (_GEN_91
               ...
               : _GEN_84
                   ? _hasReadRf_T_5
                   : _GEN_77 ? _hasReadRf_T_3 : _GEN_70 ? _hasReadRf_T_1 : _GEN_62)
          : _GEN_33
              ? (_GEN_91
                   ? _hasReadRf_T_15
                   : _GEN_84
                       ? _hasReadRf_T_13
                       : _GEN_77 ? _hasReadRf_T_11 : _GEN_70 ? _hasReadRf_T_9 : _GEN_62)
              : _GEN_62;
      hasReadRf_2 <=
        _o_status_busy_WIRE_1
          ? (_GEN_92
               ...
               : _GEN_85
                   ? _hasReadRf_T_5
                   : _GEN_78 ? _hasReadRf_T_3 : _GEN_71 ? _hasReadRf_T_1 : _GEN_63)
          : _GEN_33
              ? (_GEN_92
                   ? _hasReadRf_T_15
                   : _GEN_85
                       ? _hasReadRf_T_13
                       : _GEN_78 ? _hasReadRf_T_11 : _GEN_71 ? _hasReadRf_T_9 : _GEN_63)
              : _GEN_63;
      hasReadRf_3 <=
        _o_status_busy_WIRE_1
          ? (_GEN_93
               ...
               : _GEN_86
                   ? _hasReadRf_T_5
                   : _GEN_79 ? _hasReadRf_T_3 : _GEN_72 ? _hasReadRf_T_1 : _GEN_64)
          : _GEN_33
              ? (_GEN_93
                   ? _hasReadRf_T_15
                   : _GEN_86
                       ? _hasReadRf_T_13
                       : _GEN_79 ? _hasReadRf_T_11 : _GEN_72 ? _hasReadRf_T_9 : _GEN_64)
              : _GEN_64;
      hasReadRf_4 <=
        _o_status_busy_WIRE_1
          ? (_GEN_94
               ...
               : _GEN_87
                   ? _hasReadRf_T_5
                   : _GEN_80 ? _hasReadRf_T_3 : _GEN_73 ? _hasReadRf_T_1 : _GEN_65)
          : _GEN_33
              ? (_GEN_94
                   ? _hasReadRf_T_15
                   : _GEN_87
                       ? _hasReadRf_T_13
                       : _GEN_80 ? _hasReadRf_T_11 : _GEN_73 ? _hasReadRf_T_9 : _GEN_65)
              : _GEN_65;
      hasReadRf_5 <=
        _o_status_busy_WIRE_1
          ? (_GEN_95
               ...
               : _GEN_88
                   ? _hasReadRf_T_5
                   : _GEN_81 ? _hasReadRf_T_3 : _GEN_74 ? _hasReadRf_T_1 : _GEN_66)
          : _GEN_33
              ? (_GEN_95
                   ? _hasReadRf_T_15
                   : _GEN_88
                       ? _hasReadRf_T_13
                       : _GEN_81 ? _hasReadRf_T_11 : _GEN_74 ? _hasReadRf_T_9 : _GEN_66)
              : _GEN_66;
      hasReadRf_6 <=
        _o_status_busy_WIRE_1
          ? (_GEN_96
               ...
               : _GEN_89
                   ? _hasReadRf_T_5
                   : _GEN_82 ? _hasReadRf_T_3 : _GEN_75 ? _hasReadRf_T_1 : _GEN_67)
          : _GEN_33
              ? (_GEN_96
                   ? _hasReadRf_T_15
                   : _GEN_89
                       ? _hasReadRf_T_13
                       : _GEN_82 ? _hasReadRf_T_11 : _GEN_75 ? _hasReadRf_T_9 : _GEN_67)
              : _GEN_67;
      hasReadRf_7 <=
        _o_status_busy_WIRE_1
          ? ((&(_currentIdxVec_T_3[2:0]))
               ...
               : (&(_currentIdxVec_T_2[2:0]))
                   ...
                   : (&(_currentIdxVec_T_1[2:0]))
                       ? _hasReadRf_T_3
                       : (&(currentIdx[2:0])) ? _hasReadRf_T_1 : _GEN_68)
          : _GEN_33
              ? ((&(_currentIdxVec_T_3[2:0]))
                   ? _hasReadRf_T_15
                   : (&(_currentIdxVec_T_2[2:0]))
  ...
  wire [6:0]      oldPregVecFromRat_0_bits =
  ...
  wire [6:0]      oldPregVecFromRat_1_bits =
  ...
  wire [6:0]      oldPregVecFromRat_2_bits =
  ...
  wire [6:0]      oldPregVecFromRat_3_bits =
  ...
  wire [6:0]      oldPregVecFromRat_4_bits =
  ...
  wire [6:0]      oldPregVecFromRat_5_bits =
  ...
  wire [6:0]      oldPregVecFromRat_6_bits =
    (i_fromRat_vecOldVdPdest_6_valid ? i_fromRat_vecOldVdPdest_6_bits : 7'h0)
    | (i_fromRat_v0OldVdPdest_6_valid ? i_fromRat_v0OldVdPdest_6_bits : 7'h0);
  wire [6:0]      oldPregVecFromRat_7_bits =
    (i_fromRat_vecOldVdPdest_7_valid ? i_fromRat_vecOldVdPdest_7_bits : 7'h0)
    | (i_fromRat_v0OldVdPdest_7_valid ? i_fromRat_v0OldVdPdest_7_bits : 7'h0);
  ...
  wire            _GEN_102 = _GEN_31 | ~(_GEN_32 & _GEN_39);
  wire            _GEN_103 = state == 3'h2 | _GEN_33;
  always @(posedge clock) begin
    ...
    if (_GEN_102) begin
      ...
      if (oldPregVecFromRat_2_valid)
        regMaps_0_oldPreg <= oldPregVecFromRat_2_bits;
    end
    else if (oldPregVecFromRat_1_valid)
      regMaps_0_oldPreg <= oldPregVecFromRat_1_bits;
    if (_GEN_101) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
    ...
    if (_GEN_102) begin
      ...
      if (oldPregVecFromRat_3_valid)
        regMaps_1_oldPreg <= oldPregVecFromRat_3_bits;
    end
    else if (oldPregVecFromRat_2_valid)
      regMaps_1_oldPreg <= oldPregVecFromRat_2_bits;
    if (_GEN_101) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
    ...
    if (_GEN_102) begin
      ...
      if (oldPregVecFromRat_4_valid)
        regMaps_2_oldPreg <= oldPregVecFromRat_4_bits;
    end
    else if (oldPregVecFromRat_3_valid)
      regMaps_2_oldPreg <= oldPregVecFromRat_3_bits;
    if (_GEN_101) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
    ...
    if (_GEN_102) begin
      ...
      if (oldPregVecFromRat_5_valid)
        regMaps_3_oldPreg <= oldPregVecFromRat_5_bits;
    end
    else if (oldPregVecFromRat_4_valid)
      regMaps_3_oldPreg <= oldPregVecFromRat_4_bits;
    if (_GEN_101) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
      if (i_fromRab_logicPhyRegMap_6_valid) begin
        regMaps_4_lreg <= i_fromRab_logicPhyRegMap_6_bits_lreg;
        regMaps_4_newPreg <= i_fromRab_logicPhyRegMap_6_bits_preg;
      end
    end
    else if (i_fromRab_logicPhyRegMap_5_valid) begin
    ...
    if (_GEN_102) begin
      ...
      if (oldPregVecFromRat_6_valid)
        regMaps_4_oldPreg <= oldPregVecFromRat_6_bits;
    end
    else if (oldPregVecFromRat_5_valid)
      regMaps_4_oldPreg <= oldPregVecFromRat_5_bits;
    if (_GEN_101) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
      if (i_fromRab_logicPhyRegMap_7_valid) begin
        regMaps_5_lreg <= i_fromRab_logicPhyRegMap_7_bits_lreg;
        regMaps_5_newPreg <= i_fromRab_logicPhyRegMap_7_bits_preg;
      end
    end
    else if (i_fromRab_logicPhyRegMap_6_valid) begin
      regMaps_5_lreg <= i_fromRab_logicPhyRegMap_6_bits_lreg;
      regMaps_5_newPreg <= i_fromRab_logicPhyRegMap_6_bits_preg;
    end
    if (_GEN_102) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
      if (oldPregVecFromRat_7_valid)
        regMaps_5_oldPreg <= oldPregVecFromRat_7_bits;
    end
    else if (oldPregVecFromRat_6_valid)
      regMaps_5_oldPreg <= oldPregVecFromRat_6_bits;
    if (_GEN_31 | ~_GEN_32) begin
    end
    else begin
      if (_GEN_37) begin
        if (sWaitRab_vecExcpInfo_next_bits_r_isStride
            | ~i_fromRab_logicPhyRegMap_7_valid) begin
        end
        else begin
          regMaps_6_lreg <= i_fromRab_logicPhyRegMap_7_bits_lreg;
          regMaps_6_newPreg <= i_fromRab_logicPhyRegMap_7_bits_preg;
        end
      end
      else if (_GEN_38) begin
        regMaps_6_lreg <= i_fromRab_logicPhyRegMap_0_bits_lreg;
        regMaps_6_newPreg <= i_fromRab_logicPhyRegMap_0_bits_preg;
      end
      if (_GEN_39) begin
        if (sWaitRab_vecExcpInfo_next_bits_r_isStride | ~oldPregVecFromRat_7_valid) begin
        end
        else
          regMaps_6_oldPreg <= oldPregVecFromRat_7_bits;
      end
      else if (_GEN_40)
        regMaps_6_oldPreg <= oldPregVecFromRat_0_bits;
    end
    if (_GEN_31 | ~_GEN_32 | _GEN_37) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
      if (i_fromRab_logicPhyRegMap_1_valid) begin
        regMaps_7_lreg <= i_fromRab_logicPhyRegMap_1_bits_lreg;
        regMaps_7_newPreg <= i_fromRab_logicPhyRegMap_1_bits_preg;
      end
    end
    else if (i_fromRab_logicPhyRegMap_0_valid) begin
      regMaps_7_lreg <= i_fromRab_logicPhyRegMap_0_bits_lreg;
      regMaps_7_newPreg <= i_fromRab_logicPhyRegMap_0_bits_preg;
    end
    if (_GEN_31 | ~_GEN_32 | _GEN_39) begin
    end
    else if (sWaitRab_vecExcpInfo_next_bits_r_isStride) begin
      if (oldPregVecFromRat_1_valid)
        regMaps_7_oldPreg <= oldPregVecFromRat_1_bits;
    end
    else if (oldPregVecFromRat_0_valid)
      regMaps_7_oldPreg <= oldPregVecFromRat_0_bits;
    if (_GEN_103 & i_fromVprf_rdata_0_valid)
      mergedVd_0_rawData <=
        {_o_status_busy_WIRE_1
         ...
         _o_status_busy_WIRE_1
           ...
           : i_fromVprf_rdata_0_bits[7:0]};
    if (_GEN_103 & i_fromVprf_rdata_1_valid)
      mergedVd_1_rawData <=
        {_o_status_busy_WIRE_1
         ...
         _o_status_busy_WIRE_1
           ...
           : i_fromVprf_rdata_1_bits[7:0]};
    if (_GEN_103 & i_fromVprf_rdata_2_valid)
      mergedVd_2_rawData <=
        {_o_status_busy_WIRE_1
         ...
         _o_status_busy_WIRE_1
           ...
           : i_fromVprf_rdata_2_bits[7:0]};
    if (_GEN_103 & i_fromVprf_rdata_3_valid)
      mergedVd_3_rawData <=
        {_o_status_busy_WIRE_1
  ...
  DelayN_8 o_status_busy_delay (
    .clock  (clock),
    .io_in  (|{state == 3'h3, _o_status_busy_WIRE_1, state == 3'h1}),
  ...
  assign o_toVPRF_r_4_valid = _o_status_busy_WIRE_1 & _GEN_44 & ~_GEN_42 & _hasReadRf_T_1;
  assign o_toVPRF_r_4_bits_isV0 = _o_status_busy_WIRE_1 & ~(|_GEN_45[newVdLocVec_0]);
  assign o_toVPRF_r_4_bits_addr = _o_status_busy_WIRE_1 ? _GEN_47[newVdLocVec_0] : 7'h0;
  assign o_toVPRF_r_5_valid = _o_status_busy_WIRE_1 & _GEN_49 & ~_GEN_48 & _hasReadRf_T_3;
  assign o_toVPRF_r_5_bits_addr = _o_status_busy_WIRE_1 ? _GEN_47[newVdLocVec_1] : 7'h0;
  assign o_toVPRF_r_6_valid = _o_status_busy_WIRE_1 & _GEN_51 & ~_GEN_50 & _hasReadRf_T_5;
  assign o_toVPRF_r_6_bits_addr = _o_status_busy_WIRE_1 ? _GEN_47[newVdLocVec_2] : 7'h0;
  assign o_toVPRF_r_7_valid = _o_status_busy_WIRE_1 & _GEN_53 & ~_GEN_52 & _hasReadRf_T_7;
  assign o_toVPRF_r_7_bits_addr = _o_status_busy_WIRE_1 ? _GEN_47[newVdLocVec_3] : 7'h0;
