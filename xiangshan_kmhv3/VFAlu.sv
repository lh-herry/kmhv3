      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vs1Reg =
          {_RANDOM[6'h1C][31:10],
           ...
           _RANDOM[6'h1F],
           _RANDOM[6'h20][9:0]};
        outWiden = _RANDOM[6'h20][10];
        outVlFix = _RANDOM[6'h20][18:11];
        allVmZero = _RANDOM[6'h20][19];
        mgu_io_in_info_eew_r = _RANDOM[6'h20][21:20];
        mgu_io_in_info_vdIdx_r = _RANDOM[6'h20][28:22];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVecThisFu_1 = 1'h0;
    end // initial
