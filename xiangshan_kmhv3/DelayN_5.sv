...
module DelayN_5(
  ...
  reg        REG_1_mbmc_BME;
  reg        REG_1_mbmc_CMODE;
  reg        REG_1_priv_mxr;
  reg        REG_1_priv_sum;
  reg        REG_1_priv_vmxr;
  reg        REG_1_priv_vsum;
  reg        REG_1_priv_virt;
  reg        REG_1_priv_virt_changed;
  reg        REG_1_priv_spvp;
  ...
  always @(posedge clock) begin
    ...
    REG_1_mbmc_BME <= REG_mbmc_BME;
    REG_1_mbmc_CMODE <= REG_mbmc_CMODE;
    ...
    REG_1_priv_virt_changed <= REG_priv_virt_changed;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_mbmc_BME = _RANDOM[5'h6][4];
        REG_mbmc_CMODE = _RANDOM[5'h6][5];
        REG_priv_mxr = _RANDOM[5'h8][1];
        REG_priv_sum = _RANDOM[5'h8][2];
        REG_priv_vmxr = _RANDOM[5'h8][3];
        REG_priv_vsum = _RANDOM[5'h8][4];
        REG_priv_virt = _RANDOM[5'h8][5];
        REG_priv_virt_changed = _RANDOM[5'h8][6];
        REG_priv_spvp = _RANDOM[5'h8][7];
        REG_priv_imode = _RANDOM[5'h8][9:8];
        REG_priv_dmode = _RANDOM[5'h8][11:10];
        REG_pmm_mseccfg = _RANDOM[5'h8][15:14];
        REG_pmm_menvcfg = _RANDOM[5'h8][17:16];
        REG_pmm_henvcfg = _RANDOM[5'h8][19:18];
        REG_pmm_hstatus = _RANDOM[5'h8][21:20];
        REG_pmm_senvcfg = _RANDOM[5'h8][23:22];
        REG_1_satp_mode = _RANDOM[5'h8][27:24];
        REG_1_satp_asid = {_RANDOM[5'h8][31:28], _RANDOM[5'h9][11:0]};
        REG_1_satp_changed = _RANDOM[5'hA][24];
        REG_1_vsatp_mode = _RANDOM[5'hA][28:25];
        REG_1_vsatp_asid = {_RANDOM[5'hA][31:29], _RANDOM[5'hB][12:0]};
        REG_1_vsatp_changed = _RANDOM[5'hC][25];
        REG_1_hgatp_mode = _RANDOM[5'hC][29:26];
        REG_1_hgatp_vmid = {_RANDOM[5'hC][31:30], _RANDOM[5'hD][13:0]};
        REG_1_hgatp_changed = _RANDOM[5'hE][26];
        REG_1_mbmc_BME = _RANDOM[5'hE][28];
        REG_1_mbmc_CMODE = _RANDOM[5'hE][29];
        REG_1_priv_mxr = _RANDOM[5'h10][25];
        REG_1_priv_sum = _RANDOM[5'h10][26];
        REG_1_priv_vmxr = _RANDOM[5'h10][27];
        REG_1_priv_vsum = _RANDOM[5'h10][28];
        REG_1_priv_virt = _RANDOM[5'h10][29];
        REG_1_priv_virt_changed = _RANDOM[5'h10][30];
        REG_1_priv_spvp = _RANDOM[5'h10][31];
        REG_1_priv_imode = _RANDOM[5'h11][1:0];
        REG_1_priv_dmode = _RANDOM[5'h11][3:2];
        REG_1_pmm_mseccfg = _RANDOM[5'h11][7:6];
        REG_1_pmm_menvcfg = _RANDOM[5'h11][9:8];
        REG_1_pmm_henvcfg = _RANDOM[5'h11][11:10];
        REG_1_pmm_hstatus = _RANDOM[5'h11][13:12];
        REG_1_pmm_senvcfg = _RANDOM[5'h11][15:14];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_mbmc_BME = REG_1_mbmc_BME;
  assign io_out_mbmc_CMODE = REG_1_mbmc_CMODE;
  ...
  assign io_out_priv_virt_changed = REG_1_priv_virt_changed;
