...
module SinkA_4(
  ...
  wire              _GEN_66 = _io_a_pb_beat_T_1 & io_a_pb_pop_bits_last;
  wire              _GEN_67 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h0 | _GEN_59;
  wire              _GEN_68 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h1 | _GEN_60;
  wire              _GEN_69 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h2 | _GEN_61;
  wire              _GEN_70 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h3 | _GEN_62;
  wire              _GEN_71 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h4 | _GEN_63;
  wire              _GEN_72 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h5 | _GEN_64;
  wire              _GEN_73 = io_a_pb_pop_bits_bufIdx[2:0] == 3'h6 | _GEN_65;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      beatVals_0_0 <= _GEN_66 ? ~_GEN_67 & _GEN_44 : ~_GEN_59 & _GEN_44;
      beatVals_0_1 <= _GEN_66 ? ~_GEN_67 & _GEN_45 : ~_GEN_59 & _GEN_45;
      beatVals_1_0 <= _GEN_66 ? ~_GEN_68 & _GEN_46 : ~_GEN_60 & _GEN_46;
      beatVals_1_1 <= _GEN_66 ? ~_GEN_68 & _GEN_47 : ~_GEN_60 & _GEN_47;
      beatVals_2_0 <= _GEN_66 ? ~_GEN_69 & _GEN_48 : ~_GEN_61 & _GEN_48;
      beatVals_2_1 <= _GEN_66 ? ~_GEN_69 & _GEN_49 : ~_GEN_61 & _GEN_49;
      beatVals_3_0 <= _GEN_66 ? ~_GEN_70 & _GEN_50 : ~_GEN_62 & _GEN_50;
      beatVals_3_1 <= _GEN_66 ? ~_GEN_70 & _GEN_51 : ~_GEN_62 & _GEN_51;
      beatVals_4_0 <= _GEN_66 ? ~_GEN_71 & _GEN_52 : ~_GEN_63 & _GEN_52;
      beatVals_4_1 <= _GEN_66 ? ~_GEN_71 & _GEN_53 : ~_GEN_63 & _GEN_53;
      beatVals_5_0 <= _GEN_66 ? ~_GEN_72 & _GEN_54 : ~_GEN_64 & _GEN_54;
      beatVals_5_1 <= _GEN_66 ? ~_GEN_72 & _GEN_55 : ~_GEN_64 & _GEN_55;
      beatVals_6_0 <= _GEN_66 ? ~_GEN_73 & _GEN_56 : ~_GEN_65 & _GEN_56;
      beatVals_6_1 <= _GEN_66 ? ~_GEN_73 & _GEN_57 : ~_GEN_65 & _GEN_57;
      bufferLeakCnt <= (|_bufVals_T) ? 12'(bufferLeakCnt + 12'h1) : 12'h0;
    end
  ...
  always @(posedge clock) begin
    ...
    if (_io_d_pb_beat_T_1) begin
      ...
      io_d_pb_beat_r_mask <=
        io_d_pb_pop_bits_count
          ? _GEN_79[io_d_pb_pop_bits_bufIdx[2:0]]
    ...
    if (_io_a_pb_beat_T_1) begin
      ...
      io_a_pb_beat_r_mask <=
        io_a_pb_pop_bits_count
          ? _GEN_79[io_a_pb_pop_bits_bufIdx[2:0]]
