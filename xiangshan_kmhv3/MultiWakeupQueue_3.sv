  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hC][6:5];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hC][8:7];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hC][10:9];
      `endif // RANDOMIZE_REG_INIT
    end // initial
