  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_ftqPtr_value = _RANDOM[6'h4][14:9];
        data_uop_ftqOffset = _RANDOM[6'h4][19:15];
        data_uop_fuOpType = _RANDOM[6'h6][28:20];
        data_uop_robIdx_flag = _RANDOM[6'h13][1];
        data_uop_robIdx_value = _RANDOM[6'h13][10:2];
        data_uop_sqIdx_flag = _RANDOM[6'h28][22];
        data_uop_sqIdx_value = _RANDOM[6'h28][28:23];
        data_vaddr = {_RANDOM[6'h29][31:4], _RANDOM[6'h2A][21:0]};
        data_fullva = {_RANDOM[6'h2A][31:22], _RANDOM[6'h2B], _RANDOM[6'h2C][21:0]};
        data_size = _RANDOM[6'h2C][24:22];
        data_mask = {_RANDOM[6'h2C][31:25], _RANDOM[6'h2D][8:0]};
        data_elemIdx = {_RANDOM[6'h2E][31:29], _RANDOM[6'h2F][4:0]};
        data_mbIndex = _RANDOM[6'h2F][8:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
