...
module array_512x76(
  ...
  always @(posedge RW0_clk) begin
    ...
    if (RW0_en & RW0_wmask[0] & RW0_wmode)
      Memory[RW0_addr][32'h0 +: 19] <= RW0_wdata[18:0];
    if (RW0_en & RW0_wmask[1] & RW0_wmode)
      Memory[RW0_addr][32'h13 +: 19] <= RW0_wdata[37:19];
    if (RW0_en & RW0_wmask[2] & RW0_wmode)
      Memory[RW0_addr][32'h26 +: 19] <= RW0_wdata[56:38];
    if (RW0_en & RW0_wmask[3] & RW0_wmode)
      Memory[RW0_addr][32'h39 +: 19] <= RW0_wdata[75:57];
  end // always @(posedge)
