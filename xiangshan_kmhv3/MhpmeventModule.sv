...
module MhpmeventModule(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      reg_OF <= fromSireg2_bits[63];
      reg_OPTYPE2 <= fromSireg2_bits[54:50];
      reg_OPTYPE1 <= fromSireg2_bits[49:45];
      reg_OPTYPE0 <= fromSireg2_bits[44:40];
      reg_EVENT3 <= fromSireg2_bits[39:30];
      reg_EVENT2 <= fromSireg2_bits[29:20];
      reg_EVENT1 <= fromSireg2_bits[19:10];
      reg_EVENT0 <= fromSireg2_bits[9:0];
    end
    else begin
      if (ofFromPerfCnt)
        reg_OF <= ofFromPerfCnt;
      if (w_wen
          & (w_wdata[54:50] == 5'h0 | w_wdata[54:50] == 5'h1 | w_wdata[54:50] == 5'h2
             | w_wdata[54:50] == 5'h4))
        reg_OPTYPE2 <= w_wdata[54:50];
      if (w_wen
          & (w_wdata[49:45] == 5'h0 | w_wdata[49:45] == 5'h1 | w_wdata[49:45] == 5'h2
             | w_wdata[49:45] == 5'h4))
        reg_OPTYPE1 <= w_wdata[49:45];
      if (w_wen
          & (w_wdata[44:40] == 5'h0 | w_wdata[44:40] == 5'h1 | w_wdata[44:40] == 5'h2
             | w_wdata[44:40] == 5'h4))
        reg_OPTYPE0 <= w_wdata[44:40];
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_MINH = _RANDOM[1'h0][0];
        reg_SINH = _RANDOM[1'h0][1];
        reg_UINH = _RANDOM[1'h0][2];
        reg_VSINH = _RANDOM[1'h0][3];
        reg_VUINH = _RANDOM[1'h0][4];
        reg_OF = _RANDOM[1'h0][5];
