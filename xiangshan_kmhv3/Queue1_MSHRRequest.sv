...
module Queue1_MSHRRequest(
  ...
  assign io_deq_bits_channel = ram[118:116];
  assign io_deq_bits_opcode = ram[115:113];
  assign io_deq_bits_param = ram[112:110];
  assign io_deq_bits_size = ram[109:107];
  assign io_deq_bits_source = ram[106:96];
  assign io_deq_bits_set = ram[95:84];
  assign io_deq_bits_tag = ram[83:56];
  assign io_deq_bits_off = ram[55:50];
  assign io_deq_bits_mask = ram[49:18];
  assign io_deq_bits_bufIdx = ram[17:14];
  assign io_deq_bits_needHint = ram[13];
  assign io_deq_bits_isPrefetch = ram[12];
  assign io_deq_bits_isBop = ram[11];
  assign io_deq_bits_preferCache = ram[10];
  assign io_deq_bits_dirty = ram[9];
  assign io_deq_bits_fromProbeHelper = ram[7];
  assign io_deq_bits_fromCmoHelper = ram[6];
  assign io_deq_bits_needProbeAckData = ram[5];
