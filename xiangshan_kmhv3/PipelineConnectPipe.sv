  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_ftqPtr_value = _RANDOM[4'h1][18:13];
        data_ftqOffset = _RANDOM[4'h1][23:19];
        data_isLastInFtqEntry = _RANDOM[4'h1][24];
        data_commitType = _RANDOM[4'h2][26:25];
        data_srcType_0 = _RANDOM[4'h2][30:27];
        data_srcType_1 = {_RANDOM[4'h2][31], _RANDOM[4'h3][2:0]};
        data_srcType_2 = _RANDOM[4'h3][6:3];
        data_srcType_3 = _RANDOM[4'h3][10:7];
        data_vlRen = _RANDOM[4'h3][11];
        data_lsrc_0 = _RANDOM[4'h3][17:12];
        data_lsrc_1 = _RANDOM[4'h3][23:18];
        data_lsrc_2 = _RANDOM[4'h3][29:24];
        data_ldest = _RANDOM[4'h4][9:4];
        data_fuType = {_RANDOM[4'h4][31:10], _RANDOM[4'h5][13:0]};
        data_fuOpType = _RANDOM[4'h5][22:14];
        data_rfWen = _RANDOM[4'h5][23];
        data_fpWen = _RANDOM[4'h5][24];
        data_vecWen = _RANDOM[4'h5][25];
        data_v0Wen = _RANDOM[4'h5][26];
        data_vlWen = _RANDOM[4'h5][27];
        data_waitForward = _RANDOM[4'h5][28];
        data_blockBackward = _RANDOM[4'h5][29];
        data_flushPipe = _RANDOM[4'h5][30];
        data_canRobCompress = _RANDOM[4'h5][31];
        data_selImm = _RANDOM[4'h6][3:0];
        data_imm = {_RANDOM[4'h6][31:4], _RANDOM[4'h7][3:0]};
        data_fpu_wflags = _RANDOM[4'h7][4];
        data_fpu_fmt = _RANDOM[4'h7][6:5];
        data_fpu_rm = _RANDOM[4'h7][9:7];
        data_vpu_vill = _RANDOM[4'h7][10];
        data_vpu_vma = _RANDOM[4'h7][11];
        data_vpu_vta = _RANDOM[4'h7][12];
        data_vpu_vsew = _RANDOM[4'h7][14:13];
        data_vpu_vlmul = _RANDOM[4'h7][17:15];
        data_vpu_specVill = _RANDOM[4'h7][18];
        data_vpu_specVma = _RANDOM[4'h7][19];
        data_vpu_specVta = _RANDOM[4'h7][20];
        data_vpu_specVsew = _RANDOM[4'h7][22:21];
        data_vpu_specVlmul = _RANDOM[4'h7][25:23];
        data_vpu_vm = _RANDOM[4'h7][26];
        data_vpu_vstart = {_RANDOM[4'h7][31:27], _RANDOM[4'h8][2:0]};
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[4'h8][10];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[4'h8][11];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[4'h8][12];
        data_vpu_nf = {_RANDOM[4'hC][31], _RANDOM[4'hD][1:0]};
        data_vpu_veew = _RANDOM[4'hD][3:2];
        data_vpu_isExt = _RANDOM[4'hD][5];
        data_vpu_isNarrow = _RANDOM[4'hD][6];
        data_vpu_isDstMask = _RANDOM[4'hD][7];
        data_vpu_isOpMask = _RANDOM[4'hD][8];
        data_vpu_isDependOldVd = _RANDOM[4'hD][10];
        data_vpu_isWritePartVd = _RANDOM[4'hD][11];
        data_vpu_isVleff = _RANDOM[4'hD][12];
        data_vlsInstr = _RANDOM[4'hE][1];
        data_wfflags = _RANDOM[4'hE][2];
        data_isMove = _RANDOM[4'hE][3];
        data_uopIdx = _RANDOM[4'hE][10:4];
        data_uopSplitType = _RANDOM[4'hE][16:11];
        data_isVset = _RANDOM[4'hE][17];
        data_firstUop = _RANDOM[4'hE][18];
        data_lastUop = _RANDOM[4'hE][19];
        data_numWB = _RANDOM[4'hE][26:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
