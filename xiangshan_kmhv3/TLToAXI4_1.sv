...
module TLToAXI4_1(
  ...
  wire [31:0]      _a_sel_T = 32'h1 << _GEN[auto_in_a_bits_source];
  wire [31:0]      _d_sel_T_1 =
    32'h1 << (r_wins ? auto_out_r_bits_id : auto_out_b_bits_id);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      count <=
        1'(1'(count + (_a_sel_T[0] & _inc_T_16)) - (_d_sel_T_1[0] & d_last & _dec_T_33));
      count_1 <=
        1'(1'(count_1 + (_a_sel_T[1] & _inc_T_16))
           - (_d_sel_T_1[1] & d_last & _dec_T_33));
      count_2 <=
        1'(1'(count_2 + (_a_sel_T[2] & _inc_T_16))
           - (_d_sel_T_1[2] & d_last & _dec_T_33));
      count_3 <=
        1'(1'(count_3 + (_a_sel_T[3] & _inc_T_16))
           - (_d_sel_T_1[3] & d_last & _dec_T_33));
      count_4 <=
        1'(1'(count_4 + (_a_sel_T[4] & _inc_T_16))
           - (_d_sel_T_1[4] & d_last & _dec_T_33));
      count_5 <=
        1'(1'(count_5 + (_a_sel_T[5] & _inc_T_16))
           - (_d_sel_T_1[5] & d_last & _dec_T_33));
      count_6 <=
        1'(1'(count_6 + (_a_sel_T[6] & _inc_T_16))
           - (_d_sel_T_1[6] & d_last & _dec_T_33));
      count_7 <=
        1'(1'(count_7 + (_a_sel_T[7] & _inc_T_16))
           - (_d_sel_T_1[7] & d_last & _dec_T_33));
      count_8 <=
        1'(1'(count_8 + (_a_sel_T[8] & _inc_T_16))
           - (_d_sel_T_1[8] & d_last & _dec_T_33));
      count_9 <=
        1'(1'(count_9 + (_a_sel_T[9] & _inc_T_16))
           - (_d_sel_T_1[9] & d_last & _dec_T_33));
      count_10 <=
        1'(1'(count_10 + (_a_sel_T[10] & _inc_T_16))
           - (_d_sel_T_1[10] & d_last & _dec_T_33));
      count_11 <=
        1'(1'(count_11 + (_a_sel_T[11] & _inc_T_16))
           - (_d_sel_T_1[11] & d_last & _dec_T_33));
      count_12 <=
        1'(1'(count_12 + (_a_sel_T[12] & _inc_T_16))
           - (_d_sel_T_1[12] & d_last & _dec_T_33));
      count_13 <=
        1'(1'(count_13 + (_a_sel_T[13] & _inc_T_16))
           - (_d_sel_T_1[13] & d_last & _dec_T_33));
      count_14 <=
        1'(1'(count_14 + (_a_sel_T[14] & _inc_T_16))
           - (_d_sel_T_1[14] & d_last & _dec_T_33));
      count_15 <=
        1'(1'(count_15 + (_a_sel_T[15] & _inc_T_16))
           - (_d_sel_T_1[15] & d_last & _dec_T_33));
      count_16 <=
        1'(1'(count_16 + (_a_sel_T[16] & _inc_T_16))
           - (_d_sel_T_1[16] & d_last & _dec_T_33));
    end
