...
module TL2TLCoupledL2(
  ...
  wire         childBd_8_ack;
  wire [111:0] childBd_7_outdata;
  wire         childBd_7_ack;
  wire [136:0] childBd_6_outdata;
  wire         childBd_6_ack;
  wire [111:0] childBd_5_outdata;
  wire         childBd_5_ack;
  wire [136:0] childBd_4_outdata;
  wire         childBd_4_ack;
  wire [111:0] childBd_3_outdata;
  wire         childBd_3_ack;
  wire [136:0] childBd_2_outdata;
  wire         childBd_2_ack;
  wire [111:0] childBd_1_outdata;
  wire         childBd_1_ack;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        arbReadys_mask = _RANDOM[5'h1A][14:11];
        master_ready_REG = _RANDOM[5'h1A][15];
        arbReadys_mask_1 = _RANDOM[5'h1A][19:16];
        master_ready_REG_1 = _RANDOM[5'h1A][20];
        arbReadys_mask_2 = _RANDOM[5'h1A][24:21];
        master_ready_REG_2 = _RANDOM[5'h1A][25];
        io_l2Miss_REG = _RANDOM[5'h1A][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arbReadys_mask = 4'hF;
        arbReadys_mask_1 = 4'hF;
  ...
  FastArbiter_4 prefetch_train_arb (
    .clock                  (clock),
    .reset                  (reset),
  ...
  FastArbiter_5 prefetch_resp_arb (
    .clock         (clock),
    .reset         (reset),
