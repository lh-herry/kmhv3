...
module Arbiter4_MainPipeReq(
  ...
  assign io_out_bits_miss = ~io_in_0_valid & io_in_1_valid;
  assign io_out_bits_miss_id = _GEN ? 4'h0 : io_in_1_bits_miss_id;
  assign io_out_bits_occupy_way = _GEN ? 4'h0 : io_in_1_bits_occupy_way;
  assign io_out_bits_miss_fail_cause_evict_btot =
    ~io_in_0_valid & io_in_1_valid & io_in_1_bits_miss_fail_cause_evict_btot;
