  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_p_hit_last_REG_1 = _RANDOM[7'h2F][1];
        readResult_p_ppn_1 = {_RANDOM[7'h2F][31:2], _RANDOM[7'h30][5:0]};
        readResult_p_pbmt_1 = _RANDOM[7'h30][7:6];
        readResult_p_perm_1_pf = _RANDOM[7'h30][8];
        readResult_p_perm_1_af = _RANDOM[7'h30][9];
        readResult_p_perm_1_v = _RANDOM[7'h30][10];
        readResult_p_perm_1_d = _RANDOM[7'h30][11];
        readResult_p_perm_1_a = _RANDOM[7'h30][12];
        readResult_p_perm_1_u = _RANDOM[7'h30][14];
        readResult_p_perm_1_x = _RANDOM[7'h30][15];
        readResult_p_perm_1_w = _RANDOM[7'h30][16];
        readResult_p_perm_1_r = _RANDOM[7'h30][17];
        readResult_p_g_pbmt_1 = _RANDOM[7'h31][31:30];
        readResult_p_g_perm_1_pf = _RANDOM[7'h32][0];
        readResult_p_g_perm_1_af = _RANDOM[7'h32][1];
        readResult_p_g_perm_1_d = _RANDOM[7'h32][3];
        readResult_p_g_perm_1_a = _RANDOM[7'h32][4];
        readResult_p_g_perm_1_x = _RANDOM[7'h32][7];
        readResult_p_g_perm_1_w = _RANDOM[7'h32][8];
        readResult_p_g_perm_1_r = _RANDOM[7'h32][9];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[7'h32][16];
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[7'h36][7];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[7'h36][11];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value = _RANDOM[7'h36][20:12];
        readResult_p_hit_last_REG_2 = _RANDOM[7'h3B][15];
        readResult_p_ppn_2 = {_RANDOM[7'h3B][31:16], _RANDOM[7'h3C][19:0]};
        readResult_p_pbmt_2 = _RANDOM[7'h3C][21:20];
        readResult_p_perm_2_pf = _RANDOM[7'h3C][22];
        readResult_p_perm_2_af = _RANDOM[7'h3C][23];
        readResult_p_perm_2_v = _RANDOM[7'h3C][24];
        readResult_p_perm_2_d = _RANDOM[7'h3C][25];
        readResult_p_perm_2_a = _RANDOM[7'h3C][26];
        readResult_p_perm_2_u = _RANDOM[7'h3C][28];
        readResult_p_perm_2_x = _RANDOM[7'h3C][29];
        readResult_p_perm_2_w = _RANDOM[7'h3C][30];
        readResult_p_perm_2_r = _RANDOM[7'h3C][31];
        readResult_p_g_pbmt_2 = _RANDOM[7'h3E][13:12];
        readResult_p_g_perm_2_pf = _RANDOM[7'h3E][14];
        readResult_p_g_perm_2_af = _RANDOM[7'h3E][15];
        readResult_p_g_perm_2_d = _RANDOM[7'h3E][17];
        readResult_p_g_perm_2_a = _RANDOM[7'h3E][18];
        readResult_p_g_perm_2_x = _RANDOM[7'h3E][21];
        readResult_p_g_perm_2_w = _RANDOM[7'h3E][22];
        readResult_p_g_perm_2_r = _RANDOM[7'h3E][23];
        readResult_lastCycleRedirect_REG_2_valid = _RANDOM[7'h3E][30];
        readResult_lastCycleRedirect_REG_2_bits_level = _RANDOM[7'h42][21];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_flag = _RANDOM[7'h42][25];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_value =
          {_RANDOM[7'h42][31:26], _RANDOM[7'h43][2:0]};
        noTranslateReg_1 = _RANDOM[7'h48][12];
        REG_2 = _RANDOM[7'h48][13];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h48][14];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h48][16];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h48][17];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h48][18];
        REG_3 = _RANDOM[7'h48][20];
        noTranslateReg_2 = _RANDOM[7'h48][27];
        REG_4 = _RANDOM[7'h48][28];
        io_requestor_2_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h48][29];
        io_requestor_2_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h48][31];
        io_requestor_2_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h49][0];
        io_requestor_2_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h49][1];
        REG_5 = _RANDOM[7'h49][3];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h49][11:10];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h49][31:12], _RANDOM[7'h4A][14:0]};
        ptw_resp_bits_reg_s1_entry_asid = _RANDOM[7'h4A][30:15];
        ptw_resp_bits_reg_s1_entry_vmid = {_RANDOM[7'h4A][31], _RANDOM[7'h4B][12:0]};
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[7'h4B][13];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[7'h4B][18];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h4B][24:23];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h4D][6:4];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h4D][31];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h4E][0];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h4E][1];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h4E][2];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h4E][3];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h4E][4];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h4E][5];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h4E][6];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h4E][31:17], _RANDOM[7'h4F][22:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h50][20:7];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[7'h50][21];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h52][6:5];
        ptw_already_back_last_REG = _RANDOM[7'h52][21];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h52][24:23];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h52][31:25], _RANDOM[7'h53][27:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = {_RANDOM[7'h53][31:28], _RANDOM[7'h54][11:0]};
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h54][25:12];
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[7'h54][26];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[7'h54][31];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h55][5:4];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h56][19:17];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h57][12];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h57][13];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h57][14];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h57][15];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h57][16];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h57][17];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h57][18];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h57][19];
        ptw_resp_bits_reg_1_s2_entry_tag =
          {_RANDOM[7'h57][31:30], _RANDOM[7'h58], _RANDOM[7'h59][3:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h59][31:20], _RANDOM[7'h5A][1:0]};
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[7'h5A][2];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h5B][19:18];
        ptw_already_back_last_REG_1 = _RANDOM[7'h5C][2];
        ptw_resp_bits_reg_2_s2xlate = _RANDOM[7'h5C][5:4];
        ptw_resp_bits_reg_2_s1_entry_tag = {_RANDOM[7'h5C][31:6], _RANDOM[7'h5D][8:0]};
        ptw_resp_bits_reg_2_s1_entry_asid = _RANDOM[7'h5D][24:9];
        ptw_resp_bits_reg_2_s1_entry_vmid = {_RANDOM[7'h5D][31:25], _RANDOM[7'h5E][6:0]};
        ptw_resp_bits_reg_2_s1_entry_n = _RANDOM[7'h5E][7];
        ptw_resp_bits_reg_2_s1_entry_perm_g = _RANDOM[7'h5E][12];
        ptw_resp_bits_reg_2_s1_entry_level = _RANDOM[7'h5E][18:17];
        ptw_resp_bits_reg_2_s1_addr_low = {_RANDOM[7'h5F][31:30], _RANDOM[7'h60][0]};
        ptw_resp_bits_reg_2_s1_valididx_0 = _RANDOM[7'h60][25];
        ptw_resp_bits_reg_2_s1_valididx_1 = _RANDOM[7'h60][26];
        ptw_resp_bits_reg_2_s1_valididx_2 = _RANDOM[7'h60][27];
        ptw_resp_bits_reg_2_s1_valididx_3 = _RANDOM[7'h60][28];
        ptw_resp_bits_reg_2_s1_valididx_4 = _RANDOM[7'h60][29];
        ptw_resp_bits_reg_2_s1_valididx_5 = _RANDOM[7'h60][30];
        ptw_resp_bits_reg_2_s1_valididx_6 = _RANDOM[7'h60][31];
        ptw_resp_bits_reg_2_s1_valididx_7 = _RANDOM[7'h61][0];
        ptw_resp_bits_reg_2_s2_entry_tag = {_RANDOM[7'h61][31:11], _RANDOM[7'h62][16:0]};
        ptw_resp_bits_reg_2_s2_entry_vmid = _RANDOM[7'h63][14:1];
        ptw_resp_bits_reg_2_s2_entry_n = _RANDOM[7'h63][15];
        ptw_resp_bits_reg_2_s2_entry_level = {_RANDOM[7'h64][31], _RANDOM[7'h65][0]};
        ptw_already_back_last_REG_2 = _RANDOM[7'h65][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
