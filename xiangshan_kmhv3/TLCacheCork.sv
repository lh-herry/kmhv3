...
module TLCacheCork(
  ...
  wire [7:0]   _c_a_bits_a_mask_sizeOH_T_1 = 8'h1 << auto_in_c_bits_size;
  wire         c_a_bits_a_mask_sub_sub_sub_sub_sub_0_1 = auto_in_c_bits_size > 3'h4;
  wire         c_a_bits_a_mask_sub_sub_sub_sub_0_1 =
    c_a_bits_a_mask_sub_sub_sub_sub_sub_0_1 | _c_a_bits_a_mask_sizeOH_T_1[4]
  ...
  wire         c_a_bits_a_mask_sub_sub_sub_0_1 =
    c_a_bits_a_mask_sub_sub_sub_sub_0_1 | _c_a_bits_a_mask_sizeOH_T_1[3]
  ...
  wire         c_a_bits_a_mask_sub_sub_sub_2_1 =
    c_a_bits_a_mask_sub_sub_sub_sub_1_1 | _c_a_bits_a_mask_sizeOH_T_1[3]
  ...
  wire         c_a_bits_a_mask_sub_sub_0_1 =
    c_a_bits_a_mask_sub_sub_sub_0_1 | _c_a_bits_a_mask_sizeOH_T_1[2]
  ...
  wire         c_a_bits_a_mask_sub_sub_2_1 =
    c_a_bits_a_mask_sub_sub_sub_1_1 | _c_a_bits_a_mask_sizeOH_T_1[2]
  ...
  wire         c_a_bits_a_mask_sub_sub_4_1 =
    c_a_bits_a_mask_sub_sub_sub_2_1 | _c_a_bits_a_mask_sizeOH_T_1[2]
  ...
  wire         c_a_bits_a_mask_sub_sub_6_1 =
    c_a_bits_a_mask_sub_sub_sub_3_1 | _c_a_bits_a_mask_sizeOH_T_1[2]
  ...
  reg          beatsLeft;
  wire         winner_1 = ~c_a_valid & a_a_valid;
  reg          state_0;
  reg          state_1;
  wire         muxState_0 = beatsLeft ? state_0 : c_a_valid;
  wire         muxState_1 = beatsLeft ? state_1 : winner_1;
  assign c_a_ready = auto_out_a_ready & (~beatsLeft | state_0);
  assign a_a_ready = auto_out_a_ready & (beatsLeft ? state_1 : ~c_a_valid);
  wire         nodeOut_a_valid =
    beatsLeft ? state_0 & c_a_valid | state_1 & a_a_valid : c_a_valid | a_a_valid;
  reg          beatsLeft_1;
  wire [1:0]   _GEN_1 = ~({_q_io_deq_valid, auto_out_d_valid} | {auto_out_d_valid, 1'h0});
  wire         winner_1_1 = _GEN_1[0] & _q_io_deq_valid;
  wire         winner_1_2 = _GEN_1[1] & _q_1_io_deq_valid;
  reg          state_1_0;
  reg          state_1_1;
  reg          state_1_2;
  ...
  wire [12:0]  _d_first_beats1_decode_T = 13'h3F << in_d_bits_size;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_beatsLeft_T_4)
        d_first_counter <=
          ~d_first_counter & in_d_bits_opcode[0] & ~(_d_first_beats1_decode_T[5]);
      beatsLeft <=
        ~beatsLeft & auto_out_a_ready
          ? c_a_valid & ~(_decode_T[5]) | winner_1 & ~(a_a_bits_opcode[2])
            & ~(_decode_T_3[5])
          : 1'(beatsLeft - (auto_out_a_ready & nodeOut_a_valid));
      if (beatsLeft) begin
      end
      else begin
        state_0 <= c_a_valid;
  ...
  Queue2_TLBundleD_2 q (
    ...
    .io_deq_ready        (in_d_ready & (beatsLeft_1 ? state_1_1 : _GEN_1[0])),
  ...
  Queue2_TLBundleD_2 q_1 (
    ...
    .io_deq_ready        (in_d_ready & (beatsLeft_1 ? state_1_2 : _GEN_1[1])),
