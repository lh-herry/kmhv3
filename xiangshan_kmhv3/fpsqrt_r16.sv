...
module fpsqrt_r16(
  ...
  wire         op_is_zero_0 =
    ~fp_aIsFpCanonicalNAN & need_2_cycles_init & _u_lzc_0_lzc_io_out_isZero;
  wire         op_is_inf_0 =
    ~fp_aIsFpCanonicalNAN & op_exp_is_max_0 & _u_lzc_0_lzc_io_out_isZero;
  wire         op_is_qnan_0 =
  ...
  wire         early_finish =
    res_is_nan_0_d | op_is_inf_0 | op_is_zero_0 | _u_lzc_0_lzc_io_out_isZero;
    ...
    if (reset) begin
      ...
      fsm_q <=
        flush_i
          ...
          : fsm_q == 4'h1
              ? (start_valid_i
                   ? (early_finish ? 4'h8 : {1'h0, need_2_cycles_init ? 3'h2 : 3'h4})
                   : 4'h1)
              : fsm_q == 4'h2
                  ? 4'h4
                  : fsm_q == 4'h4
  ...
  wire [55:0]  rt_iter_init = {rt_iter_init_0[3:2], 54'h0};
  ...
  always @(posedge clock) begin
      ...
      iter_num_q <=
        fsm_q[0]
          ? (need_2_cycles_init
               ...
               : {2'h0, ~(|fp_format_i), 1'h0} | {1'h0, {3{_iter_num_d_T_7}} & 3'h5}
    ...
    if (start_handshaked) begin
      ...
      res_is_sqrt_2_q <= _u_lzc_0_lzc_io_out_isZero & ~(op_exp_0[0]);
      res_is_sqrt_2_odd_q <= _u_lzc_0_lzc_io_out_isZero & op_exp_0[0];
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        wakeupSuccessReg = _RANDOM[4'h9][26];
        outValidBlock = _RANDOM[4'h9][28:27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fsm_q = 4'h1;
        wakeupSuccessReg = 1'h1;
  ...
  assign finish_valid_o = fsm_q[3] & outValidBlock == 2'h0;
  assign fpsqrt_res_o =
    (fp_fmt_q[0]
       ? {48'h0,
          out_sign_0_q,
