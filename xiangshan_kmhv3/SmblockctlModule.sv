...
module SmblockctlModule(
  ...
  input  [63:0] w_wdata,
  output [63:0] rdata,
  output [21:0] regOut_SBUFFER_TIMEOUT,
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      reg_SBUFFER_TIMEOUT <= 22'h100000;
      ...
      reg_SBUFFER_TIMEOUT <= w_wdata[31:10];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_SBUFFER_TIMEOUT = _RANDOM[/*Zero width*/ 1'b0][21:0];
        reg_HD_MISALIGN_LD_ENABLE = _RANDOM[/*Zero width*/ 1'b0][22];
        reg_HD_MISALIGN_ST_ENABLE = _RANDOM[/*Zero width*/ 1'b0][23];
        reg_UNCACHE_WRITE_OUTSTANDING_ENABLE = _RANDOM[/*Zero width*/ 1'b0][24];
        reg_CACHE_ERROR_ENABLE = _RANDOM[/*Zero width*/ 1'b0][25];
        reg_SOFT_PREFETCH_ENABLE = _RANDOM[/*Zero width*/ 1'b0][26];
        reg_LDLD_VIO_CHECK_ENABLE = _RANDOM[/*Zero width*/ 1'b0][27];
        reg_SBUFFER_THRESHOLD = _RANDOM[/*Zero width*/ 1'b0][31:28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_SBUFFER_TIMEOUT = 22'h100000;
        reg_HD_MISALIGN_LD_ENABLE = 1'h1;
  ...
  assign regOut_SBUFFER_TIMEOUT = reg_SBUFFER_TIMEOUT;
