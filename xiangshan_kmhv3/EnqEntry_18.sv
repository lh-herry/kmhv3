  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        enqDelayValidReg_last_REG = _RANDOM[3'h6][12];
        io_commonOut_entry_bits_payload_og1Payload_REG_isRVC = _RANDOM[3'h6][13];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType = _RANDOM[3'h6][22:14];
        io_commonOut_entry_bits_payload_og1Payload_REG_imm =
          {_RANDOM[3'h6][31:27], _RANDOM[3'h7][6:0]};
        io_commonOut_entry_bits_payload_og1Payload_REG_storeSetHit = _RANDOM[3'h7][7];
        io_commonOut_entry_bits_payload_og1Payload_REG_ssid = _RANDOM[3'h7][12:8];
        io_commonOut_entry_bits_payload_og1Payload_REG_sqIdx_flag = _RANDOM[3'h7][13];
        io_commonOut_entry_bits_payload_og1Payload_REG_sqIdx_value = _RANDOM[3'h7][19:14];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[3'h7][27:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
