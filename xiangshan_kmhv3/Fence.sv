  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_ctrl_pdest = _RANDOM[4'h0][30:23];
        uop_ctrl_flushPipe = _RANDOM[4'h0][31];
        uop_data_imm = {_RANDOM[4'h5], _RANDOM[4'h6]};
        io_fenceio_sfence_bits_addr_r = {_RANDOM[4'h7], _RANDOM[4'h8]};
        io_fenceio_sfence_bits_id_r = {_RANDOM[4'h9], _RANDOM[4'hA]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 3'h0;
    end // initial
