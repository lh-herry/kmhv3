...
module MbistPipeMemBlk(
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        {76'h0, selected ? toNextPipeline_0_outdata : 72'h0}
        | {62'h0, selected_1 ? toNextPipeline_1_outdata : 86'h0}
        | {58'h0, selected_2 ? toNextPipeline_2_outdata : 90'h0}
        | {17'h0, selected_3 ? toNextPipeline_3_outdata : 131'h0}
        | {34'h0, selected_4 ? toNextPipeline_4_outdata : 114'h0}
