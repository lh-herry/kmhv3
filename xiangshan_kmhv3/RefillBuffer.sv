...
module RefillBuffer(
  ...
  buffer_7x514 buffer_ext (
    ...
    .W0_clk  (clock),
    .W0_data ({io_w_data_data, 1'h0, io_w_data_data, 1'h0}),
    .W0_mask ({{257{io_w_beat}}, {257{~io_w_beat}}})
  );
  assign io_r_ready = io_r_ready_0;
  assign io_r_buffer_data_data =
    io_r_beat ? _buffer_ext_R0_data[513:258] : _buffer_ext_R0_data[256:1];
  assign io_r_buffer_data_corrupt =
    io_r_beat ? _buffer_ext_R0_data[257] : _buffer_ext_R0_data[0];
