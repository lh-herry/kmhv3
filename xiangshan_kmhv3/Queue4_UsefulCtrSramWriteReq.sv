...
module Queue4_UsefulCtrSramWriteReq(
  input        clock,
  input        reset,
  input        io_enq_valid,
  input  [8:0] io_enq_bits_setIdx,
  input  [1:0] io_enq_bits_usefulCtr_value,
  input        io_deq_ready,
  output       io_deq_valid,
  output [8:0] io_deq_bits_setIdx,
  output [1:0] io_deq_bits_usefulCtr_value
);
  ...
  ram_4x11 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_setIdx, io_enq_bits_usefulCtr_value})
  );
  assign io_deq_valid = io_deq_valid_0;
  assign io_deq_bits_setIdx = empty ? io_enq_bits_setIdx : _ram_ext_R0_data[10:2];
  assign io_deq_bits_usefulCtr_value =
    empty ? io_enq_bits_usefulCtr_value : _ram_ext_R0_data[1:0];
endmodule
