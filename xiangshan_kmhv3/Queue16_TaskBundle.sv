...
module Queue16_TaskBundle(
  ...
  assign io_deq_bits_set = empty ? io_enq_bits_set : _ram_ext_R0_data[66:58];
  assign io_deq_bits_tag = empty ? io_enq_bits_tag : _ram_ext_R0_data[57:27];
  assign io_deq_bits_off = empty ? io_enq_bits_off : _ram_ext_R0_data[26:21];
  assign io_deq_bits_opcode = empty ? io_enq_bits_opcode : _ram_ext_R0_data[20:17];
  assign io_deq_bits_param = empty ? io_enq_bits_param : _ram_ext_R0_data[16:14];
  assign io_deq_bits_mshrId = empty ? io_enq_bits_mshrId : _ram_ext_R0_data[13:6];
  assign io_deq_bits_dirty = empty ? io_enq_bits_dirty : _ram_ext_R0_data[5];
  assign io_deq_bits_reqSource = empty ? io_enq_bits_reqSource : _ram_ext_R0_data[4:0];
