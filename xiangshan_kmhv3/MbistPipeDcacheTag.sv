...
module MbistPipeDcacheTag(
  ...
  reg         renReg;
  reg  [8:0]  addrRdReg;
  wire        selectedVec_0 = arrayReg == 6'h20;
  wire        doSpread = selectedVec_0 | allReg;
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 86'h0;
  wire        selectedVec_0_1 = arrayReg == 6'h21;
  wire        doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 86'h0;
  wire        selectedVec_0_2 = arrayReg == 6'h22;
  wire        doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = selectedVec_0_2 ? toSRAM_2_rdata : 86'h0;
  wire        selectedVec_0_3 = arrayReg == 6'h23;
  wire        doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = selectedVec_0_3 ? toSRAM_3_rdata : 86'h0;
  wire        selectedVec_0_4 = arrayReg == 6'h24;
  wire        doSpread_4 = selectedVec_0_4 | allReg;
  assign sramDataOut_4 = selectedVec_0_4 ? toSRAM_4_rdata : 86'h0;
  wire        selectedVec_0_5 = arrayReg == 6'h25;
  wire        doSpread_5 = selectedVec_0_5 | allReg;
  assign sramDataOut_5 = selectedVec_0_5 ? toSRAM_5_rdata : 86'h0;
  wire        selectedVec_0_6 = arrayReg == 6'h26;
  wire        doSpread_6 = selectedVec_0_6 | allReg;
  assign sramDataOut_6 = selectedVec_0_6 ? toSRAM_6_rdata : 86'h0;
  wire        selectedVec_0_7 = arrayReg == 6'h27;
  wire        doSpread_7 = selectedVec_0_7 | allReg;
  assign sramDataOut_7 = selectedVec_0_7 ? toSRAM_7_rdata : 86'h0;
  wire        activated =
    mbist_all | mbist_req
    & (mbist_array == 6'h20 | mbist_array == 6'h21 | mbist_array == 6'h22
       | mbist_array == 6'h23 | mbist_array == 6'h24 | mbist_array == 6'h25
       | mbist_array == 6'h26 | mbist_array == 6'h27);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        arrayReg = _RANDOM[2'h0][5:0];
        reqReg = _RANDOM[2'h0][6];
        allReg = _RANDOM[2'h0][7];
        wenReg = _RANDOM[2'h0][8];
        beReg = _RANDOM[2'h0][10:9];
        addrReg = _RANDOM[2'h0][19:11];
        dataInReg =
          {_RANDOM[2'h0][31:20], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][9:0]};
        renReg = _RANDOM[2'h3][10];
        addrRdReg = _RANDOM[2'h3][19:11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
