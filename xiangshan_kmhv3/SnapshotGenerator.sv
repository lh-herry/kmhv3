...
module SnapshotGenerator(
  ...
  output [8:0] io_snapshots_0_value,
  output       io_snapshots_1_flag,
  output [8:0] io_snapshots_1_value,
  output       io_snapshots_2_flag,
  output [8:0] io_snapshots_2_value,
  output       io_snapshots_3_flag,
  output [8:0] io_snapshots_3_value
);

  reg        snapshots_0_flag;
  reg  [8:0] snapshots_0_value;
  reg        snapshots_1_flag;
  reg  [8:0] snapshots_1_value;
  reg        snapshots_2_flag;
  reg  [8:0] snapshots_2_value;
  reg        snapshots_3_flag;
  reg  [8:0] snapshots_3_value;
  reg        snptEnqPtr_flag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        snapshots_0_value = _RANDOM[1'h0][9:1];
        snapshots_1_flag = _RANDOM[1'h0][10];
        snapshots_1_value = _RANDOM[1'h0][19:11];
        snapshots_2_flag = _RANDOM[1'h0][20];
        snapshots_2_value = _RANDOM[1'h0][29:21];
        snapshots_3_flag = _RANDOM[1'h0][30];
        snapshots_3_value = {_RANDOM[1'h0][31], _RANDOM[1'h1][7:0]};
        snptEnqPtr_flag = _RANDOM[1'h1][8];
        snptEnqPtr_value = _RANDOM[1'h1][10:9];
        snptDeqPtr_flag = _RANDOM[1'h1][11];
        snptDeqPtr_value = _RANDOM[1'h1][13:12];
        snptValids_0 = _RANDOM[1'h1][14];
        snptValids_1 = _RANDOM[1'h1][15];
        snptValids_2 = _RANDOM[1'h1][16];
        snptValids_3 = _RANDOM[1'h1][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        snptEnqPtr_flag = 1'h0;
        snptEnqPtr_value = 2'h0;
