...
module L2Directory(
  ...
  wire         activated =
    ...
    & (mbist_array == 4'h6 | mbist_array == 4'h7 | mbist_array == 4'h8
       | mbist_array == 4'h9 | mbist_array == 4'hA | mbist_array == 4'hB
       | mbist_array == 4'hC);
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[3'h0][31:25],
           ...
           _RANDOM[3'h3],
           _RANDOM[3'h4][8:0]};
        renReg = _RANDOM[3'h4][9];
        addrRdReg = _RANDOM[3'h4][19:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 4'h0;
        reqReg = 1'h0;
