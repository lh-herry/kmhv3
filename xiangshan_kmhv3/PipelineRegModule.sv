...
module PipelineRegModule(
  ...
  reg  [8:0]  io_out_bits_r_robIdx_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_r_robIdx_value = _RANDOM[3'h0][10:2];
        io_out_bits_r_cmd = _RANDOM[3'h0][15:11];
        io_out_bits_r_addr = {_RANDOM[3'h0][31:16], _RANDOM[3'h1]};
        io_out_bits_r_vaddr = {_RANDOM[3'h2], _RANDOM[3'h3][17:0]};
        io_out_bits_r_data = {_RANDOM[3'h3][31:18], _RANDOM[3'h4], _RANDOM[3'h5][17:0]};
        io_out_bits_r_mask = _RANDOM[3'h5][25:18];
        io_out_bits_r_id = {_RANDOM[3'h5][31:26], _RANDOM[3'h6][0]};
        io_out_bits_r_nc = _RANDOM[3'h6][1];
        io_out_bits_r_memBackTypeMM = _RANDOM[3'h6][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        pipeline_reg_valid = 1'h0;
    end // initial
