...
module TLXbar(
  ...
  output [3:0]  auto_out_8_a_bits_opcode,
  output [1:0]  auto_out_8_a_bits_size,
  ...
  input  [3:0]  auto_out_8_d_bits_opcode,
  input  [1:0]  auto_out_8_d_bits_size,
  ...
  wire [10:0] _GEN = auto_in_a_bits_address[29:19] ^ 11'h701;
  wire [9:0]  _GEN_0 = auto_in_a_bits_address[29:20] ^ 10'h381;
  wire [8:0]  _GEN_1 = auto_in_a_bits_address[29:21] ^ 9'h1C1;
  wire [7:0]  _GEN_2 = auto_in_a_bits_address[29:22] ^ 8'hE1;
  wire [6:0]  _GEN_3 = auto_in_a_bits_address[29:23] ^ 7'h71;
  wire        requestAIO_0_1 =
    ...
    | {auto_in_a_bits_address[47:30], _GEN[10:6], _GEN[4:0]} == 28'h0
    | {auto_in_a_bits_address[47:30], _GEN_0[9:5], _GEN_0[3:0]} == 27'h0
    | {auto_in_a_bits_address[47:30], _GEN_1[8:4], _GEN_1[2:0]} == 26'h0
    | {auto_in_a_bits_address[47:30], _GEN_2[7:3], _GEN_2[1:0]} == 25'h0
    | {auto_in_a_bits_address[47:30], _GEN_3[6:2], _GEN_3[0]} == 24'h0
    ...
    | {auto_in_a_bits_address[47:30], auto_in_a_bits_address[29:18] ^ 12'hE41} == 30'h0
  ...
  wire        requestAIO_0_2 =
    {auto_in_a_bits_address[47:30], auto_in_a_bits_address[29:16] ^ 14'h3804} == 32'h0;
  wire        requestAIO_0_3 =
  ...
  wire        _GEN_4 = auto_out_8_d_valid & _readys_filter_T[8];
  wire [15:0] _GEN_5 =
    {_readys_filter_T_1[7:0],
     auto_out_8_d_valid,
     auto_out_7_d_valid,
     auto_out_6_d_valid,
     auto_out_5_d_valid,
    ...
    | {_readys_filter_T_1,
       ...
       auto_out_3_d_valid,
       auto_out_2_d_valid};
  wire [14:0] _GEN_6 = _GEN_5[14:0] | {_GEN_4, _GEN_5[15:2]};
  wire [12:0] _GEN_7 = _GEN_6[12:0] | {_GEN_4, _GEN_5[15], _GEN_6[14:4]};
  wire [17:0] readys_unready =
    {1'h0,
     _GEN_4,
     _GEN_5[15],
     _GEN_6[14:13],
     _GEN_7[12:9],
     _GEN_7[8:0] | {_GEN_4, _GEN_5[15], _GEN_6[14:13], _GEN_7[12:8]}}
    | {readys_mask, 9'h0};
  wire [8:0]  readys_readys = ~(readys_unready[17:9] & readys_unready[8:0]);
  ...
  wire        winner_8 = readys_readys[8] & auto_out_8_d_valid;
  reg         state_0;
  reg         state_1;
  reg         state_2;
  reg         state_3;
  ...
  wire        in_0_d_valid =
    idle
      ...
      : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2
        ...
        & auto_out_7_d_valid | state_8 & auto_out_8_d_valid;
          ...
          ? {maskedBeats_0[2],
             maskedBeats_0[1:0]
               | (winner_1 & auto_out_1_d_bits_opcode[0]
                    ...
                    : 2'h0)}
          : 3'(beatsLeft - {2'h0, auto_in_d_ready & in_0_d_valid});
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM[/*Zero width*/ 1'b0][11:3];
        state_0 = _RANDOM[/*Zero width*/ 1'b0][12];
        state_1 = _RANDOM[/*Zero width*/ 1'b0][13];
        state_2 = _RANDOM[/*Zero width*/ 1'b0][14];
        state_3 = _RANDOM[/*Zero width*/ 1'b0][15];
        state_4 = _RANDOM[/*Zero width*/ 1'b0][16];
        state_5 = _RANDOM[/*Zero width*/ 1'b0][17];
        state_6 = _RANDOM[/*Zero width*/ 1'b0][18];
        state_7 = _RANDOM[/*Zero width*/ 1'b0][19];
        state_8 = _RANDOM[/*Zero width*/ 1'b0][20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        beatsLeft = 3'h0;
        readys_mask = 9'h1FF;
  ...
  assign auto_in_a_ready =
    ...
    | requestAIO_0_8 & auto_out_8_a_ready;
  ...
  assign auto_in_d_bits_size =
    ...
    | (muxState_8 ? {1'h0, auto_out_8_d_bits_size} : 3'h0);
  assign auto_in_d_bits_source =
    (muxState_0 ? auto_out_0_d_bits_source : 5'h0)
    | (muxState_1 ? auto_out_1_d_bits_source : 5'h0)
    | (muxState_2 ? auto_out_2_d_bits_source : 5'h0)
    | (muxState_3 ? auto_out_3_d_bits_source : 5'h0)
    | (muxState_4 ? auto_out_4_d_bits_source : 5'h0)
    | (muxState_5 ? auto_out_5_d_bits_source : 5'h0)
    | (muxState_6 ? auto_out_6_d_bits_source : 5'h0)
    | (muxState_7 ? auto_out_7_d_bits_source : 5'h0)
    | (muxState_8 ? auto_out_8_d_bits_source : 5'h0);
  assign auto_in_d_bits_sink =
    muxState_0 & auto_out_0_d_bits_sink | muxState_1 & auto_out_1_d_bits_sink | muxState_7
  ...
  assign auto_in_d_bits_denied =
    ...
    | muxState_7 & auto_out_7_d_bits_denied;
