  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        current_exceptionVec_0 = _RANDOM[6'h0][25];
        current_exceptionVec_1 = _RANDOM[6'h0][26];
        current_exceptionVec_2 = _RANDOM[6'h0][27];
        current_exceptionVec_3 = _RANDOM[6'h0][28];
        current_exceptionVec_4 = _RANDOM[6'h0][29];
        current_exceptionVec_5 = _RANDOM[6'h0][30];
        current_exceptionVec_6 = _RANDOM[6'h0][31];
        current_exceptionVec_7 = _RANDOM[6'h1][0];
        current_exceptionVec_8 = _RANDOM[6'h1][1];
        current_exceptionVec_9 = _RANDOM[6'h1][2];
        current_exceptionVec_10 = _RANDOM[6'h1][3];
        current_exceptionVec_11 = _RANDOM[6'h1][4];
        current_exceptionVec_12 = _RANDOM[6'h1][5];
        current_exceptionVec_13 = _RANDOM[6'h1][6];
        current_exceptionVec_14 = _RANDOM[6'h1][7];
        current_exceptionVec_15 = _RANDOM[6'h1][8];
        current_exceptionVec_16 = _RANDOM[6'h1][9];
        current_exceptionVec_17 = _RANDOM[6'h1][10];
        current_exceptionVec_18 = _RANDOM[6'h1][11];
        current_exceptionVec_19 = _RANDOM[6'h1][12];
        current_exceptionVec_20 = _RANDOM[6'h1][13];
        current_exceptionVec_21 = _RANDOM[6'h1][14];
        current_exceptionVec_22 = _RANDOM[6'h1][15];
        current_exceptionVec_23 = _RANDOM[6'h1][16];
        current_isFetchMalAddr = _RANDOM[6'h1][17];
        current_flushPipe = _RANDOM[6'h1][18];
        current_isVset = _RANDOM[6'h1][19];
        current_replayInst = _RANDOM[6'h1][20];
        current_singleStep = _RANDOM[6'h1][21];
        current_crossPageIPFFix = _RANDOM[6'h1][22];
        current_trigger = _RANDOM[6'h1][26:23];
        current_vstartEn = _RANDOM[6'h1][27];
        current_vstart = {_RANDOM[6'h1][31:28], _RANDOM[6'h2], _RANDOM[6'h3][27:0]};
        current_isVecLoad = _RANDOM[6'h4][3];
        current_isVlm = _RANDOM[6'h4][4];
        current_isStrided = _RANDOM[6'h4][5];
        current_isIndexed = _RANDOM[6'h4][6];
        current_isWhole = _RANDOM[6'h4][7];
        current_nf = _RANDOM[6'h4][10:8];
        current_vsew = _RANDOM[6'h4][12:11];
        current_veew = _RANDOM[6'h4][14:13];
        current_vlmul = _RANDOM[6'h4][17:15];
        lastCycleFlush = _RANDOM[6'h4][18];
        s0_out_valid_0 = _RANDOM[6'h4][19];
        s0_out_valid_1 = _RANDOM[6'h4][20];
        s0_out_valid_2 = _RANDOM[6'h4][21];
        s0_out_valid_3 = _RANDOM[6'h4][22];
        s0_out_valid_4 = _RANDOM[6'h4][23];
        s0_out_bits_0_robIdx_flag = _RANDOM[6'h4][24];
        s0_out_bits_0_robIdx_value = {_RANDOM[6'h4][31:25], _RANDOM[6'h5][1:0]};
        s0_out_bits_0_hasException = _RANDOM[6'h5][14];
        s0_out_bits_0_exceptionVec_0 = _RANDOM[6'h5][16];
        s0_out_bits_0_exceptionVec_1 = _RANDOM[6'h5][17];
        s0_out_bits_0_exceptionVec_2 = _RANDOM[6'h5][18];
        s0_out_bits_0_exceptionVec_3 = _RANDOM[6'h5][19];
        s0_out_bits_0_exceptionVec_4 = _RANDOM[6'h5][20];
        s0_out_bits_0_exceptionVec_5 = _RANDOM[6'h5][21];
        s0_out_bits_0_exceptionVec_6 = _RANDOM[6'h5][22];
        s0_out_bits_0_exceptionVec_7 = _RANDOM[6'h5][23];
        s0_out_bits_0_exceptionVec_8 = _RANDOM[6'h5][24];
        s0_out_bits_0_exceptionVec_9 = _RANDOM[6'h5][25];
        s0_out_bits_0_exceptionVec_10 = _RANDOM[6'h5][26];
        s0_out_bits_0_exceptionVec_11 = _RANDOM[6'h5][27];
        s0_out_bits_0_exceptionVec_12 = _RANDOM[6'h5][28];
        s0_out_bits_0_exceptionVec_13 = _RANDOM[6'h5][29];
        s0_out_bits_0_exceptionVec_14 = _RANDOM[6'h5][30];
        s0_out_bits_0_exceptionVec_15 = _RANDOM[6'h5][31];
        s0_out_bits_0_exceptionVec_16 = _RANDOM[6'h6][0];
        s0_out_bits_0_exceptionVec_17 = _RANDOM[6'h6][1];
        s0_out_bits_0_exceptionVec_18 = _RANDOM[6'h6][2];
        s0_out_bits_0_exceptionVec_19 = _RANDOM[6'h6][3];
        s0_out_bits_0_exceptionVec_20 = _RANDOM[6'h6][4];
        s0_out_bits_0_exceptionVec_21 = _RANDOM[6'h6][5];
        s0_out_bits_0_exceptionVec_22 = _RANDOM[6'h6][6];
        s0_out_bits_0_exceptionVec_23 = _RANDOM[6'h6][7];
        s0_out_bits_0_flushPipe = _RANDOM[6'h6][9];
        s0_out_bits_1_robIdx_flag = _RANDOM[6'h9][9];
        s0_out_bits_1_robIdx_value = _RANDOM[6'h9][18:10];
        s0_out_bits_1_hasException = _RANDOM[6'h9][31];
        s0_out_bits_1_exceptionVec_0 = _RANDOM[6'hA][1];
        s0_out_bits_1_exceptionVec_1 = _RANDOM[6'hA][2];
        s0_out_bits_1_exceptionVec_2 = _RANDOM[6'hA][3];
        s0_out_bits_1_exceptionVec_3 = _RANDOM[6'hA][4];
        s0_out_bits_1_exceptionVec_4 = _RANDOM[6'hA][5];
        s0_out_bits_1_exceptionVec_5 = _RANDOM[6'hA][6];
        s0_out_bits_1_exceptionVec_6 = _RANDOM[6'hA][7];
        s0_out_bits_1_exceptionVec_7 = _RANDOM[6'hA][8];
        s0_out_bits_1_exceptionVec_8 = _RANDOM[6'hA][9];
        s0_out_bits_1_exceptionVec_9 = _RANDOM[6'hA][10];
        s0_out_bits_1_exceptionVec_10 = _RANDOM[6'hA][11];
        s0_out_bits_1_exceptionVec_11 = _RANDOM[6'hA][12];
        s0_out_bits_1_exceptionVec_12 = _RANDOM[6'hA][13];
        s0_out_bits_1_exceptionVec_13 = _RANDOM[6'hA][14];
        s0_out_bits_1_exceptionVec_14 = _RANDOM[6'hA][15];
        s0_out_bits_1_exceptionVec_15 = _RANDOM[6'hA][16];
        s0_out_bits_1_exceptionVec_16 = _RANDOM[6'hA][17];
        s0_out_bits_1_exceptionVec_17 = _RANDOM[6'hA][18];
        s0_out_bits_1_exceptionVec_18 = _RANDOM[6'hA][19];
        s0_out_bits_1_exceptionVec_19 = _RANDOM[6'hA][20];
        s0_out_bits_1_exceptionVec_20 = _RANDOM[6'hA][21];
        s0_out_bits_1_exceptionVec_21 = _RANDOM[6'hA][22];
        s0_out_bits_1_exceptionVec_22 = _RANDOM[6'hA][23];
        s0_out_bits_1_exceptionVec_23 = _RANDOM[6'hA][24];
        s0_out_bits_1_trigger = {_RANDOM[6'hA][31], _RANDOM[6'hB][2:0]};
        s0_out_bits_2_robIdx_flag = _RANDOM[6'hD][26];
        s0_out_bits_2_robIdx_value = {_RANDOM[6'hD][31:27], _RANDOM[6'hE][3:0]};
        s0_out_bits_2_hasException = _RANDOM[6'hE][16];
        s0_out_bits_2_exceptionVec_0 = _RANDOM[6'hE][18];
        s0_out_bits_2_exceptionVec_1 = _RANDOM[6'hE][19];
        s0_out_bits_2_exceptionVec_2 = _RANDOM[6'hE][20];
        s0_out_bits_2_exceptionVec_3 = _RANDOM[6'hE][21];
        s0_out_bits_2_exceptionVec_4 = _RANDOM[6'hE][22];
        s0_out_bits_2_exceptionVec_5 = _RANDOM[6'hE][23];
        s0_out_bits_2_exceptionVec_6 = _RANDOM[6'hE][24];
        s0_out_bits_2_exceptionVec_7 = _RANDOM[6'hE][25];
        s0_out_bits_2_exceptionVec_8 = _RANDOM[6'hE][26];
        s0_out_bits_2_exceptionVec_9 = _RANDOM[6'hE][27];
        s0_out_bits_2_exceptionVec_10 = _RANDOM[6'hE][28];
        s0_out_bits_2_exceptionVec_11 = _RANDOM[6'hE][29];
        s0_out_bits_2_exceptionVec_12 = _RANDOM[6'hE][30];
        s0_out_bits_2_exceptionVec_13 = _RANDOM[6'hE][31];
        s0_out_bits_2_exceptionVec_14 = _RANDOM[6'hF][0];
        s0_out_bits_2_exceptionVec_15 = _RANDOM[6'hF][1];
        s0_out_bits_2_exceptionVec_16 = _RANDOM[6'hF][2];
        s0_out_bits_2_exceptionVec_17 = _RANDOM[6'hF][3];
        s0_out_bits_2_exceptionVec_18 = _RANDOM[6'hF][4];
        s0_out_bits_2_exceptionVec_19 = _RANDOM[6'hF][5];
        s0_out_bits_2_exceptionVec_20 = _RANDOM[6'hF][6];
        s0_out_bits_2_exceptionVec_21 = _RANDOM[6'hF][7];
        s0_out_bits_2_exceptionVec_22 = _RANDOM[6'hF][8];
        s0_out_bits_2_exceptionVec_23 = _RANDOM[6'hF][9];
        s0_out_bits_2_trigger = _RANDOM[6'hF][19:16];
        s0_out_bits_3_robIdx_flag = _RANDOM[6'h12][11];
        s0_out_bits_3_robIdx_value = _RANDOM[6'h12][20:12];
        s0_out_bits_3_hasException = _RANDOM[6'h13][1];
        s0_out_bits_3_exceptionVec_2 = _RANDOM[6'h13][5];
        s0_out_bits_4_robIdx_flag = _RANDOM[6'h16][28];
        s0_out_bits_4_robIdx_value = {_RANDOM[6'h16][31:29], _RANDOM[6'h17][5:0]};
        s0_out_bits_4_hasException = _RANDOM[6'h17][18];
        s0_out_bits_4_exceptionVec_3 = _RANDOM[6'h17][23];
        s0_out_bits_4_exceptionVec_4 = _RANDOM[6'h17][24];
        s0_out_bits_4_exceptionVec_5 = _RANDOM[6'h17][25];
        s0_out_bits_4_exceptionVec_6 = _RANDOM[6'h17][26];
        s0_out_bits_4_exceptionVec_7 = _RANDOM[6'h17][27];
        s0_out_bits_4_exceptionVec_13 = _RANDOM[6'h18][1];
        s0_out_bits_4_exceptionVec_15 = _RANDOM[6'h18][3];
        s0_out_bits_4_exceptionVec_19 = _RANDOM[6'h18][7];
        s0_out_bits_4_exceptionVec_21 = _RANDOM[6'h18][9];
        s0_out_bits_4_exceptionVec_23 = _RANDOM[6'h18][11];
        s0_out_bits_4_trigger = _RANDOM[6'h18][21:18];
        s0_out_bits_4_vstartEn = _RANDOM[6'h18][22];
        s0_out_bits_4_vstart =
          {_RANDOM[6'h18][31:23], _RANDOM[6'h19], _RANDOM[6'h1A][22:0]};
        s0_out_bits_4_vuopIdx = _RANDOM[6'h1A][29:23];
        s0_out_bits_4_isVecLoad = _RANDOM[6'h1A][30];
        s0_out_bits_4_isVlm = _RANDOM[6'h1A][31];
        s0_out_bits_4_isStrided = _RANDOM[6'h1B][0];
        s0_out_bits_4_isIndexed = _RANDOM[6'h1B][1];
        s0_out_bits_4_isWhole = _RANDOM[6'h1B][2];
        s0_out_bits_4_nf = _RANDOM[6'h1B][5:3];
        s0_out_bits_4_vsew = _RANDOM[6'h1B][7:6];
        s0_out_bits_4_veew = _RANDOM[6'h1B][9:8];
        s0_out_bits_4_vlmul = _RANDOM[6'h1B][12:10];
        s1_out_bits_robIdx_flag = _RANDOM[6'h1B][13];
        s1_out_bits_robIdx_value = _RANDOM[6'h1B][22:14];
        s1_out_bits_hasException = _RANDOM[6'h1C][3];
        s1_out_bits_exceptionVec_0 = _RANDOM[6'h1C][5];
        s1_out_bits_exceptionVec_1 = _RANDOM[6'h1C][6];
        s1_out_bits_exceptionVec_2 = _RANDOM[6'h1C][7];
        s1_out_bits_exceptionVec_3 = _RANDOM[6'h1C][8];
        s1_out_bits_exceptionVec_4 = _RANDOM[6'h1C][9];
        s1_out_bits_exceptionVec_5 = _RANDOM[6'h1C][10];
        s1_out_bits_exceptionVec_6 = _RANDOM[6'h1C][11];
        s1_out_bits_exceptionVec_7 = _RANDOM[6'h1C][12];
        s1_out_bits_exceptionVec_8 = _RANDOM[6'h1C][13];
        s1_out_bits_exceptionVec_9 = _RANDOM[6'h1C][14];
        s1_out_bits_exceptionVec_10 = _RANDOM[6'h1C][15];
        s1_out_bits_exceptionVec_11 = _RANDOM[6'h1C][16];
        s1_out_bits_exceptionVec_12 = _RANDOM[6'h1C][17];
        s1_out_bits_exceptionVec_13 = _RANDOM[6'h1C][18];
        s1_out_bits_exceptionVec_14 = _RANDOM[6'h1C][19];
        s1_out_bits_exceptionVec_15 = _RANDOM[6'h1C][20];
        s1_out_bits_exceptionVec_16 = _RANDOM[6'h1C][21];
        s1_out_bits_exceptionVec_17 = _RANDOM[6'h1C][22];
        s1_out_bits_exceptionVec_18 = _RANDOM[6'h1C][23];
        s1_out_bits_exceptionVec_19 = _RANDOM[6'h1C][24];
        s1_out_bits_exceptionVec_20 = _RANDOM[6'h1C][25];
        s1_out_bits_exceptionVec_21 = _RANDOM[6'h1C][26];
        s1_out_bits_exceptionVec_22 = _RANDOM[6'h1C][27];
        s1_out_bits_exceptionVec_23 = _RANDOM[6'h1C][28];
        s1_out_bits_flushPipe = _RANDOM[6'h1C][30];
        s1_out_bits_trigger = _RANDOM[6'h1D][6:3];
        s1_out_bits_vstartEn = _RANDOM[6'h1D][7];
        s1_out_bits_vstart = {_RANDOM[6'h1D][31:8], _RANDOM[6'h1E], _RANDOM[6'h1F][7:0]};
        s1_out_bits_isVecLoad = _RANDOM[6'h1F][15];
        s1_out_bits_isVlm = _RANDOM[6'h1F][16];
        s1_out_bits_isStrided = _RANDOM[6'h1F][17];
        s1_out_bits_isIndexed = _RANDOM[6'h1F][18];
        s1_out_bits_isWhole = _RANDOM[6'h1F][19];
        s1_out_bits_nf = _RANDOM[6'h1F][22:20];
        s1_out_bits_vsew = _RANDOM[6'h1F][24:23];
        s1_out_bits_veew = _RANDOM[6'h1F][26:25];
        s1_out_bits_vlmul = _RANDOM[6'h1F][29:27];
        s1_out_valid = _RANDOM[6'h1F][30];
        enq_s1_valid = _RANDOM[6'h1F][31];
        enq_s1_bits_robIdx_flag = _RANDOM[6'h20][0];
        enq_s1_bits_robIdx_value = _RANDOM[6'h20][9:1];
        enq_s1_bits_ftqPtr_value = _RANDOM[6'h20][16:11];
        enq_s1_bits_ftqOffset = _RANDOM[6'h20][21:17];
        enq_s1_bits_hasException = _RANDOM[6'h20][22];
        enq_s1_bits_exceptionVec_0 = _RANDOM[6'h20][24];
        enq_s1_bits_exceptionVec_1 = _RANDOM[6'h20][25];
        enq_s1_bits_exceptionVec_2 = _RANDOM[6'h20][26];
        enq_s1_bits_exceptionVec_3 = _RANDOM[6'h20][27];
        enq_s1_bits_exceptionVec_12 = _RANDOM[6'h21][4];
        enq_s1_bits_exceptionVec_20 = _RANDOM[6'h21][12];
        enq_s1_bits_exceptionVec_22 = _RANDOM[6'h21][14];
        enq_s1_bits_isFetchMalAddr = _RANDOM[6'h21][16];
        enq_s1_bits_flushPipe = _RANDOM[6'h21][17];
        enq_s1_bits_isVset = _RANDOM[6'h21][18];
        enq_s1_bits_singleStep = _RANDOM[6'h21][20];
        enq_s1_bits_crossPageIPFFix = _RANDOM[6'h21][21];
        enq_s1_bits_trigger = _RANDOM[6'h21][25:22];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        currentValid = 1'h0;
    end // initial
