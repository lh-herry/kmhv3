...
module Debug(
  ...
  wire [3:0] _tselect1H_T_2 = 4'h1 << io_in_tselect_ALL;
  wire       newTriggerChainVec_1 = _tselect1H_T_2[1] | io_in_tdata1Vec_1_DATA[11];
  wire       newTriggerChainVec_2 = _tselect1H_T_2[2] | io_in_tdata1Vec_2_DATA[11];
  wire       triggerUpdate = io_in_tdata1Update | io_in_tdata2Update;
  wire       _memTriggerUpdate_T_1 = io_in_tdata1Wdata_TYPE == 4'h6;
  wire       frontendTriggerUpdate =
    io_in_tdata1Update & _memTriggerUpdate_T_1 & io_in_tdata1Wdata_DATA[2]
  ...
  always @(posedge clock) begin
    ...
    io_out_memTrigger_tUpdate_valid_REG <=
      io_in_tdata1Update & _memTriggerUpdate_T_1
  ...
  assign io_out_newTriggerChainIsLegal =
    ~((_tselect1H_T_2[0] | io_in_tdata1Vec_0_DATA[11]) & newTriggerChainVec_1
      | newTriggerChainVec_1 & newTriggerChainVec_2 | newTriggerChainVec_2
      & (_tselect1H_T_2[3] | io_in_tdata1Vec_3_DATA[11]));
