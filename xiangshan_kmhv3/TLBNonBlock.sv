  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[8'h34][9];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[8'h34][13];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[8'h34][22:14];
        readResult_p_hit_last_REG_1 = _RANDOM[8'h39][17];
        readResult_p_ppn_1 = {_RANDOM[8'h39][31:18], _RANDOM[8'h3A][21:0]};
        readResult_p_pbmt_1 = _RANDOM[8'h3A][23:22];
        readResult_p_perm_1_pf = _RANDOM[8'h3A][24];
        readResult_p_perm_1_af = _RANDOM[8'h3A][25];
        readResult_p_perm_1_v = _RANDOM[8'h3A][26];
        readResult_p_perm_1_a = _RANDOM[8'h3A][28];
        readResult_p_perm_1_u = _RANDOM[8'h3A][30];
        readResult_p_perm_1_x = _RANDOM[8'h3A][31];
        readResult_p_perm_1_w = _RANDOM[8'h3B][0];
        readResult_p_perm_1_r = _RANDOM[8'h3B][1];
        readResult_p_gvpn_1 = {_RANDOM[8'h3B][31:2], _RANDOM[8'h3C][13:0]};
        readResult_p_g_pbmt_1 = _RANDOM[8'h3C][15:14];
        readResult_p_g_perm_1_pf = _RANDOM[8'h3C][16];
        readResult_p_g_perm_1_af = _RANDOM[8'h3C][17];
        readResult_p_g_perm_1_a = _RANDOM[8'h3C][20];
        readResult_p_g_perm_1_x = _RANDOM[8'h3C][23];
        readResult_p_g_perm_1_r = _RANDOM[8'h3C][25];
        readResult_p_s2xlate_1 = _RANDOM[8'h3C][27:26];
        readResult_p_s1_level_1 = _RANDOM[8'h3C][29:28];
        readResult_p_s1_isLeaf_1 = _RANDOM[8'h3C][30];
        readResult_p_s1_isFakePte_1 = _RANDOM[8'h3C][31];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[8'h3D][0];
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[8'h40][23];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[8'h40][27];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[8'h40][31:28], _RANDOM[8'h41][4:0]};
        readResult_p_hit_last_REG_2 = _RANDOM[8'h45][31];
        readResult_p_ppn_2 = {_RANDOM[8'h46], _RANDOM[8'h47][3:0]};
        readResult_p_pbmt_2 = _RANDOM[8'h47][5:4];
        readResult_p_perm_2_pf = _RANDOM[8'h47][6];
        readResult_p_perm_2_af = _RANDOM[8'h47][7];
        readResult_p_perm_2_v = _RANDOM[8'h47][8];
        readResult_p_perm_2_a = _RANDOM[8'h47][10];
        readResult_p_perm_2_u = _RANDOM[8'h47][12];
        readResult_p_perm_2_x = _RANDOM[8'h47][13];
        readResult_p_perm_2_w = _RANDOM[8'h47][14];
        readResult_p_perm_2_r = _RANDOM[8'h47][15];
        readResult_p_gvpn_2 = {_RANDOM[8'h47][31:16], _RANDOM[8'h48][27:0]};
        readResult_p_g_pbmt_2 = _RANDOM[8'h48][29:28];
        readResult_p_g_perm_2_pf = _RANDOM[8'h48][30];
        readResult_p_g_perm_2_af = _RANDOM[8'h48][31];
        readResult_p_g_perm_2_a = _RANDOM[8'h49][2];
        readResult_p_g_perm_2_x = _RANDOM[8'h49][5];
        readResult_p_g_perm_2_r = _RANDOM[8'h49][7];
        readResult_p_s2xlate_2 = _RANDOM[8'h49][9:8];
        readResult_p_s1_level_2 = _RANDOM[8'h49][11:10];
        readResult_p_s1_isLeaf_2 = _RANDOM[8'h49][12];
        readResult_p_s1_isFakePte_2 = _RANDOM[8'h49][13];
        readResult_lastCycleRedirect_REG_2_valid = _RANDOM[8'h49][14];
        readResult_lastCycleRedirect_REG_2_bits_level = _RANDOM[8'h4D][5];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_flag = _RANDOM[8'h4D][9];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_value = _RANDOM[8'h4D][18:10];
        readResult_p_hit_last_REG_3 = _RANDOM[8'h52][13];
        readResult_p_ppn_3 = {_RANDOM[8'h52][31:14], _RANDOM[8'h53][17:0]};
        readResult_p_pbmt_3 = _RANDOM[8'h53][19:18];
        readResult_p_perm_3_pf = _RANDOM[8'h53][20];
        readResult_p_perm_3_af = _RANDOM[8'h53][21];
        readResult_p_perm_3_v = _RANDOM[8'h53][22];
        readResult_p_perm_3_d = _RANDOM[8'h53][23];
        readResult_p_perm_3_a = _RANDOM[8'h53][24];
        readResult_p_perm_3_u = _RANDOM[8'h53][26];
        readResult_p_perm_3_x = _RANDOM[8'h53][27];
        readResult_p_perm_3_w = _RANDOM[8'h53][28];
        readResult_p_perm_3_r = _RANDOM[8'h53][29];
        readResult_p_g_pbmt_3 = _RANDOM[8'h55][11:10];
        readResult_p_g_perm_3_pf = _RANDOM[8'h55][12];
        readResult_p_g_perm_3_af = _RANDOM[8'h55][13];
        readResult_p_g_perm_3_d = _RANDOM[8'h55][15];
        readResult_p_g_perm_3_a = _RANDOM[8'h55][16];
        readResult_p_g_perm_3_x = _RANDOM[8'h55][19];
        readResult_p_g_perm_3_w = _RANDOM[8'h55][20];
        readResult_p_g_perm_3_r = _RANDOM[8'h55][21];
        readResult_lastCycleRedirect_REG_3_valid = _RANDOM[8'h55][28];
        readResult_lastCycleRedirect_REG_3_bits_level = _RANDOM[8'h59][19];
        readResult_lastCycleRedirect_REG_3_bits_robIdx_flag = _RANDOM[8'h59][23];
        readResult_lastCycleRedirect_REG_3_bits_robIdx_value =
          {_RANDOM[8'h59][31:24], _RANDOM[8'h5A][0]};
        noTranslateReg = _RANDOM[8'h5E][27];
        REG = _RANDOM[8'h5E][28];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h5E][29];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[8'h5E][30];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h5E][31];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h5F][0];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h5F][1];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[8'h5F][2];
        REG_1 = _RANDOM[8'h5F][3];
        noTranslateReg_1 = _RANDOM[8'h5F][10];
        REG_2 = _RANDOM[8'h5F][11];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h5F][12];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h5F][14];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h5F][16];
        REG_3 = _RANDOM[8'h5F][18];
        noTranslateReg_2 = _RANDOM[8'h5F][25];
        REG_4 = _RANDOM[8'h5F][26];
        io_requestor_2_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h5F][27];
        io_requestor_2_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h5F][29];
        io_requestor_2_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h5F][31];
        REG_5 = _RANDOM[8'h60][1];
        noTranslateReg_3 = _RANDOM[8'h60][8];
        REG_6 = _RANDOM[8'h60][9];
        io_requestor_3_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h60][10];
        io_requestor_3_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h60][12];
        io_requestor_3_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h60][13];
        io_requestor_3_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h60][14];
        REG_7 = _RANDOM[8'h60][16];
        ptw_resp_bits_reg_s2xlate = _RANDOM[8'h60][24:23];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[8'h60][31:25], _RANDOM[8'h61][27:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[8'h61][31:28], _RANDOM[8'h62][11:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[8'h62][25:12];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[8'h62][26];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[8'h62][31];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[8'h63][5:4];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[8'h64][19:17];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[8'h65][12];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[8'h65][13];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[8'h65][14];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[8'h65][15];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[8'h65][16];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[8'h65][17];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[8'h65][18];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[8'h65][19];
        ptw_resp_bits_reg_s2_entry_tag =
          {_RANDOM[8'h65][31:30], _RANDOM[8'h66], _RANDOM[8'h67][3:0]};
        ptw_resp_bits_reg_s2_entry_vmid = {_RANDOM[8'h67][31:20], _RANDOM[8'h68][1:0]};
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[8'h68][2];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[8'h69][19:18];
        ptw_already_back_last_REG = _RANDOM[8'h6A][2];
        last_REG = _RANDOM[8'h6A][3];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[8'h6A][5:4];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[8'h6A][31:6], _RANDOM[8'h6B][8:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = _RANDOM[8'h6B][24:9];
        ptw_resp_bits_reg_1_s1_entry_vmid = {_RANDOM[8'h6B][31:25], _RANDOM[8'h6C][6:0]};
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[8'h6C][7];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[8'h6C][12];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[8'h6C][18:17];
        ptw_resp_bits_reg_1_s1_addr_low = {_RANDOM[8'h6D][31:30], _RANDOM[8'h6E][0]};
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[8'h6E][25];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[8'h6E][26];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[8'h6E][27];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[8'h6E][28];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[8'h6E][29];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[8'h6E][30];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[8'h6E][31];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[8'h6F][0];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[8'h6F][31:11], _RANDOM[8'h70][16:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = _RANDOM[8'h71][14:1];
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[8'h71][15];
        ptw_resp_bits_reg_1_s2_entry_level = {_RANDOM[8'h72][31], _RANDOM[8'h73][0]};
        ptw_already_back_last_REG_1 = _RANDOM[8'h73][15];
        last_REG_1 = _RANDOM[8'h73][16];
        ptw_resp_bits_reg_2_s2xlate = _RANDOM[8'h73][18:17];
        ptw_resp_bits_reg_2_s1_entry_tag = {_RANDOM[8'h73][31:19], _RANDOM[8'h74][21:0]};
        ptw_resp_bits_reg_2_s1_entry_asid = {_RANDOM[8'h74][31:22], _RANDOM[8'h75][5:0]};
        ptw_resp_bits_reg_2_s1_entry_vmid = _RANDOM[8'h75][19:6];
        ptw_resp_bits_reg_2_s1_entry_n = _RANDOM[8'h75][20];
        ptw_resp_bits_reg_2_s1_entry_perm_g = _RANDOM[8'h75][25];
        ptw_resp_bits_reg_2_s1_entry_level = _RANDOM[8'h75][31:30];
        ptw_resp_bits_reg_2_s1_addr_low = _RANDOM[8'h77][13:11];
        ptw_resp_bits_reg_2_s1_valididx_0 = _RANDOM[8'h78][6];
        ptw_resp_bits_reg_2_s1_valididx_1 = _RANDOM[8'h78][7];
        ptw_resp_bits_reg_2_s1_valididx_2 = _RANDOM[8'h78][8];
        ptw_resp_bits_reg_2_s1_valididx_3 = _RANDOM[8'h78][9];
        ptw_resp_bits_reg_2_s1_valididx_4 = _RANDOM[8'h78][10];
        ptw_resp_bits_reg_2_s1_valididx_5 = _RANDOM[8'h78][11];
        ptw_resp_bits_reg_2_s1_valididx_6 = _RANDOM[8'h78][12];
        ptw_resp_bits_reg_2_s1_valididx_7 = _RANDOM[8'h78][13];
        ptw_resp_bits_reg_2_s2_entry_tag = {_RANDOM[8'h78][31:24], _RANDOM[8'h79][29:0]};
        ptw_resp_bits_reg_2_s2_entry_vmid = _RANDOM[8'h7A][27:14];
        ptw_resp_bits_reg_2_s2_entry_n = _RANDOM[8'h7A][28];
        ptw_resp_bits_reg_2_s2_entry_level = _RANDOM[8'h7C][13:12];
        ptw_already_back_last_REG_2 = _RANDOM[8'h7C][28];
        last_REG_2 = _RANDOM[8'h7C][29];
        ptw_resp_bits_reg_3_s2xlate = _RANDOM[8'h7C][31:30];
        ptw_resp_bits_reg_3_s1_entry_tag = {_RANDOM[8'h7D], _RANDOM[8'h7E][2:0]};
        ptw_resp_bits_reg_3_s1_entry_asid = _RANDOM[8'h7E][18:3];
        ptw_resp_bits_reg_3_s1_entry_vmid = {_RANDOM[8'h7E][31:19], _RANDOM[8'h7F][0]};
        ptw_resp_bits_reg_3_s1_entry_n = _RANDOM[8'h7F][1];
        ptw_resp_bits_reg_3_s1_entry_perm_g = _RANDOM[8'h7F][6];
        ptw_resp_bits_reg_3_s1_entry_level = _RANDOM[8'h7F][12:11];
        ptw_resp_bits_reg_3_s1_addr_low = _RANDOM[8'h80][26:24];
        ptw_resp_bits_reg_3_s1_valididx_0 = _RANDOM[8'h81][19];
        ptw_resp_bits_reg_3_s1_valididx_1 = _RANDOM[8'h81][20];
        ptw_resp_bits_reg_3_s1_valididx_2 = _RANDOM[8'h81][21];
        ptw_resp_bits_reg_3_s1_valididx_3 = _RANDOM[8'h81][22];
        ptw_resp_bits_reg_3_s1_valididx_4 = _RANDOM[8'h81][23];
        ptw_resp_bits_reg_3_s1_valididx_5 = _RANDOM[8'h81][24];
        ptw_resp_bits_reg_3_s1_valididx_6 = _RANDOM[8'h81][25];
        ptw_resp_bits_reg_3_s1_valididx_7 = _RANDOM[8'h81][26];
        ptw_resp_bits_reg_3_s2_entry_tag = {_RANDOM[8'h82][31:5], _RANDOM[8'h83][10:0]};
        ptw_resp_bits_reg_3_s2_entry_vmid = {_RANDOM[8'h83][31:27], _RANDOM[8'h84][8:0]};
        ptw_resp_bits_reg_3_s2_entry_n = _RANDOM[8'h84][9];
        ptw_resp_bits_reg_3_s2_entry_level = _RANDOM[8'h85][26:25];
        ptw_already_back_last_REG_3 = _RANDOM[8'h86][9];
        result_ok_last_REG = _RANDOM[8'h86][11];
        result_ok_last_REG_1 = _RANDOM[8'h86][12];
        result_ok_last_REG_2 = _RANDOM[8'h86][13];
        result_ok_last_REG_3 = _RANDOM[8'h86][14];
        io_perf_0_value_REG = _RANDOM[8'h86][17:15];
        io_perf_0_value_REG_1 = _RANDOM[8'h86][20:18];
        io_perf_1_value_REG = _RANDOM[8'h86][23:21];
        io_perf_1_value_REG_1 = _RANDOM[8'h86][26:24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
