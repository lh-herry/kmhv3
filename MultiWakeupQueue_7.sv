...
module MultiWakeupQueue_7(
  ...
  wire [1:0] _io_enqAppend_ready_T = {allValidVec_1, allValidVec_0};
  wire       allValidVec_2 = io_enqAppend_valid & _io_enqAppend_ready_T == 2'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_fpWen = _RANDOM[4'hA][10];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hB][7:6];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hB][9:8];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hB][11:10];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_enqAppend_ready = ~io_enqAppend_valid | _io_enqAppend_ready_T == 2'h0;
