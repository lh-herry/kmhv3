...
module FarPathF16Pipeline(
  ...
  wire [1:0]  _NX_T = EOP_reg ? 2'(~_lgs_normal_reg_T_5 + 2'h1) : _lgs_normal_reg_T_5;
  reg         far_sign_result_reg;
  wire        _far_case_overflow_round_up_T_13 = RDN_reg & far_sign_result_reg;
  wire        far_case_normal_round_up =
    EOP_reg & ~(_NX_T[1]) & ~(_NX_T[0]) | RNE_reg & _NX_T[1]
    & (_U_FS0_io_result[0] | _NX_T[0]) | _far_case_overflow_round_up_T_13 & (|_NX_T)
    | RUP_reg & ~far_sign_result_reg & (|_NX_T) | RMM_reg & _NX_T[1];
  reg         grs_overflow_r;
  ...
  wire        _far_case_overflow_round_up_T_22 = grs_overflow[1] | grs_overflow[0];
  wire        far_case_overflow_round_up =
    EOP_reg & ~(grs_overflow[2]) & ~_far_case_overflow_round_up_T_22 | RNE_reg
    & grs_overflow[2] & (_U_FS0_io_result[1] | _far_case_overflow_round_up_T_22)
    | _far_case_overflow_round_up_T_13
    & (grs_overflow[2] | _far_case_overflow_round_up_T_22) | RUP_reg
    & ~far_sign_result_reg & (grs_overflow[2] | _far_case_overflow_round_up_T_22)
    | RMM_reg & grs_overflow[2];
  ...
  assign NX =
    (_U_FS0_io_result[11]
       ? (|{grs_overflow[2], _far_case_overflow_round_up_T_22})
       : (|_NX_T)) | OF;
