...
module FloatDividerR64(
  ...
  wire         _io_outValidAhead3Cycle_T_1 = early_finish | ~(|opb_frac_f64_0);
  reg  [3:0]   iter_num_q;
  ...
  wire         io_outValidAhead3Cycle_0 =
    ...
    & (res_is_denormal_f64_0 ? iter_num_q == 4'h1 : iter_num_q == 4'h2) | fsm_q[2]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      wakeupSuccessReg <= io_flush_i | io_wakeupSuccess;
    end
  ...
  wire         _GEN_9 = _scale_adder_opb_in_f64_0_2_T | _scale_adder_opb_in_f64_0_2_T_1;
  ...
  wire [51:0]  _GEN_10 = {52{_u_r64_block_vector_io_nxt_quo_dig_o_0_0[0]}};
  wire [51:0]  _GEN_11 = {52{_u_r64_block_vector_io_nxt_quo_dig_o_0_0[1]}};
  wire [51:0]  _GEN_12 = {nxt_quo_iter_f64_0_0[49:0], 2'h1};
  wire [51:0]  _GEN_13 = {52{_u_r64_block_vector_io_nxt_quo_dig_o_0_0[2]}};
  wire [51:0]  _GEN_14 = {nxt_quo_iter_f64_0_0[49:0], 2'h0};
  wire [51:0]  _GEN_15 = {52{_u_r64_block_vector_io_nxt_quo_dig_o_0_0[3]}};
  wire [51:0]  _GEN_16 = {nxt_quo_m1_iter_f64_0_0[49:0], 2'h3};
  wire [51:0]  _GEN_17 = {52{_u_r64_block_vector_io_nxt_quo_dig_o_0_0[4]}};
  wire [51:0]  _GEN_18 = {nxt_quo_m1_iter_f64_0_0[49:0], 2'h2};
  wire [51:0]  nxt_quo_iter_f64_0_1 =
    _GEN_10 & {nxt_quo_iter_f64_0_0[49:0], 2'h2} | _GEN_11 & _GEN_12 | _GEN_13 & _GEN_14
    | _GEN_15 & _GEN_16 | _GEN_17 & _GEN_18;
  wire [51:0]  nxt_quo_m1_iter_f64_0_1 =
    _GEN_10 & _GEN_12 | _GEN_11 & _GEN_14 | _GEN_13 & _GEN_16 | _GEN_15 & _GEN_18
    | _GEN_17 & {nxt_quo_m1_iter_f64_0_0[49:0], 2'h1};
  wire [53:0]  _GEN_19 = {54{_u_r64_block_vector_io_nxt_quo_dig_o_0_1[0]}};
  wire [53:0]  _GEN_20 = {54{_u_r64_block_vector_io_nxt_quo_dig_o_0_1[1]}};
  wire [53:0]  _GEN_21 = {nxt_quo_iter_f64_0_1, 2'h1};
  wire [53:0]  _GEN_22 = {54{_u_r64_block_vector_io_nxt_quo_dig_o_0_1[2]}};
  wire [53:0]  _GEN_23 = {nxt_quo_iter_f64_0_1, 2'h0};
  wire [53:0]  _GEN_24 = {54{_u_r64_block_vector_io_nxt_quo_dig_o_0_1[3]}};
  wire [53:0]  _GEN_25 = {nxt_quo_m1_iter_f64_0_1, 2'h3};
  wire [53:0]  _GEN_26 = {54{_u_r64_block_vector_io_nxt_quo_dig_o_0_1[4]}};
  wire [53:0]  _GEN_27 = {nxt_quo_m1_iter_f64_0_1, 2'h2};
  ...
  wire [56:0]  _scale_adder_opb_f64_0_T_2 =
    57'({2'h1, _prescaled_b_frac_f64_0_T_2, 3'h0}
        + 57'(((_scale_adder_opb_in_f64_0_2_T ? _scale_adder_opb_in_f64_0_2_T_9 : 57'h0)
               | (_scale_adder_opb_in_f64_0_2_T_1
  ...
  always @(posedge clock) begin
    ...
    if (start_handshaked & _io_outValidAhead3Cycle_T_1 | io_outValidAhead3Cycle_0)
      outValidBlock <= 2'h2;
    ...
    if ((start_handshaked | fsm_q[1] | fsm_q[2] | fsm_q[3])
      ...
      quo_iter_q_f64_0 <=
        ...
        & (_GEN_19 & {nxt_quo_iter_f64_0_1, 2'h2} | _GEN_20 & _GEN_21 | _GEN_22 & _GEN_23
    ...
    if (start_handshaked | fsm_q[1] | fsm_q[3] | fsm_q[4] & res_is_denormal_f64_0)
      quo_m1_iter_q_f64_0 <=
        ...
        & (_GEN_19 & _GEN_21 | _GEN_20 & _GEN_23 | _GEN_22 & _GEN_25 | _GEN_24 & _GEN_27
           | _GEN_26 & {nxt_quo_m1_iter_f64_0_1, 2'h1}) | {54{fsm_q[4]}}
        & (res_is_denormal_f64_0
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        wakeupSuccessReg = _RANDOM[4'h0][7];
        outValidBlock = _RANDOM[4'h0][9:8];
        iter_num_q = _RANDOM[4'h0][13:10];
        fp_format_onehot_q = _RANDOM[4'h0][16:14];
        rm_q = _RANDOM[4'h0][19:17];
        out_sign_q = _RANDOM[4'h0][20];
        res_is_nan_q = _RANDOM[4'h0][21];
        res_is_inf_q = _RANDOM[4'h0][22];
        res_is_exact_zero_q = _RANDOM[4'h0][23];
        op_invalid_div_q = _RANDOM[4'h0][24];
        divided_by_zero_q = _RANDOM[4'h0][25];
        out_exp_diff_q_f64_0 = {_RANDOM[4'h0][31:26], _RANDOM[4'h1][6:0]};
        quo_iter_q_f64_0 = {_RANDOM[4'h1][31:7], _RANDOM[4'h2][28:0]};
        quo_m1_iter_q_f64_0 = {_RANDOM[4'h2][31:29], _RANDOM[4'h3], _RANDOM[4'h4][18:0]};
        frac_divisor_q_60bit = {_RANDOM[4'h4][31:19], _RANDOM[4'h5], _RANDOM[4'h6][14:0]};
        nr_f_r_6b_for_nxt_cycle_s0_qds_q_f64_0 = _RANDOM[4'h6][20:15];
        nr_f_r_7b_for_nxt_cycle_s1_qds_q_f64_0 = _RANDOM[4'h6][27:21];
        f_r_s_q_72bit =
          {_RANDOM[4'h6][31:28], _RANDOM[4'h7], _RANDOM[4'h8], _RANDOM[4'h9][3:0]};
        f_r_c_q_72bit = {_RANDOM[4'h9][31:4], _RANDOM[4'hA], _RANDOM[4'hB][11:0]};
        prev_quo_dig_q_f64_0 = _RANDOM[4'hF][8:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fsm_q = 6'h1;
        wakeupSuccessReg = 1'h1;
  ...
  assign io_finish_valid_o =
    outValidBlock == 2'h0 & (fsm_q[5] | fsm_q[4] & ~res_is_denormal_f64_0);
