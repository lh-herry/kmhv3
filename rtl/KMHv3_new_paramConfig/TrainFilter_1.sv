  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h26][4];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h26][13:5];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h3C][31:8], _RANDOM[10'h3D][25:0]};
        ld_in_reordered_res_0_1_0_bits_miss = _RANDOM[10'h47][29];
        ld_in_reordered_res_0_1_0_bits_meta_prefetch = _RANDOM[10'h52][24:22];
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h53][11];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h66][7];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value = _RANDOM[10'h66][16:8];
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h7C][31:11], _RANDOM[10'h7D][28:0]};
        ld_in_reordered_res_0_1_1_bits_miss = _RANDOM[10'h88][0];
        ld_in_reordered_res_0_1_1_bits_meta_prefetch = _RANDOM[10'h92][27:25];
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h93][14];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hA6][10];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hA6][19:11];
        ld_in_reordered_res_0_1_2_bits_vaddr = {_RANDOM[10'hBC][31:14], _RANDOM[10'hBD]};
        ld_in_reordered_res_0_1_2_bits_miss = _RANDOM[10'hC8][3];
        ld_in_reordered_res_0_1_2_bits_meta_prefetch = _RANDOM[10'hD2][30:28];
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hD3][17];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hE6][13];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hE6][22:14];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'hFC][31:17], _RANDOM[10'hFD], _RANDOM[10'hFE][2:0]};
        ld_in_reordered_res_1_2_0_bits_miss = _RANDOM[10'h108][6];
        ld_in_reordered_res_1_2_0_bits_meta_prefetch =
          {_RANDOM[10'h112][31], _RANDOM[10'h113][1:0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h113][20];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h126][16];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h126][25:17];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h13C][31:20], _RANDOM[10'h13D], _RANDOM[10'h13E][5:0]};
        ld_in_reordered_res_1_2_1_bits_miss = _RANDOM[10'h148][9];
        ld_in_reordered_res_1_2_1_bits_meta_prefetch = _RANDOM[10'h153][4:2];
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h153][23];
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h17C][31:23], _RANDOM[10'h17D], _RANDOM[10'h17E][8:0]};
        ld_in_reordered_res_1_2_2_bits_miss = _RANDOM[10'h188][12];
        ld_in_reordered_res_1_2_2_bits_meta_prefetch = _RANDOM[10'h193][7:5];
        ld_in_reordered_0_valid = _RANDOM[10'h193][26];
        ld_in_reordered_0_bits_vaddr =
          {_RANDOM[10'h1BC][31:26], _RANDOM[10'h1BD], _RANDOM[10'h1BE][11:0]};
        ld_in_reordered_0_bits_miss = _RANDOM[10'h1C8][15];
        ld_in_reordered_0_bits_meta_prefetch = _RANDOM[10'h1D3][10:8];
        ld_in_reordered_1_valid = _RANDOM[10'h1D3][29];
        ld_in_reordered_1_bits_vaddr =
          {_RANDOM[10'h1FC][31:29], _RANDOM[10'h1FD], _RANDOM[10'h1FE][14:0]};
        ld_in_reordered_1_bits_miss = _RANDOM[10'h208][18];
        ld_in_reordered_1_bits_meta_prefetch = _RANDOM[10'h213][13:11];
        ld_in_reordered_2_valid = _RANDOM[10'h214][0];
        ld_in_reordered_2_bits_vaddr = {_RANDOM[10'h23D], _RANDOM[10'h23E][17:0]};
        ld_in_reordered_2_bits_miss = _RANDOM[10'h248][21];
        ld_in_reordered_2_bits_meta_prefetch = _RANDOM[10'h253][16:14];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
