...
module IMSIC(
  ...
  wire [7:0]   _toCSR_topeis_2_T_2 = 8'h1 << 3'(fromCSR_vgein[2:0] - 3'h1);
  wire [8:0]   _toCSR_topeis_2_T_16 =
    (_toCSR_topeis_2_T_2[0] ? _intFile_2_toCSR_topei : 9'h0)
    | (_toCSR_topeis_2_T_2[1] ? _intFile_3_toCSR_topei : 9'h0)
    ...
    | (_toCSR_topeis_2_T_2[6] ? _intFile_8_toCSR_topei : 9'h0);
        ...
        {7'h0,
         {1'h0,
          {1'h0,
           ...
           | {_intFile_8_toCSR_pending, 8'h0}};
      toCSR_topeis_0_REG <= {7'h0, _intFile_toCSR_topei, 7'h0, _intFile_toCSR_topei};
      toCSR_topeis_1_REG <= {7'h0, _intFile_1_toCSR_topei, 7'h0, _intFile_1_toCSR_topei};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        toCSR_pendings_REG = {_RANDOM[5'h12][31:18], _RANDOM[5'h13][1:0]};
        toCSR_topeis_0_REG = {_RANDOM[5'h13][31:2], _RANDOM[5'h14][1:0]};
        toCSR_topeis_1_REG = {_RANDOM[5'h14][31:2], _RANDOM[5'h15][1:0]};
        toCSR_topeis_2_REG = {_RANDOM[5'h15][31:2], _RANDOM[5'h16][1:0]};
        toCSR_illegal_d = _RANDOM[5'h16][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        msi_valid_delayed = 1'h0;
        msi_valid_delayed_1 = 1'h0;
  ...
  assign toCSR_pendings = toCSR_pendings_REG[8:0];
  assign toCSR_topeis_0 = toCSR_topeis_0_REG;
  assign toCSR_topeis_1 = toCSR_topeis_1_REG;
  assign toCSR_topeis_2 = toCSR_topeis_2_REG;
endmodule
