  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdxReg_flag = _RANDOM[1'h0][0];
        robIdxReg_value = _RANDOM[1'h0][9:1];
        ctrlReg_isW = _RANDOM[1'h0][11];
        ctrlReg_isHi = _RANDOM[1'h0][12];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[1'h0][13];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[1'h0][14];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[1'h0][23:15];
        io_out_bits_ctrl_pdest_r = {_RANDOM[1'h0][31:24], _RANDOM[1'h1][0]};
        io_out_bits_ctrl_rfWen_r = _RANDOM[1'h1][1];
      `endif // RANDOMIZE_REG_INIT
    end // initial
