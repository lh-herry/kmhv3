...
module FreeList(
  ...
  wire             _remFreeSelIndexOHVec_highIndexOH_T =
    freeMask[0] & _remFreeSelMaskVec_T_11[0];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_1 =
    freeMask[2] & _remFreeSelMaskVec_T_11[2];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_2 =
    freeMask[4] & _remFreeSelMaskVec_T_11[4];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_3 =
    freeMask[6] & _remFreeSelMaskVec_T_11[6];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_4 =
    freeMask[8] & _remFreeSelMaskVec_T_11[8];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_5 =
    freeMask[10] & _remFreeSelMaskVec_T_11[10];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_6 =
    freeMask[12] & _remFreeSelMaskVec_T_11[12];
  wire             _remFreeSelIndexOHVec_highIndexOH_T_7 =
    freeMask[14] & _remFreeSelMaskVec_T_11[14];
