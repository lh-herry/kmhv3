...
module VLSplitPipelineImp(
  ...
  reg  [4:0]    s1_in_r_uop_ftqPtr_value;
  ...
  reg  [6:0]    s1_in_r_uop_sqIdx_value;
  reg           s1_in_r_fof;
  ...
  always @(posedge clock) begin
    if (s0_fire) begin
      ...
      s1_in_r_uop_pdest <= {2'h0, io_in_bits_pdest};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_ftqPtr_flag = _RANDOM[6'h13][6];
        s1_in_r_uop_ftqPtr_value = _RANDOM[6'h13][11:7];
        s1_in_r_uop_ftqOffset = _RANDOM[6'h13][16:12];
        s1_in_r_uop_fuOpType = _RANDOM[6'h15][25:17];
        s1_in_r_uop_vecWen = _RANDOM[6'h15][28];
        s1_in_r_uop_v0Wen = _RANDOM[6'h15][29];
        s1_in_r_uop_vlWen = _RANDOM[6'h15][30];
        ...
        s1_in_r_uop_uopIdx = _RANDOM[6'h1E][17:11];
        s1_in_r_uop_pdest = _RANDOM[6'h21][13:5];
        s1_in_r_uop_robIdx_flag = _RANDOM[6'h22][3];
        s1_in_r_uop_robIdx_value = _RANDOM[6'h22][12:4];
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h37][16];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h37][23:17];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h37][24];
        s1_in_r_uop_sqIdx_value = _RANDOM[6'h37][31:25];
        s1_in_r_fof = _RANDOM[6'h38][7];
        s1_in_r_vdIdxInField = _RANDOM[6'h38][10:8];
        s1_in_r_preIsSplit = _RANDOM[6'h3C][11];
        s1_in_r_alignedType = _RANDOM[6'h3C][18:16];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3C][26:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
