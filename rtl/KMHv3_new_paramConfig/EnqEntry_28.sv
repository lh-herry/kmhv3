  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_pdest = _RANDOM[4'h6][11:3];
        enqDelayValidReg_last_REG = _RANDOM[4'h6][30];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType =
          {_RANDOM[4'h6][31], _RANDOM[4'h7][7:0]};
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_wflags = _RANDOM[4'h7][8];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_fmt = _RANDOM[4'h7][10:9];
        io_commonOut_entry_bits_payload_og1Payload_REG_fpu_rm = _RANDOM[4'h7][13:11];
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[4'h7][22:15];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG = _RANDOM[4'h7][30:23];
        io_commonOut_entry_bits_status_srcStatus_2_psrc_REG =
          {_RANDOM[4'h7][31], _RANDOM[4'h8][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
