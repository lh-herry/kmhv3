...
module MultiWakeupQueue_3(
  ...
  input  [8:0] io_enq_bits_uop_pdest,
  ...
  input  [8:0] io_enqAppend_bits_uop_pdest,
  input        io_enqAppend_bits_uop_rfWen,
  output       io_deq_valid,
  output       io_deq_bits_is0Lat,
  output [8:0] io_deq_bits_pdestCopy_0,
  output [8:0] io_deq_bits_pdestCopy_1,
  output [8:0] io_deq_bits_pdestCopy_2,
  output [8:0] io_deq_bits_pdestCopy_3,
  output [8:0] io_deq_bits_pdestCopy_4,
  output [8:0] io_deq_bits_pdestCopy_5,
  output [8:0] io_deq_bits_pdestCopy_6,
  ...
  wire [8:0] _pipes_0_io_deq_bits_pdest;
  ...
  reg  [8:0] lastConnect_bits_pdestCopy_0;
  reg  [8:0] lastConnect_bits_pdestCopy_1;
  reg  [8:0] lastConnect_bits_pdestCopy_2;
  reg  [8:0] lastConnect_bits_pdestCopy_3;
  reg  [8:0] lastConnect_bits_pdestCopy_4;
  reg  [8:0] lastConnect_bits_pdestCopy_5;
  reg  [8:0] lastConnect_bits_pdestCopy_6;
  ...
  reg  [8:0] lastConnect_bits_pdest;
  ...
  wire       allValidVec_1 =
    ...
    & ~(io_flush_redirect_valid
        ...
        | io_flush_og1Fail);
  wire       allValidVec_2 =
    io_enqAppend_valid & {allValidVec_1, _pipes_0_io_deq_valid} == 2'h0;
  ...
  wire [8:0] pipesOut_bits_pdest =
    (_pipes_0_io_deq_valid ? _pipes_0_io_deq_bits_pdest : 9'h0)
    | (allValidVec_1 ? _pipes_1_io_deq_bits_pdest : 9'h0)
    | (allValidVec_2 ? io_enqAppend_bits_uop_pdest : 9'h0);
  wire       pipesOut_bits_rfWen =
    _pipes_0_io_deq_valid & _pipes_0_io_deq_bits_rfWen | allValidVec_1
    & _pipes_1_io_deq_bits_rfWen | allValidVec_2 & io_enqAppend_bits_uop_rfWen;
  always @(posedge clock) begin
    lastConnect_valid <= |{allValidVec_2, allValidVec_1, _pipes_0_io_deq_valid};
    lastConnect_bits_is0Lat <=
      _pipes_0_io_deq_valid & _pipes_0_io_deq_bits_is0Lat | allValidVec_1
      & _pipes_1_io_deq_bits_is0Lat;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdestCopy_0 = _RANDOM[4'h8][11:3];
        lastConnect_bits_pdestCopy_1 = _RANDOM[4'h8][20:12];
        lastConnect_bits_pdestCopy_2 = _RANDOM[4'h8][29:21];
        lastConnect_bits_pdestCopy_3 = {_RANDOM[4'h8][31:30], _RANDOM[4'h9][6:0]};
        lastConnect_bits_pdestCopy_4 = _RANDOM[4'h9][15:7];
        lastConnect_bits_pdestCopy_5 = _RANDOM[4'h9][24:16];
        lastConnect_bits_pdestCopy_6 = {_RANDOM[4'h9][31:25], _RANDOM[4'hA][1:0]};
        lastConnect_bits_rfWenCopy_0 = _RANDOM[4'hA][2];
        lastConnect_bits_rfWenCopy_1 = _RANDOM[4'hA][3];
        lastConnect_bits_rfWenCopy_2 = _RANDOM[4'hA][4];
        lastConnect_bits_rfWenCopy_3 = _RANDOM[4'hA][5];
        lastConnect_bits_rfWenCopy_4 = _RANDOM[4'hA][6];
        lastConnect_bits_rfWenCopy_5 = _RANDOM[4'hA][7];
        lastConnect_bits_rfWenCopy_6 = _RANDOM[4'hA][8];
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'hA][10:9];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'hA][12:11];
        lastConnect_bits_loadDependencyCopy_0_2 = _RANDOM[4'hA][14:13];
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'hA][16:15];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'hA][18:17];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'hA][20:19];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'hA][22:21];
        lastConnect_bits_loadDependencyCopy_2_1 = _RANDOM[4'hA][24:23];
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'hA][26:25];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'hA][28:27];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'hA][30:29];
        lastConnect_bits_loadDependencyCopy_3_2 = {_RANDOM[4'hA][31], _RANDOM[4'hB][0]};
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'hB][2:1];
        lastConnect_bits_loadDependencyCopy_4_1 = _RANDOM[4'hB][4:3];
        lastConnect_bits_loadDependencyCopy_4_2 = _RANDOM[4'hB][6:5];
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'hB][8:7];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'hB][10:9];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'hB][12:11];
        lastConnect_bits_loadDependencyCopy_6_0 = _RANDOM[4'hB][14:13];
        lastConnect_bits_loadDependencyCopy_6_1 = _RANDOM[4'hB][16:15];
        lastConnect_bits_loadDependencyCopy_6_2 = _RANDOM[4'hB][18:17];
        lastConnect_bits_pdest = _RANDOM[4'hB][27:19];
        lastConnect_bits_rfWen = _RANDOM[4'hB][28];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hC][14:13];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hC][16:15];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hC][18:17];
      `endif // RANDOMIZE_REG_INIT
    end // initial
