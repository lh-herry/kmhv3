  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_pdest = _RANDOM[5'h8][12:4];
        bits_1_rfWen = _RANDOM[5'h8][13];
        bits_1_loadDependency_0 = _RANDOM[5'h8][31:30];
        bits_1_loadDependency_1 = _RANDOM[5'h9][1:0];
        bits_1_loadDependency_2 = _RANDOM[5'h9][3:2];
        bits_2_is0Lat = _RANDOM[5'hE][17];
        bits_2_robIdx_flag = _RANDOM[5'h10][22];
        bits_2_robIdx_value = _RANDOM[5'h10][31:23];
        bits_2_pdest = _RANDOM[5'h11][14:6];
        bits_2_rfWen = _RANDOM[5'h11][15];
        bits_2_loadDependency_0 = _RANDOM[5'h12][1:0];
        bits_2_loadDependency_1 = _RANDOM[5'h12][3:2];
        bits_2_loadDependency_2 = _RANDOM[5'h12][5:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
