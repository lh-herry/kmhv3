...
module IssueQueueFaluFmacFdiv(
  ...
  wire [35:0] deqBeforeDly_0_bits_fuType =
    {21'h0,
     ...
     11'h0};
  assign deqBeforeDly_0_bits_pdest = _entries_io_deqEntry_0_bits_payload_pdest[7:0];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_fpWen = _RANDOM[2'h2][15];
        deqDelay_0_bits_pdest = _RANDOM[2'h2][23:16];
        deqDelay_0_bits_dataSources_0_value = _RANDOM[2'h2][27:24];
        deqDelay_0_bits_dataSources_1_value = _RANDOM[2'h2][31:28];
        deqDelay_0_bits_dataSources_2_value = _RANDOM[2'h3][3:0];
        deqDelay_0_bits_exuSources_0_value = _RANDOM[2'h3][6:4];
        deqDelay_0_bits_exuSources_1_value = _RANDOM[2'h3][9:7];
        deqDelay_0_bits_exuSources_2_value = _RANDOM[2'h3][12:10];
        deqDelay_0_bits_loadDependency_0 = _RANDOM[2'h3][14:13];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[2'h3][16:15];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[2'h3][18:17];
  ...
  MultiWakeupQueue_7 wakeUpQueues_0 (
    ...
    .io_enq_valid
      (finalResp0 & ~_entries_io_deqEntry_0_bits_status_fuType_14),
    .io_enq_bits_uop_robIdx_flag
      (finalResp0 & _entries_io_deqEntry_0_bits_status_robIdx_flag),
    .io_enq_bits_uop_robIdx_value
      (finalResp0 ? _entries_io_deqEntry_0_bits_status_robIdx_value : 9'h0),
    ...
    .io_enq_bits_uop_loadDependency_0    (finalResp0 ? finalLoadDependency_0_0 : 2'h0),
    .io_enq_bits_uop_loadDependency_1    (finalResp0 ? finalLoadDependency_0_1 : 2'h0),
    .io_enq_bits_uop_loadDependency_2    (finalResp0 ? finalLoadDependency_0_2 : 2'h0),
    .io_enq_bits_lat
      ({1'h0,
        finalResp0
          ? (_entries_io_deqEntry_0_bits_status_fuType_14
