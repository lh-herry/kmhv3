...
module MbistPipeICacheData_bank6(
  input         clock,
  input         reset,
  ...
  wire        activated =
    mbist_all | mbist_req
    & (mbist_array == 5'h1C | mbist_array == 5'h1D | mbist_array == 5'h1E
       | (&mbist_array));
