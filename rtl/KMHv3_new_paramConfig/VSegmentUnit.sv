...
module VSegmentUnit(
  ...
  output [6:0]   io_feedback_bits_sqIdx_value,
  ...
  wire              _GEN_3 = exception_pa | exception_va | exception_gpa;
  wire              _GEN_4 = isMisalignReg & ~notCross16ByteReg;
  wire              _GEN_5 = _GEN_4 & ~curPtr;
  wire              _GEN_6 = state == 4'h8;
  wire              _GEN_7 = segmentIdx == _maxSegIdx_T;
  wire [3:0]        _GEN_8 = {1'h0, instMicroOp_uop_vpu_nf};
  wire              _GEN_9 = fieldIdx == _GEN_8;
  wire              _GEN_10 = _GEN_7 & ~(|_GEN_1);
  wire              _GEN_11 = _VSegmentUnitPipelineConnect_io_in_ready & sbufferOut_valid;
  wire [3:0]        _GEN_12 = state == 4'hD & fofBufferValid ? 4'hD : 4'h0;
  wire [15:0][3:0]  _GEN_13 =
    {{_GEN_12},
     ...
     {~_GEN_11 & (|_GEN_1) | _GEN_5
        ? 4'hA
        : _GEN_7
          & (_GEN_9 & _GEN_11 | ~(|_GEN_1) & _VSegmentUnitPipelineConnect_io_out_valid
             & ~io_sbuffer_ready)
            ? 4'hB
            : _GEN_10 ? 4'hC : 4'h3},
     {exception_pa | _GEN_7 & _GEN_9 | _GEN_10 ? 4'hC : 4'h3},
     ...
     {_GEN_3
        ? 4'hC
        : _GEN_2 & _canHandleMisalign_T & _canHandleMisalign_T_1 & _canHandleMisalign_T_3
          & isMisalignWire & ~notCross16ByteWire | _GEN_5 & instMicroOp_isVSegStore
            ? 4'h3
  ...
  wire [3:0]        stateNext = _GEN_13[state];
  wire [2:0]        _emul_T_3 =
    3'(3'({1'h0, io_in_bits_vpu_veew} - {1'h0, io_in_bits_vpu_vsew})
       + io_in_bits_vpu_vlmul);
  wire              _GEN_14 = io_in_valid & ~instMicroOpValid;
  wire              _GEN_15 = _GEN_14 & ~isEnqFixVlUop;
  wire              _GEN_16 = io_in_valid & ~isEnqFixVlUop;
  wire [8:0]        _GEN_17 = {2'h0, io_in_bits_pdest};
  wire [7:0][127:0] _GEN_18 =
    {{stride_7},
     {stride_6},
     {stride_5},
     {stride_4},
     ...
     {stride_1},
     {stride_0}};
  wire [127:0]      _GEN_19 = _GEN_18[stridePtrReg_value];
                ...
                {16'h0,
                 {8'h0,
                  instMicroOp_uop_vpu_veew == 2'h0
                    ? (_indexStride_T_111 ? _GEN_19[7:0] : 8'h0)
                      | (_indexStride_T_112 ? _GEN_19[15:8] : 8'h0)
                      | (_indexStride_T_100 ? _GEN_19[23:16] : 8'h0)
                      | (_indexStride_T_101 ? _GEN_19[31:24] : 8'h0)
                      | (_indexStride_T_75 ? _GEN_19[39:32] : 8'h0)
                      | (_indexStride_T_76 ? _GEN_19[47:40] : 8'h0)
                      | (_indexStride_T_77 ? _GEN_19[55:48] : 8'h0)
                      | (_indexStride_T_78 ? _GEN_19[63:56] : 8'h0)
                      | (issueIndexIdx == 8'h8 ? _GEN_19[71:64] : 8'h0)
                      | (issueIndexIdx == 8'h9 ? _GEN_19[79:72] : 8'h0)
                      | (issueIndexIdx == 8'hA ? _GEN_19[87:80] : 8'h0)
                      | (issueIndexIdx == 8'hB ? _GEN_19[95:88] : 8'h0)
                      | (issueIndexIdx == 8'hC ? _GEN_19[103:96] : 8'h0)
                      | (issueIndexIdx == 8'hD ? _GEN_19[111:104] : 8'h0)
                      | (issueIndexIdx == 8'hE ? _GEN_19[119:112] : 8'h0)
                      | (issueIndexIdx == 8'hF ? _GEN_19[127:120] : 8'h0)
                    : 8'h0}
                   | (instMicroOp_uop_vpu_veew == 2'h1
                        ? (_indexStride_T_111 ? _GEN_19[15:0] : 16'h0)
                          | (_indexStride_T_112 ? _GEN_19[31:16] : 16'h0)
                          | (_indexStride_T_100 ? _GEN_19[47:32] : 16'h0)
                          | (_indexStride_T_101 ? _GEN_19[63:48] : 16'h0)
                          | (_indexStride_T_75 ? _GEN_19[79:64] : 16'h0)
                          | (_indexStride_T_76 ? _GEN_19[95:80] : 16'h0)
                          | (_indexStride_T_77 ? _GEN_19[111:96] : 16'h0)
                          | (_indexStride_T_78 ? _GEN_19[127:112] : 16'h0)
                        : 16'h0)}
                  | (instMicroOp_uop_vpu_veew == 2'h2
                       ? (_indexStride_T_111 ? _GEN_19[31:0] : 32'h0)
                         | (_indexStride_T_112 ? _GEN_19[63:32] : 32'h0)
                         | (_indexStride_T_100 ? _GEN_19[95:64] : 32'h0)
                         | (_indexStride_T_101 ? _GEN_19[127:96] : 32'h0)
                       : 32'h0)}
               | ((&instMicroOp_uop_vpu_veew)
                    ? (_indexStride_T_111 ? _GEN_19[63:0] : 64'h0)
                      | (_indexStride_T_112 ? _GEN_19[127:64] : 64'h0)
                    : 64'h0)
             : segmentOffset));
  wire [60:0]       _GEN_20 = curPtr ? 61'(latchVaddr[63:3] + 61'h1) : latchVaddr[63:3];
  wire [63:0]       tlbReqVaddr = isMisalignReg ? {_GEN_20, 3'h0} : _vaddr_T;
  wire              _triggerBreakpoint_T_1 = state == 4'h3;
  wire [49:0]       dcacheReqVaddr =
    isMisalignReg ? {_GEN_20[46:0], 3'h0} : latchVaddr[49:0];
  reg               triggerDebugMode;
  reg               triggerBreakpoint;
  wire              _GEN_21 = io_dtlb_resp_valid & state == 4'h4;
  ...
  wire              _GEN_22 = _segmentInactiveFinish_T_1 & _segmentInactiveFinish_T_2;
  reg               last_REG;
  wire              _GEN_23 =
    (_segmentInactiveFinish_T | _GEN_6)
    & (|{io_rdcache_resp_bits_tl_error_delayed_tl_denied,
         io_rdcache_resp_bits_tl_error_delayed_tl_corrupt}) & last_REG & (|_GEN_1);
  assign exception_pa = _GEN_23 | _GEN_2 & (pmp_st | pmp_ld | pmp_mmio);
  wire [3:0]        _splitData_T = segmentIdx[3:0] & instMicroOp_uopFlowNumMask[3:0];
  wire [7:0][127:0] _GEN_24 =
    {{data_7}, {data_6}, {data_5}, {data_4}, {data_3}, {data_2}, {data_1}, {data_0}};
  wire [127:0]      _GEN_25 = _GEN_24[splitPtr_value];
  ...
  wire              _GEN_26 = _segmentInactiveFinish_T & (|_GEN_1);
  ...
  wire [127:0]      splitData =
    (_flowData_T_15
       ? {120'h0,
          (_splitData_T == 4'h0 ? _GEN_25[7:0] : 8'h0)
            | (_splitData_T == 4'h1 ? _GEN_25[15:8] : 8'h0)
            | (_splitData_T == 4'h2 ? _GEN_25[23:16] : 8'h0)
            | (_splitData_T == 4'h3 ? _GEN_25[31:24] : 8'h0)
            | (_splitData_T == 4'h4 ? _GEN_25[39:32] : 8'h0)
            | (_splitData_T == 4'h5 ? _GEN_25[47:40] : 8'h0)
            | (_splitData_T == 4'h6 ? _GEN_25[55:48] : 8'h0)
            | (_splitData_T == 4'h7 ? _GEN_25[63:56] : 8'h0)
            | (_splitData_T == 4'h8 ? _GEN_25[71:64] : 8'h0)
            | (_splitData_T == 4'h9 ? _GEN_25[79:72] : 8'h0)
            | (_splitData_T == 4'hA ? _GEN_25[87:80] : 8'h0)
            | (_splitData_T == 4'hB ? _GEN_25[95:88] : 8'h0)
            | (_splitData_T == 4'hC ? _GEN_25[103:96] : 8'h0)
            | (_splitData_T == 4'hD ? _GEN_25[111:104] : 8'h0)
            | (_splitData_T == 4'hE ? _GEN_25[119:112] : 8'h0)
            | ((&_splitData_T) ? _GEN_25[127:120] : 8'h0)}
       : 128'h0)
    | (_flowData_T_16
         ? {112'h0,
            (_splitData_T_65 == 3'h0 ? _GEN_25[15:0] : 16'h0)
              | (_splitData_T_65 == 3'h1 ? _GEN_25[31:16] : 16'h0)
              | (_splitData_T_65 == 3'h2 ? _GEN_25[47:32] : 16'h0)
              | (_splitData_T_65 == 3'h3 ? _GEN_25[63:48] : 16'h0)
              | (_splitData_T_65 == 3'h4 ? _GEN_25[79:64] : 16'h0)
              | (_splitData_T_65 == 3'h5 ? _GEN_25[95:80] : 16'h0)
              | (_splitData_T_65 == 3'h6 ? _GEN_25[111:96] : 16'h0)
              | ((&_splitData_T_65) ? _GEN_25[127:112] : 16'h0)}
         : 128'h0)
    | (_flowData_T_17
         ? {96'h0,
            (_splitData_T_98 == 2'h0 ? _GEN_25[31:0] : 32'h0)
              | (_splitData_T_98 == 2'h1 ? _GEN_25[63:32] : 32'h0)
              | (_splitData_T_98 == 2'h2 ? _GEN_25[95:64] : 32'h0)
              | ((&_splitData_T_98) ? _GEN_25[127:96] : 32'h0)}
         : 128'h0)
    | (_flowData_T_18
         ? {64'h0,
            (_splitData_T_119 ? 64'h0 : _GEN_25[63:0])
              | (_splitData_T_119 ? _GEN_25[127:64] : 64'h0)}
         : 128'h0) | (_flowData_T_19 ? _GEN_25 : 128'h0);
  wire [127:0]      flowData =
  ...
  wire [47:0]       dcacheReqPaddr =
    isMisalignReg ? {instMicroOp_paddr[47:12], _GEN_20[8:0], 3'h0} : instMicroOp_paddr;
  assign io_rdcache_req_valid_0 = state == 4'h6 & instMicroOp_isVSegLoad;
  wire [254:0]      _GEN_27 = {127'h0, flowData};
  wire [254:0]      _GEN_28 = {248'h0, latchVaddr[3:0], 3'h0};
  wire [254:0]      notCross16ByteData = _GEN_27 << _GEN_28;
        ...
        & ({4'h0,
            {2'h0,
             {1'h0, ~(|(instMicroOp_alignedType[1:0]))}
              ...
              | {4{instMicroOp_alignedType[1:0] == 2'h2}}}
           | {8{&(instMicroOp_alignedType[1:0])}})} << latchVaddr[3:0]};
  wire [254:0]      _Cross16ByteData_T_1 = _GEN_27 << _GEN_28;
  wire [49:0]       _GEN_29 = {latchVaddr[49:3], 3'h0};
  assign sbufferOut_valid = _segmentInactiveFinish_T_1 & (|_GEN_1);
  wire [7:0][6:0]   _GEN_30 =
  ...
  wire [6:0]        io_exceptionInfo_bits_uopIdx_0 = _GEN_30[deqPtr_value];
  ...
  wire              segmentInactiveFinish =
    ...
    & ~(|_GEN_1);
  wire              _fieldIdxWire_T = fieldIdx == _GEN_8;
  wire [8:0]        _segmentIdxWire_T_2 = 9'({1'h0, segmentIdx} + 9'h1);
  wire [3:0]        _io_exceptionInfo_valid_T_5 = {deqPtr_flag, deqPtr_value};
  wire              _GEN_31 = _GEN_22 & fieldActiveWirteFinish;
  wire              _GEN_32 = _GEN_26 | _GEN_31;
  wire [3:0]        _fieldIdxWire_T_3 = _fieldIdxWire_T ? 4'h0 : 4'(fieldIdx + 4'h1);
  wire              _GEN_33 = _fieldIdxWire_T & (_segmentInactiveFinish_T | _GEN_31);
  wire              _GEN_34 = segmentIdx != _maxSegIdx_T;
  wire              _GEN_35 = _GEN_33 & _GEN_34;
  wire              _GEN_36 = segmentInactiveFinish & _GEN_34;
  ...
  reg  [6:0]        io_feedback_bits_r_sqIdx_value;
  ...
  wire [4:0]        _GEN_37 = {3'h0, io_in_bits_vpu_veew};
  wire [2:0]        _GEN_38 = {1'h0, _emul_T_3 == 3'h5, 1'h0};
  ...
  wire [3:0]        _GEN_40 =
    _GEN_39[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[3:0] : 4'h0);
  ...
  wire [3:0]        _GEN_42 =
    _GEN_41[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[7:4] : 4'h0);
  ...
  wire [3:0]        _GEN_44 =
    _GEN_43[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[11:8] : 4'h0);
  ...
  wire [3:0]        _GEN_46 =
    _GEN_45[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[15:12] : 4'h0);
  ...
  wire [3:0]        _GEN_48 =
    _GEN_47[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[19:16] : 4'h0);
  ...
  wire [3:0]        _GEN_50 =
    _GEN_49[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[23:20] : 4'h0);
  ...
  wire [3:0]        _GEN_52 =
    _GEN_51[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[27:24] : 4'h0);
  ...
  wire [3:0]        _GEN_54 =
    _GEN_53[3:0] | (_maskDataVec_maskDataVec_7_T_4 ? instMicroOp_mask[31:28] : 4'h0);
  ...
  wire [7:0][15:0]  _GEN_59 =
    {{{_maskDataVec_maskDataVec_7_T_8[15:8],
       _GEN_53[7:4],
       _GEN_54[3:2],
       _GEN_54[1:0] | ((&realEw) ? instMicroOp_mask[15:14] : 2'h0)}},
     {{_maskDataVec_maskDataVec_6_T_8[15:8],
       _GEN_51[7:4],
       _GEN_52[3:2],
       _GEN_52[1:0] | ((&realEw) ? instMicroOp_mask[13:12] : 2'h0)}},
     {{_maskDataVec_maskDataVec_5_T_8[15:8],
       _GEN_49[7:4],
       _GEN_50[3:2],
       _GEN_50[1:0] | ((&realEw) ? instMicroOp_mask[11:10] : 2'h0)}},
     {{_maskDataVec_maskDataVec_4_T_8[15:8],
       _GEN_47[7:4],
       _GEN_48[3:2],
       _GEN_48[1:0] | ((&realEw) ? instMicroOp_mask[9:8] : 2'h0)}},
     {{_maskDataVec_maskDataVec_3_T_8[15:8],
       _GEN_45[7:4],
       _GEN_46[3:2],
       _GEN_46[1:0] | ((&realEw) ? instMicroOp_mask[7:6] : 2'h0)}},
     {{_maskDataVec_maskDataVec_2_T_8[15:8],
       _GEN_43[7:4],
       _GEN_44[3:2],
       _GEN_44[1:0] | ((&realEw) ? instMicroOp_mask[5:4] : 2'h0)}},
     {{_maskDataVec_maskDataVec_1_T_8[15:8],
       _GEN_41[7:4],
       _GEN_42[3:2],
       _GEN_42[1:0] | ((&realEw) ? instMicroOp_mask[3:2] : 2'h0)}},
     {{_maskDataVec_maskDataVec_0_T_8[15:8],
       _GEN_39[7:4],
       _GEN_40[3:2],
       _GEN_40[1:0] | ((&realEw) ? instMicroOp_mask[1:0] : 2'h0)}}};
  wire [7:0]        _GEN_60 =
  ...
  wire              _GEN_62 = _GEN_16 & enqPtr_value == 3'h0;
  wire              _GEN_63 = _GEN_16 & enqPtr_value == 3'h1;
  wire              _GEN_64 = _GEN_16 & enqPtr_value == 3'h2;
  wire              _GEN_65 = _GEN_16 & enqPtr_value == 3'h3;
  wire              _GEN_66 = _GEN_16 & enqPtr_value == 3'h4;
  wire              _GEN_67 = _GEN_16 & enqPtr_value == 3'h5;
  wire              _GEN_68 = _GEN_16 & enqPtr_value == 3'h6;
  wire              _GEN_69 = _GEN_16 & (&enqPtr_value);
  ...
  wire              _GEN_70 = _GEN_23 & canTriggerException;
  ...
  wire [127:0]      mergedData =
    ((|(instMicroOp_alignedType[1:0]))
       ? 128'h0
       : {_mergedData_T_2[15] ? pickData[7:0] : _GEN_25[127:120],
          _mergedData_T_2[14] ? pickData[7:0] : _GEN_25[119:112],
          _mergedData_T_2[13] ? pickData[7:0] : _GEN_25[111:104],
          _mergedData_T_2[12] ? pickData[7:0] : _GEN_25[103:96],
          _mergedData_T_2[11] ? pickData[7:0] : _GEN_25[95:88],
          _mergedData_T_2[10] ? pickData[7:0] : _GEN_25[87:80],
          _mergedData_T_2[9] ? pickData[7:0] : _GEN_25[79:72],
          _mergedData_T_2[8] ? pickData[7:0] : _GEN_25[71:64],
          _mergedData_T_2[7] ? pickData[7:0] : _GEN_25[63:56],
          _mergedData_T_2[6] ? pickData[7:0] : _GEN_25[55:48],
          _mergedData_T_2[5] ? pickData[7:0] : _GEN_25[47:40],
          _mergedData_T_2[4] ? pickData[7:0] : _GEN_25[39:32],
          _mergedData_T_2[3] ? pickData[7:0] : _GEN_25[31:24],
          _mergedData_T_2[2] ? pickData[7:0] : _GEN_25[23:16],
          _mergedData_T_2[1] ? pickData[7:0] : _GEN_25[15:8],
          _mergedData_T_2[0] ? pickData[7:0] : _GEN_25[7:0]})
    | (instMicroOp_alignedType[1:0] == 2'h1
         ? {_mergedData_T_101[7] ? pickData[15:0] : _GEN_25[127:112],
            _mergedData_T_101[6] ? pickData[15:0] : _GEN_25[111:96],
            _mergedData_T_101[5] ? pickData[15:0] : _GEN_25[95:80],
            _mergedData_T_101[4] ? pickData[15:0] : _GEN_25[79:64],
            _mergedData_T_101[3] ? pickData[15:0] : _GEN_25[63:48],
            _mergedData_T_101[2] ? pickData[15:0] : _GEN_25[47:32],
            _mergedData_T_101[1] ? pickData[15:0] : _GEN_25[31:16],
            _mergedData_T_101[0] ? pickData[15:0] : _GEN_25[15:0]}
         : 128'h0)
    | (instMicroOp_alignedType[1:0] == 2'h2
         ? {_mergedData_T_152[3] ? pickData[31:0] : _GEN_25[127:96],
            _mergedData_T_152[2] ? pickData[31:0] : _GEN_25[95:64],
            _mergedData_T_152[1] ? pickData[31:0] : _GEN_25[63:32],
            _mergedData_T_152[0] ? pickData[31:0] : _GEN_25[31:0]}
         : 128'h0)
    | ((&(instMicroOp_alignedType[1:0]))
         ? {_mergedData_T_179[1] ? pickData : _GEN_25[127:64],
            _mergedData_T_179[0] ? pickData : _GEN_25[63:0]}
         : 128'h0);
  wire [2:0]        _vdIdxInField_T_2 =
    io_in_bits_fuOpType[5] ? instMicroOp_uop_vpu_vlmul : _issueEmul_T_3;
  ...
  always @(posedge clock) begin
      ...
      instMicroOp_uopFlowNumMask <=
        8'({3'h0,
            (io_in_bits_fuOpType[6:5] == 2'h0
               ? ({1'h0, {1'h0, _GEN_38 | {_uopFlowNum_T_158, 2'h0}} | {&_emul_T_3, 3'h0}}
                  | {_uopFlowNum_T_160, 4'h0} | {_uopFlowNum_T_161, 4'h0}
                  | {_uopFlowNum_T_162, 4'h0} | {_uopFlowNum_T_163, 4'h0}) >> _GEN_37
               : 5'h0)
              | (io_in_bits_fuOpType[6:5] == 2'h2
                   ? ({1'h0,
                       {1'h0, _GEN_38 | {_uopFlowNum_T_158, 2'h0}} | {&_emul_T_3, 3'h0}}
                      | {_uopFlowNum_T_160, 4'h0} | {_uopFlowNum_T_161, 4'h0}
                      | {_uopFlowNum_T_162, 4'h0} | {_uopFlowNum_T_163, 4'h0}) >> _GEN_37
                   : 5'h0)
    ...
    instMicroOp_uop_exceptionVec_3 <=
      _GEN_2
        ...
        : ~_GEN_15 & instMicroOp_uop_exceptionVec_3;
      ...
      _GEN_70
        ...
        : _GEN_2
            ...
            : _GEN_21
                ...
                : ~_GEN_15 & instMicroOp_uop_exceptionVec_5;
      ...
      _GEN_2
        ...
        : _GEN_21
            ? io_dtlb_resp_bits_excp_0_af_st | _instMicroOp_uop_exceptionVec_5_T
              | _instMicroOp_uop_exceptionVec_5_T_1
            : ~_GEN_15 & instMicroOp_uop_exceptionVec_7;
    instMicroOp_uop_exceptionVec_13 <=
      _GEN_2
        ...
        : _GEN_21
            ...
            : ~_GEN_15 & instMicroOp_uop_exceptionVec_13;
    ...
    instMicroOp_uop_exceptionVec_21 <=
      _GEN_2
        ...
        : _GEN_21
            ...
            : ~_GEN_15 & instMicroOp_uop_exceptionVec_21;
    instMicroOp_uop_exceptionVec_23 <=
      _GEN_2
        ...
        : _GEN_21
            ...
            : ~_GEN_15 & instMicroOp_uop_exceptionVec_23;
    ...
    if (_GEN_21 & ~io_dtlb_resp_bits_miss) begin
    ...
    if (_GEN_23 & canTriggerException | _GEN_2 & _GEN_3 & canTriggerException)
      instMicroOp_exceptionVstart <= segmentIdx;
    if (~_GEN_23 & ~(_GEN_2 & _GEN_3) | canTriggerException) begin
      if (_GEN_15)
        instMicroOp_exceptionVl_bits <= io_in_bits_vl;
    end
    else
      instMicroOp_exceptionVl_bits <= segmentIdx;
    if (_GEN_26 & splitPtr_value == 3'h0)
      data_0 <= mergedData;
    else if (_GEN_62)
      data_0 <= io_in_bits_src_2;
    if (_GEN_26 & splitPtr_value == 3'h1)
      data_1 <= mergedData;
    else if (_GEN_63)
      data_1 <= io_in_bits_src_2;
    if (_GEN_26 & splitPtr_value == 3'h2)
      data_2 <= mergedData;
    else if (_GEN_64)
      data_2 <= io_in_bits_src_2;
    if (_GEN_26 & splitPtr_value == 3'h3)
      data_3 <= mergedData;
    else if (_GEN_65)
      data_3 <= io_in_bits_src_2;
    if (_GEN_26 & splitPtr_value == 3'h4)
      data_4 <= mergedData;
    else if (_GEN_66)
      data_4 <= io_in_bits_src_2;
    if (_GEN_26 & splitPtr_value == 3'h5)
      data_5 <= mergedData;
    else if (_GEN_67)
      data_5 <= io_in_bits_src_2;
    if (_GEN_26 & splitPtr_value == 3'h6)
      data_6 <= mergedData;
    else if (_GEN_68)
      data_6 <= io_in_bits_src_2;
    if (_GEN_26 & (&splitPtr_value))
      data_7 <= mergedData;
    else if (_GEN_69)
    ...
    if (writebackValid) begin
      io_uopwriteback_bits_r_data_0 <=
        fofFixVlValid ? {120'h0, instMicroOp_exceptionVl_bits} : _GEN_24[deqPtr_value];
      io_uopwriteback_bits_r_pdest <=
        fofFixVlValid ? fofBuffer_pdest[6:0] : _GEN_55[deqPtr_value][6:0];
      ...
      io_uopwriteback_bits_r_vecWen <=
        fofFixVlValid ? fofBuffer_vecWen : _GEN_56[deqPtr_value];
      io_uopwriteback_bits_r_v0Wen <=
        fofFixVlValid ? fofBuffer_v0Wen : _GEN_57[deqPtr_value];
      io_uopwriteback_bits_r_vlWen <=
        fofFixVlValid ? fofBuffer_vlWen : _GEN_58[deqPtr_value];
    ...
    if (feedbackValid) begin
      io_feedback_bits_r_sqIdx_flag <= _GEN_60[deqPtr_value];
      io_feedback_bits_r_sqIdx_value <= _GEN_61[deqPtr_value];
    end
  end // always @(posedge)
  ...
  wire [2:0]        _issueUopFlowNumLog2_sewRealFlowLog2_T_3 =
    3'(3'(($signed(instMicroOp_uop_vpu_vlmul) > -3'sh1 ? 3'h0 : instMicroOp_uop_vpu_vlmul)
          - 3'h4) - _GEN_0);
  wire              _splitPtrNext_T_2 = _fieldIdxWire_T | ~(|_GEN_1);
  ...
  wire [15:0]       _GEN_87 =
    _GEN_86[15:0]
    | (latchVaddr[3:0] == 4'hE ? io_rdcache_resp_bits_data_delayed[127:112] : 16'h0);
  wire              _GEN_88 = _GEN_2 & isMisalignWire & ~_GEN_3;
  wire              _GEN_89 =
    _io_exceptionInfo_valid_T | _segmentInactiveFinish_T | _GEN_22;
  wire              _GEN_90 = stateNext == 4'hA;
  wire [3:0]        _GEN_91 = {deqPtr_flag, deqPtr_value};
  wire [7:0]        _GEN_92 = {5'h0, issueMaxIdxInIndexLog2};
  wire              _GEN_93 = isEnqFixVlUop & ~fofBufferValid;
  wire [3:0]        _deqPtr_new_ptr_T_1 = 4'(_GEN_91 + 4'h1);
  wire [7:0]        _strideOffsetWire_T_2 =
    (_GEN_14
       ? 8'h0
       : _GEN_35
           ? _segmentIdxWire_T_2[7:0]
           : _GEN_36 ? _segmentIdxWire_T_2[7:0] : segmentIdx) >> _GEN_92;
  wire [7:0]        _strideOffset_T_2 = segmentIdx >> _GEN_92;
  wire [3:0]        _splitPtrNext_new_ptr_T_1 = 4'(_GEN_91 + _splitPtrNext_T_4[3:0]);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      instMicroOpValid <= (|stateNext) & (_GEN_15 | instMicroOpValid);
      if (_GEN_16) begin
      ...
      if (_GEN_14 | _GEN_35 | _GEN_36) begin
        if (_GEN_14)
          segmentIdx <= 8'h0;
        else if (_GEN_35)
      ...
      if (_GEN_14 | _GEN_32 | segmentInactiveFinish) begin
        if (_GEN_14)
          fieldIdx <= 4'h0;
        else if (_GEN_32)
      ...
      if (_GEN_33 | segmentInactiveFinish)
        segmentOffset <=
          64'(segmentOffset
              + ((|(instMicroOp_uop_fuOpType[6:5]))
                   ? _GEN_18[3'(deqPtr_value
                                + (instMicroOp_uop_fuOpType[5]
                                     ? _strideOffset_T_2[2:0]
                                     : 3'h0))][63:0]
                   : {57'h0, {3'h0, 4'(_GEN_8 + 4'h1)} << instMicroOp_uop_vpu_veew}));
      else if (_GEN_15)
        segmentOffset <= 64'h0;
      if (_segmentInactiveFinish_T | _GEN_22
          & (fieldActiveWirteFinish | ~(|_GEN_1))) begin
        splitPtr_flag <=
          _splitPtrNext_T_2 ? _splitPtrNext_new_ptr_T_1[3] : _splitPtrNext_new_ptr_T_8[3];
        splitPtr_value <=
          _splitPtrNext_T_2
            ? _splitPtrNext_new_ptr_T_1[2:0]
            : _splitPtrNext_new_ptr_T_8[2:0];
      end
      ...
      if (fofFixVlValid) begin
        ...
        fofBuffer_pdest <= _GEN_17;
        fofBuffer_robIdx_value <= io_in_bits_robIdx_value;
      end
      fofBuffer_vecWen <=
        ~fofFixVlValid & (_GEN_93 ? io_in_bits_vecWen : fofBuffer_vecWen);
      fofBuffer_v0Wen <= ~fofFixVlValid & (_GEN_93 ? io_in_bits_v0Wen : fofBuffer_v0Wen);
      fofBuffer_vlWen <= ~fofFixVlValid & (_GEN_93 ? io_in_bits_vlWen : fofBuffer_vlWen);
      fofBuffer_vpu_vma <=
        ~fofFixVlValid & (_GEN_93 ? io_in_bits_vpu_vma : fofBuffer_vpu_vma);
      fofBuffer_vpu_vta <=
        ~fofFixVlValid & (_GEN_93 ? io_in_bits_vpu_vta : fofBuffer_vpu_vta);
      fofBuffer_vpu_vm <=
        ~fofFixVlValid & (_GEN_93 ? io_in_bits_vpu_vm : fofBuffer_vpu_vm);
      fofBuffer_robIdx_flag <=
        ~fofFixVlValid & (_GEN_93 ? io_in_bits_robIdx_flag : fofBuffer_robIdx_flag);
      fofBufferValid <= ~fofFixVlValid & (_GEN_93 | fofBufferValid);
      state <= stateNext;
      curPtr <=
        ~_GEN_89
        & (instMicroOp_isVSegLoad
             ? _GEN_4 & _GEN_6 | curPtr
             : isMisalignWire & ~notCross16ByteReg & _GEN_2
                 ? ~curPtr
                 : ~(_GEN_4 & _GEN_2 & _GEN_90) & (_GEN_4 & _GEN_90 & _GEN_11 ^ curPtr));
      isMisalignReg <= ~_GEN_89 & (_GEN_88 | ~_GEN_15 & isMisalignReg);
      notCross16ByteReg <=
        ~_GEN_89 & (_GEN_88 ? notCross16ByteWire : ~_GEN_15 & notCross16ByteReg);
      if (_GEN_6 & (|_GEN_1))
        combinedData <=
          curPtr
            ? (latchVaddr[3:0] == 4'h9
            ...
            : {8'h0,
               ...
               _GEN_87[7:0]
                 | ((&(latchVaddr[3:0]))
                      ...
                      : 8'h0)};
      if (_GEN_21 & ~io_dtlb_resp_bits_miss & ~curPtr)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:521];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h20A; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        instMicroOp_uop_fuOpType = _RANDOM[10'h8][17:9];
        ...
        instMicroOp_uop_robIdx_flag = _RANDOM[10'h14][27];
        instMicroOp_uop_robIdx_value = {_RANDOM[10'h14][31:28], _RANDOM[10'h15][4:0]};
        instMicroOp_paddr = {_RANDOM[10'h2A][31], _RANDOM[10'h2B], _RANDOM[10'h2C][14:0]};
        instMicroOp_mask =
          {_RANDOM[10'h2C][31:15],
           _RANDOM[10'h2D],
           _RANDOM[10'h2E],
           _RANDOM[10'h2F],
           _RANDOM[10'h30][14:0]};
        instMicroOp_alignedType = _RANDOM[10'h30][17:15];
        instMicroOp_vl = _RANDOM[10'h30][25:18];
        instMicroOp_uopFlowNumMask = _RANDOM[10'h31][9:2];
        instMicroOp_isVSegLoad = _RANDOM[10'h31][10];
        instMicroOp_isVSegStore = _RANDOM[10'h31][11];
        instMicroOp_exceptionVaddr =
          {_RANDOM[10'h31][31:20], _RANDOM[10'h32], _RANDOM[10'h33][19:0]};
        instMicroOp_exceptionGpaddr =
          {_RANDOM[10'h33][31:20], _RANDOM[10'h34], _RANDOM[10'h35][19:0]};
        instMicroOp_exceptionIsForVSnonLeafPTE = _RANDOM[10'h35][20];
        instMicroOp_exceptionVstart = _RANDOM[10'h35][31:24];
        instMicroOp_exceptionVl_bits = _RANDOM[10'h36][8:1];
        instMicroOp_isFof = _RANDOM[10'h36][9];
        instMicroOpValid = _RANDOM[10'h36][10];
        data_0 =
          {_RANDOM[10'h36][31:11],
           _RANDOM[10'h37],
           _RANDOM[10'h38],
           _RANDOM[10'h39],
           _RANDOM[10'h3A][10:0]};
        data_1 =
          {_RANDOM[10'h3A][31:11],
           _RANDOM[10'h3B],
           _RANDOM[10'h3C],
           _RANDOM[10'h3D],
           _RANDOM[10'h3E][10:0]};
        data_2 =
          {_RANDOM[10'h3E][31:11],
           _RANDOM[10'h3F],
           _RANDOM[10'h40],
           _RANDOM[10'h41],
           _RANDOM[10'h42][10:0]};
        data_3 =
          {_RANDOM[10'h42][31:11],
           _RANDOM[10'h43],
           _RANDOM[10'h44],
           _RANDOM[10'h45],
           _RANDOM[10'h46][10:0]};
        data_4 =
          {_RANDOM[10'h46][31:11],
           _RANDOM[10'h47],
           _RANDOM[10'h48],
           _RANDOM[10'h49],
           _RANDOM[10'h4A][10:0]};
        data_5 =
          {_RANDOM[10'h4A][31:11],
           _RANDOM[10'h4B],
           _RANDOM[10'h4C],
           _RANDOM[10'h4D],
           _RANDOM[10'h4E][10:0]};
        data_6 =
          {_RANDOM[10'h4E][31:11],
           _RANDOM[10'h4F],
           _RANDOM[10'h50],
           _RANDOM[10'h51],
           _RANDOM[10'h52][10:0]};
        data_7 =
          {_RANDOM[10'h52][31:11],
           _RANDOM[10'h53],
           _RANDOM[10'h54],
           _RANDOM[10'h55],
           _RANDOM[10'h56][10:0]};
        uopq_0_uop_vecWen = _RANDOM[10'h5C][31];
        uopq_0_uop_v0Wen = _RANDOM[10'h5D][0];
        uopq_0_uop_vlWen = _RANDOM[10'h5D][1];
        uopq_0_uop_vpu_vuopIdx = _RANDOM[10'h5F][30:24];
        uopq_0_uop_pdest = _RANDOM[10'h68][16:8];
        uopq_0_uop_sqIdx_flag = _RANDOM[10'h7E][27];
        uopq_0_uop_sqIdx_value = {_RANDOM[10'h7E][31:28], _RANDOM[10'h7F][2:0]};
        uopq_1_uop_vecWen = _RANDOM[10'h85][30];
        uopq_1_uop_v0Wen = _RANDOM[10'h85][31];
        uopq_1_uop_vlWen = _RANDOM[10'h86][0];
        uopq_1_uop_vpu_vuopIdx = _RANDOM[10'h88][29:23];
        uopq_1_uop_pdest = _RANDOM[10'h91][15:7];
        uopq_1_uop_sqIdx_flag = _RANDOM[10'hA7][26];
        uopq_1_uop_sqIdx_value = {_RANDOM[10'hA7][31:27], _RANDOM[10'hA8][1:0]};
        uopq_2_uop_vecWen = _RANDOM[10'hAE][29];
        uopq_2_uop_v0Wen = _RANDOM[10'hAE][30];
        uopq_2_uop_vlWen = _RANDOM[10'hAE][31];
        uopq_2_uop_vpu_vuopIdx = _RANDOM[10'hB1][28:22];
        uopq_2_uop_pdest = _RANDOM[10'hBA][14:6];
        uopq_2_uop_sqIdx_flag = _RANDOM[10'hD0][25];
        uopq_2_uop_sqIdx_value = {_RANDOM[10'hD0][31:26], _RANDOM[10'hD1][0]};
        uopq_3_uop_vecWen = _RANDOM[10'hD7][28];
        uopq_3_uop_v0Wen = _RANDOM[10'hD7][29];
        uopq_3_uop_vlWen = _RANDOM[10'hD7][30];
        uopq_3_uop_vpu_vuopIdx = _RANDOM[10'hDA][27:21];
        uopq_3_uop_pdest = _RANDOM[10'hE3][13:5];
        uopq_3_uop_sqIdx_flag = _RANDOM[10'hF9][24];
        uopq_3_uop_sqIdx_value = _RANDOM[10'hF9][31:25];
        uopq_4_uop_vecWen = _RANDOM[10'h100][27];
        uopq_4_uop_v0Wen = _RANDOM[10'h100][28];
        uopq_4_uop_vlWen = _RANDOM[10'h100][29];
        uopq_4_uop_vpu_vuopIdx = _RANDOM[10'h103][26:20];
        uopq_4_uop_pdest = _RANDOM[10'h10C][12:4];
        uopq_4_uop_sqIdx_flag = _RANDOM[10'h122][23];
        uopq_4_uop_sqIdx_value = _RANDOM[10'h122][30:24];
        uopq_5_uop_vecWen = _RANDOM[10'h129][26];
        uopq_5_uop_v0Wen = _RANDOM[10'h129][27];
        uopq_5_uop_vlWen = _RANDOM[10'h129][28];
        uopq_5_uop_vpu_vuopIdx = _RANDOM[10'h12C][25:19];
        uopq_5_uop_pdest = _RANDOM[10'h135][11:3];
        uopq_5_uop_sqIdx_flag = _RANDOM[10'h14B][22];
        uopq_5_uop_sqIdx_value = _RANDOM[10'h14B][29:23];
        uopq_6_uop_vecWen = _RANDOM[10'h152][25];
        uopq_6_uop_v0Wen = _RANDOM[10'h152][26];
        uopq_6_uop_vlWen = _RANDOM[10'h152][27];
        uopq_6_uop_vpu_vuopIdx = _RANDOM[10'h155][24:18];
        uopq_6_uop_pdest = _RANDOM[10'h15E][10:2];
        uopq_6_uop_sqIdx_flag = _RANDOM[10'h174][21];
        uopq_6_uop_sqIdx_value = _RANDOM[10'h174][28:22];
        uopq_7_uop_vecWen = _RANDOM[10'h17B][24];
        uopq_7_uop_v0Wen = _RANDOM[10'h17B][25];
        uopq_7_uop_vlWen = _RANDOM[10'h17B][26];
        uopq_7_uop_vpu_vuopIdx = _RANDOM[10'h17E][23:17];
        uopq_7_uop_pdest = _RANDOM[10'h187][9:1];
        uopq_7_uop_sqIdx_flag = _RANDOM[10'h19D][20];
        uopq_7_uop_sqIdx_value = _RANDOM[10'h19D][27:21];
        stride_0 =
          {_RANDOM[10'h19E][31:3],
           _RANDOM[10'h19F],
           _RANDOM[10'h1A0],
           _RANDOM[10'h1A1],
           _RANDOM[10'h1A2][2:0]};
        stride_1 =
          {_RANDOM[10'h1A2][31:3],
           _RANDOM[10'h1A3],
           _RANDOM[10'h1A4],
           _RANDOM[10'h1A5],
           _RANDOM[10'h1A6][2:0]};
        stride_2 =
          {_RANDOM[10'h1A6][31:3],
           _RANDOM[10'h1A7],
           _RANDOM[10'h1A8],
           _RANDOM[10'h1A9],
           _RANDOM[10'h1AA][2:0]};
        stride_3 =
          {_RANDOM[10'h1AA][31:3],
           _RANDOM[10'h1AB],
           _RANDOM[10'h1AC],
           _RANDOM[10'h1AD],
           _RANDOM[10'h1AE][2:0]};
        stride_4 =
          {_RANDOM[10'h1AE][31:3],
           _RANDOM[10'h1AF],
           _RANDOM[10'h1B0],
           _RANDOM[10'h1B1],
           _RANDOM[10'h1B2][2:0]};
        stride_5 =
          {_RANDOM[10'h1B2][31:3],
           _RANDOM[10'h1B3],
           _RANDOM[10'h1B4],
           _RANDOM[10'h1B5],
           _RANDOM[10'h1B6][2:0]};
        stride_6 =
          {_RANDOM[10'h1B6][31:3],
           _RANDOM[10'h1B7],
           _RANDOM[10'h1B8],
           _RANDOM[10'h1B9],
           _RANDOM[10'h1BA][2:0]};
        stride_7 =
          {_RANDOM[10'h1BA][31:3],
           _RANDOM[10'h1BB],
           _RANDOM[10'h1BC],
           _RANDOM[10'h1BD],
           _RANDOM[10'h1BE][2:0]};
        enqPtr_flag = _RANDOM[10'h1BE][11];
        enqPtr_value = _RANDOM[10'h1BE][14:12];
        deqPtr_flag = _RANDOM[10'h1BE][15];
        deqPtr_value = _RANDOM[10'h1BE][18:16];
        stridePtrReg_value = _RANDOM[10'h1BE][22:20];
        segmentIdx = _RANDOM[10'h1BE][30:23];
        fieldIdx = {_RANDOM[10'h1BE][31], _RANDOM[10'h1BF][2:0]};
        segmentOffset = {_RANDOM[10'h1BF][31:3], _RANDOM[10'h1C0], _RANDOM[10'h1C1][2:0]};
        splitPtr_flag = _RANDOM[10'h1C1][3];
        splitPtr_value = _RANDOM[10'h1C1][6:4];
        latchVaddr = {_RANDOM[10'h1C1][31:7], _RANDOM[10'h1C2], _RANDOM[10'h1C3][6:0]};
        latchVaddrDup = {_RANDOM[10'h1C3][31:7], _RANDOM[10'h1C4], _RANDOM[10'h1C5][6:0]};
        issueMaxIdxInIndexLog2 = _RANDOM[10'h1C5][9:7];
        fofBuffer_fuOpType = _RANDOM[10'h1CB][27:19];
        fofBuffer_vecWen = _RANDOM[10'h1CB][30];
        fofBuffer_v0Wen = _RANDOM[10'h1CB][31];
        fofBuffer_vlWen = _RANDOM[10'h1CC][0];
        fofBuffer_vpu_vma = _RANDOM[10'h1CD][19];
        fofBuffer_vpu_vta = _RANDOM[10'h1CD][20];
        fofBuffer_vpu_vsew = _RANDOM[10'h1CD][22:21];
        fofBuffer_vpu_vlmul = _RANDOM[10'h1CD][25:23];
        fofBuffer_vpu_vm = _RANDOM[10'h1CE][2];
        fofBuffer_vpu_vstart = _RANDOM[10'h1CE][10:3];
        fofBuffer_vpu_vuopIdx = _RANDOM[10'h1CE][29:23];
        fofBuffer_vpu_nf = _RANDOM[10'h1D3][9:7];
        fofBuffer_vpu_veew = _RANDOM[10'h1D3][11:10];
        fofBuffer_pdest = _RANDOM[10'h1D7][15:7];
        fofBuffer_robIdx_flag = _RANDOM[10'h1D8][5];
        fofBuffer_robIdx_value = _RANDOM[10'h1D8][14:6];
        fofBufferValid = _RANDOM[10'h1EE][9];
        state = _RANDOM[10'h1EE][13:10];
        curPtr = _RANDOM[10'h1EE][14];
        isMisalignReg = _RANDOM[10'h1EE][15];
        notCross16ByteReg = _RANDOM[10'h1EE][16];
        combinedData =
          {_RANDOM[10'h1EE][31:17], _RANDOM[10'h1EF], _RANDOM[10'h1F0][16:0]};
        lowPagePaddr = {_RANDOM[10'h1F0][31:17], _RANDOM[10'h1F1], _RANDOM[10'h1F2][0]};
        triggerDebugMode = _RANDOM[10'h1F6][21];
        triggerBreakpoint = _RANDOM[10'h1F6][22];
        last_REG = _RANDOM[10'h1F6][23];
        nextBaseVaddr_r =
          {_RANDOM[10'h1F6][31:24], _RANDOM[10'h1F7], _RANDOM[10'h1F8][23:0]};
        io_uopwriteback_valid_REG = _RANDOM[10'h1F8][24];
        io_uopwriteback_bits_r_data_0 =
          {_RANDOM[10'h1F8][31:25],
           _RANDOM[10'h1F9],
           _RANDOM[10'h1FA],
           _RANDOM[10'h1FB],
           _RANDOM[10'h1FC][24:0]};
        io_uopwriteback_bits_r_pdest = _RANDOM[10'h1FC][31:25];
        io_uopwriteback_bits_r_robIdx_flag = _RANDOM[10'h1FD][5];
        io_uopwriteback_bits_r_robIdx_value = _RANDOM[10'h1FD][14:6];
        io_uopwriteback_bits_r_vecWen = _RANDOM[10'h1FD][15];
        io_uopwriteback_bits_r_v0Wen = _RANDOM[10'h1FD][16];
        io_uopwriteback_bits_r_vlWen = _RANDOM[10'h1FD][17];
        io_uopwriteback_bits_r_exceptionVec_3 = _RANDOM[10'h1FD][21];
        io_uopwriteback_bits_r_exceptionVec_5 = _RANDOM[10'h1FD][23];
        io_uopwriteback_bits_r_exceptionVec_7 = _RANDOM[10'h1FD][25];
        io_uopwriteback_bits_r_exceptionVec_13 = _RANDOM[10'h1FD][31];
        io_uopwriteback_bits_r_exceptionVec_15 = _RANDOM[10'h1FE][1];
        io_uopwriteback_bits_r_exceptionVec_19 = _RANDOM[10'h1FE][5];
        io_uopwriteback_bits_r_exceptionVec_21 = _RANDOM[10'h1FE][7];
        io_uopwriteback_bits_r_exceptionVec_23 = _RANDOM[10'h1FE][9];
        io_uopwriteback_bits_r_trigger = _RANDOM[10'h1FE][13:10];
        io_uopwriteback_bits_r_vls_vpu_vma = _RANDOM[10'h1FE][15];
        io_uopwriteback_bits_r_vls_vpu_vta = _RANDOM[10'h1FE][16];
        io_uopwriteback_bits_r_vls_vpu_vsew = _RANDOM[10'h1FE][18:17];
        io_uopwriteback_bits_r_vls_vpu_vlmul = _RANDOM[10'h1FE][21:19];
        io_uopwriteback_bits_r_vls_vpu_vm = _RANDOM[10'h1FE][30];
        io_uopwriteback_bits_r_vls_vpu_vstart =
          {_RANDOM[10'h1FE][31], _RANDOM[10'h1FF][6:0]};
        io_uopwriteback_bits_r_vls_vpu_vuopIdx = _RANDOM[10'h1FF][25:19];
        io_uopwriteback_bits_r_vls_vpu_vmask =
          {_RANDOM[10'h1FF][31:27],
           _RANDOM[10'h200],
           _RANDOM[10'h201],
           _RANDOM[10'h202],
           _RANDOM[10'h203][26:0]};
        io_uopwriteback_bits_r_vls_vpu_vl =
          {_RANDOM[10'h203][31:27], _RANDOM[10'h204][2:0]};
        io_uopwriteback_bits_r_vls_vpu_nf = _RANDOM[10'h204][5:3];
        io_uopwriteback_bits_r_vls_vpu_veew = _RANDOM[10'h204][7:6];
        io_uopwriteback_bits_r_vls_vdIdx = _RANDOM[10'h205][16:14];
        io_uopwriteback_bits_r_vls_vdIdxInField = _RANDOM[10'h205][19:17];
        io_uopwriteback_bits_r_vls_isIndexed = _RANDOM[10'h205][20];
        io_uopwriteback_bits_r_vls_isMasked = _RANDOM[10'h205][21];
        io_uopwriteback_bits_r_vls_isStrided = _RANDOM[10'h205][22];
        io_uopwriteback_bits_r_vls_isWhole = _RANDOM[10'h205][23];
        io_uopwriteback_bits_r_vls_isVecLoad = _RANDOM[10'h205][24];
        io_uopwriteback_bits_r_vls_isVlm = _RANDOM[10'h205][25];
        io_feedback_valid_REG = _RANDOM[10'h208][31];
        io_feedback_bits_r_sqIdx_flag = _RANDOM[10'h209][24];
        io_feedback_bits_r_sqIdx_value = _RANDOM[10'h209][31:25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        instMicroOpValid = 1'h0;
        enqPtr_flag = 1'h0;
    ...
    .io_in_bits_vaddr
      (isMisalignReg
         ? (notCross16ByteReg
              ...
              : curPtr ? 50'(_GEN_29 + 50'h8) : _GEN_29)
         : latchVaddr[49:0]),
    .io_in_bits_data
      (isMisalignReg
         ? (notCross16ByteReg
  ...
  assign io_dtlb_req_valid = _triggerBreakpoint_T_1 & (|_GEN_1);
