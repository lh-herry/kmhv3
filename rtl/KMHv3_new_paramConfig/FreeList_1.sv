...
module FreeList_1(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (remFreeSelIndexOHVec_highIndexOH != freeSlotOH_next_nextVec_0_r)
        freeSlotOH_next_nextVec_0_r <= remFreeSelIndexOHVec_highIndexOH;
      freeSlotCnt <=
