...
module L2Directory_2(
  ...
  reg          renReg;
  reg  [9:0]   addrRdReg;
  wire         selectedVec_0 = arrayReg == 6'h1C;
  wire         doSpread = selectedVec_0 | allReg;
  assign sramDataOut_0 = {36'h0, selectedVec_0 ? toSRAM_0_rdata : 76'h0};
  wire         selectedVec_0_1 = arrayReg == 6'h1D;
  wire         doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = {36'h0, selectedVec_0_1 ? toSRAM_1_rdata : 76'h0};
  wire         selectedVec_0_2 = arrayReg == 6'h1E;
  wire         doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = {36'h0, selectedVec_0_2 ? toSRAM_2_rdata : 76'h0};
  wire         selectedVec_0_3 = arrayReg == 6'h1F;
  wire         doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = {36'h0, selectedVec_0_3 ? toSRAM_3_rdata : 76'h0};
  wire         selectedVec_0_4 = arrayReg == 6'h20;
  wire         doSpread_4 = selectedVec_0_4 | allReg;
  assign sramDataOut_4 = selectedVec_0_4 ? toSRAM_4_rdata : 112'h0;
  wire         selectedVec_0_5 = arrayReg == 6'h21;
  wire         doSpread_5 = selectedVec_0_5 | allReg;
  assign sramDataOut_5 = {96'h0, selectedVec_0_5 ? toSRAM_5_rdata : 16'h0};
  wire         selectedVec_0_6 = arrayReg == 6'h22;
  wire         doSpread_6 = selectedVec_0_6 | allReg;
  assign sramDataOut_6 = {104'h0, selectedVec_0_6 ? toSRAM_6_rdata : 8'h0};
  wire         activated =
    mbist_all | mbist_req
    & (mbist_array == 6'h1C | mbist_array == 6'h1D | mbist_array == 6'h1E
       | mbist_array == 6'h1F | mbist_array == 6'h20 | mbist_array == 6'h21
       | mbist_array == 6'h22);
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[3'h0][31:27],
           ...
           _RANDOM[3'h3],
           _RANDOM[3'h4][10:0]};
        renReg = _RANDOM[3'h4][11];
        addrRdReg = _RANDOM[3'h4][21:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
