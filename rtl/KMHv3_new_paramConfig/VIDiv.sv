...
module VIDiv(
  ...
  wire         _io_out_bits_ctrl_vpu_T = _vidiv_io_div_in_ready & io_in_valid;
  ...
  wire         _GEN = _vidiv_io_div_in_ready | _io_out_bits_ctrl_vpu_T;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[5'h1][0];
        outCtrl_r_vpu_vta = _RANDOM[5'h1][1];
        outCtrl_r_vpu_vsew = _RANDOM[5'h1][3:2];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][15];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][23:16];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][10:4];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h6][27];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h6][28];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:22],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:22],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][21:0]};
        outData_r_vl = _RANDOM[5'h17][29:22];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h1B][30];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][31];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1C][8:0];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1C][17:9];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1C][18];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1C][19];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  VectorIdiv vidiv (
    ...
    .io_div_out_ready (_vidiv_io_div_out_valid),
