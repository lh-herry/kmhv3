  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        redirect_next_bits_r_meta_ras_ssp = _RANDOM[4'h7][18:15];
        redirect_next_bits_r_meta_ras_sctr = _RANDOM[4'h7][21:19];
        redirect_next_bits_r_meta_ras_tosw_flag = _RANDOM[4'h7][22];
        redirect_next_bits_r_meta_ras_tosw_value = _RANDOM[4'h7][27:23];
        redirect_next_bits_r_meta_ras_tosr_flag = _RANDOM[4'h7][28];
        redirect_next_bits_r_meta_ras_tosr_value =
          {_RANDOM[4'h7][31:29], _RANDOM[4'h8][1:0]};
        redirect_next_bits_r_meta_ras_nos_flag = _RANDOM[4'h8][2];
        redirect_next_bits_r_meta_ras_nos_value = _RANDOM[4'h8][7:3];
        commitValid = _RANDOM[4'h9][25];
        commitInfo_meta_ras_ssp = _RANDOM[4'h9][29:26];
        commitInfo_meta_ras_tosw_flag = _RANDOM[4'h9][30];
        commitInfo_meta_ras_tosw_value = {_RANDOM[4'h9][31], _RANDOM[4'hA][3:0]};
        commitInfo_attribute_rasAction = _RANDOM[4'hA][7:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        redirect_next_valid_last_REG = 1'h0;
        commitValid = 1'h0;
