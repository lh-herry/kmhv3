  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_pdest = _RANDOM[6'h8][13:5];
        bits_1_rfWen = _RANDOM[6'h8][19];
        bits_1_vecWen = _RANDOM[6'h8][21];
        bits_1_v0Wen = _RANDOM[6'h8][22];
        bits_1_loadDependency_0 = _RANDOM[6'hB][7:6];
        bits_1_loadDependency_1 = _RANDOM[6'hB][9:8];
        bits_1_loadDependency_2 = _RANDOM[6'hB][11:10];
        bits_2_is0Lat = _RANDOM[6'h10][25];
        bits_2_robIdx_flag = _RANDOM[6'h12][30];
        bits_2_robIdx_value = {_RANDOM[6'h12][31], _RANDOM[6'h13][7:0]};
        bits_2_pdest = _RANDOM[6'h13][22:14];
        bits_2_rfWen = _RANDOM[6'h13][28];
        bits_2_vecWen = _RANDOM[6'h13][30];
        bits_2_v0Wen = _RANDOM[6'h13][31];
        bits_2_loadDependency_0 = _RANDOM[6'h16][16:15];
        bits_2_loadDependency_1 = _RANDOM[6'h16][18:17];
        bits_2_loadDependency_2 = _RANDOM[6'h16][20:19];
        bits_3_is0Lat = _RANDOM[6'h1C][2];
        bits_3_robIdx_flag = _RANDOM[6'h1E][7];
        bits_3_robIdx_value = _RANDOM[6'h1E][16:8];
        bits_3_pdest = _RANDOM[6'h1E][31:23];
        bits_3_rfWen = _RANDOM[6'h1F][5];
        bits_3_vecWen = _RANDOM[6'h1F][7];
        bits_3_v0Wen = _RANDOM[6'h1F][8];
        bits_3_loadDependency_0 = _RANDOM[6'h21][25:24];
        bits_3_loadDependency_1 = _RANDOM[6'h21][27:26];
        bits_3_loadDependency_2 = _RANDOM[6'h21][29:28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
