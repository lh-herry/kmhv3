...
module PTW(
  ...
  input         io_req_bits_stage1_entry_0_cf,
  ...
  input         io_req_bits_stage1_entry_1_cf,
  ...
  input         io_req_bits_stage1_entry_2_cf,
  ...
  input         io_req_bits_stage1_entry_3_cf,
  ...
  input         io_req_bits_stage1_entry_4_cf,
  ...
  input         io_req_bits_stage1_entry_5_cf,
  ...
  input         io_req_bits_stage1_entry_6_cf,
  ...
  input         io_req_bits_stage1_entry_7_cf,
  ...
  output        io_resp_bits_resp_entry_0_cf,
  ...
  output        io_resp_bits_resp_entry_1_cf,
  ...
  output        io_resp_bits_resp_entry_2_cf,
  ...
  output        io_resp_bits_resp_entry_3_cf,
  ...
  output        io_resp_bits_resp_entry_4_cf,
  ...
  output        io_resp_bits_resp_entry_5_cf,
  ...
  output        io_resp_bits_resp_entry_6_cf,
  ...
  output        io_resp_bits_resp_entry_7_cf,
  ...
  wire [43:0]      current_satp_ppn =
    (|io_req_bits_req_info_s2xlate) ? io_csr_vsatp_ppn : io_csr_satp_ppn;
  wire [3:0]       satp_mode = (|req_s2xlate) ? io_csr_vsatp_mode : io_csr_satp_mode;
  wire [15:0]      satp_asid = (|req_s2xlate) ? io_csr_vsatp_asid : io_csr_satp_asid;
  wire [43:0]      satp_ppn = (|req_s2xlate) ? io_csr_vsatp_ppn : io_csr_satp_ppn;
  ...
  reg              l3Hit;
  reg              l2Hit;
  wire             jmp_bitmap_check_w =
    io_req_bits_bitmapCheck_jmp_bitmap_check & io_req_bits_req_info_s2xlate != 2'h2;
  wire             perfEvents_0_2 = idle & io_req_valid;
  reg              jmp_bitmap_check_r;
  reg              cache_pte_n;
  ...
  wire             pte_n = jmp_bitmap_check_r ? cache_pte_n : io_mem_resp_bits[63];
  wire [1:0]       pte_pbmt =
    jmp_bitmap_check_r ? cache_pte_pbmt : io_mem_resp_bits[62:61];
  wire [7:0]       pte_ppn_high =
    jmp_bitmap_check_r ? cache_pte_ppn_high : io_mem_resp_bits[53:46];
  wire [35:0]      pte_ppn = jmp_bitmap_check_r ? cache_pte_ppn : io_mem_resp_bits[45:10];
  wire             pte_perm_d =
    jmp_bitmap_check_r ? cache_pte_perm_d : io_mem_resp_bits[7];
  wire             pte_perm_a =
    jmp_bitmap_check_r ? cache_pte_perm_a : io_mem_resp_bits[6];
  wire             pte_perm_u =
    jmp_bitmap_check_r ? cache_pte_perm_u : io_mem_resp_bits[4];
  wire             pte_perm_x =
    jmp_bitmap_check_r ? cache_pte_perm_x : io_mem_resp_bits[3];
  wire             pte_perm_w =
    jmp_bitmap_check_r ? cache_pte_perm_w : io_mem_resp_bits[2];
  wire             pte_perm_r =
    jmp_bitmap_check_r ? cache_pte_perm_r : io_mem_resp_bits[1];
  wire             pte_perm_v =
    jmp_bitmap_check_r ? cache_pte_perm_v : io_mem_resp_bits[0];
  reg              s_pmp_check;
  reg              s_mem_req;
  reg              s_llptw_req;
  reg              w_mem_resp;
  ...
  reg              pte_valid;
  wire             _pageFault_pf_T_6 = pte_perm_r | pte_perm_x;
  wire             pageFault =
    ...
    | (~(_pageFault_pf_T_6 | pte_perm_w) & pte_perm_v
         ...
         : ~pte_perm_v | ~pte_perm_r & pte_perm_w | pte_n
           & (|{pte_ppn[3:0] != 4'h8, level}) | (_pageFault_pf_T_6 | pte_perm_w)
           & pte_perm_v
           & ~(level == 2'h0 | level == 2'h1 & pte_ppn[8:0] == 9'h0 | level == 2'h2
  ...
  reg  [1:0]       source;
  reg              accessFault;
  wire [43:0]      full_gvpn_wire = {pte_ppn_high, pte_ppn};
  wire [52:0]      _GEN =
    (&af_level)
      ? {satp_ppn, vpn[35:27]}
      : af_level == 2'h2
          ? (satp_mode == 4'h9
               ? {l3Hit ? ppn : {pte_ppn_high, pte_ppn}, vpn[26:18]}
               : {satp_ppn, vpn[26:18]})
          : {l2Hit ? ppn : full_gvpn_wire, vpn[17:9]};
  ...
  wire [3:0][35:0] _GEN_0 =
    {{{pte_ppn[35:27], vpn[26:0]}},
     {{pte_ppn[35:18], vpn[17:0]}},
     {{pte_ppn[35:9], vpn[8:0]}},
     {pte_ppn}};
  wire [55:0]      gpaddr =
    stage1Hit | onlyS2xlate
      ? {full_gvpn, 12'h0}
      : s_last_hptw_req ? {_GEN, 3'h0} : {pte_ppn_high, _GEN_0[level], 12'h0};
  ...
  wire [1:0]       resp_pte_pbmt = pte_valid ? pte_pbmt : 2'h0;
  wire [35:0]      resp_pte_ppn = pte_valid ? pte_ppn : ppn[35:0];
  wire             resp_pte_perm_d = pte_valid & pte_perm_d;
  wire             resp_pte_perm_a = pte_valid & pte_perm_a;
  wire             resp_pte_perm_g =
    pte_valid & (jmp_bitmap_check_r ? cache_pte_perm_g : io_mem_resp_bits[5]);
  wire             resp_pte_perm_u = pte_valid & pte_perm_u;
  wire             resp_pte_perm_x = pte_valid & pte_perm_x;
  wire             resp_pte_perm_w = pte_valid & pte_perm_w;
  wire             resp_pte_perm_r = pte_valid & pte_perm_r;
  wire             ptw_resp_1_v = pte_valid & pte_perm_v;
  wire [40:0]      ptw_resp_1_ppn =
    {pte_valid ? pte_ppn_high : ppn[43:36], resp_pte_ppn[35:3]};
  wire             ptw_resp_1_n =
    pte_valid & pte_n & resp_pte_ppn[3:0] == 4'h8 & resp_level == 2'h0;
  wire [7:0]       _GEN_2 = 8'h1 << vpn[2:0];
  ...
  wire [47:0]      _io_mem_req_bits_addr_T =
    s2xlate ? {_GEN_1[hptw_resp_entry_level][35:0], gpaddr[11:0]} : {_GEN[44:0], 3'h0};
  reg  [1:0]       cache_level;
  wire             io_mem_req_valid_0 =
    ~s_mem_req & ~io_mem_mask & ~accessFault & s_pmp_check;
  wire             io_hptw_req_valid_0 = ~s_hptw_req | ~s_last_hptw_req;
  wire             _GEN_3 = perfEvents_0_2 & jmp_bitmap_check_w;
  wire             _GEN_4 = perfEvents_0_2 & io_req_bits_stage1Hit & ~jmp_bitmap_check_w;
  wire             _GEN_5 = _GEN_4 | _GEN_3;
  wire             _GEN_6 = perfEvents_0_2 & ~io_req_bits_stage1Hit & ~jmp_bitmap_check_w;
  wire             _GEN_7 =
    ((|io_req_bits_req_info_s2xlate) ? io_csr_vsatp_mode : io_csr_satp_mode) == 4'h9;
  wire             _GEN_8 = _GEN_7 & io_req_bits_l3Hit;
  wire             _GEN_9 = _GEN_8 | io_req_bits_l2Hit;
  wire             _GEN_10 = _GEN_6 | _GEN_3;
  wire             _GEN_11 = _GEN_6 | _GEN_5;
  wire             _check_gpa_high_fail_T = io_req_bits_req_info_s2xlate == 2'h2;
  wire             _GEN_12 = io_hptw_resp_valid & ~w_hptw_resp;
  wire             _hptw_resp_gpf_T =
    io_hptw_resp_bits_h_resp_gpf | ~io_hptw_resp_bits_h_resp_gaf
    & ~io_hptw_resp_bits_h_resp_entry_perm_r
    & ~(io_csr_priv_mxr & io_hptw_resp_bits_h_resp_entry_perm_x);
  wire             _GEN_13 = io_hptw_resp_valid & ~w_last_hptw_resp;
  wire             _GEN_14 = _GEN_13 & stage1Hit;
  wire             _GEN_15 = _GEN_13 & ~stage1Hit;
  wire             _GEN_16 = _GEN_15 | _GEN_14;
  wire             perfEvents_4_2 = io_mem_req_ready & io_mem_req_valid_0;
  wire             _GEN_17 =
    level[1] & req_s2xlate != 2'h2 & ~(guestFault | find_pte | accessFault);
  wire             _GEN_18 = mem_addr_update & _GEN_17;
  wire             vs_finish = _GEN_18 & s2xlate;
  wire             _GEN_19 = s2xlate & need_last_s2xlate;
  wire             finish =
    mem_addr_update & ~_GEN_17 & (io_llptw_valid_0 | ~_GEN_19 & io_resp_valid_0);
  reg              perfEvents_5_2;
  ...
  wire [2:0]       full_gvpn_reg_idx =
    {|full_gvpn_reg_idx_hi, |(_full_gvpn_reg_idx_T_2[2:1]), _full_gvpn_reg_idx_T_4};
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_6) begin
      ppn <= _GEN_9 ? io_req_bits_ppn : current_satp_ppn;
      l3Hit <= _GEN_8;
    ...
    if (perfEvents_0_2) begin
      jmp_bitmap_check_r <= jmp_bitmap_check_w;
      cache_pte_n <= io_req_bits_bitmapCheck_pte[63];
      cache_pte_pbmt <= io_req_bits_bitmapCheck_pte[62:61];
      cache_pte_reserved <= io_req_bits_bitmapCheck_pte[60:54];
      cache_pte_ppn_high <= io_req_bits_bitmapCheck_pte[53:46];
      cache_pte_ppn <= io_req_bits_bitmapCheck_pte[45:10];
      cache_pte_perm_d <= io_req_bits_bitmapCheck_pte[7];
      cache_pte_perm_a <= io_req_bits_bitmapCheck_pte[6];
      cache_pte_perm_g <= io_req_bits_bitmapCheck_pte[5];
      cache_pte_perm_u <= io_req_bits_bitmapCheck_pte[4];
      cache_pte_perm_x <= io_req_bits_bitmapCheck_pte[3];
      cache_pte_perm_w <= io_req_bits_bitmapCheck_pte[2];
      cache_pte_perm_r <= io_req_bits_bitmapCheck_pte[1];
      cache_pte_perm_v <= io_req_bits_bitmapCheck_pte[0];
      ...
      stage1_entry_0_cf <= io_req_bits_stage1_entry_0_cf;
      ...
      stage1_entry_1_cf <= io_req_bits_stage1_entry_1_cf;
      ...
      stage1_entry_2_cf <= io_req_bits_stage1_entry_2_cf;
      ...
      stage1_entry_3_cf <= io_req_bits_stage1_entry_3_cf;
      ...
      stage1_entry_4_cf <= io_req_bits_stage1_entry_4_cf;
      ...
      stage1_entry_5_cf <= io_req_bits_stage1_entry_5_cf;
      ...
      stage1_entry_6_cf <= io_req_bits_stage1_entry_6_cf;
      ...
      stage1_entry_7_cf <= io_req_bits_stage1_entry_7_cf;
    ...
    hptw_resp_stage2 <= _GEN_14 | ~_GEN_4 & hptw_resp_stage2;
    if (_GEN_15 | _GEN_14 | _GEN_12) begin
        ...
        _GEN_21[full_gvpn_reg_idx] == 2'h0
          ...
          : {_GEN_21[full_gvpn_reg_idx] == 2'h1
               ...
               : _GEN_21[full_gvpn_reg_idx] == 2'h2
                   ...
                   : {_GEN_22[full_gvpn_reg_idx][40:24],
                      _GEN_20[full_gvpn_reg_idx][23:0]},
             |full_gvpn_reg_idx_hi,
             |(_full_gvpn_reg_idx_T_2[2:1]),
             _full_gvpn_reg_idx_T_4};
  ...
  wire             _GEN_26 = ~_GEN_5 & need_last_s2xlate;
  wire             _GEN_27 = io_resp_ready & io_resp_valid_0;
  wire [1:0]       _GEN_28 =
    io_req_bits_l2Hit ? 2'h1 : _GEN_7 ? {1'h1, ~io_req_bits_l3Hit} : 2'h2;
  wire [14:0]      gvpn_wire = _GEN_9 ? io_req_bits_ppn[43:29] : current_satp_ppn[43:29];
  wire             _GEN_29 = ~_GEN_6 & (_GEN_27 & stage1Hit | ~_GEN_5 & idle);
  ...
  wire             _GEN_30 = (&io_req_bits_req_info_s2xlate) & check_gpa_high_fail_1;
  wire             _GEN_31 = io_hptw_req_ready & io_hptw_req_valid_0;
  wire             _GEN_32 = _GEN_31 & ~s_hptw_req;
  wire             _GEN_33 = _hptw_resp_gpf_T | io_hptw_resp_bits_h_resp_gaf;
  wire             _GEN_34 =
    (~_GEN_12 | ~_GEN_33)
    & (_GEN_6
         ? ~_check_gpa_high_fail_T & (&io_req_bits_req_info_s2xlate)
           & (~check_gpa_high_fail_1 | _GEN_26)
         : _GEN_26);
  wire             _GEN_35 = _GEN_31 & ~s_last_hptw_req;
  wire             _GEN_36 = sent_to_pmp & ~mem_addr_update;
  wire             _GEN_37 = accessFault & ~idle;
  wire             _GEN_38 = guestFault & ~idle;
  wire             _GEN_39 = _GEN_38 | _GEN_37;
  wire             _GEN_40 = io_mem_resp_valid & ~w_mem_resp;
  wire             _GEN_41 =
    bitmap_enable & (~(|req_s2xlate) | onlyS1xlate) & (_find_pte_T | pte_perm_w)
    & pte_perm_v & ~pageFault;
  wire             _GEN_42 =
    (~whether_need_bitmap_check | _GEN_41) & (~_GEN_40 | bitmap_enable)
    & (_GEN_39 | s_llptw_req);
  wire             _GEN_43 = io_bitmap_req_ready & ~s_bitmap_check;
  wire             _GEN_44 = ~w_bitmap_resp & io_bitmap_resp_valid;
  wire             _GEN_45 =
    _GEN_44 | whether_need_bitmap_check & ~_GEN_41 | _GEN_40 & ~bitmap_enable | _GEN_38
    | _GEN_37 | _GEN_15 | _GEN_12 & _GEN_33
    | (_GEN_6
         ? (_check_gpa_high_fail_T
              ? check_gpa_high_fail | mem_addr_update
              : _GEN_30 | mem_addr_update)
         : mem_addr_update);
  wire             _GEN_46 = io_llptw_ready & io_llptw_valid_0;
  wire             _GEN_47 = ~mem_addr_update | _GEN_17;
  wire             _GEN_48 = guestFault | accessFault | pageFault | ppn_af;
  wire             _GEN_49 = ~_GEN_19 & _GEN_27;
  wire             _GEN_50 = _GEN_17 | io_llptw_valid_0 | _GEN_19;
  wire             _GEN_51 = ~mem_addr_update | _GEN_50 | ~_GEN_27;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_18)
        ...
        level <= io_req_bits_bitmapCheck_SPlevel;
      if (_GEN_40) begin
        af_level <= 2'(af_level - 2'h1);
        gpf_level <=
          satp_mode == 4'h8 & ~pte_valid & ~l2Hit
            ? 2'(gpf_level - 2'h2)
            : 2'(gpf_level - 2'h1);
      end
      ...
      s_pmp_check <=
        ...
        & s_pmp_check;
      s_mem_req <=
        flush | (~_GEN_18 | s2xlate) & (perfEvents_4_2 | _GEN_39 | ~_GEN_36 & s_mem_req);
      s_llptw_req <=
        flush
        | (mem_addr_update
             ? _GEN_17 | (io_llptw_valid_0 ? _GEN_46 | _GEN_42 : _GEN_49 | _GEN_42)
             : _GEN_42);
      w_mem_resp <= flush | _GEN_40 | ~perfEvents_4_2 & (_GEN_39 | w_mem_resp);
      s_hptw_req <=
        flush | ~(mem_addr_update & _GEN_17 & s2xlate)
        & (_GEN_38 | _GEN_37 | _GEN_32
           | (~_GEN_6 | _check_gpa_high_fail_T | ~(&io_req_bits_req_info_s2xlate)
              | check_gpa_high_fail_1) & s_hptw_req);
      w_hptw_resp <= flush | _GEN_38 | _GEN_37 | _GEN_12 | ~_GEN_32 & w_hptw_resp;
      s_last_hptw_req <=
        flush | (~mem_addr_update | _GEN_17 | io_llptw_valid_0 | ~(_GEN_19 & ~_GEN_48))
        & (_GEN_38 | _GEN_37 | _GEN_35
           | (~(_GEN_6 & _check_gpa_high_fail_T) | check_gpa_high_fail) & ~_GEN_4
           & s_last_hptw_req);
      w_last_hptw_resp <=
        flush | _GEN_38 | _GEN_37 | _GEN_16 | ~_GEN_35 & w_last_hptw_resp;
      mem_addr_update <=
        ~flush
        & (mem_addr_update
             ? ~_GEN_17
               & (io_llptw_valid_0
                    ? ~_GEN_46 & _GEN_45
                    : _GEN_19 ? _GEN_48 & _GEN_45 : ~_GEN_27 & _GEN_45)
             : _GEN_45);
      s_bitmap_check <=
        flush | _GEN_43 | ~(whether_need_bitmap_check & _GEN_41)
        & (_GEN_39 | ~_GEN_3 & s_bitmap_check);
      w_bitmap_resp <= flush | _GEN_44 | ~_GEN_43 & (_GEN_39 | w_bitmap_resp);
      whether_need_bitmap_check <=
        ~(flush | whether_need_bitmap_check)
        & (_GEN_40 ? bitmap_enable : ~_GEN_39 & whether_need_bitmap_check);
      bitmap_checkfailed <=
        ~flush & _GEN_51
        & (_GEN_44 ? io_bitmap_resp_bits_cf : ~_GEN_39 & bitmap_checkfailed);
      idle <=
        flush
        | (_GEN_47 ? _GEN_29 : io_llptw_valid_0 ? _GEN_46 | _GEN_29 : _GEN_49 | _GEN_29);
      hptw_pageFault <=
        _GEN_15
          ? io_hptw_resp_bits_h_resp_gpf
          : _GEN_12 ? _hptw_resp_gpf_T : ~_GEN_11 & hptw_pageFault;
      hptw_accessFault <=
        _GEN_15 | _GEN_12 ? io_hptw_resp_bits_h_resp_gaf : ~_GEN_11 & hptw_accessFault;
      need_last_s2xlate <=
        _GEN_47
          ? ~_GEN_39 & _GEN_34
          : io_llptw_valid_0
              ? ~(_GEN_46 | _GEN_39) & _GEN_34
              : ~(_GEN_19 | _GEN_39) & _GEN_34;
      first_gvpn_check_fail <=
        ~flush & _GEN_51
        & (_GEN_6
             ? (_check_gpa_high_fail_T
                  ? check_gpa_high_fail | first_gvpn_check_fail
                  : _GEN_30 | first_gvpn_check_fail)
             : first_gvpn_check_fail);
      pte_valid <= _GEN_40 | ~_GEN_6 & (_GEN_3 | pte_valid);
      accessFault <=
        ~flush
        & (~mem_addr_update | _GEN_50 | ~io_resp_valid_0
             ? ~_GEN_10 & _GEN_25
             : ~(_GEN_27 | _GEN_10) & _GEN_25);
      update_full_gvpn_mem_resp <=
        ~update_full_gvpn_mem_resp & (_GEN_40 | update_full_gvpn_mem_resp);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        jmp_bitmap_check_r = _RANDOM[6'h2][28];
        cache_pte_n = _RANDOM[6'h2][29];
        cache_pte_pbmt = _RANDOM[6'h2][31:30];
        cache_pte_reserved = _RANDOM[6'h3][6:0];
        cache_pte_ppn_high = _RANDOM[6'h3][14:7];
        cache_pte_ppn = {_RANDOM[6'h3][31:15], _RANDOM[6'h4][18:0]};
        cache_pte_perm_d = _RANDOM[6'h4][21];
        cache_pte_perm_a = _RANDOM[6'h4][22];
        cache_pte_perm_g = _RANDOM[6'h4][23];
        cache_pte_perm_u = _RANDOM[6'h4][24];
        cache_pte_perm_x = _RANDOM[6'h4][25];
        cache_pte_perm_w = _RANDOM[6'h4][26];
        cache_pte_perm_r = _RANDOM[6'h4][27];
        cache_pte_perm_v = _RANDOM[6'h4][28];
        s_pmp_check = _RANDOM[6'h4][29];
        s_mem_req = _RANDOM[6'h4][30];
        s_llptw_req = _RANDOM[6'h4][31];
        w_mem_resp = _RANDOM[6'h5][0];
        s_hptw_req = _RANDOM[6'h5][1];
        w_hptw_resp = _RANDOM[6'h5][2];
        s_last_hptw_req = _RANDOM[6'h5][3];
        w_last_hptw_resp = _RANDOM[6'h5][4];
        mem_addr_update = _RANDOM[6'h5][5];
        s_bitmap_check = _RANDOM[6'h5][6];
        w_bitmap_resp = _RANDOM[6'h5][7];
        whether_need_bitmap_check = _RANDOM[6'h5][8];
        bitmap_checkfailed = _RANDOM[6'h5][9];
        idle = _RANDOM[6'h5][10];
        hptw_pageFault = _RANDOM[6'h5][11];
        hptw_accessFault = _RANDOM[6'h5][12];
        need_last_s2xlate = _RANDOM[6'h5][13];
        stage1Hit = _RANDOM[6'h5][14];
        stage1_entry_0_tag = {_RANDOM[6'h5][31:15], _RANDOM[6'h6][17:0]};
        stage1_entry_0_asid = {_RANDOM[6'h6][31:18], _RANDOM[6'h7][1:0]};
        stage1_entry_0_vmid = _RANDOM[6'h7][15:2];
        stage1_entry_0_n = _RANDOM[6'h7][16];
        stage1_entry_0_pbmt = _RANDOM[6'h7][18:17];
        stage1_entry_0_perm_d = _RANDOM[6'h7][19];
        stage1_entry_0_perm_a = _RANDOM[6'h7][20];
        stage1_entry_0_perm_g = _RANDOM[6'h7][21];
        stage1_entry_0_perm_u = _RANDOM[6'h7][22];
        stage1_entry_0_perm_x = _RANDOM[6'h7][23];
        stage1_entry_0_perm_w = _RANDOM[6'h7][24];
        stage1_entry_0_perm_r = _RANDOM[6'h7][25];
        stage1_entry_0_level = _RANDOM[6'h7][27:26];
        stage1_entry_0_v = _RANDOM[6'h7][29];
        stage1_entry_0_ppn = {_RANDOM[6'h7][31:30], _RANDOM[6'h8], _RANDOM[6'h9][6:0]};
        stage1_entry_0_ppn_low = _RANDOM[6'h9][9:7];
        stage1_entry_0_pf = _RANDOM[6'h9][11];
        stage1_entry_0_cf = _RANDOM[6'h9][12];
        stage1_entry_1_tag = {_RANDOM[6'h9][31:13], _RANDOM[6'hA][15:0]};
        stage1_entry_1_asid = _RANDOM[6'hA][31:16];
        stage1_entry_1_vmid = _RANDOM[6'hB][13:0];
        stage1_entry_1_n = _RANDOM[6'hB][14];
        stage1_entry_1_pbmt = _RANDOM[6'hB][16:15];
        stage1_entry_1_perm_d = _RANDOM[6'hB][17];
        stage1_entry_1_perm_a = _RANDOM[6'hB][18];
        stage1_entry_1_perm_g = _RANDOM[6'hB][19];
        stage1_entry_1_perm_u = _RANDOM[6'hB][20];
        stage1_entry_1_perm_x = _RANDOM[6'hB][21];
        stage1_entry_1_perm_w = _RANDOM[6'hB][22];
        stage1_entry_1_perm_r = _RANDOM[6'hB][23];
        stage1_entry_1_level = _RANDOM[6'hB][25:24];
        stage1_entry_1_v = _RANDOM[6'hB][27];
        stage1_entry_1_ppn = {_RANDOM[6'hB][31:28], _RANDOM[6'hC], _RANDOM[6'hD][4:0]};
        stage1_entry_1_ppn_low = _RANDOM[6'hD][7:5];
        stage1_entry_1_pf = _RANDOM[6'hD][9];
        stage1_entry_1_cf = _RANDOM[6'hD][10];
        stage1_entry_2_tag = {_RANDOM[6'hD][31:11], _RANDOM[6'hE][13:0]};
        stage1_entry_2_asid = _RANDOM[6'hE][29:14];
        stage1_entry_2_vmid = {_RANDOM[6'hE][31:30], _RANDOM[6'hF][11:0]};
        stage1_entry_2_n = _RANDOM[6'hF][12];
        stage1_entry_2_pbmt = _RANDOM[6'hF][14:13];
        stage1_entry_2_perm_d = _RANDOM[6'hF][15];
        stage1_entry_2_perm_a = _RANDOM[6'hF][16];
        stage1_entry_2_perm_g = _RANDOM[6'hF][17];
        stage1_entry_2_perm_u = _RANDOM[6'hF][18];
        stage1_entry_2_perm_x = _RANDOM[6'hF][19];
        stage1_entry_2_perm_w = _RANDOM[6'hF][20];
        stage1_entry_2_perm_r = _RANDOM[6'hF][21];
        stage1_entry_2_level = _RANDOM[6'hF][23:22];
        stage1_entry_2_v = _RANDOM[6'hF][25];
        stage1_entry_2_ppn = {_RANDOM[6'hF][31:26], _RANDOM[6'h10], _RANDOM[6'h11][2:0]};
        stage1_entry_2_ppn_low = _RANDOM[6'h11][5:3];
        stage1_entry_2_pf = _RANDOM[6'h11][7];
        stage1_entry_2_cf = _RANDOM[6'h11][8];
        stage1_entry_3_tag = {_RANDOM[6'h11][31:9], _RANDOM[6'h12][11:0]};
        stage1_entry_3_asid = _RANDOM[6'h12][27:12];
        stage1_entry_3_vmid = {_RANDOM[6'h12][31:28], _RANDOM[6'h13][9:0]};
        stage1_entry_3_n = _RANDOM[6'h13][10];
        stage1_entry_3_pbmt = _RANDOM[6'h13][12:11];
        stage1_entry_3_perm_d = _RANDOM[6'h13][13];
        stage1_entry_3_perm_a = _RANDOM[6'h13][14];
        stage1_entry_3_perm_g = _RANDOM[6'h13][15];
        stage1_entry_3_perm_u = _RANDOM[6'h13][16];
        stage1_entry_3_perm_x = _RANDOM[6'h13][17];
        stage1_entry_3_perm_w = _RANDOM[6'h13][18];
        stage1_entry_3_perm_r = _RANDOM[6'h13][19];
        stage1_entry_3_level = _RANDOM[6'h13][21:20];
        stage1_entry_3_v = _RANDOM[6'h13][23];
        stage1_entry_3_ppn = {_RANDOM[6'h13][31:24], _RANDOM[6'h14], _RANDOM[6'h15][0]};
        stage1_entry_3_ppn_low = _RANDOM[6'h15][3:1];
        stage1_entry_3_pf = _RANDOM[6'h15][5];
        stage1_entry_3_cf = _RANDOM[6'h15][6];
        stage1_entry_4_tag = {_RANDOM[6'h15][31:7], _RANDOM[6'h16][9:0]};
        stage1_entry_4_asid = _RANDOM[6'h16][25:10];
        stage1_entry_4_vmid = {_RANDOM[6'h16][31:26], _RANDOM[6'h17][7:0]};
        stage1_entry_4_n = _RANDOM[6'h17][8];
        stage1_entry_4_pbmt = _RANDOM[6'h17][10:9];
        stage1_entry_4_perm_d = _RANDOM[6'h17][11];
        stage1_entry_4_perm_a = _RANDOM[6'h17][12];
        stage1_entry_4_perm_g = _RANDOM[6'h17][13];
        stage1_entry_4_perm_u = _RANDOM[6'h17][14];
        stage1_entry_4_perm_x = _RANDOM[6'h17][15];
        stage1_entry_4_perm_w = _RANDOM[6'h17][16];
        stage1_entry_4_perm_r = _RANDOM[6'h17][17];
        stage1_entry_4_level = _RANDOM[6'h17][19:18];
        stage1_entry_4_v = _RANDOM[6'h17][21];
        stage1_entry_4_ppn = {_RANDOM[6'h17][31:22], _RANDOM[6'h18][30:0]};
        stage1_entry_4_ppn_low = {_RANDOM[6'h18][31], _RANDOM[6'h19][1:0]};
        stage1_entry_4_pf = _RANDOM[6'h19][3];
        stage1_entry_4_cf = _RANDOM[6'h19][4];
        stage1_entry_5_tag = {_RANDOM[6'h19][31:5], _RANDOM[6'h1A][7:0]};
        stage1_entry_5_asid = _RANDOM[6'h1A][23:8];
        stage1_entry_5_vmid = {_RANDOM[6'h1A][31:24], _RANDOM[6'h1B][5:0]};
        stage1_entry_5_n = _RANDOM[6'h1B][6];
        stage1_entry_5_pbmt = _RANDOM[6'h1B][8:7];
        stage1_entry_5_perm_d = _RANDOM[6'h1B][9];
        stage1_entry_5_perm_a = _RANDOM[6'h1B][10];
        stage1_entry_5_perm_g = _RANDOM[6'h1B][11];
        stage1_entry_5_perm_u = _RANDOM[6'h1B][12];
        stage1_entry_5_perm_x = _RANDOM[6'h1B][13];
        stage1_entry_5_perm_w = _RANDOM[6'h1B][14];
        stage1_entry_5_perm_r = _RANDOM[6'h1B][15];
        stage1_entry_5_level = _RANDOM[6'h1B][17:16];
        stage1_entry_5_v = _RANDOM[6'h1B][19];
        stage1_entry_5_ppn = {_RANDOM[6'h1B][31:20], _RANDOM[6'h1C][28:0]};
        stage1_entry_5_ppn_low = _RANDOM[6'h1C][31:29];
        stage1_entry_5_pf = _RANDOM[6'h1D][1];
        stage1_entry_5_cf = _RANDOM[6'h1D][2];
        stage1_entry_6_tag = {_RANDOM[6'h1D][31:3], _RANDOM[6'h1E][5:0]};
        stage1_entry_6_asid = _RANDOM[6'h1E][21:6];
        stage1_entry_6_vmid = {_RANDOM[6'h1E][31:22], _RANDOM[6'h1F][3:0]};
        stage1_entry_6_n = _RANDOM[6'h1F][4];
        stage1_entry_6_pbmt = _RANDOM[6'h1F][6:5];
        stage1_entry_6_perm_d = _RANDOM[6'h1F][7];
        stage1_entry_6_perm_a = _RANDOM[6'h1F][8];
        stage1_entry_6_perm_g = _RANDOM[6'h1F][9];
        stage1_entry_6_perm_u = _RANDOM[6'h1F][10];
        stage1_entry_6_perm_x = _RANDOM[6'h1F][11];
        stage1_entry_6_perm_w = _RANDOM[6'h1F][12];
        stage1_entry_6_perm_r = _RANDOM[6'h1F][13];
        stage1_entry_6_level = _RANDOM[6'h1F][15:14];
        stage1_entry_6_v = _RANDOM[6'h1F][17];
        stage1_entry_6_ppn = {_RANDOM[6'h1F][31:18], _RANDOM[6'h20][26:0]};
        stage1_entry_6_ppn_low = _RANDOM[6'h20][29:27];
        stage1_entry_6_pf = _RANDOM[6'h20][31];
        stage1_entry_6_cf = _RANDOM[6'h21][0];
        stage1_entry_7_tag = {_RANDOM[6'h21][31:1], _RANDOM[6'h22][3:0]};
        stage1_entry_7_asid = _RANDOM[6'h22][19:4];
        stage1_entry_7_vmid = {_RANDOM[6'h22][31:20], _RANDOM[6'h23][1:0]};
        stage1_entry_7_n = _RANDOM[6'h23][2];
        stage1_entry_7_pbmt = _RANDOM[6'h23][4:3];
        stage1_entry_7_perm_d = _RANDOM[6'h23][5];
        stage1_entry_7_perm_a = _RANDOM[6'h23][6];
        stage1_entry_7_perm_g = _RANDOM[6'h23][7];
        stage1_entry_7_perm_u = _RANDOM[6'h23][8];
        stage1_entry_7_perm_x = _RANDOM[6'h23][9];
        stage1_entry_7_perm_w = _RANDOM[6'h23][10];
        stage1_entry_7_perm_r = _RANDOM[6'h23][11];
        stage1_entry_7_level = _RANDOM[6'h23][13:12];
        stage1_entry_7_v = _RANDOM[6'h23][15];
        stage1_entry_7_ppn = {_RANDOM[6'h23][31:16], _RANDOM[6'h24][24:0]};
        stage1_entry_7_ppn_low = _RANDOM[6'h24][27:25];
        stage1_entry_7_pf = _RANDOM[6'h24][29];
        stage1_entry_7_cf = _RANDOM[6'h24][30];
        stage1_pteidx_0 = _RANDOM[6'h24][31];
        stage1_pteidx_1 = _RANDOM[6'h25][0];
        stage1_pteidx_2 = _RANDOM[6'h25][1];
        stage1_pteidx_3 = _RANDOM[6'h25][2];
        stage1_pteidx_4 = _RANDOM[6'h25][3];
        stage1_pteidx_5 = _RANDOM[6'h25][4];
        stage1_pteidx_6 = _RANDOM[6'h25][5];
        stage1_pteidx_7 = _RANDOM[6'h25][6];
        stage1_not_super = _RANDOM[6'h25][7];
        hptw_resp_stage2 = _RANDOM[6'h25][9];
        first_gvpn_check_fail = _RANDOM[6'h25][10];
        pte_valid = _RANDOM[6'h25][11];
        source = _RANDOM[6'h25][13:12];
        accessFault = _RANDOM[6'h25][14];
        hptw_resp_entry_tag = {_RANDOM[6'h25][31:15], _RANDOM[6'h26][20:0]};
        hptw_resp_entry_vmid = _RANDOM[6'h27][18:5];
        hptw_resp_entry_n = _RANDOM[6'h27][19];
        hptw_resp_entry_pbmt = _RANDOM[6'h27][21:20];
        hptw_resp_entry_ppn = {_RANDOM[6'h27][31:22], _RANDOM[6'h28][27:0]};
        hptw_resp_entry_perm_d = _RANDOM[6'h28][28];
        hptw_resp_entry_perm_a = _RANDOM[6'h28][29];
        hptw_resp_entry_perm_x = _RANDOM[6'h29][0];
        hptw_resp_entry_perm_w = _RANDOM[6'h29][1];
        hptw_resp_entry_perm_r = _RANDOM[6'h29][2];
        hptw_resp_entry_level = _RANDOM[6'h29][4:3];
        hptw_resp_gpf = _RANDOM[6'h29][7];
        hptw_resp_gaf = _RANDOM[6'h29][8];
        update_full_gvpn_mem_resp = _RANDOM[6'h29][9];
        full_gvpn_reg = {_RANDOM[6'h29][31:10], _RANDOM[6'h2A][21:0]};
        cache_level = _RANDOM[6'h2A][23:22];
        perfEvents_5_2 = _RANDOM[6'h2A][25];
        io_perf_0_value_REG = _RANDOM[6'h2A][26];
        io_perf_0_value_REG_1 = _RANDOM[6'h2A][27];
        io_perf_1_value_REG = _RANDOM[6'h2A][28];
        io_perf_1_value_REG_1 = _RANDOM[6'h2A][29];
        io_perf_2_value_REG = _RANDOM[6'h2A][30];
        io_perf_2_value_REG_1 = _RANDOM[6'h2A][31];
        io_perf_3_value_REG = _RANDOM[6'h2B][0];
        io_perf_3_value_REG_1 = _RANDOM[6'h2B][1];
        io_perf_4_value_REG = _RANDOM[6'h2B][2];
        io_perf_4_value_REG_1 = _RANDOM[6'h2B][3];
        io_perf_5_value_REG = _RANDOM[6'h2B][4];
        io_perf_5_value_REG_1 = _RANDOM[6'h2B][5];
        io_perf_6_value_REG = _RANDOM[6'h2B][6];
        io_perf_6_value_REG_1 = _RANDOM[6'h2B][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        level = 2'h3;
        af_level = 2'h3;
  ...
  assign io_resp_bits_resp_entry_0_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_1_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_2_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_3_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_4_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_5_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_6_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_cf : bitmap_checkfailed;
  ...
  assign io_resp_bits_resp_entry_7_cf =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_cf : bitmap_checkfailed;
  assign io_resp_bits_resp_pteidx_0 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_0 : _GEN_2[0];
  assign io_resp_bits_resp_pteidx_1 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_1 : _GEN_2[1];
  assign io_resp_bits_resp_pteidx_2 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_2 : _GEN_2[2];
  assign io_resp_bits_resp_pteidx_3 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_3 : _GEN_2[3];
  assign io_resp_bits_resp_pteidx_4 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_4 : _GEN_2[4];
  assign io_resp_bits_resp_pteidx_5 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_5 : _GEN_2[5];
  assign io_resp_bits_resp_pteidx_6 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_6 : _GEN_2[6];
  assign io_resp_bits_resp_pteidx_7 =
    _io_resp_bits_resp_T_4 ? stage1_pteidx_7 : _GEN_2[7];
  ...
  assign io_bitmap_req_bits_vpn = vpn;
  assign io_bitmap_req_bits_level = jmp_bitmap_check_r ? cache_level : level;
  assign io_bitmap_req_bits_s2xlate = req_s2xlate;
