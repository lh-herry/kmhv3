...
module TLXbar_7(
  ...
  wire        allowed_1;
  wire        allowed_0;
  wire [6:0]  _GEN = {1'h0, auto_in_0_a_bits_source};
  wire [6:0]  out_3_c_bits_source = {1'h0, auto_in_0_c_bits_source};
  wire [6:0]  in_1_a_bits_source = {3'h5, auto_in_1_a_bits_source};
  wire [6:0]  in_2_a_bits_source = {3'h4, auto_in_2_a_bits_source};
  wire [9:0]  out_0_d_bits_sink = {2'h3, auto_out_0_d_bits_sink};
  wire [9:0]  out_1_d_bits_sink = {2'h2, auto_out_1_d_bits_sink};
  wire [9:0]  _GEN_0 = {2'h1, auto_out_2_d_bits_sink};
  wire [9:0]  _GEN_1 = {2'h0, auto_out_3_d_bits_sink};
  ...
  wire        requestDOI_0_1 = auto_out_0_d_bits_source[6:4] == 3'h5;
  wire        requestDOI_0_2 = auto_out_0_d_bits_source[6:4] == 3'h4;
  wire        requestDOI_1_1 = auto_out_1_d_bits_source[6:4] == 3'h5;
  wire        requestDOI_1_2 = auto_out_1_d_bits_source[6:4] == 3'h4;
  wire        requestDOI_2_1 = auto_out_2_d_bits_source[6:4] == 3'h5;
  wire        requestDOI_2_2 = auto_out_2_d_bits_source[6:4] == 3'h4;
  wire        requestDOI_3_1 = auto_out_3_d_bits_source[6:4] == 3'h5;
  wire        requestDOI_3_2 = auto_out_3_d_bits_source[6:4] == 3'h4;
  ...
  wire        _GEN_2 = portsAOI_filtered_2_0_valid & _readys_filter_T[2];
  wire [3:0]  _GEN_3 =
  ...
  wire [5:0]  readys_unready =
    {1'h0, _GEN_2, _GEN_3[3], _GEN_3[2:0] | {_GEN_2, _GEN_3[3:2]}} | {readys_mask, 3'h0};
  ...
  wire [2:0]  _readys_filter_T_2 = ~readys_mask_1;
  wire [2:0]  _readys_filter_T_3 = readys_valid_1 & _readys_filter_T_2;
  wire        _GEN_4 = portsAOI_filtered_2_1_valid & _readys_filter_T_2[2];
  wire [3:0]  _GEN_5 =
  ...
  wire [5:0]  readys_unready_1 =
    {1'h0, _GEN_4, _GEN_5[3], _GEN_5[2:0] | {_GEN_4, _GEN_5[3:2]}}
    | {readys_mask_1, 3'h0};
  ...
  wire [2:0]  _readys_filter_T_4 = ~readys_mask_2;
  wire [2:0]  _readys_filter_T_5 = readys_valid_2 & _readys_filter_T_4;
  wire        _GEN_6 = portsAOI_filtered_2_2_valid & _readys_filter_T_4[2];
  wire [3:0]  _GEN_7 =
  ...
  wire [5:0]  readys_unready_2 =
    {1'h0, _GEN_6, _GEN_7[3], _GEN_7[2:0] | {_GEN_6, _GEN_7[3:2]}}
    | {readys_mask_2, 3'h0};
  wire [2:0]  readys_readys_2 = ~(readys_unready_2[5:3] & readys_unready_2[2:0]);
  ...
  wire        _GEN_8 = portsAOI_filtered_2_3_valid & _readys_filter_T_6[2];
  wire [3:0]  _GEN_9 =
  ...
  wire [5:0]  readys_unready_3 =
    {1'h0, _GEN_8, _GEN_9[3], _GEN_9[2:0] | {_GEN_8, _GEN_9[3:2]}}
    | {readys_mask_3, 3'h0};
  ...
  wire        _GEN_10 = portsBIO_filtered_3_0_valid & _readys_filter_T_8[3];
  wire [5:0]  _GEN_11 =
  ...
  wire [7:0]  readys_unready_4 =
    {1'h0, _GEN_10, _GEN_11[5], _GEN_11[4:0] | {_GEN_10, _GEN_11[5:2]}}
    | {readys_mask_4, 4'h0};
  ...
  wire        _GEN_12 = portsDIO_filtered_3_0_valid & _readys_filter_T_10[3];
  wire [5:0]  _GEN_13 =
  ...
  wire [7:0]  readys_unready_5 =
    {1'h0, _GEN_12, _GEN_13[5], _GEN_13[4:0] | {_GEN_12, _GEN_13[5:2]}}
    | {readys_mask_5, 4'h0};
  ...
  wire        _GEN_14 = portsDIO_filtered_3_1_valid & _readys_filter_T_12[3];
  wire [5:0]  _GEN_15 =
  ...
  wire [7:0]  readys_unready_6 =
    {1'h0, _GEN_14, _GEN_15[5], _GEN_15[4:0] | {_GEN_14, _GEN_15[5:2]}}
    | {readys_mask_6, 4'h0};
  ...
  wire [3:0]  _readys_filter_T_14 = ~readys_mask_7;
  wire [3:0]  _readys_filter_T_15 = readys_valid_7 & _readys_filter_T_14;
  wire        _GEN_16 = portsDIO_filtered_3_2_valid & _readys_filter_T_14[3];
  wire [5:0]  _GEN_17 =
  ...
  wire [7:0]  readys_unready_7 =
    {1'h0, _GEN_16, _GEN_17[5], _GEN_17[4:0] | {_GEN_16, _GEN_17[5:2]}}
    | {readys_mask_7, 4'h0};
  wire [3:0]  readys_readys_7 = ~(readys_unready_7[7:4] & readys_unready_7[3:0]);
  ...
  assign auto_in_2_d_bits_source =
    (muxState_7_0 ? auto_out_0_d_bits_source[3:0] : 4'h0)
    | (muxState_7_1 ? auto_out_1_d_bits_source[3:0] : 4'h0)
    | (muxState_7_2 ? auto_out_2_d_bits_source[3:0] : 4'h0)
    | (muxState_7_3 ? auto_out_3_d_bits_source[3:0] : 4'h0);
  assign auto_in_2_d_bits_sink =
    (muxState_7_0 ? out_0_d_bits_sink : 10'h0)
    | (muxState_7_1 ? out_1_d_bits_sink : 10'h0) | (muxState_7_2 ? _GEN_0 : 10'h0)
    | (muxState_7_3 ? _GEN_1 : 10'h0);
  ...
  assign auto_in_1_d_bits_sink =
    ...
    | (muxState_6_1 ? out_1_d_bits_sink : 10'h0) | (muxState_6_2 ? _GEN_0 : 10'h0)
    | (muxState_6_3 ? _GEN_1 : 10'h0);
  ...
  assign auto_in_0_d_bits_sink =
    ...
    | (muxState_5_1 ? out_1_d_bits_sink : 10'h0) | (muxState_5_2 ? _GEN_0 : 10'h0)
    | (muxState_5_3 ? _GEN_1 : 10'h0);
  ...
  assign auto_out_3_a_bits_source =
    (muxState_3_0 ? _GEN : 7'h0) | (muxState_3_1 ? in_1_a_bits_source : 7'h0)
  ...
  assign auto_out_3_a_bits_user_alias = muxState_3_0 ? auto_in_0_a_bits_user_alias : 2'h0;
  assign auto_out_3_a_bits_user_vaddr =
    muxState_3_0 ? auto_in_0_a_bits_user_vaddr : 44'h0;
  assign auto_out_3_a_bits_user_needHint = muxState_3_0 & auto_in_0_a_bits_user_needHint;
  ...
  assign auto_out_2_a_bits_source =
    (muxState_2_0 ? _GEN : 7'h0) | (muxState_2_1 ? in_1_a_bits_source : 7'h0)
  ...
  assign auto_out_2_a_bits_user_alias = muxState_2_0 ? auto_in_0_a_bits_user_alias : 2'h0;
  assign auto_out_2_a_bits_user_vaddr =
    muxState_2_0 ? auto_in_0_a_bits_user_vaddr : 44'h0;
  assign auto_out_2_a_bits_user_needHint = muxState_2_0 & auto_in_0_a_bits_user_needHint;
  ...
  assign auto_out_1_a_bits_source =
    (muxState_1_0 ? _GEN : 7'h0) | (muxState_1_1 ? in_1_a_bits_source : 7'h0)
  ...
  assign auto_out_1_a_bits_user_alias = muxState_1_0 ? auto_in_0_a_bits_user_alias : 2'h0;
  assign auto_out_1_a_bits_user_vaddr =
    muxState_1_0 ? auto_in_0_a_bits_user_vaddr : 44'h0;
  assign auto_out_1_a_bits_user_needHint = muxState_1_0 & auto_in_0_a_bits_user_needHint;
  ...
  assign auto_out_0_a_bits_source =
    (muxState_0 ? _GEN : 7'h0) | (muxState_1 ? in_1_a_bits_source : 7'h0)
  ...
  assign auto_out_0_a_bits_user_alias = muxState_0 ? auto_in_0_a_bits_user_alias : 2'h0;
  assign auto_out_0_a_bits_user_vaddr = muxState_0 ? auto_in_0_a_bits_user_vaddr : 44'h0;
  assign auto_out_0_a_bits_user_needHint = muxState_0 & auto_in_0_a_bits_user_needHint;
