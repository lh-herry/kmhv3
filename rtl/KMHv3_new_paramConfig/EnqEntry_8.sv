  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_og1Payload_fuOpType = {_RANDOM[4'h3][31:26], _RANDOM[4'h4][2:0]};
        entryReg_payload_og1Payload_selImm = _RANDOM[4'h4][6:3];
        entryReg_payload_og1Payload_imm = {_RANDOM[4'h4][31:7], _RANDOM[4'h5][6:0]};
        entryReg_payload_srcType_0 = _RANDOM[4'h5][10:7];
        entryReg_payload_srcType_1 = _RANDOM[4'h5][14:11];
        entryReg_payload_rfWen = _RANDOM[4'h6][19];
        entryReg_payload_pdest = _RANDOM[4'h6][28:20];
        enqDelayValidReg_last_REG = _RANDOM[4'h7][9];
        io_commonOut_entry_bits_payload_og1Payload_REG_fuOpType = _RANDOM[4'h7][18:10];
        io_commonOut_entry_bits_payload_og1Payload_REG_selImm = _RANDOM[4'h7][22:19];
        io_commonOut_entry_bits_payload_og1Payload_REG_imm =
          {_RANDOM[4'h7][31:23], _RANDOM[4'h8][22:0]};
        io_commonOut_entry_bits_status_srcStatus_0_psrc_REG = _RANDOM[4'h8][31:23];
        io_commonOut_entry_bits_status_srcStatus_1_psrc_REG = _RANDOM[4'h9][8:0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
