...
module skidBufferConnect(
  ...
  reg  [4:0]   dataBuffer_uop_ftqPtr_value;
  ...
  reg  [6:0]   dataBuffer_uop_sqIdx_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataBuffer_uop_ftqPtr_value = _RANDOM[6'h13][8:4];
        dataBuffer_uop_ftqOffset = _RANDOM[6'h13][13:9];
        dataBuffer_uop_fuOpType = _RANDOM[6'h15][22:14];
        ...
        dataBuffer_uop_pdest = _RANDOM[6'h21][10:2];
        dataBuffer_uop_robIdx_flag = _RANDOM[6'h22][0];
        dataBuffer_uop_robIdx_value = _RANDOM[6'h22][9:1];
        dataBuffer_uop_lqIdx_flag = _RANDOM[6'h37][13];
        dataBuffer_uop_lqIdx_value = _RANDOM[6'h37][20:14];
        dataBuffer_uop_sqIdx_flag = _RANDOM[6'h37][21];
        dataBuffer_uop_sqIdx_value = _RANDOM[6'h37][28:22];
        dataBuffer_preIsSplit = _RANDOM[6'h3C][8];
        dataBuffer_mBIndex = _RANDOM[6'h3C][12:9];
        dataBuffer_alignedType = _RANDOM[6'h3C][15:13];
        dataBuffer_indexVlMaxInVd = _RANDOM[6'h3C][23:16];
        dataBuffer_usLowBitsAddr = _RANDOM[6'h3C][27:24];
        dataBuffer_usAligned128 = _RANDOM[6'h3C][28];
        dataBuffer_usMask = {_RANDOM[6'h3C][31:29], _RANDOM[6'h3D][28:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 1'h0;
    end // initial
