...
module FloatAdderF32WidenF16MixedPipeline(
  ...
  wire        fp_b_is_greater =
    ...
    & fp_a_to32[31]
    & (~_U_far_path_io_isEfp_bGreater & fp_a_to32[30:23] != fp_b_to32[30:23]
       | fp_b_exponent_is_equal & ~fp_b_significand_is_greater
       & fp_a_to32[22:0] != fp_b_to32[22:0]);
  wire        fp_b_is_equal =
    fp_a_to32[31] == fp_b_to32[31] & fp_b_exponent_is_equal
    & fp_a_to32[22:0] == fp_b_to32[22:0] | _fp_b_is_equal_T_2;
  ...
  always @(posedge clock) begin
    if (io_fire) begin
      ...
      io_fp_c_r_1 <=
        (is_min ? result_min : 32'h0) | (is_max ? result_max : 32'h0)
        ...
        | (is_fmax_re
             ? (_result_fmin_re_T
                  ? out_NAN
                  : (&io_maskForReduction) ? result_max : re_masked_one_out)
             : 32'h0)
        | (is_fmin_re
             ? (_result_fmin_re_T
                  ? out_NAN
                  : (&io_maskForReduction) ? result_min : re_masked_one_out)
             : 32'h0)
