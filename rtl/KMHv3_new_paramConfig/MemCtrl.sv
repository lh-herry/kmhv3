  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lfst_io_redirect_REG_bits_level = _RANDOM[5'hF][5];
        lfst_io_redirect_REG_bits_robIdx_flag = _RANDOM[5'hF][9];
        lfst_io_redirect_REG_bits_robIdx_value = _RANDOM[5'hF][18:10];
        REG_0_valid = _RANDOM[5'h14][3];
        REG_0_bits_robIdx_value = _RANDOM[5'h14][13:5];
        REG_0_bits_ssid = _RANDOM[5'h14][18:14];
        REG_0_bits_storeSetHit = _RANDOM[5'h14][19];
        REG_1_valid = _RANDOM[5'h14][20];
        REG_1_bits_robIdx_value = _RANDOM[5'h14][30:22];
        REG_1_bits_ssid = {_RANDOM[5'h14][31], _RANDOM[5'h15][3:0]};
        REG_1_bits_storeSetHit = _RANDOM[5'h15][4];
        lfst_io_csrCtrl_REG_lvpred_disable = _RANDOM[5'h16][6];
        lfst_io_csrCtrl_REG_no_spec_load = _RANDOM[5'h16][7];
        lfst_io_csrCtrl_REG_storeset_wait_store = _RANDOM[5'h16][8];
      `endif // RANDOMIZE_REG_INIT
    end // initial
