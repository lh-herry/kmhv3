...
module VMask(
  ...
  assign vid_vd_0 =
    _GEN_34 | _GEN_35 | vsew_reg == 2'h2 | (&vsew_reg) ? vd_reg[7:0] : 8'h0;
      ...
      : reg_vmsbf_m | reg_vmsif_m | reg_vmsof_m
          ...
          : (reg_vid_v | reg_viota_m) & ~(uopIdx_reg[0])
              ? ({vid_vd_15,
                  ...
                  vid_vd_2,
                  vid_vd_1,
                  vid_vd_0} & vmask_vd_bits | _GEN_33 & ~vmask_vd_bits) & vmask_tail_bits
                & _vmask_vstart_bits_T[127:0] | ({128{ta_reg}} | old_vd_reg)
                & ~vmask_tail_bits | old_vd_reg & ~(_vmask_vstart_bits_T[127:0])
              : vd_reg;
endmodule
