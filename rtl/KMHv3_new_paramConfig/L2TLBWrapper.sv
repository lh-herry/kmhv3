...
module L2TLBWrapper(
  ...
  input          io_csr_tlb_priv_vmxr,
  input          io_csr_tlb_priv_vsum,
  input          io_csr_tlb_priv_virt,
  input          io_csr_tlb_priv_virt_changed,
  input          io_csr_tlb_priv_spvp,
  input  [1:0]   io_csr_tlb_priv_imode,
  input  [1:0]   io_csr_tlb_priv_dmode,
  input          io_csr_tlb_mPBMTE,
  input          io_csr_tlb_hPBMTE,
  input  [1:0]   io_csr_tlb_pmm_mseccfg,
  input  [1:0]   io_csr_tlb_pmm_menvcfg,
  input  [1:0]   io_csr_tlb_pmm_henvcfg,
  input  [1:0]   io_csr_tlb_pmm_hstatus,
  input  [1:0]   io_csr_tlb_pmm_senvcfg,
