  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_robIdx_flag = _RANDOM[7'h12][28];
        req_uop_robIdx_value = {_RANDOM[7'h12][31:29], _RANDOM[7'h13][5:0]};
        req_uop_lqIdx_flag = _RANDOM[7'h28][9];
        req_uop_lqIdx_value = _RANDOM[7'h28][16:10];
        req_vaddr = {_RANDOM[7'h29], _RANDOM[7'h2A][17:0]};
        req_fullva = {_RANDOM[7'h2A][31:18], _RANDOM[7'h2B], _RANDOM[7'h2C][17:0]};
        req_paddr = {_RANDOM[7'h2C][31:19], _RANDOM[7'h2D], _RANDOM[7'h2E][2:0]};
        req_gpaddr = {_RANDOM[7'h2E][31:3], _RANDOM[7'h2F], _RANDOM[7'h30][2:0]};
        req_mask = _RANDOM[7'h30][18:3];
        req_nc = _RANDOM[7'h34][25];
        req_mmio = _RANDOM[7'h34][26];
        req_memBackTypeMM = _RANDOM[7'h34][27];
        req_isHyper = _RANDOM[7'h34][29];
        req_isForVSnonLeafPTE = _RANDOM[7'h34][30];
        slaveAccept = _RANDOM[7'h53][3];
        slaveId = _RANDOM[7'h53][7:4];
        uncacheState = _RANDOM[7'h53][10:8];
        uncacheData = {_RANDOM[7'h53][31:11], _RANDOM[7'h54], _RANDOM[7'h55][10:0]};
        nderr = _RANDOM[7'h55][11];
        derr = _RANDOM[7'h55][12];
        needFlushReg = _RANDOM[7'h55][13];
        pendingPtr_next_r_flag = _RANDOM[7'h55][14];
        pendingPtr_next_r_value = _RANDOM[7'h55][23:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
