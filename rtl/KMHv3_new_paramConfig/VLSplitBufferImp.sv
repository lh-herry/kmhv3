...
module VLSplitBufferImp(
  ...
  wire [8:0]   _io_out_bits_uop_lqIdx_diff_T_4 =
    9'({1'h0, io_out_bits_uop_lqIdx_new_value} - 9'h78);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_ftqPtr_flag = _RANDOM[7'h13][2];
        ...
        uopq_uop_pdest = _RANDOM[7'h21][9:1];
        uopq_uop_robIdx_flag = _RANDOM[7'h21][31];
        uopq_uop_robIdx_value = _RANDOM[7'h22][8:0];
        uopq_uop_lqIdx_flag = _RANDOM[7'h37][12];
        uopq_uop_lqIdx_value = _RANDOM[7'h37][19:13];
        ...
        uopq_usLowBitsAddr = _RANDOM[7'h3C][26:23];
