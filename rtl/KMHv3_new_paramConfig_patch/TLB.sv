  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ptw_resp_bits_reg_s2xlate = _RANDOM[6'h1A][8:7];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[6'h1A][31:9], _RANDOM[6'h1B][11:0]};
        ptw_resp_bits_reg_s1_entry_asid = _RANDOM[6'h1B][27:12];
        ptw_resp_bits_reg_s1_entry_vmid = {_RANDOM[6'h1B][31:28], _RANDOM[6'h1C][9:0]};
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[6'h1C][10];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[6'h1C][15];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[6'h1C][21:20];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[6'h1E][3:1];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[6'h1E][28];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[6'h1E][29];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[6'h1E][30];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[6'h1E][31];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[6'h1F][0];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[6'h1F][1];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[6'h1F][2];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[6'h1F][3];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[6'h1F][31:14], _RANDOM[6'h20][19:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[6'h21][17:4];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[6'h21][18];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[6'h23][3:2];
        ptw_already_back_last_REG = _RANDOM[6'h23][18];
        result_ok_last_REG = _RANDOM[6'h23][20];
        io_perf_0_value_REG = _RANDOM[6'h23][21];
        io_perf_0_value_REG_1 = _RANDOM[6'h23][22];
        io_perf_1_value_REG = _RANDOM[6'h23][23];
        io_perf_1_value_REG_1 = _RANDOM[6'h23][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        need_gpa = 1'h0;
