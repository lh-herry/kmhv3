...
module MbistPipeICacheData_bank0(
  input         clock,
  input         reset,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        arrayReg = _RANDOM[2'h0][2:0];
        reqReg = _RANDOM[2'h0][3];
        allReg = _RANDOM[2'h0][4];
        wenReg = _RANDOM[2'h0][5];
        beReg = _RANDOM[2'h0][6];
        addrReg = _RANDOM[2'h0][13:7];
        dataInReg = {_RANDOM[2'h0][31:14], _RANDOM[2'h1], _RANDOM[2'h2][15:0]};
        renReg = _RANDOM[2'h2][16];
        addrRdReg = _RANDOM[2'h2][23:17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 3'h0;
        reqReg = 1'h0;
  ...
  assign toSRAM_3_selectedOH = allReg | ~reqReg | (&arrayReg);
