...
module ExeUnitImp(
  ...
  output [8:0]  io_uncertainWakeupOut_bits_pdest,
  ...
  wire [8:0]  _in1ToN_io_out_1_bits_toRF_pdest;
  ...
  wire [8:0]  _Fence_io_out_bits_ctrl_pdest;
  ...
  wire [8:0]  _csr_io_out_bits_ctrl_pdest;
  ...
  assign io_out_bits_pdest =
    ...
    | (fuOutValidOH_1 ? _csr_io_out_bits_ctrl_pdest : 9'h0)
    | (fuOutValidOH_2 ? _Fence_io_out_bits_ctrl_pdest : 9'h0);
