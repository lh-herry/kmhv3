...
module PipelineConnectPipe(
  ...
  input  [4:0]  io_in_bits_ftqPtr_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_exceptionVec_0 = _RANDOM[4'h0][11];
        data_exceptionVec_1 = _RANDOM[4'h0][12];
        data_exceptionVec_2 = _RANDOM[4'h0][13];
        data_exceptionVec_3 = _RANDOM[4'h0][14];
        data_exceptionVec_4 = _RANDOM[4'h0][15];
        data_exceptionVec_5 = _RANDOM[4'h0][16];
        data_exceptionVec_6 = _RANDOM[4'h0][17];
        data_exceptionVec_7 = _RANDOM[4'h0][18];
        data_exceptionVec_8 = _RANDOM[4'h0][19];
        data_exceptionVec_9 = _RANDOM[4'h0][20];
        data_exceptionVec_10 = _RANDOM[4'h0][21];
        data_exceptionVec_11 = _RANDOM[4'h0][22];
        data_exceptionVec_12 = _RANDOM[4'h0][23];
        data_exceptionVec_13 = _RANDOM[4'h0][24];
        data_exceptionVec_14 = _RANDOM[4'h0][25];
        data_exceptionVec_15 = _RANDOM[4'h0][26];
        data_exceptionVec_16 = _RANDOM[4'h0][27];
        data_exceptionVec_17 = _RANDOM[4'h0][28];
        data_exceptionVec_18 = _RANDOM[4'h0][29];
        data_exceptionVec_19 = _RANDOM[4'h0][30];
        data_exceptionVec_20 = _RANDOM[4'h0][31];
        data_exceptionVec_21 = _RANDOM[4'h1][0];
        data_exceptionVec_22 = _RANDOM[4'h1][1];
        data_exceptionVec_23 = _RANDOM[4'h1][2];
        data_isFetchMalAddr = _RANDOM[4'h1][3];
        data_trigger = _RANDOM[4'h1][7:4];
        data_isRVC = _RANDOM[4'h1][8];
        data_fixedTaken = _RANDOM[4'h1][9];
        data_predTaken = _RANDOM[4'h1][10];
        data_crossPageIPFFix = _RANDOM[4'h1][11];
        data_ftqPtr_flag = _RANDOM[4'h1][12];
        data_ftqPtr_value = _RANDOM[4'h1][17:13];
        data_ftqOffset = _RANDOM[4'h1][22:18];
        data_isLastInFtqEntry = _RANDOM[4'h1][23];
        data_commitType = _RANDOM[4'h2][25:24];
        data_srcType_0 = _RANDOM[4'h2][29:26];
        data_srcType_1 = {_RANDOM[4'h2][31:30], _RANDOM[4'h3][1:0]};
        data_srcType_2 = _RANDOM[4'h3][5:2];
        data_srcType_3 = _RANDOM[4'h3][9:6];
        data_vlRen = _RANDOM[4'h3][10];
        data_lsrc_0 = _RANDOM[4'h3][16:11];
        data_lsrc_1 = _RANDOM[4'h3][22:17];
        data_lsrc_2 = _RANDOM[4'h3][28:23];
        data_ldest = _RANDOM[4'h4][8:3];
        data_fuType = {_RANDOM[4'h4][31:9], _RANDOM[4'h5][12:0]};
        data_fuOpType = _RANDOM[4'h5][21:13];
        data_rfWen = _RANDOM[4'h5][22];
        data_fpWen = _RANDOM[4'h5][23];
        data_vecWen = _RANDOM[4'h5][24];
        data_v0Wen = _RANDOM[4'h5][25];
        data_vlWen = _RANDOM[4'h5][26];
        data_waitForward = _RANDOM[4'h5][27];
        data_blockBackward = _RANDOM[4'h5][28];
        data_flushPipe = _RANDOM[4'h5][29];
        data_canRobCompress = _RANDOM[4'h5][30];
        data_selImm = {_RANDOM[4'h5][31], _RANDOM[4'h6][2:0]};
        data_imm = {_RANDOM[4'h6][31:3], _RANDOM[4'h7][2:0]};
        data_fpu_wflags = _RANDOM[4'h7][3];
        data_fpu_fmt = _RANDOM[4'h7][5:4];
        data_fpu_rm = _RANDOM[4'h7][8:6];
        data_vpu_vill = _RANDOM[4'h7][9];
        data_vpu_vma = _RANDOM[4'h7][10];
        data_vpu_vta = _RANDOM[4'h7][11];
        data_vpu_vsew = _RANDOM[4'h7][13:12];
        data_vpu_vlmul = _RANDOM[4'h7][16:14];
        data_vpu_specVill = _RANDOM[4'h7][17];
        data_vpu_specVma = _RANDOM[4'h7][18];
        data_vpu_specVta = _RANDOM[4'h7][19];
        data_vpu_specVsew = _RANDOM[4'h7][21:20];
        data_vpu_specVlmul = _RANDOM[4'h7][24:22];
        data_vpu_vm = _RANDOM[4'h7][25];
        data_vpu_vstart = {_RANDOM[4'h7][31:26], _RANDOM[4'h8][1:0]};
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[4'h8][9];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[4'h8][10];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[4'h8][11];
        data_vpu_nf = {_RANDOM[4'hC][31:30], _RANDOM[4'hD][0]};
        data_vpu_veew = _RANDOM[4'hD][2:1];
        data_vpu_isExt = _RANDOM[4'hD][4];
        data_vpu_isNarrow = _RANDOM[4'hD][5];
        data_vpu_isDstMask = _RANDOM[4'hD][6];
        data_vpu_isOpMask = _RANDOM[4'hD][7];
        data_vpu_isDependOldVd = _RANDOM[4'hD][9];
        data_vpu_isWritePartVd = _RANDOM[4'hD][10];
        data_vpu_isVleff = _RANDOM[4'hD][11];
        data_vlsInstr = _RANDOM[4'hE][0];
        data_wfflags = _RANDOM[4'hE][1];
        data_isMove = _RANDOM[4'hE][2];
        data_uopIdx = _RANDOM[4'hE][9:3];
        data_uopSplitType = _RANDOM[4'hE][15:10];
        data_isVset = _RANDOM[4'hE][16];
        data_firstUop = _RANDOM[4'hE][17];
        data_lastUop = _RANDOM[4'hE][18];
        data_numWB = _RANDOM[4'hE][25:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
