  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_exceptionVec_19 = _RANDOM[6'h3][25];
        data_uop_isRVC = _RANDOM[6'h4][4];
        data_uop_ftqPtr_value = _RANDOM[6'h4][13:9];
        data_uop_ftqOffset = _RANDOM[6'h4][18:14];
        data_uop_fuOpType = _RANDOM[6'h6][27:19];
        data_uop_robIdx_flag = _RANDOM[6'h13][5];
        data_uop_robIdx_value = _RANDOM[6'h13][14:6];
        data_uop_sqIdx_flag = _RANDOM[6'h28][26];
        data_uop_sqIdx_value = {_RANDOM[6'h28][31:27], _RANDOM[6'h29][1:0]};
        ...
        data_elemIdx = _RANDOM[6'h2F][9:2];
        data_mbIndex = _RANDOM[6'h2F][13:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
