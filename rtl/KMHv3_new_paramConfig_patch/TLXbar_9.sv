...
module TLXbar_9(
  ...
  wire        _GEN = auto_in_3_a_valid & _readys_filter_T[3];
  wire [5:0]  _GEN_0 =
  ...
  wire [7:0]  readys_unready =
    {1'h0, _GEN, _GEN_0[5], _GEN_0[4:0] | {_GEN, _GEN_0[5:2]}} | {readys_mask, 4'h0};
  wire [3:0]  readys_readys = ~(readys_unready[7:4] & readys_unready[3:0]);
  ...
  wire        _GEN_1 = auto_in_3_c_valid & _readys_filter_T_2[3];
  wire [5:0]  _GEN_2 =
  ...
  wire [7:0]  readys_unready_1 =
    {1'h0, _GEN_1, _GEN_2[5], _GEN_2[4:0] | {_GEN_1, _GEN_2[5:2]}}
    | {readys_mask_1, 4'h0};
  wire [3:0]  readys_readys_1 = ~(readys_unready_1[7:4] & readys_unready_1[3:0]);
  ...
  wire [3:0]  _readys_filter_T_4 = ~readys_mask_2;
  wire [3:0]  _readys_filter_T_5 = readys_valid_2 & _readys_filter_T_4;
  wire        _GEN_3 = auto_in_3_e_valid & _readys_filter_T_4[3];
  wire [5:0]  _GEN_4 =
  ...
  wire [7:0]  readys_unready_2 =
    {1'h0, _GEN_3, _GEN_4[5], _GEN_4[4:0] | {_GEN_3, _GEN_4[5:2]}}
    | {readys_mask_2, 4'h0};
  wire [3:0]  readys_readys_2 = ~(readys_unready_2[7:4] & readys_unready_2[3:0]);
    ...
    if (reset) begin
      ...
      beatsLeft <=
        latch
          ...
          : 1'(beatsLeft - (auto_out_a_ready & out_0_a_valid));
      ...
      beatsLeft_1 <=
        latch_1
          ...
          : 1'(beatsLeft_1 - (auto_out_c_ready & out_0_c_valid));
