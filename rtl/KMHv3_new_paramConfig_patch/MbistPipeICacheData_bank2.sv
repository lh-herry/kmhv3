...
module MbistPipeICacheData_bank2(
  input         clock,
  input         reset,
  ...
  wire        activated =
    mbist_all | mbist_req
    & (mbist_array == 4'hC | mbist_array == 4'hD | mbist_array == 4'hE | (&mbist_array));
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        arrayReg = _RANDOM[2'h0][3:0];
        reqReg = _RANDOM[2'h0][4];
        allReg = _RANDOM[2'h0][5];
        wenReg = _RANDOM[2'h0][6];
        beReg = _RANDOM[2'h0][7];
        addrReg = _RANDOM[2'h0][14:8];
        dataInReg = {_RANDOM[2'h0][31:15], _RANDOM[2'h1], _RANDOM[2'h2][16:0]};
        renReg = _RANDOM[2'h2][17];
        addrRdReg = _RANDOM[2'h2][24:18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 4'h0;
        reqReg = 1'h0;
