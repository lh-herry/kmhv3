...
module VFAlu(
  ...
  wire [3:0]      elementsInOneUop =
    ...
    | {2'h0, &outEew, 1'h0};
  wire [6:0]      _GEN_10 = {3'h0, elementsInOneUop};
  wire [7:0]      _GEN_11 =
    {1'h0,
     {1'h0,
      {1'h0,
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vs1Reg =
          {_RANDOM[6'h1C][31:11],
           ...
           _RANDOM[6'h1F],
           _RANDOM[6'h20][10:0]};
        outWiden = _RANDOM[6'h20][11];
        outVlFix = _RANDOM[6'h20][19:12];
        allVmZero = _RANDOM[6'h20][20];
        mgu_io_in_info_eew_r = _RANDOM[6'h20][22:21];
        mgu_io_in_info_vdIdx_r = _RANDOM[6'h20][29:23];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVecThisFu_1 = 1'h0;
    end // initial
    ...
    .io_in_vd
      (io_in_bits_ctrlPipe_1_vpu_isDstMask
         ? {120'h0,
            ...
            8'(_GEN_11 + 8'h2) >= io_in_bits_dataPipe_1_vl
            ...
            8'(_GEN_11 + 8'h1) >= io_in_bits_dataPipe_1_vl
            ...
            _GEN_11 >= io_in_bits_dataPipe_1_vl
