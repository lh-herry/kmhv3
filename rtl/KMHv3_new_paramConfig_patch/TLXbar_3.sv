...
module TLXbar_3(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source[7:5] == 3'h4;
  reg         beatsLeft;
  ...
  wire [3:0]  readys_unready =
    {1'h0,
     auto_in_1_a_valid & _readys_filter_T[1],
  ...
  assign auto_in_1_d_bits_source = auto_out_d_bits_source[4:0];
  ...
  assign auto_out_a_bits_source =
    ...
    | (muxState_1 ? {3'h4, auto_in_1_a_bits_source} : 8'h0);
