  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fixValidVec_1 = _RANDOM[5'hA][12];
        fireReg_last_r = _RANDOM[5'hF][18];
        outIs16bits_REG = _RANDOM[5'hF][19];
        outIs16bits = _RANDOM[5'hF][20];
        outIs32bits_REG = _RANDOM[5'hF][21];
        outIs32bits = _RANDOM[5'hF][22];
        result_r = {_RANDOM[5'h10][31:1], _RANDOM[5'h11], _RANDOM[5'h12][0]};
        result_r_1 = {_RANDOM[5'h12][31:1], _RANDOM[5'h13], _RANDOM[5'h14][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
