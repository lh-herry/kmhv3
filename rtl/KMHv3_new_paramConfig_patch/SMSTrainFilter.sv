...
module SMSTrainFilter(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:597];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h256; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        ld_reorder_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h39][12];
        ld_reorder_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h39][21:13];
        ld_reorder_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h4F][31:16], _RANDOM[10'h50], _RANDOM[10'h51][1:0]};
        ld_reorder_res_0_1_0_bits_paddr = {_RANDOM[10'h53][31:3], _RANDOM[10'h54][18:0]};
        ld_reorder_res_0_1_1_valid = _RANDOM[10'h66][19];
        ld_reorder_res_0_1_1_bits_uop_pc =
          {_RANDOM[10'h67][31:20], _RANDOM[10'h68], _RANDOM[10'h69][5:0]};
        ld_reorder_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h79][15];
        ld_reorder_res_0_1_1_bits_uop_robIdx_value = _RANDOM[10'h79][24:16];
        ld_reorder_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h8F][31:19], _RANDOM[10'h90], _RANDOM[10'h91][4:0]};
        ld_reorder_res_0_1_1_bits_paddr = {_RANDOM[10'h93][31:6], _RANDOM[10'h94][21:0]};
        ld_reorder_res_0_1_2_valid = _RANDOM[10'hA6][22];
        ld_reorder_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'hA7][31:23], _RANDOM[10'hA8], _RANDOM[10'hA9][8:0]};
        ld_reorder_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hB9][18];
        ld_reorder_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hB9][27:19];
        ld_reorder_res_0_1_2_bits_vaddr =
          {_RANDOM[10'hCF][31:22], _RANDOM[10'hD0], _RANDOM[10'hD1][7:0]};
        ld_reorder_res_0_1_2_bits_paddr = {_RANDOM[10'hD3][31:9], _RANDOM[10'hD4][24:0]};
        ld_reorder_res_1_2_0_valid = _RANDOM[10'hE6][25];
        ld_reorder_res_1_2_0_bits_uop_pc =
          {_RANDOM[10'hE7][31:26], _RANDOM[10'hE8], _RANDOM[10'hE9][11:0]};
        ld_reorder_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hF9][21];
        ld_reorder_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hF9][30:22];
        ld_reorder_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h10F][31:25], _RANDOM[10'h110], _RANDOM[10'h111][10:0]};
        ld_reorder_res_1_2_0_bits_paddr =
          {_RANDOM[10'h113][31:12], _RANDOM[10'h114][27:0]};
        ld_reorder_res_1_2_1_valid = _RANDOM[10'h126][28];
        ld_reorder_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h127][31:29], _RANDOM[10'h128], _RANDOM[10'h129][14:0]};
        ld_reorder_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h139][24];
        ld_reorder_res_1_2_1_bits_uop_robIdx_value =
          {_RANDOM[10'h139][31:25], _RANDOM[10'h13A][1:0]};
        ld_reorder_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h14F][31:28], _RANDOM[10'h150], _RANDOM[10'h151][13:0]};
        ld_reorder_res_1_2_1_bits_paddr =
          {_RANDOM[10'h153][31:15], _RANDOM[10'h154][30:0]};
        ld_reorder_res_1_2_2_valid = _RANDOM[10'h166][31];
        ld_reorder_res_1_2_2_bits_uop_pc = {_RANDOM[10'h168], _RANDOM[10'h169][17:0]};
        ld_reorder_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h18F][31], _RANDOM[10'h190], _RANDOM[10'h191][16:0]};
        ld_reorder_res_1_2_2_bits_paddr =
          {_RANDOM[10'h193][31:18], _RANDOM[10'h194], _RANDOM[10'h195][1:0]};
        ld_reorder_0_valid = _RANDOM[10'h1A7][2];
        ld_reorder_0_bits_uop_pc = {_RANDOM[10'h1A8][31:3], _RANDOM[10'h1A9][20:0]};
        ld_reorder_0_bits_vaddr = {_RANDOM[10'h1D0][31:2], _RANDOM[10'h1D1][19:0]};
        ld_reorder_0_bits_paddr =
          {_RANDOM[10'h1D3][31:21], _RANDOM[10'h1D4], _RANDOM[10'h1D5][4:0]};
        ld_reorder_1_valid = _RANDOM[10'h1E7][5];
        ld_reorder_1_bits_uop_pc = {_RANDOM[10'h1E8][31:6], _RANDOM[10'h1E9][23:0]};
        ld_reorder_1_bits_vaddr = {_RANDOM[10'h210][31:5], _RANDOM[10'h211][22:0]};
        ld_reorder_1_bits_paddr =
          {_RANDOM[10'h213][31:24], _RANDOM[10'h214], _RANDOM[10'h215][7:0]};
        ld_reorder_2_valid = _RANDOM[10'h227][8];
        ld_reorder_2_bits_uop_pc = {_RANDOM[10'h228][31:9], _RANDOM[10'h229][26:0]};
        ld_reorder_2_bits_vaddr = {_RANDOM[10'h250][31:8], _RANDOM[10'h251][25:0]};
        ld_reorder_2_bits_paddr =
          {_RANDOM[10'h253][31:27], _RANDOM[10'h254], _RANDOM[10'h255][10:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_0_vaddr = 50'h0;
        entries_0_paddr = 48'h0;
