...
module FDivSqrt(
  ...
  wire        _io_out_bits_ctrl_fpu_T = _fdiv_io_start_ready_o & io_in_valid;
  reg         outCtrl_r_robIdx_flag;
  reg  [8:0]  outCtrl_r_robIdx_value;
  reg  [1:0]  outCtrl_r_fpu_fmt;
  wire [1:0]  outCtrl_fpu_fmt =
    _io_out_bits_ctrl_fpu_T ? io_in_bits_ctrl_fpu_fmt : outCtrl_r_fpu_fmt;
  ...
  wire        _GEN = _fdiv_io_start_ready_o | _io_out_bits_ctrl_fpu_T;
  ...
  always @(posedge clock) begin
    if (_io_out_bits_ctrl_fpu_T) begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_robIdx_flag = _RANDOM[3'h0][10];
        outCtrl_r_robIdx_value = _RANDOM[3'h0][19:11];
        outCtrl_r_fpu_fmt = {_RANDOM[3'h0][31], _RANDOM[3'h1][0]};
        io_out_bits_ctrl_toRobValid_r = _RANDOM[3'h7][4];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[3'h7][5];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[3'h7][14:6];
        io_out_bits_ctrl_pdest_r = _RANDOM[3'h7][23:15];
        io_out_bits_ctrl_fpWen_r = _RANDOM[3'h7][24];
  ...
  FloatDivider fdiv (
    ...
    .io_finish_ready_i       (_fdiv_io_finish_valid_o),
  ...
  assign io_out_bits_ctrl_toRobValid =
    _io_out_bits_ctrl_fpu_T ? io_in_bits_ctrl_toRobValid : io_out_bits_ctrl_toRobValid_r;
  ...
  assign io_out_bits_ctrl_pdest =
    _io_out_bits_ctrl_fpu_T ? io_in_bits_ctrl_pdest : io_out_bits_ctrl_pdest_r;
  assign io_out_bits_ctrl_fpWen =
    _io_out_bits_ctrl_fpu_T ? io_in_bits_ctrl_fpWen : io_out_bits_ctrl_fpWen_r;
  assign io_out_bits_ctrl_fpu_wflags =
    _io_out_bits_ctrl_fpu_T ? io_in_bits_ctrl_fpu_wflags : io_out_bits_ctrl_fpu_r_wflags;
