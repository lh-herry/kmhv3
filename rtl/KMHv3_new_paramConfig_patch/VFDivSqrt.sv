...
module VFDivSqrt(
  ...
  wire         _io_out_bits_ctrl_vpu_T = io_in_ready_0 & io_in_valid;
  reg  [8:0]   outCtrl_r_fuOpType;
  reg          outCtrl_r_robIdx_flag;
  reg  [8:0]   outCtrl_r_robIdx_value;
  ...
  wire [8:0]   outCtrl_fuOpType =
    _io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_fuOpType : outCtrl_r_fuOpType;
  wire [1:0]   outCtrl_vpu_vsew =
    _io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_vsew : outCtrl_r_vpu_vsew;
  wire [2:0]   outCtrl_vpu_vlmul =
    _io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_vlmul : outCtrl_r_vpu_vlmul;
  ...
  wire [7:0]   outData_vl = _io_out_bits_ctrl_vpu_T ? io_in_bits_data_vl : outData_r_vl;
  wire [127:0] outSrcMask =
    outCtrl_fuOpType[8:7] == 2'h1
    & (outCtrl_fuOpType[5:0] == 6'h4 | outCtrl_fuOpType[5:0] == 6'h14)
      ? 128'h0
      : (_io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_vm : outCtrl_r_vpu_vm)
          ? 128'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
          : _io_out_bits_ctrl_vpu_T ? io_in_bits_data_src_3 : outData_r_src_3;
  reg          io_out_bits_ctrl_toRobValid_r;
  reg          io_out_bits_ctrl_robIdx_r_flag;
  reg  [8:0]   io_out_bits_ctrl_robIdx_r_value;
  ...
  wire         _GEN = io_in_ready_0 | _io_out_bits_ctrl_vpu_T;
  ...
  wire [9:0]   _vfdivs_1_io_flush_i_flushItself_T_1 = {thisRobIdx_flag, thisRobIdx_value};
  ...
  wire         io_out_valid_0 = _vfdivs_0_io_finish_valid_o & _vfdivs_1_io_finish_valid_o;
  ...
  always @(posedge clock) begin
    if (_io_out_bits_ctrl_vpu_T) begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_robIdx_value = _RANDOM[5'h0][19:11];
        outCtrl_r_vpu_vma = _RANDOM[5'h1][6];
        outCtrl_r_vpu_vta = _RANDOM[5'h1][7];
        outCtrl_r_vpu_vsew = _RANDOM[5'h1][9:8];
        outCtrl_r_vpu_vlmul = _RANDOM[5'h1][12:10];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][21];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][29:22];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][16:10];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h7][1];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h7][2];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:28],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:28],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][27:0]};
        outData_r_vl = {_RANDOM[5'h17][31:28], _RANDOM[5'h18][3:0]};
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h1C][4];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1C][5];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1C][14:6];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1C][23:15];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1C][24];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1C][25];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[5'h1C][26];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Mgu mgu (
    ...
    .io_in_oldVd
      (_io_out_bits_ctrl_vpu_T ? io_in_bits_data_src_2 : outData_r_src_2),
    .io_in_mask         (outSrcMask),
    .io_in_info_ta
      (_io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_vta : outCtrl_r_vpu_vta),
    .io_in_info_ma
      (_io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_vma : outCtrl_r_vpu_vma),
    .io_in_info_vl      (outData_vl),
    .io_in_info_vstart
      (_io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_vstart : outCtrl_r_vpu_vstart),
    .io_in_info_eew     (outCtrl_vpu_vsew),
    .io_in_info_vdIdx   (outCtrl_vpu_vuopIdx),
    .io_in_info_narrow
      (_io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_isNarrow : outCtrl_r_vpu_isNarrow),
    .io_in_info_dstMask
      (_io_out_bits_ctrl_vpu_T ? io_in_bits_ctrl_vpu_isDstMask : outCtrl_r_vpu_isDstMask),
