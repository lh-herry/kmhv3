...
module MultiWakeupQueue_2(
  ...
  always @(posedge clock) begin
    lastConnect_valid <= |{allValidVec_1, _pipes_0_io_deq_valid};
    ...
    lastConnect_bits_vecWen <=
      _pipes_0_io_deq_valid & _pipes_0_io_deq_bits_vecWen | allValidVec_1
      & _pipes_1_io_deq_bits_vecWen;
    lastConnect_bits_v0Wen <=
      _pipes_0_io_deq_valid & _pipes_0_io_deq_bits_v0Wen | allValidVec_1
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'hB][6:5];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'hB][8:7];
        lastConnect_bits_loadDependencyCopy_0_2 = _RANDOM[4'hB][10:9];
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'hB][12:11];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'hB][14:13];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'hB][16:15];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'hB][18:17];
        lastConnect_bits_loadDependencyCopy_2_1 = _RANDOM[4'hB][20:19];
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'hB][22:21];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'hB][24:23];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'hB][26:25];
        lastConnect_bits_loadDependencyCopy_3_2 = _RANDOM[4'hB][28:27];
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'hB][30:29];
        lastConnect_bits_loadDependencyCopy_4_1 = {_RANDOM[4'hB][31], _RANDOM[4'hC][0]};
        lastConnect_bits_loadDependencyCopy_4_2 = _RANDOM[4'hC][2:1];
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'hC][4:3];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'hC][6:5];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'hC][8:7];
        lastConnect_bits_loadDependencyCopy_6_0 = _RANDOM[4'hC][10:9];
        lastConnect_bits_loadDependencyCopy_6_1 = _RANDOM[4'hC][12:11];
        lastConnect_bits_loadDependencyCopy_6_2 = _RANDOM[4'hC][14:13];
        lastConnect_bits_pdest = _RANDOM[4'hC][23:15];
        lastConnect_bits_rfWen = _RANDOM[4'hC][29];
        lastConnect_bits_vecWen = _RANDOM[4'hC][31];
        lastConnect_bits_v0Wen = _RANDOM[4'hD][0];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hF][17:16];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hF][19:18];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hF][21:20];
      `endif // RANDOMIZE_REG_INIT
    end // initial
