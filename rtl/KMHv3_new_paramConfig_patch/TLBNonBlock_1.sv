  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[7'h1F][8];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[7'h1F][12];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[7'h1F][21:13];
        readResult_p_hit_last_REG_1 = _RANDOM[7'h24][15];
        readResult_p_ppn_1 = {_RANDOM[7'h24][31:16], _RANDOM[7'h25][19:0]};
        readResult_p_pbmt_1 = _RANDOM[7'h25][21:20];
        readResult_p_perm_1_pf = _RANDOM[7'h25][22];
        readResult_p_perm_1_af = _RANDOM[7'h25][23];
        readResult_p_perm_1_v = _RANDOM[7'h25][24];
        readResult_p_perm_1_d = _RANDOM[7'h25][25];
        readResult_p_perm_1_a = _RANDOM[7'h25][26];
        readResult_p_perm_1_u = _RANDOM[7'h25][28];
        readResult_p_perm_1_x = _RANDOM[7'h25][29];
        readResult_p_perm_1_w = _RANDOM[7'h25][30];
        readResult_p_perm_1_r = _RANDOM[7'h25][31];
        readResult_p_gvpn_1 = {_RANDOM[7'h26], _RANDOM[7'h27][11:0]};
        readResult_p_g_pbmt_1 = _RANDOM[7'h27][13:12];
        readResult_p_g_perm_1_pf = _RANDOM[7'h27][14];
        readResult_p_g_perm_1_af = _RANDOM[7'h27][15];
        readResult_p_g_perm_1_d = _RANDOM[7'h27][17];
        readResult_p_g_perm_1_a = _RANDOM[7'h27][18];
        readResult_p_g_perm_1_x = _RANDOM[7'h27][21];
        readResult_p_g_perm_1_w = _RANDOM[7'h27][22];
        readResult_p_g_perm_1_r = _RANDOM[7'h27][23];
        readResult_p_s2xlate_1 = _RANDOM[7'h27][25:24];
        readResult_p_s1_level_1 = _RANDOM[7'h27][27:26];
        readResult_p_s1_isLeaf_1 = _RANDOM[7'h27][28];
        readResult_p_s1_isFakePte_1 = _RANDOM[7'h27][29];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[7'h27][30];
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[7'h2B][20];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[7'h2B][24];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[7'h2B][31:25], _RANDOM[7'h2C][1:0]};
        REG = _RANDOM[7'h30][28];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h30][29];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h30][30];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h30][31];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h31][0];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h31][1];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[7'h31][2];
        REG_1 = _RANDOM[7'h31][4];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h31][5];
        io_requestor_1_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h31][6];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h31][7];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h31][8];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h31][9];
        io_requestor_1_resp_bits_excp_0_af_st_REG = _RANDOM[7'h31][10];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h31][12:11];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h31][31:13], _RANDOM[7'h32][15:0]};
        ptw_resp_bits_reg_s1_entry_asid = _RANDOM[7'h32][31:16];
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[7'h33][13:0];
        ptw_resp_bits_reg_s1_entry_n = _RANDOM[7'h33][14];
        ptw_resp_bits_reg_s1_entry_perm_g = _RANDOM[7'h33][19];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h33][25:24];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h35][7:5];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h36][0];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h36][1];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h36][2];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h36][3];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h36][4];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h36][5];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h36][6];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h36][7];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h36][31:18], _RANDOM[7'h37][23:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h38][21:8];
        ptw_resp_bits_reg_s2_entry_n = _RANDOM[7'h38][22];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h3A][7:6];
        ptw_already_back_last_REG = _RANDOM[7'h3A][22];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h3A][25:24];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h3A][31:26], _RANDOM[7'h3B][28:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = {_RANDOM[7'h3B][31:29], _RANDOM[7'h3C][12:0]};
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h3C][26:13];
        ptw_resp_bits_reg_1_s1_entry_n = _RANDOM[7'h3C][27];
        ptw_resp_bits_reg_1_s1_entry_perm_g = _RANDOM[7'h3D][0];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h3D][6:5];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h3E][20:18];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h3F][13];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h3F][14];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h3F][15];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h3F][16];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h3F][17];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h3F][18];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h3F][19];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h3F][20];
        ptw_resp_bits_reg_1_s2_entry_tag =
          {_RANDOM[7'h3F][31], _RANDOM[7'h40], _RANDOM[7'h41][4:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h41][31:21], _RANDOM[7'h42][2:0]};
        ptw_resp_bits_reg_1_s2_entry_n = _RANDOM[7'h42][3];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h43][20:19];
        ptw_already_back_last_REG_1 = _RANDOM[7'h44][3];
        result_ok_last_REG = _RANDOM[7'h44][5];
        result_ok_last_REG_1 = _RANDOM[7'h44][6];
        io_perf_0_value_REG = _RANDOM[7'h44][8:7];
        io_perf_0_value_REG_1 = _RANDOM[7'h44][10:9];
        io_perf_1_value_REG = _RANDOM[7'h44][12:11];
        io_perf_1_value_REG_1 = _RANDOM[7'h44][14:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
