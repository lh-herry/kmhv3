...
module FloatAdderF16Pipeline(
  ...
  wire        fp_b_is_greater =
    ...
    & (~_U_far_path_io_isEfp_bGreater & io_fp_a[14:10] != io_fp_b[14:10]
       | fp_b_exponent_is_equal & ~fp_b_significand_is_greater
       & io_fp_a[9:0] != io_fp_b[9:0]);
  wire        fp_b_is_equal =
    io_fp_a[15] == io_fp_b[15] & fp_b_exponent_is_equal & io_fp_a[9:0] == io_fp_b[9:0]
    | _fp_b_is_equal_T_2;
  ...
  always @(posedge clock) begin
    if (io_fire) begin
      ...
      io_fp_c_r_1 <=
        (is_min ? result_min : 16'h0) | (is_max ? result_max : 16'h0)
