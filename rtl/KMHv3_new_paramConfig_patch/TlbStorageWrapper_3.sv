...
module TlbStorageWrapper_3(
  ...
  wire        _page_pftlb_storage_fa_io_access_2_touch_ways_valid;
  wire [5:0]  _page_pftlb_storage_fa_io_access_2_touch_ways_bits;
  ...
  wire [45:0] _refill_idx_state_reg_T_327 =
    _page_pftlb_storage_fa_io_access_1_touch_ways_valid
  ...
  always @(posedge clock or posedge reset) begin
    if (reset)
      refill_idx_state_reg <= 47'h0;
             ...
             | _page_pftlb_storage_fa_io_access_1_touch_ways_valid
             | _page_pftlb_storage_fa_io_access_2_touch_ways_valid) begin
      if (_page_pftlb_storage_fa_io_access_2_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[5]),
           _page_pftlb_storage_fa_io_access_2_touch_ways_bits[5]
             ? {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[3]),
                _page_pftlb_storage_fa_io_access_2_touch_ways_bits[3]
                  ? {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[2]),
                     _page_pftlb_storage_fa_io_access_2_touch_ways_bits[2]
                       ? {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[1]),
                          _page_pftlb_storage_fa_io_access_2_touch_ways_bits[1]
                            ? ~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[0])
           ...
           _page_pftlb_storage_fa_io_access_2_touch_ways_bits[5]
             ...
             : {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[4]),
                _page_pftlb_storage_fa_io_access_2_touch_ways_bits[4]
                  ? {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[3]),
                     _page_pftlb_storage_fa_io_access_2_touch_ways_bits[3]
                       ? {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[2]),
                          ...
                          _page_pftlb_storage_fa_io_access_2_touch_ways_bits[2]
                            ...
                            : {~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[1]),
                               ...
                               _page_pftlb_storage_fa_io_access_2_touch_ways_bits[1]
                                 ...
                                 : ~(_page_pftlb_storage_fa_io_access_2_touch_ways_bits[0])}}}}};
      else if (_page_pftlb_storage_fa_io_access_1_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_pftlb_storage_fa_io_access_1_touch_ways_bits[5]),
  ...
  TLBFA_3 page_pftlb_storage_fa (
    ...
    .io_access_2_touch_ways_valid   (_page_pftlb_storage_fa_io_access_2_touch_ways_valid),
    .io_access_2_touch_ways_bits    (_page_pftlb_storage_fa_io_access_2_touch_ways_bits)
  );
endmodule
