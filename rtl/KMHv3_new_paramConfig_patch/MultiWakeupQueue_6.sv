...
module MultiWakeupQueue_6(
  ...
  always @(posedge clock) begin
    ...
    lastConnect_bits_pdest <=
      (allValidVec_0 ? _pipes_0_io_deq_bits_pdest : 9'h0)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdest = _RANDOM[4'hA][10:2];
        lastConnect_bits_fpWen = _RANDOM[4'hA][12];
        lastConnect_bits_vecWen = _RANDOM[4'hA][13];
        lastConnect_bits_v0Wen = _RANDOM[4'hA][14];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hB][11:10];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hB][13:12];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hB][15:14];
      `endif // RANDOMIZE_REG_INIT
    end // initial
