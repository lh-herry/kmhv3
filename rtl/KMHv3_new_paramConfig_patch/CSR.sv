...
module CSR(
  ...
  input  [8:0]  io_in_bits_ctrl_pdest,
  ...
  output [8:0]  io_out_bits_ctrl_pdest,
  ...
  output [8:0]  io_outPdestAhead3Cycle,
  ...
  wire        _pipMod_io_out_bits_2;
  wire        _pipMod_io_out_bits_3;
  wire        _pipMod_io_out_bits_8;
  wire        _pipMod_io_out_bits_9;
  wire        _pipMod_io_out_bits_10;
  wire        _pipMod_io_out_bits_11;
  wire        _pipMod_io_out_bits_22;
  ...
  reg  [4:0]  trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_value;
  ...
  reg  [4:0]  trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_value;
  ...
  reg  [4:0]  io_out_bits_res_redirect_bits_ftqIdx_r_value;
  reg  [4:0]  io_out_bits_res_redirect_bits_ftqOffset_r;
  reg         rfWenReg;
  reg  [8:0]  pdestReg;
  reg         io_out_bits_ctrl_toRobValid_r;
  reg  [8:0]  io_out_bits_ctrl_pdest_r;
  reg         io_error_0_REG;
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_value =
          _RANDOM[4'h3][28:24];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqOffset =
          {_RANDOM[4'h3][31:29], _RANDOM[4'h4][1:0]};
        trapInstMod_io_faultCsrUop_bits_fuOpType_r = _RANDOM[4'h4][10:2];
        trapInstMod_io_faultCsrUop_bits_imm_r =
          {_RANDOM[4'h4][31:11], _RANDOM[4'h5], _RANDOM[4'h6][10:0]};
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_flag = _RANDOM[4'h6][11];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_value = _RANDOM[4'h6][16:12];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqOffset_r = _RANDOM[4'h6][21:17];
        exceptionVec_3_r = _RANDOM[4'h6][22];
        exceptionVec_11_r = _RANDOM[4'h6][23];
        exceptionVec_9_r = _RANDOM[4'h6][24];
        exceptionVec_10_r = _RANDOM[4'h6][25];
        exceptionVec_8_r = _RANDOM[4'h6][26];
        tlb_priv_virt_changed_old_data = _RANDOM[4'h6][27];
        isXRetReg = _RANDOM[4'h6][28];
        io_out_bits_res_redirect_bits_ftqIdx_r_flag = _RANDOM[4'h6][29];
        io_out_bits_res_redirect_bits_ftqIdx_r_value =
          {_RANDOM[4'h6][31:30], _RANDOM[4'h7][2:0]};
        io_out_bits_res_redirect_bits_ftqOffset_r = _RANDOM[4'h7][7:3];
        rfWenReg = _RANDOM[4'h7][8];
        pdestReg = _RANDOM[4'h7][17:9];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[4'h7][18];
        io_out_bits_ctrl_pdest_r = _RANDOM[4'h7][27:19];
        io_error_0_REG = _RANDOM[4'h7][29];
        io_error_0_REG_1 = _RANDOM[4'h7][30];
        io_csrio_isPerfCnt_r = _RANDOM[4'h7][31];
        io_csrToDecode_REG_illegalInst_sfenceVMA = _RANDOM[4'h8][0];
        io_csrToDecode_REG_illegalInst_sfencePart = _RANDOM[4'h8][1];
        io_csrToDecode_REG_illegalInst_hfenceGVMA = _RANDOM[4'h8][2];
        io_csrToDecode_REG_illegalInst_hfenceVVMA = _RANDOM[4'h8][3];
        io_csrToDecode_REG_illegalInst_hlsv = _RANDOM[4'h8][4];
        io_csrToDecode_REG_illegalInst_fsIsOff = _RANDOM[4'h8][5];
        io_csrToDecode_REG_illegalInst_vsIsOff = _RANDOM[4'h8][6];
        io_csrToDecode_REG_illegalInst_wfi = _RANDOM[4'h8][7];
        io_csrToDecode_REG_illegalInst_wrs_nto = _RANDOM[4'h8][8];
        io_csrToDecode_REG_illegalInst_frm = _RANDOM[4'h8][9];
        io_csrToDecode_REG_virtualInst_sfenceVMA = _RANDOM[4'h8][13];
        io_csrToDecode_REG_virtualInst_sfencePart = _RANDOM[4'h8][14];
        io_csrToDecode_REG_virtualInst_hfence = _RANDOM[4'h8][15];
        io_csrToDecode_REG_virtualInst_hlsv = _RANDOM[4'h8][16];
        io_csrToDecode_REG_virtualInst_wfi = _RANDOM[4'h8][17];
        io_csrToDecode_REG_virtualInst_wrs_nto = _RANDOM[4'h8][18];
        io_csrToDecode_REG_virtualInst_cboZ = _RANDOM[4'h8][19];
        io_csrToDecode_REG_virtualInst_cboCF = _RANDOM[4'h8][20];
        io_csrToDecode_REG_virtualInst_cboI = _RANDOM[4'h8][21];
        io_csrToDecode_REG_special_cboI2F = _RANDOM[4'h8][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        waddrReg = 12'h0;
        wdataReg = 64'h0;
  ...
  DelayNWithValid pipMod (
    .clock          (clock),
    .reset          (reset),
    .io_in_bits_2   (_csrMod_io_out_bits_EX_II),
    .io_in_bits_3   (exceptionVec_3),
    .io_in_bits_8   (exceptionVec_8),
    .io_in_bits_9   (exceptionVec_9),
    .io_in_bits_10  (exceptionVec_10),
    .io_in_bits_11  (exceptionVec_11),
    .io_in_bits_22  (_csrMod_io_out_bits_EX_VI),
  ...
  DelayNWithValid_1 io_out_bits_ctrl_flushPipe_pipMod (
    .clock       (clock),
    .reset       (reset),
  ...
  DelayNWithValid_2 io_out_bits_res_data_pipMod (
    .clock       (clock),
    .reset       (reset),
  ...
  DelayNWithValid_3 io_out_bits_ctrl_robIdx_pipMod (
    .clock             (clock),
    .reset             (reset),
  ...
  DelayNWithValid_4 io_out_bits_ctrl_pdest_pipMod (
    .clock       (clock),
    .reset       (reset),
  ...
  DelayNWithValid_1 io_out_bits_ctrl_rfWen_pipMod (
    .clock       (clock),
    .reset       (reset),
    .io_in_bits  (rfWenReg),
    .io_in_valid (_csrMod_io_out_valid),
  ...
  assign io_out_bits_ctrl_exceptionVec_2 =
    isXRetReg ? _csrMod_io_out_bits_EX_II : _pipMod_io_out_bits_2;
  assign io_out_bits_ctrl_exceptionVec_3 =
    isXRetReg ? exceptionVec_3 : _pipMod_io_out_bits_3;
  assign io_out_bits_ctrl_exceptionVec_8 =
    isXRetReg ? exceptionVec_8 : _pipMod_io_out_bits_8;
  assign io_out_bits_ctrl_exceptionVec_9 =
    isXRetReg ? exceptionVec_9 : _pipMod_io_out_bits_9;
  assign io_out_bits_ctrl_exceptionVec_10 =
    isXRetReg ? exceptionVec_10 : _pipMod_io_out_bits_10;
  ...
  assign io_out_bits_ctrl_exceptionVec_22 =
    isXRetReg ? _csrMod_io_out_bits_EX_VI : _pipMod_io_out_bits_22;
