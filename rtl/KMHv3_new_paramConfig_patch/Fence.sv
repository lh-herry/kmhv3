...
module Fence(
  ...
  reg  [8:0]  uop_ctrl_robIdx_value;
  reg  [8:0]  uop_ctrl_pdest;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_ctrl_fuOpType = _RANDOM[4'h0][11:3];
        uop_ctrl_toRobValid = _RANDOM[4'h0][12];
        uop_ctrl_robIdx_flag = _RANDOM[4'h0][13];
        uop_ctrl_robIdx_value = _RANDOM[4'h0][22:14];
        uop_ctrl_pdest = _RANDOM[4'h0][31:23];
        uop_ctrl_flushPipe = _RANDOM[4'h1][0];
        uop_data_imm = {_RANDOM[4'h5][31:1], _RANDOM[4'h6], _RANDOM[4'h7][0]};
        io_fenceio_sfence_bits_addr_r =
          {_RANDOM[4'h7][31:1], _RANDOM[4'h8], _RANDOM[4'h9][0]};
        io_fenceio_sfence_bits_id_r =
          {_RANDOM[4'h9][31:1], _RANDOM[4'hA], _RANDOM[4'hB][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 3'h0;
    end // initial
