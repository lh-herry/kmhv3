...
module GPAMem(
  ...
  input  [4:0]  io_fromIFU_gpAddrMem_waddr,
  ...
  input  [4:0]  io_exceptionReadAddr_bits_ftqPtr_value,
  input  [4:0]  io_exceptionReadAddr_bits_ftqOffset,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ftqOffset = _RANDOM[/*Zero width*/ 1'b0][4:0];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  SyncDataModuleTemplate__32entry mem (
    .clock                        (clock),
    .reset                        (reset),
  ...
  assign io_exceptionReadData_gpaddr =
    56'(_mem_io_rdata_0_gpaddr + {50'h0, ftqOffset, 1'h0});
endmodule
