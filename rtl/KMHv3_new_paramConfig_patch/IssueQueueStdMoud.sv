  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_fpRen_0 = _RANDOM[2'h2][15];
        deqDelay_0_bits_dataSources_0_value = _RANDOM[2'h2][19:16];
        deqDelay_0_bits_exuSources_0_value = _RANDOM[2'h2][23:20];
        deqDelay_0_bits_loadDependency_0 = _RANDOM[2'h2][25:24];
        deqDelay_0_bits_loadDependency_1 = _RANDOM[2'h2][27:26];
        deqDelay_0_bits_loadDependency_2 = _RANDOM[2'h2][29:28];
        enqReady_last_REG = _RANDOM[2'h2][30];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        enqReady_last_REG = 1'h0;
    end // initial
