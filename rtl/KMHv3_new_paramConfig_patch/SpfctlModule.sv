...
module SpfctlModule(
  ...
  input  [63:0] w_wdata,
  output [63:0] rdata,
  output        regOut_BERTI_ENABLE,
  output [9:0]  regOut_L2_PF_DELAY_LATENCY,
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      reg_BERTI_ENABLE <= 1'h1;
      reg_L2_PF_DELAY_LATENCY <= 10'h0;
      ...
      reg_BERTI_ENABLE <= w_wdata[32];
      reg_L2_PF_DELAY_LATENCY <= w_wdata[31:22];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_BERTI_ENABLE = _RANDOM[1'h0][0];
        reg_L2_PF_DELAY_LATENCY = _RANDOM[1'h0][10:1];
        reg_L2_PF_TP_ENABLE = _RANDOM[1'h0][11];
        reg_L2_PF_VBOP_ENABLE = _RANDOM[1'h0][12];
        reg_L2_PF_PBOP_ENABLE = _RANDOM[1'h0][13];
        reg_L2_PF_RECV_ENABLE = _RANDOM[1'h0][14];
        reg_L2_PF_STORE_ONLY = _RANDOM[1'h0][15];
        reg_L1D_PF_ENABLE_STRIDE = _RANDOM[1'h0][16];
        reg_L1D_PF_ACTIVE_STRIDE = _RANDOM[1'h0][22:17];
        reg_L1D_PF_ACTIVE_THRESHOLD = _RANDOM[1'h0][26:23];
        reg_L1D_PF_ENABLE_PHT = _RANDOM[1'h0][27];
        reg_L1D_PF_ENABLE_AGT = _RANDOM[1'h0][28];
        reg_L1D_PF_TRAIN_ON_HIT = _RANDOM[1'h0][29];
        reg_L1D_PF_ENABLE = _RANDOM[1'h0][30];
        reg_L2_PF_ENABLE = _RANDOM[1'h0][31];
        reg_L1I_PF_ENABLE = _RANDOM[1'h1][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_BERTI_ENABLE = 1'h1;
        reg_L2_PF_DELAY_LATENCY = 10'h0;
  ...
  assign rdata =
    {31'h0,
     ...
     reg_L2_PF_ENABLE,
     reg_L1I_PF_ENABLE};
  assign regOut_BERTI_ENABLE = reg_BERTI_ENABLE;
  assign regOut_L2_PF_DELAY_LATENCY = reg_L2_PF_DELAY_LATENCY;
