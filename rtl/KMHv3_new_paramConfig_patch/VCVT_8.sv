...
module VCVT_8(
  ...
  input  [8:0]   io_in_bits_ctrlPipe_2_robIdx_value,
  input  [8:0]   io_in_bits_ctrlPipe_2_pdest,
  ...
  wire [10:0]  _GEN_0 = {3'h0, io_in_bits_data_vl > _GEN ? _GEN : io_in_bits_data_vl};
  always @(posedge clock) begin
    if (io_in_valid) begin
      outEew_r <=
        {1'h0, |_output1H_orMatrixOutputs_T_1} | {|_output1H_orMatrixOutputs_T_3, 1'h0}
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fireReg_last_r = _RANDOM[6'h38][10];
        outEew_r = _RANDOM[6'h38][14:13];
        outEew = _RANDOM[6'h38][16:15];
        fflagsEnCycle2_r_0 = _RANDOM[6'h38][17];
        fflagsEnCycle2_r_1 = _RANDOM[6'h38][18];
        fflagsEnCycle2_r_2 = _RANDOM[6'h38][19];
        fflagsEnCycle2_r_3 = _RANDOM[6'h38][20];
        fflagsEnCycle2_r_4 = _RANDOM[6'h38][21];
        fflagsEnCycle2_r_5 = _RANDOM[6'h38][22];
        fflagsEnCycle2_r_6 = _RANDOM[6'h38][23];
        fflagsEnCycle2_r_7 = _RANDOM[6'h38][24];
        fflagsEnCycle2_0 = _RANDOM[6'h38][25];
        fflagsEnCycle2_1 = _RANDOM[6'h38][26];
        fflagsEnCycle2_2 = _RANDOM[6'h38][27];
        fflagsEnCycle2_3 = _RANDOM[6'h38][28];
        fflagsEnCycle2_4 = _RANDOM[6'h38][29];
        fflagsEnCycle2_5 = _RANDOM[6'h38][30];
        fflagsEnCycle2_6 = _RANDOM[6'h38][31];
        fflagsEnCycle2_7 = _RANDOM[6'h39][0];
        narrow_r = _RANDOM[6'h39][1];
        narrow = _RANDOM[6'h39][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
