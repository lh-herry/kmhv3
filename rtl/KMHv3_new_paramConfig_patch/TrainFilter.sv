  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h2F][22];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h2F][31:23];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h45][31:26], _RANDOM[10'h46], _RANDOM[10'h47][11:0]};
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h5C][29];
        ld_in_reordered_res_0_1_1_bits_uop_pc =
          {_RANDOM[10'h5D][31:30], _RANDOM[10'h5E], _RANDOM[10'h5F][15:0]};
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h6F][25];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value =
          {_RANDOM[10'h6F][31:26], _RANDOM[10'h70][2:0]};
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h85][31:29], _RANDOM[10'h86], _RANDOM[10'h87][14:0]};
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h9D][0];
        ld_in_reordered_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'h9E][31:1], _RANDOM[10'h9F][18:0]};
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hAF][28];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value =
          {_RANDOM[10'hAF][31:29], _RANDOM[10'hB0][5:0]};
        ld_in_reordered_res_0_1_2_bits_vaddr = {_RANDOM[10'hC6], _RANDOM[10'hC7][17:0]};
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hDD][3];
        ld_in_reordered_res_1_2_0_bits_uop_pc =
          {_RANDOM[10'hDE][31:4], _RANDOM[10'hDF][21:0]};
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hEF][31];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hF0][8:0];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h106][31:3], _RANDOM[10'h107][20:0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h11D][6];
        ld_in_reordered_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h11E][31:7], _RANDOM[10'h11F][24:0]};
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h130][2];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h130][11:3];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h146][31:6], _RANDOM[10'h147][23:0]};
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h15D][9];
        ld_in_reordered_res_1_2_2_bits_uop_pc =
          {_RANDOM[10'h15E][31:10], _RANDOM[10'h15F][27:0]};
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h186][31:9], _RANDOM[10'h187][26:0]};
        ld_in_reordered_0_valid = _RANDOM[10'h19D][12];
        ld_in_reordered_0_bits_uop_pc = {_RANDOM[10'h19E][31:13], _RANDOM[10'h19F][30:0]};
        ld_in_reordered_0_bits_vaddr = {_RANDOM[10'h1C6][31:12], _RANDOM[10'h1C7][29:0]};
        ld_in_reordered_1_valid = _RANDOM[10'h1DD][15];
        ld_in_reordered_1_bits_uop_pc =
          {_RANDOM[10'h1DE][31:16], _RANDOM[10'h1DF], _RANDOM[10'h1E0][1:0]};
        ld_in_reordered_1_bits_vaddr =
          {_RANDOM[10'h206][31:15], _RANDOM[10'h207], _RANDOM[10'h208][0]};
        ld_in_reordered_2_valid = _RANDOM[10'h21D][18];
        ld_in_reordered_2_bits_uop_pc =
          {_RANDOM[10'h21E][31:19], _RANDOM[10'h21F], _RANDOM[10'h220][4:0]};
        ld_in_reordered_2_bits_vaddr =
          {_RANDOM[10'h246][31:18], _RANDOM[10'h247], _RANDOM[10'h248][3:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
