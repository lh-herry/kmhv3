...
module ICacheDataBank_6(
  ...
  wire [6:0]  bd_addr = boreChildrenBd_bore_addr;
  wire [65:0] bd_indata = boreChildrenBd_bore_indata;
  wire        bd_readen = boreChildrenBd_bore_readen;
  wire [6:0]  bd_addr_rd = boreChildrenBd_bore_addr_rd;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readReqReg_waymask = _RANDOM[/*Zero width*/ 1'b0][9:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        readReqReg_waymask = 4'h0;
    end // initial
  ...
  wire [6:0]  childBd_addr;
  wire [6:0]  childBd_addr_rd;
  ...
  MbistPipeICacheData_bank6 mbistPl (
    .clock               (clock),
    .reset               (reset),
