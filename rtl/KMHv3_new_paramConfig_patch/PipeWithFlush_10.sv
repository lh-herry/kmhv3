  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_pdest = _RANDOM[6'hA][12:4];
        bits_1_fpWen = _RANDOM[6'hA][14];
        bits_1_vecWen = _RANDOM[6'hA][15];
        bits_1_v0Wen = _RANDOM[6'hA][16];
        bits_1_loadDependency_0 = _RANDOM[6'hB][13:12];
        bits_1_loadDependency_1 = _RANDOM[6'hB][15:14];
        bits_1_loadDependency_2 = _RANDOM[6'hB][17:16];
        bits_2_robIdx_flag = _RANDOM[6'h15][3];
        bits_2_robIdx_value = _RANDOM[6'h15][12:4];
        bits_2_pdest = _RANDOM[6'h15][27:19];
        bits_2_fpWen = _RANDOM[6'h15][29];
        bits_2_vecWen = _RANDOM[6'h15][30];
        bits_2_v0Wen = _RANDOM[6'h15][31];
        bits_2_loadDependency_0 = _RANDOM[6'h16][28:27];
        bits_2_loadDependency_1 = _RANDOM[6'h16][30:29];
        bits_2_loadDependency_2 = {_RANDOM[6'h16][31], _RANDOM[6'h17][0]};
        bits_3_robIdx_flag = _RANDOM[6'h20][18];
        bits_3_robIdx_value = _RANDOM[6'h20][27:19];
        bits_3_pdest = _RANDOM[6'h21][10:2];
        bits_3_fpWen = _RANDOM[6'h21][12];
        bits_3_vecWen = _RANDOM[6'h21][13];
        bits_3_v0Wen = _RANDOM[6'h21][14];
        bits_3_loadDependency_0 = _RANDOM[6'h22][11:10];
        bits_3_loadDependency_1 = _RANDOM[6'h22][13:12];
        bits_3_loadDependency_2 = _RANDOM[6'h22][15:14];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
