...
module MipModule(
  ...
  wire [6:0]  _GEN;
  wire        _regOut_MEIP_output;
  wire        _regOut_VSEIP_output;
  wire        _rdataFields_SEIP_output;
  wire        _regOut_VSTIP_output;
  wire        _regOut_STIP_output;
  reg         reg_SSIP;
  reg         reg_STIP;
  reg         reg_LCOFIP;
  assign _regOut_STIP_output = menvcfg_STCE ? platformIRP_STIP : reg_STIP;
  assign _regOut_VSTIP_output = hvip_VSTIP | platformIRP_VSTIP;
  wire        _regOut_SEIP_output = ~mvien_SEIE & mvip_SEIP;
  assign _rdataFields_SEIP_output =
    _regOut_SEIP_output | platformIRP_SEIP | aiaToCSR_seip;
  wire [63:0] _GEN_0 = {56'h0, hgeip_ip, 1'h0} >> hstatusVGEIN;
  assign _regOut_VSEIP_output = hvip_VSEIP | _GEN_0[0];
  assign _regOut_MEIP_output = platformIRP_MEIP | aiaToCSR_meip;
  ...
  assign regOut_VSTIP = _regOut_VSTIP_output;
  assign regOut_MTIP = platformIRP_MTIP;
  assign regOut_SEIP = _regOut_SEIP_output;
  assign regOut_VSEIP = _regOut_VSEIP_output;
  assign regOut_MEIP = _regOut_MEIP_output;
  ...
  assign rdataFields_STIP = _regOut_STIP_output;
  assign rdataFields_VSTIP = _regOut_VSTIP_output;
  assign rdataFields_MTIP = platformIRP_MTIP;
  assign rdataFields_SEIP = _rdataFields_SEIP_output;
  assign rdataFields_VSEIP = _regOut_VSEIP_output;
  assign rdataFields_MEIP = _regOut_MEIP_output;
