  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_uop_robIdx_flag = _RANDOM[7'h12][24];
        req_uop_robIdx_value = {_RANDOM[7'h12][31:25], _RANDOM[7'h13][1:0]};
        req_uop_lqIdx_flag = _RANDOM[7'h28][5];
        req_uop_lqIdx_value = _RANDOM[7'h28][12:6];
        req_vaddr = {_RANDOM[7'h28][31:27], _RANDOM[7'h29], _RANDOM[7'h2A][12:0]};
        req_fullva = {_RANDOM[7'h2A][31:13], _RANDOM[7'h2B], _RANDOM[7'h2C][12:0]};
        req_paddr = {_RANDOM[7'h2C][31:14], _RANDOM[7'h2D][29:0]};
        req_gpaddr = {_RANDOM[7'h2D][31:30], _RANDOM[7'h2E], _RANDOM[7'h2F][29:0]};
        req_mask = {_RANDOM[7'h2F][31:30], _RANDOM[7'h30][13:0]};
        req_nc = _RANDOM[7'h34][20];
        req_mmio = _RANDOM[7'h34][21];
        req_memBackTypeMM = _RANDOM[7'h34][22];
        req_isHyper = _RANDOM[7'h34][24];
        req_isForVSnonLeafPTE = _RANDOM[7'h34][25];
        slaveAccept = _RANDOM[7'h52][28];
        slaveId = {_RANDOM[7'h52][31:29], _RANDOM[7'h53][0]};
        uncacheState = _RANDOM[7'h53][3:1];
        uncacheData = {_RANDOM[7'h53][31:4], _RANDOM[7'h54], _RANDOM[7'h55][3:0]};
        nderr = _RANDOM[7'h55][4];
        derr = _RANDOM[7'h55][5];
        needFlushReg = _RANDOM[7'h55][6];
        pendingPtr_next_r_flag = _RANDOM[7'h55][7];
        pendingPtr_next_r_value = _RANDOM[7'h55][16:8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
