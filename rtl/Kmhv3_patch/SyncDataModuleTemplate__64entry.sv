...
module SyncDataModuleTemplate__64entry(
  ...
  assign io_rdata_0_gpaddr =
    ...
    | (index_dec[2] ? _dataBanks_2_io_rdata_0_gpaddr : 56'h0)
    | (index_dec[3] ? _dataBanks_3_io_rdata_0_gpaddr : 56'h0);
  assign io_rdata_0_isForVSnonLeafPTE =
    index_dec[0] & _dataBanks_0_io_rdata_0_isForVSnonLeafPTE | index_dec[1]
    & _dataBanks_1_io_rdata_0_isForVSnonLeafPTE | index_dec[2]
    & _dataBanks_2_io_rdata_0_isForVSnonLeafPTE | index_dec[3]
