  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_pdest = _RANDOM[4'hA][9:2];
        bits_1_fpWen = _RANDOM[4'hA][11];
        bits_1_vecWen = _RANDOM[4'hA][12];
        bits_1_v0Wen = _RANDOM[4'hA][13];
        bits_1_loadDependency_0 = _RANDOM[4'hB][10:9];
        bits_1_loadDependency_1 = _RANDOM[4'hB][12:11];
        bits_1_loadDependency_2 = _RANDOM[4'hB][14:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valids_1 = 1'h0;
    end // initial
