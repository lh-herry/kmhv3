...
module TrainFilter(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:582];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h247; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_flag = _RANDOM[10'h2F][18];
        ld_in_reordered_res_0_1_0_bits_uop_robIdx_value = _RANDOM[10'h2F][27:19];
        ld_in_reordered_res_0_1_0_bits_vaddr =
          {_RANDOM[10'h45][31:21], _RANDOM[10'h46], _RANDOM[10'h47][6:0]};
        ld_in_reordered_res_0_1_1_valid = _RANDOM[10'h5C][24];
        ld_in_reordered_res_0_1_1_bits_uop_pc =
          {_RANDOM[10'h5D][31:25], _RANDOM[10'h5E], _RANDOM[10'h5F][10:0]};
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_flag = _RANDOM[10'h6F][16];
        ld_in_reordered_res_0_1_1_bits_uop_robIdx_value = _RANDOM[10'h6F][25:17];
        ld_in_reordered_res_0_1_1_bits_vaddr =
          {_RANDOM[10'h85][31:19], _RANDOM[10'h86], _RANDOM[10'h87][4:0]};
        ld_in_reordered_res_0_1_2_valid = _RANDOM[10'h9C][22];
        ld_in_reordered_res_0_1_2_bits_uop_pc =
          {_RANDOM[10'h9D][31:23], _RANDOM[10'h9E], _RANDOM[10'h9F][8:0]};
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_flag = _RANDOM[10'hAF][14];
        ld_in_reordered_res_0_1_2_bits_uop_robIdx_value = _RANDOM[10'hAF][23:15];
        ld_in_reordered_res_0_1_2_bits_vaddr =
          {_RANDOM[10'hC5][31:17], _RANDOM[10'hC6], _RANDOM[10'hC7][2:0]};
        ld_in_reordered_res_1_2_0_valid = _RANDOM[10'hDC][20];
        ld_in_reordered_res_1_2_0_bits_uop_pc =
          {_RANDOM[10'hDD][31:21], _RANDOM[10'hDE], _RANDOM[10'hDF][6:0]};
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_flag = _RANDOM[10'hEF][12];
        ld_in_reordered_res_1_2_0_bits_uop_robIdx_value = _RANDOM[10'hEF][21:13];
        ld_in_reordered_res_1_2_0_bits_vaddr =
          {_RANDOM[10'h105][31:15], _RANDOM[10'h106], _RANDOM[10'h107][0]};
        ld_in_reordered_res_1_2_1_valid = _RANDOM[10'h11C][18];
        ld_in_reordered_res_1_2_1_bits_uop_pc =
          {_RANDOM[10'h11D][31:19], _RANDOM[10'h11E], _RANDOM[10'h11F][4:0]};
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_flag = _RANDOM[10'h12F][10];
        ld_in_reordered_res_1_2_1_bits_uop_robIdx_value = _RANDOM[10'h12F][19:11];
        ld_in_reordered_res_1_2_1_bits_vaddr =
          {_RANDOM[10'h145][31:13], _RANDOM[10'h146][30:0]};
        ld_in_reordered_res_1_2_2_valid = _RANDOM[10'h15C][16];
        ld_in_reordered_res_1_2_2_bits_uop_pc =
          {_RANDOM[10'h15D][31:17], _RANDOM[10'h15E], _RANDOM[10'h15F][2:0]};
        ld_in_reordered_res_1_2_2_bits_vaddr =
          {_RANDOM[10'h185][31:11], _RANDOM[10'h186][28:0]};
        ld_in_reordered_0_valid = _RANDOM[10'h19C][14];
        ld_in_reordered_0_bits_uop_pc =
          {_RANDOM[10'h19D][31:15], _RANDOM[10'h19E], _RANDOM[10'h19F][0]};
        ld_in_reordered_0_bits_vaddr = {_RANDOM[10'h1C5][31:9], _RANDOM[10'h1C6][26:0]};
        ld_in_reordered_1_valid = _RANDOM[10'h1DC][12];
        ld_in_reordered_1_bits_uop_pc = {_RANDOM[10'h1DD][31:13], _RANDOM[10'h1DE][30:0]};
        ld_in_reordered_1_bits_vaddr = {_RANDOM[10'h205][31:7], _RANDOM[10'h206][24:0]};
        ld_in_reordered_2_valid = _RANDOM[10'h21C][10];
        ld_in_reordered_2_bits_uop_pc = {_RANDOM[10'h21D][31:11], _RANDOM[10'h21E][28:0]};
        ld_in_reordered_2_bits_vaddr = {_RANDOM[10'h245][31:5], _RANDOM[10'h246][22:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
