...
module SourceC(
  ...
  output [4:0]   io_out_bits_user_reqSource,
  ...
  wire [8:0]   _queue_io_deq_bits_set;
  wire [30:0]  _queue_io_deq_bits_tag;
  ...
  wire [4:0]   _queue_io_deq_bits_reqSource;
  ...
  wire         _io_resp_valid_T = io_out_ready & (|beatsOH);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      beatValids_0 <= 1'h0;
      beatValids_1 <= 1'h0;
      taskR_task_set <= 9'h0;
      taskR_task_tag <= 31'h0;
      taskR_task_off <= 6'h0;
      taskR_task_opcode <= 4'h0;
      taskR_task_param <= 3'h0;
      taskR_task_mshrId <= 8'h0;
      taskR_task_dirty <= 1'h0;
      taskR_task_reqSource <= 5'h0;
      taskR_data_data <= 512'h0;
    end
    else begin
      beatValids_0 <=
        _io_resp_valid_T
          ? taskR_task_opcode[0] & beatValids_0 & _next_beatsOH_T[0]
          : _GEN | beatValids_0;
      beatValids_1 <=
        _io_resp_valid_T
          ? taskR_task_opcode[0] & beatValids_1 & _next_beatsOH_T[1]
          : _GEN | beatValids_1;
      if (_GEN) begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        taskR_task_tag = {_RANDOM[5'h0][31:17], _RANDOM[5'h1][15:0]};
        ...
        taskR_task_reqSource = _RANDOM[5'h5][14:10];
        taskR_data_data =
          {_RANDOM[5'h8][31:26],
           _RANDOM[5'h9],
           _RANDOM[5'hA],
