...
module StrideMetaArray(
  ...
  wire [3:0]        s0_index =
    (|s0_pc_match_vec)
      ? {|{_s0_pc_match_vec_WIRE_9, _s0_pc_match_vec_WIRE_8},
         |(_s0_index_T_1[6:3]),
         |(_s0_index_T_3[2:1]),
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s3_l1_pf_req_bits_confidence = _RANDOM[6'h16][5];
        s3_l2_pf_req_bits_region = {_RANDOM[6'h19][31:10], _RANDOM[6'h1A][17:0]};
        s3_l2_pf_req_bits_bit_vec = {_RANDOM[6'h1A][31:18], _RANDOM[6'h1B][1:0]};
        s4_valid_last_REG = _RANDOM[6'h1E][12];
        s4_l2_pf_req_bits_region = {_RANDOM[6'h1E][31:13], _RANDOM[6'h1F][20:0]};
        s4_l2_pf_req_bits_bit_vec = {_RANDOM[6'h1F][31:21], _RANDOM[6'h20][4:0]};
        last_REG = _RANDOM[6'h23][15];
        last_REG_1 = _RANDOM[6'h23][16];
        last_REG_2 = _RANDOM[6'h23][17];
        last_REG_3 = _RANDOM[6'h23][18];
        last_REG_4 = _RANDOM[6'h23][19];
        last_REG_5 = _RANDOM[6'h23][20];
        last_REG_6 = _RANDOM[6'h23][21];
        last_REG_7 = _RANDOM[6'h23][22];
        last_REG_8 = _RANDOM[6'h23][23];
        last_REG_9 = _RANDOM[6'h23][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
