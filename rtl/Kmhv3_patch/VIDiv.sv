  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[5'h0][31];
        outCtrl_r_vpu_vta = _RANDOM[5'h1][0];
        outCtrl_r_vpu_vsew = _RANDOM[5'h1][2:1];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][14];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][22:15];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][9:3];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h6][26];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h6][27];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:21],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:21],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][20:0]};
        outData_r_vl = _RANDOM[5'h17][28:21];
        io_out_bits_ctrl_toRobValid_r = _RANDOM[5'h1B][29];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][30];
        io_out_bits_ctrl_robIdx_r_value = {_RANDOM[5'h1B][31], _RANDOM[5'h1C][7:0]};
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1C][15:8];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1C][16];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1C][17];
      `endif // RANDOMIZE_REG_INIT
    end // initial
