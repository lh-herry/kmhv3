...
module VSSplitBufferImp(
  ...
  output [5:0]   io_vstd_bits_sqIdx_value
);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_ftqPtr_value = _RANDOM[7'h13][8:3];
        uopq_uop_ftqOffset = _RANDOM[7'h13][13:9];
        uopq_uop_fuOpType = _RANDOM[7'h15][22:14];
        uopq_uop_vpu_vuopIdx = _RANDOM[7'h18][24:18];
        uopq_uop_robIdx_flag = _RANDOM[7'h21][27];
        uopq_uop_robIdx_value = {_RANDOM[7'h21][31:28], _RANDOM[7'h22][4:0]};
        uopq_uop_sqIdx_flag = _RANDOM[7'h37][16];
        uopq_uop_sqIdx_value = _RANDOM[7'h37][22:17];
        uopq_preIsSplit = _RANDOM[7'h3C][2];
        uopq_mBIndex = _RANDOM[7'h3C][6:3];
        uopq_alignedType = _RANDOM[7'h3C][9:7];
        uopq_indexVlMaxInVd = _RANDOM[7'h3C][17:10];
        uopq_usAligned128 = _RANDOM[7'h3C][22];
        uopq_usMask = {_RANDOM[7'h3C][31:23], _RANDOM[7'h3D][22:0]};
        allocated = _RANDOM[7'h3D][23];
        splitIdx = _RANDOM[7'h3D][28:24];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:29],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
