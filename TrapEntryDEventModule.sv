...
module TrapEntryDEventModule(
  ...
  reg         out_targetPc_valid_REG;
  reg  [29:0] out_targetPc_bits_pc_r;
  wire        hasExceptionInDmode = in_debugMode & in_hasTrap;
  wire        _out_targetPc_bits_pc_T = valid | hasExceptionInDmode;
  always @(posedge clock) begin
    out_targetPc_valid_REG <= _out_targetPc_bits_pc_T;
    if (_out_targetPc_bits_pc_T)
      out_targetPc_bits_pc_r <= {26'h3802080, hasExceptionInDmode & ~in_breakPoint, 3'h0};
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_targetPc_valid_REG = _RANDOM[/*Zero width*/ 1'b0][0];
        out_targetPc_bits_pc_r = _RANDOM[/*Zero width*/ 1'b0][30:1];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign out_dpc_valid = valid & ~in_holdDpc;
    ...
    in_isFetchMalAddr
      ...
      : (trapPC_isBare_isModeM | _trapPC_isSv48_T & ~in_iMode_V & in_satp_MODE == 4'h0
        ...
        | (in_iMode_V & _trapPC_isSv48x4_T_2 & in_hgatp_MODE == 4'h9
             ...
             : 63'h0);
  assign out_targetPc_valid = out_targetPc_valid_REG;
  assign out_targetPc_bits_pc = {34'h0, out_targetPc_bits_pc_r};
