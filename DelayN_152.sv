  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_bits_exceptionVec_0 = _RANDOM[4'h2][21];
        REG_bits_exceptionVec_1 = _RANDOM[4'h2][22];
        REG_bits_exceptionVec_2 = _RANDOM[4'h2][23];
        REG_bits_exceptionVec_3 = _RANDOM[4'h2][24];
        REG_bits_exceptionVec_4 = _RANDOM[4'h2][25];
        REG_bits_exceptionVec_5 = _RANDOM[4'h2][26];
        REG_bits_exceptionVec_6 = _RANDOM[4'h2][27];
        REG_bits_exceptionVec_7 = _RANDOM[4'h2][28];
        REG_bits_exceptionVec_8 = _RANDOM[4'h2][29];
        REG_bits_exceptionVec_9 = _RANDOM[4'h2][30];
        REG_bits_exceptionVec_10 = _RANDOM[4'h2][31];
        REG_bits_exceptionVec_11 = _RANDOM[4'h3][0];
        REG_bits_exceptionVec_12 = _RANDOM[4'h3][1];
        REG_bits_exceptionVec_13 = _RANDOM[4'h3][2];
        REG_bits_exceptionVec_14 = _RANDOM[4'h3][3];
        REG_bits_exceptionVec_15 = _RANDOM[4'h3][4];
        REG_bits_exceptionVec_16 = _RANDOM[4'h3][5];
        REG_bits_exceptionVec_17 = _RANDOM[4'h3][6];
        REG_bits_exceptionVec_18 = _RANDOM[4'h3][7];
        REG_bits_exceptionVec_19 = _RANDOM[4'h3][8];
        REG_bits_exceptionVec_20 = _RANDOM[4'h3][9];
        REG_bits_exceptionVec_21 = _RANDOM[4'h3][10];
        REG_bits_exceptionVec_22 = _RANDOM[4'h3][11];
        REG_bits_exceptionVec_23 = _RANDOM[4'h3][12];
        REG_bits_isPcBkpt = _RANDOM[4'h3][13];
        REG_bits_isFetchMalAddr = _RANDOM[4'h3][14];
        REG_bits_gpaddr = {_RANDOM[4'h3][31:15], _RANDOM[4'h4], _RANDOM[4'h5][14:0]};
        REG_bits_singleStep = _RANDOM[4'h5][15];
        REG_bits_crossPageIPFFix = _RANDOM[4'h5][16];
        REG_bits_isInterrupt = _RANDOM[4'h5][17];
        REG_bits_isHls = _RANDOM[4'h5][18];
        REG_bits_trigger = _RANDOM[4'h5][23:20];
        REG_bits_isForVSnonLeafPTE = _RANDOM[4'h5][24];
        REG_1_valid = _RANDOM[4'h5][25];
        REG_1_bits_pc = {_RANDOM[4'h5][31:26], _RANDOM[4'h6], _RANDOM[4'h7][11:0]};
        REG_1_bits_exceptionVec_0 = _RANDOM[4'h8][14];
        REG_1_bits_exceptionVec_1 = _RANDOM[4'h8][15];
        REG_1_bits_exceptionVec_2 = _RANDOM[4'h8][16];
        REG_1_bits_exceptionVec_3 = _RANDOM[4'h8][17];
        REG_1_bits_exceptionVec_4 = _RANDOM[4'h8][18];
        REG_1_bits_exceptionVec_5 = _RANDOM[4'h8][19];
        REG_1_bits_exceptionVec_6 = _RANDOM[4'h8][20];
        REG_1_bits_exceptionVec_7 = _RANDOM[4'h8][21];
        REG_1_bits_exceptionVec_8 = _RANDOM[4'h8][22];
        REG_1_bits_exceptionVec_9 = _RANDOM[4'h8][23];
        REG_1_bits_exceptionVec_10 = _RANDOM[4'h8][24];
        REG_1_bits_exceptionVec_11 = _RANDOM[4'h8][25];
        REG_1_bits_exceptionVec_12 = _RANDOM[4'h8][26];
        REG_1_bits_exceptionVec_13 = _RANDOM[4'h8][27];
        REG_1_bits_exceptionVec_14 = _RANDOM[4'h8][28];
        REG_1_bits_exceptionVec_15 = _RANDOM[4'h8][29];
        REG_1_bits_exceptionVec_16 = _RANDOM[4'h8][30];
        REG_1_bits_exceptionVec_17 = _RANDOM[4'h8][31];
        REG_1_bits_exceptionVec_18 = _RANDOM[4'h9][0];
        REG_1_bits_exceptionVec_19 = _RANDOM[4'h9][1];
        REG_1_bits_exceptionVec_20 = _RANDOM[4'h9][2];
        REG_1_bits_exceptionVec_21 = _RANDOM[4'h9][3];
        REG_1_bits_exceptionVec_22 = _RANDOM[4'h9][4];
        REG_1_bits_exceptionVec_23 = _RANDOM[4'h9][5];
        REG_1_bits_isPcBkpt = _RANDOM[4'h9][6];
        REG_1_bits_isFetchMalAddr = _RANDOM[4'h9][7];
        REG_1_bits_gpaddr = {_RANDOM[4'h9][31:8], _RANDOM[4'hA], _RANDOM[4'hB][7:0]};
        REG_1_bits_singleStep = _RANDOM[4'hB][8];
        REG_1_bits_crossPageIPFFix = _RANDOM[4'hB][9];
        REG_1_bits_isInterrupt = _RANDOM[4'hB][10];
        REG_1_bits_isHls = _RANDOM[4'hB][11];
        REG_1_bits_trigger = _RANDOM[4'hB][16:13];
        REG_1_bits_isForVSnonLeafPTE = _RANDOM[4'hB][17];
      `endif // RANDOMIZE_REG_INIT
    end // initial
